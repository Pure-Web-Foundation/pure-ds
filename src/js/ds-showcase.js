...
export class DsShowcase extends LitElement {
  ...
  scrollToRelevantSection(fieldPath) {
    ...
    const normalizedPath = fieldPath.startsWith('/') ? fieldPath.slice(1) : fieldPath;
    ...
    if (sectionId) {
      ...
      console.log(`  Searching for section: [data-section="${sectionId}"]`, section ? '✓ Found' : '✗ Not found');
      ...
      if (section) {
        ...
        console.warn(`  ✗ Section [data-section="${sectionId}"] not found in DOM`);
      }
    } else {
    ...
    return html`
      <div class="showcase-container">
        ...
        <section class="showcase-hero">
          ...
          <p>Build beautiful, accessible design systems with pure web standards</p>
          <div class="btn-group">
        ...
        <section class="showcase-section" data-section="color-system">
          ...
          <div class="semantic-usage">
            <div class="semantic-message success">
              <svg-icon icon="check-circle" class="icon-success" size="lg"></svg-icon>
              <div>
          ...
          <div class="gray-scale-grid">
            ${[50, 100, 200, 300, 400, 500, 600, 700, 800].map(shade => html`
        ...
        <section class="showcase-section alt-bg">
          ...
          <p>Complete 9-step color scales (50-800) automatically generated from your base colors. Each scale maintains proper contrast and color relationships.</p>
          ...
          <p class="interactive-demo">These colors are automatically derived from your primary color with intelligent hue shifting for semantic meaning.</p>
          
          ${this.renderColorScale('success')}
          ${this.renderColorScale('warning')}
          ${this.renderColorScale('danger')}
        ...
        <section class="showcase-section alt-bg" data-section="typography">
          ...
          <div class="demo-grid cols-1">
            ...
            <p>Regular paragraph text with <a href="#">a link</a> and <code>inline code</code>.</p>
          </div>
        </section>
        ...
        <section class="showcase-section" data-section="buttons">
          <h2>
            <svg-icon icon="cursor-click" size="lg" class="icon-primary"></svg-icon>
            Buttons
          </h2>
        ...
        <section class="showcase-section alt-bg" data-section="forms">
          <h2>
            <svg-icon icon="note-pencil" size="lg" class="icon-primary"></svg-icon>
            Form Controls
          </h2>
          
          <form class="form-demo" onsubmit="event.preventDefault(); console.log('Form submitted (prevented)'); return false;">
            <fieldset>
        ...
        ` : this.renderDisabledSection('Form Controls', 'Form styles are disabled. Enable in the designer panel.')}

        <!-- Alerts Section -->
        ${components.alerts ? html`
        <section class="showcase-section" data-section="alerts">
          <h2>
            <svg-icon icon="bell-ringing" size="lg" class="icon-primary"></svg-icon>
            Alerts & Feedback
          </h2>
        ...
        ` : this.renderDisabledSection('Alerts & Feedback', 'Alert styles are disabled. Enable in the designer panel.')}
        ...
        ` : this.renderDisabledSection('Badges & Pills', 'Badge styles are disabled. Enable in the designer panel.')}
        ...
        <section class="showcase-section alt-bg">
          <h2>
            <svg-icon icon="brackets-curly" size="lg" class="icon-primary"></svg-icon>
            Enhanced Components
          </h2>
        ...
        <section class="showcase-section" data-section="icons">
          ...
          <div class="icon-colors">
            <svg-icon icon="check-circle" class="icon-primary" size="lg"></svg-icon>
            <svg-icon icon="check-circle" class="icon-secondary" size="lg"></svg-icon>
            <svg-icon icon="check-circle" class="icon-accent" size="lg"></svg-icon>
            <svg-icon icon="check-circle" class="icon-success" size="lg"></svg-icon>
            <svg-icon icon="warning" class="icon-warning" size="lg"></svg-icon>
            <svg-icon icon="x-circle" class="icon-danger" size="lg"></svg-icon>
            <svg-icon icon="info" class="icon-info" size="lg"></svg-icon>
        ...
        ` : this.renderDisabledSection('Tables', 'Table styles are disabled. Enable in the designer panel.')}

        <!-- Form Groups Section -->
        <section class="showcase-section alt-bg">
          <h2>
            <svg-icon icon="list-bullets" size="lg" class="icon-primary"></svg-icon>
            Form Groups
          </h2>
        ...
        <section class="showcase-section alt-bg" data-section="interactive-states">
          <h2>
            <svg-icon icon="cursor-click" size="lg" class="icon-primary"></svg-icon>
            Interactive States
          </h2>
          ...
          <p class="interactive-demo">
            Current setting: <strong>${this.config?.behavior?.transitionSpeed || 'normal'}</strong>
            <br>
          ...
          <p class="interactive-demo" style="margin-top: var(--spacing-4);">
            Change the <em>Transition Speed</em> setting in the designer panel to see how it affects the animation.
          </p>
        </section>
        ...
        <section class="showcase-section">
          ...
          <div class="demo-grid cols-2">
            ...
            <button class="btn-outline" @click="${this.showPersistentToast}">
              <svg-icon icon="bell" size="sm"></svg-icon>
              Persistent Toast
            </button>
          </div>
        </section>
        ` : this.renderDisabledSection('Toast Notifications', 'Toast notifications are disabled. Enable in the designer panel.')}

        ${this.config?.components?.tabStrip ? html`
        <!-- Tab Strip Section -->
        <section class="showcase-section alt-bg" data-section="tabs">
          ...
          <p>Accessible tab navigation with hash-based routing and keyboard support.</p>

          <div style="margin-top: var(--spacing-6);">
            <tab-strip label="Example Tabs">
              <tab-panel id="overview" label="Overview">
                <h3>Overview</h3>
                <p>This is the overview tab. Tab strips provide organized navigation between related content.</p>
                <p>Features include:</p>
                <ul>
                  <li>Hash-based routing (shareable URLs)</li>
                  <li>Keyboard navigation (Arrow keys)</li>
                  <li>Accessible ARIA attributes</li>
                  <li>Light DOM rendering for natural page CSS</li>
                </ul>
              </tab-panel>

              <tab-panel id="features" label="Features">
                <h3>Features</h3>
                <p>Tab strips are built with modern web components and include:</p>
                <ul>
                  <li><strong>Deep linking:</strong> Each tab has a unique URL hash</li>
                  <li><strong>Progressive enhancement:</strong> Works without JavaScript</li>
                  <li><strong>Responsive:</strong> Adapts to mobile and desktop</li>
                  <li><strong>Customizable:</strong> Style with CSS variables</li>
                </ul>
              </tab-panel>
...
&lt;/tab-strip&gt;</code></pre>
  ...
  showSuccessToast() {
    ...
    if (app?.toast) {
      app.toast('Your changes have been saved successfully!', { type: 'success' });
    }
  }
  ...
  showInfoToast() {
    const app = document.querySelector('pure-app');
    if (app?.toast) {
      app.toast('This is an informational message with helpful context.', { type: 'info' });
    }
  }
  ...
  showErrorToast() {
    const app = document.querySelector('pure-app');
    if (app?.toast) {
      app.toast('Error: Something went wrong. Please try again.', { type: 'error' });
    }
  }
  ...
  showLongToast() {
    const app = document.querySelector('pure-app');
    if (app?.toast) {
      app.toast('This is a longer toast notification message that demonstrates how the duration is automatically calculated based on the message length. The toast will stay visible longer to give you enough time to read the entire message.', { type: 'info' });
    }
  }
  ...
  showPersistentToast() {
    const app = document.querySelector('pure-app');
    if (app?.toast) {
      app.toast('This is a persistent toast that won\'t auto-dismiss. Click the × to close it.', { 
        type: 'info', 
        persistent: true 
      });
    }
  ...
  renderColorCard(name, color) {
    return html`
      <div class="color-card">
        <div class="color-card-header" style="background-color: var(--color-${color}-600);">
          ${name}
        </div>
        <div class="color-card-body">
          ...
          <p class="color-card-footer">
            9-step scale from 50 to 800
          </p>
        </div>
      </div>
    `;
