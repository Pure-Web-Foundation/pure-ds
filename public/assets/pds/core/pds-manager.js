...
`];return Object.entries(t).forEach(([n,o])=>{let a=n.replace(/^font/,"").replace(/^(.)/,i=>i.toLowerCase()).replace(/([A-Z])/g,"-$1").toLowerCase();Object.entries(o).forEach(([i,s])=>{let u=i.replace(/([A-Z])/g,"-$1").toLowerCase();r.push(`  --font-${a}-${u}: ${s};
`)})}),`${r.join("")}
`}#y(t){let r=[`  /* Shadows */
...
`)}),`${r.join("")}
`}#te(t,r){if(!t?.dark)return"";let n=[],o=(b,S="")=>{Object.entries(b).forEach(([C,E])=>{typeof E=="object"&&E!==null?o(E,`${S}${C}-`):typeof E=="string"&&n.push(`  --color-${S}${C}: ${E};
...
`));let u=[];t.surfaceAccent?.dark&&(u.push(`  /* Surface-Aware Accent Text Tokens (dark mode) */
`),Object.entries(t.surfaceAccent.dark).forEach(([b,S])=>{u.push(`  --surface-${b}-accent-text: ${S.text};
`),u.push(`  --surface-${b}-accent-text-hover: ${S.textHover};
...
`));let d=[];t.successInteractive?.dark&&(d.push(`  /* Success Role Colors (dark mode) */
`),d.push(`  --color-success-fill: ${t.successInteractive.dark.fill};
`),d.push(`  --color-success-fill-hover: ${t.successInteractive.dark.fillHover};
`),d.push(`  --color-success-fill-active: ${t.successInteractive.dark.fillActive};
`),d.push(`  --color-success-text: ${t.successInteractive.dark.text};
`),d.push(`  --color-success-text-hover: ${t.successInteractive.dark.textHover};
`),d.push(`  --color-success-contrast: ${t.successInteractive.dark.contrast};
...
`));let h=[];t.surfaceStatus?.dark&&(h.push(`  /* Surface-Aware Status Text Tokens (dark mode) */
`),Object.entries(t.surfaceStatus.dark).forEach(([b,S])=>{Object.entries(S).forEach(([C,E])=>{h.push(`  --surface-${C}-${b}-text: ${E.text};
`),h.push(`  --surface-${C}-${b}-text-hover: ${E.textHover};
`)})}));let m=[`  /* Semantic Callout Display Tokens (dark mode) */
`];for(let b of["success","info","warning","danger"])m.push(`  --color-${b}-display-bg: color-mix(in oklab, var(--color-${b}-400) 12%, var(--color-surface-base));
`),m.push(`  --color-${b}-display-border: var(--color-${b}-400);
`),m.push(`  --color-${b}-display-text: var(--color-${b}-100);
...
${[...n,...a,...y,v,...i,...s,...u,...l,...d,...c,...p,...h,...m,g,f].join("")}}
`}#re(t,r){if(!t?.dark)return"";let n=[],o=(b,S="")=>{Object.entries(b).forEach(([C,E])=>{typeof E=="object"&&E!==null?o(E,`${S}${C}-`):typeof E=="string"&&n.push(`    --color-${S}${C}: ${E};
`)})};Object.entries(t.dark).forEach(([b,S])=>{b!=="surfaceSmart"&&typeof S=="object"&&S!==null&&o(S,`${b}-`)});let a=[];t.dark.surfaceSmart&&(a.push(`    /* Smart Surface Tokens (dark mode, context-aware) */
`),Object.entries(t.dark.surfaceSmart).forEach(([b,S])=>{a.push(`    --surface-${b}-bg: ${S.bg};
`),a.push(`    --surface-${b}-text: ${S.text};
`),a.push(`    --surface-${b}-text-secondary: ${S.textSecondary};
...
${[...n,...a,...y,v,...s,...u,...l,...d,...c,...p,...h,...m,g,f].join("")}       }
...
`}#de(){let{shape:t={},spatialRhythm:r={},inputPadding:n,buttonPadding:o,focusRingWidth:a,focusRingOpacity:i,borderWidthThin:s,sectionSpacing:u,buttonMinHeight:l,inputMinHeight:d}=this.options.design,c=typeof t.borderWidth=="number"?t.borderWidth:typeof t.borderWidth=="string"?$.BorderWidths[t.borderWidth]??null:null,p=r.inputPadding??n??.75,h=r.buttonPadding??o??1,m=a||3,v=s||c||$.BorderWidths.thin,g=r.sectionSpacing??u??2,f=l||30;return`/* Mobile-First Form Styles - Generated from Design Config */
form {
  margin: 0;
  width: 100%;
}
...
input, textarea, select {
  ...
  &:invalid {
    ...
    &:focus {
      box-shadow: 0 0 0 ${m}px color-mix(in oklab, var(--color-danger-fill) ${Math.round((i||.3)*100)}%, transparent);
    }
  }
}
...
input.input-otp {
  ...
  &:focus {
    box-shadow:
      ...
      0 0 0 ${m}px color-mix(in oklab, var(--color-focus-ring, var(--color-primary-500)) ${Math.round((i||.3)*100)}%, transparent);
  }
...
:is(
  ...
  input[type="checkbox"]:focus + label:not(fieldset label):not(label[data-toggle]) {
    outline: none;
    box-shadow: 0 0 0 ${m}px color-mix(in oklab, var(--color-focus-ring, var(--color-primary-500)) ${Math.round((i||.3)*100)}%, transparent);
  }
...
button, .btn, input[type="submit"], input[type="button"], input[type="reset"] {
  --btn-pad-y: max(calc(var(--spacing-1) * ${h}), var(--spacing-2));
...
.btn-sm {
  --btn-pad-y: calc(max(calc(var(--spacing-1) * ${h}), var(--spacing-2)) * 0.85);
...
.btn-xs {
  --btn-pad-y: calc(max(calc(var(--spacing-1) * ${h}), var(--spacing-2)) * 0.7);
...
.btn-lg {
  --btn-pad-y: calc(max(calc(var(--spacing-1) * ${h}), var(--spacing-2)) * 1.15);
...
`}#xe(){let{layout:t={}}=this.options.design,r=t.breakpoints||{sm:640,md:768,lg:1024,xl:1280},n=t.gridSystem||{},o=n.columns||[1,2,3,4,6],a=n.autoFitBreakpoints||{sm:"150px",md:"250px",lg:"350px",xl:"450px"},i=this.#A(t),s=[`
/* ============================================================================
   Layout Utilities
...
`];for(let u of o)s.push(`.grid-cols-${u} { grid-template-columns: repeat(${u}, 1fr); }
`);s.push(`
/* Auto-fit grids (responsive) */
`);for(let[u,l]of Object.entries(a))s.push(`.grid-auto-${u} { grid-template-columns: repeat(auto-fit, minmax(${l}, 1fr)); }
`);return s.push(`
/* Gap utilities */
...
`}#s(t){let r=parseInt(t.slice(1,3),16)/255,n=parseInt(t.slice(3,5),16)/255,o=parseInt(t.slice(5,7),16)/255,a=Math.max(r,n,o),i=Math.min(r,n,o),s,u,l=(a+i)/2;if(a===i)s=u=0;else{let d=a-i;switch(u=l>.5?d/(2-a-i):d/(a+i),a){case r:s=(n-o)/d+(n<o?6:0);break;case n:s=(o-r)/d+2;break;case o:s=(r-n)/d+4;break}s/=6}return{h:s*360,s:u*100,l:l*100}}#t(t,r,n){t=t/360,r=r/100,n=n/100;let o=(l,d,c)=>(c<0&&(c+=1),c>1&&(c-=1),c<1/6?l+(d-l)*6*c:c<1/2?d:c<2/3?l+(d-l)*(2/3-c)*6:l),a,i,s;if(r===0)a=i=s=n;else{let l=n<.5?n*(1+r):n+r-n*r,d=2*n-l;a=o(d,l,t+1/3),i=o(d,l,t),s=o(d,l,t-1/3)}let u=l=>{let d=Math.round(l*255).toString(16);return d.length===1?"0"+d:d};return`#${u(a)}${u(i)}${u(s)}`}getTokens(){return this.tokens}exportCSS(){return this.layeredCSS}#Se(){this.#e={tokens:this.#$e(),primitives:this.#ze(),components:this.#Le(),utilities:this.#Ce()},this.options.debug&&this.options.log?.("debug","[Generator] Layer sizes:",{tokens:`${(this.#e.tokens.length/1024).toFixed(2)} KB`,primitives:`${(this.#e.primitives.length/1024).toFixed(2)} KB`,components:`${(this.#e.components.length/1024).toFixed(2)} KB`,utilities:`${(this.#e.utilities.length/1024).toFixed(2)} KB`})}#$e(){let{colors:t,spacing:r,radius:n,borderWidths:o,typography:a,shadows:i,darkShadows:s,layout:u,transitions:l,zIndex:d,icons:c}=this.tokens,p=[`@layer tokens {
       :root {
          ${this.#q(t)}
          ${this.#G(r)}
          ${this.#K(n)}
...
`}};function Dr(e={},t={}){let r=Number(t.minContrast||4.5),n=Number(t.minMutedContrast||3),o=!!t.extendedChecks,a=t.warnOnHueDrift!==!1,i=Number.isFinite(Number(t.maxHueDrift))?Number(t.maxHueDrift):35,s=Number.isFinite(Number(t.minSaturationForHueWarning))?Number(t.minSaturationForHueWarning):18,u=g=>{let y=String(g||"").trim().match(/^#?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/);if(!y)return null;let x=y[1];return`#${(x.length===3?x.split("").map(S=>S+S).join(""):x).toLowerCase()}`},l=g=>{let f=u(g);if(!f)return null;let y=f.replace("#",""),x=y.length===3?y.split("").map(S=>S+S).join(""):y,b=parseInt(x||"0",16);return{r:b>>16&255,g:b>>8&255,b:b&255}},d=g=>{let f=l(g);if(!f)return 0;let{r:y,g:x,b}=f,S=[y/255,x/255,b/255].map(C=>C<=.03928?C/12.92:Math.pow((C+.055)/1.055,2.4));return .2126*S[0]+.7152*S[1]+.0722*S[2]},c=(g,f)=>{if(!g||!f)return 0;let y=d(g),x=d(f),b=Math.max(y,x),S=Math.min(y,x);return(b+.05)/(S+.05)},p=g=>{let f=l(g);if(!f)return null;let y=f.r/255,x=f.g/255,b=f.b/255,S=Math.max(y,x,b),C=Math.min(y,x,b),E=S-C,T=0;E!==0&&(S===y?T=(x-b)/E%6:S===x?T=(b-y)/E+2:T=(y-x)/E+4,T*=60,T<0&&(T+=360));let R=(S+C)/2,A=E===0?0:E/(1-Math.abs(2*R-1));return{h:T,s:A*100,l:R*100}},h=(g,f)=>{if(!Number.isFinite(g)||!Number.isFinite(f))return null;let y=Math.abs(g-f);return Math.min(y,360-y)},m=[],v=[];try{let f=new X({design:structuredClone(e)}).tokens.colors,y={surfaceBg:f.surface?.base,surfaceText:f.gray?.[900]||"#000000",surfaceTextSecondary:f.gray?.[700]||f.gray?.[800]||f.gray?.[900],surfaceTextMuted:f.gray?.[500]||f.gray?.[600]||f.gray?.[700],surfaceElevated:f.surface?.elevated||f.surface?.base,primaryFill:f.interactive?.light?.fill||f.primary?.[600],primaryText:f.interactive?.light?.text||f.primary?.[600],accentFill:f.accent?.[600]||f.accent?.[500],successFill:f.success?.[600]||f.success?.[500],warningFill:f.warning?.[600]||f.warning?.[500],dangerFill:f.danger?.[600]||f.danger?.[500],infoFill:f.info?.[600]||f.info?.[500]},x=T=>Math.max(c(T,"#ffffff"),c(T,"#000000")),b=c(y.primaryFill,"#ffffff");b<r&&m.push({path:"/colors/primary",message:`Primary button contrast too low in light theme (${b.toFixed(2)} < ${r}). Choose a darker primary.`,ratio:b,min:r,context:"light/btn-primary"});let S=c(y.surfaceBg,y.surfaceText);if(S<r&&m.push({path:"/colors/background",message:`Base text contrast on surface (light) is too low (${S.toFixed(2)} < ${r}). Adjust background or secondary (gray).`,ratio:S,min:r,context:"light/surface-text"}),o){let T=c(y.surfaceBg,y.surfaceTextSecondary);T<r&&m.push({path:"/colors/secondary",message:`Secondary text contrast on base surface (light) is too low (${T.toFixed(2)} < ${r}).`,ratio:T,min:r,context:"light/surface-text-secondary"});let R=c(y.surfaceBg,y.surfaceTextMuted);R<n&&m.push({path:"/colors/secondary",message:`Muted text contrast on base surface (light) is too low (${R.toFixed(2)} < ${n}).`,ratio:R,min:n,context:"light/surface-text-muted"});let A=c(y.surfaceElevated,y.surfaceText);A<r&&m.push({path:"/colors/background",message:`Elevated surface text contrast (light) is too low (${A.toFixed(2)} < ${r}).`,ratio:A,min:r,context:"light/surface-elevated-text"})}let C=c(y.primaryText,y.surfaceBg);C<r&&m.push({path:"/colors/primary",message:`Primary text on surface is too low for outline/link styles (light) (${C.toFixed(2)} < ${r}). Choose a darker primary or lighter surface.`,ratio:C,min:r,context:"light/outline"}),o&&[{path:"/colors/accent",key:"accent",value:y.accentFill},{path:"/colors/success",key:"success",value:y.successFill},{path:"/colors/warning",key:"warning",value:y.warningFill},{path:"/colors/danger",key:"danger",value:y.dangerFill},{path:"/colors/info",key:"info",value:y.infoFill}].forEach(R=>{if(!R?.value)return;let A=x(R.value);A<r&&m.push({path:R.path,message:`${R.key} fill color cannot achieve accessible text contrast (${A.toFixed(2)} < ${r}) with either white or black text.`,ratio:A,min:r,context:`light/${R.key}-fill`})});let E=f.dark;if(E){let T={surfaceBg:E.surface?.base||f.surface?.inverse,surfaceText:E.gray?.[50]||E.gray?.[100]||"#ffffff",surfaceTextMuted:E.gray?.[300]||E.gray?.[400]||E.gray?.[500],primaryFill:f.interactive?.dark?.fill||E.primary?.[600],primaryText:f.interactive?.dark?.text||E.primary?.[600]},R=c(T.primaryFill,"#ffffff");R<r&&m.push({path:"/colors/darkMode/primary",message:`Primary button contrast too low in dark theme (${R.toFixed(2)} < ${r}). Override darkMode.primary or pick a brighter hue.`,ratio:R,min:r,context:"dark/btn-primary"});let A=c(T.primaryText,T.surfaceBg);if(A<r&&m.push({path:"/colors/darkMode/primary",message:`Primary text on surface is too low for outline/link styles (dark) (${A.toFixed(2)} < ${r}). Override darkMode.primary/background.`,ratio:A,min:r,context:"dark/outline"}),o){let j=c(T.surfaceBg,T.surfaceText);j<r&&m.push({path:"/colors/darkMode/background",message:`Base text contrast on surface (dark) is too low (${j.toFixed(2)} < ${r}).`,ratio:j,min:r,context:"dark/surface-text"});let M=c(T.surfaceBg,T.surfaceTextMuted);M<n&&m.push({path:"/colors/darkMode/secondary",message:`Muted text contrast on surface (dark) is too low (${M.toFixed(2)} < ${n}).`,ratio:M,min:n,context:"dark/surface-text-muted"})}}if(a){let T=e?.colors||{},R=T?.darkMode||{};["primary","secondary","accent"].forEach(j=>{let M=T?.[j],z=R?.[j];if(!M||!z)return;let L=p(M),_=p(z);if(!L||!_||L.s<s&&_.s<s)return;let k=h(L.h,_.h);k==null||k<=i||v.push({path:`/colors/darkMode/${j}`,message:`Dark mode ${j} hue drifts ${k.toFixed(1)}deg from light ${j} (${L.h.toFixed(1)}deg -> ${_.h.toFixed(1)}deg). This may reduce cross-theme brand identity consistency.`,context:`dark/identity-hue-${j}`})})}}catch(g){m.push({path:"/",message:`Validation failed: ${String(g?.message||g)}`,ratio:0,min:0})}return{ok:m.length===0,issues:m,warnings:v}}var zo=new Set(["log","warn","error","debug","info"]),Lo="__PURE_DS_PDS_SINGLETON__",Ut=null,qt=null;function Hr(){try{let t=(typeof globalThis<"u"?globalThis:window)?.[Lo];if(t&&typeof t=="object")return t}catch{return null}return null}function Co(e){return!e||typeof e!="object"?null:{mode:e.mode==="live"||e.mode==="static"?e.mode:null,debug:e.debug===!0,thisArg:e.thisArg}}function Eo(e){if(typeof e!="string")return"log";let t=e.toLowerCase();return zo.has(t)?t:"log"}function Ao(){if(typeof qt=="function")try{let t=Co(qt());if(t)return t}catch{}let e=Hr();if(e){let t=e?.mode||e?.compiled?.mode||(e?.registry?.isLive?"live":"static"),r=(e?.debug||e?.currentConfig?.debug||e?.currentConfig?.design?.debug||e?.compiled?.debug||e?.compiled?.design?.debug||!1)===!0;return{mode:t,debug:r,thisArg:e}}return{mode:null,debug:!1}}function Mo(){if(typeof Ut=="function")try{let t=Ut();if(typeof t=="function")return t}catch{}let e=Hr();return typeof e?.logHandler=="function"?e.logHandler:null}function Wr(e,t,...r){if(typeof console>"u")return;let n=typeof console[e]=="function"?console[e].bind(console):typeof console.log=="function"?console.log.bind(console):null;n&&(r.length>0?n(t,...r):n(t))}function To(e,t){let r=t?.debug===!0;return!(t?.mode==="static"&&!r||!r&&e!=="error"&&e!=="warn")}function Ur({getLogger:e,getContext:t}={}){Ut=typeof e=="function"?e:null,qt=typeof t=="function"?t:null}function xe(e="log",t,...r){let n=Eo(e),o=Ao(),a=Mo();if(a)try{a.call(o?.thisArg,n,t,...r);return}catch(i){Wr("error","Custom log handler failed:",i)}To(n,o)&&Wr(n,t,...r)}var _o="en",Ro=16,qr=5,Io=1e3,Vr="__PURE_DS_LOCALIZATION_STATE__";function Vt(){return{defaultLocale:_o,provider:null,messagesByLocale:new Map,loadingByLocale:new Map,observer:null,reconcileTimer:null,reconcileInFlight:!1,reconcileDirty:!1,selfWrittenTextNodes:new WeakSet,textNodeValueMap:new WeakMap,attributeValueMap:new WeakMap,requestedKeys:new Set,textNodeKeyMap:new WeakMap,attributeKeyMap:new WeakMap,valueToKeys:new Map,messageValueToKeys:new Map,missingWarnings:new Set,configureCount:0}}function Fo(e){let t=Vt();for(let r of Object.keys(t))r in e||(e[r]=t[r]);return e}function Po(){try{if(typeof globalThis<"u")return globalThis;if(typeof window<"u")return window}catch{return null}return null}function No(){let e=Po();if(!e)return Vt();let t=e[Vr];if(t&&typeof t=="object")return Fo(t);let r=Vt();try{e[Vr]=r}catch{}return r}var I=No(),Oo=["title","placeholder","aria-label","aria-description","aria-placeholder","aria-roledescription","alt","label"],jo=e=>!!e&&typeof e!="string"&&typeof e=="object"&&"strTag"in e;function ie(e){return String(e||"").trim().toLowerCase()}function Bo(e){let t=ie(e);return t?t.split("-")[0]||t:""}function pe(e){let t=ie(e);if(!t)return I.defaultLocale;let r=I.provider?.resolveLocale;if(typeof r=="function"){let n=ie(r(e));if(n)return n}return t}function Do(e){let t="";for(let r=0;r<=e.length-1;r+=1)t+=e[r],r<e.length-1&&(t+=`{${r}}`);return t}function we(e,t){return String(e).replace(/\{(\d+)\}/g,(r,n)=>t(Number(n)))}function Gt(e){if(!e||typeof e!="object")return{};let t={};for(let[r,n]of Object.entries(e)){if(typeof n=="string"){t[r]=n;continue}n&&typeof n=="object"&&typeof n.content=="string"&&(t[r]=n.content)}return t}function Wo(e){let t=ie(e);if(!t)return[I.defaultLocale];let r=Bo(t);return!r||r===t?[t]:[t,r]}function Xr(){let e=new Map;for(let t of I.messagesByLocale.values())if(t)for(let[r,n]of Object.entries(t)){if(typeof n!="string"||!n.length)continue;let o=e.get(n);o||(o=new Set,e.set(n,o)),o.add(r)}I.messageValueToKeys=e}function Qr(){I.textNodeValueMap=new WeakMap,I.attributeValueMap=new WeakMap}function Gr(e,t){let r=pe(e);I.messagesByLocale.set(r,Gt(t)),Xr(),Qr(),Jt()}function en(e){return typeof e!="string"||e.length===0||I.requestedKeys.has(e)?!1:(I.requestedKeys.add(e),Qr(),!0)}function Kr(e,t){if(typeof e!="string"||!e.length)return;let r=typeof t=="string"?t:String(t||"");if(!r.length)return;let n=I.valueToKeys,o=n.get(r);if(!o){for(;n.size>=Io;){let a=n.keys().next();if(a.done)break;n.delete(a.value)}o=new Set,n.set(r,o)}o.add(e)}function je(e){let t=Wo(e);for(let r of t)if(I.messagesByLocale.has(r))return{locale:r,messages:I.messagesByLocale.get(r)};return null}async function ke(e,t="explicit"){let r=pe(e),n=je(r);if(n)return n.messages;let o=r;if(I.loadingByLocale.has(o))return I.loadingByLocale.get(o);if(!I.provider)return{};let a=I.provider.loadLocale||I.provider.setLocale||null;if(typeof a!="function")return{};let i={locale:r,defaultLocale:I.defaultLocale,reason:t,loadedLocales:Array.from(I.messagesByLocale.keys()),messages:{...je(r)?.messages||{}},load:t==="set-default"||t==="explicit-load"},s;try{s=a(i)}catch{return{}}if(s&&typeof s.then=="function"){let l=s.then(d=>{let c=Gt(d);return Gr(r,c),c}).catch(()=>({})).finally(()=>{I.loadingByLocale.delete(o)});return I.loadingByLocale.set(o,l),l}let u=Gt(s);return Gr(r,u),u}function Ho(e){if(!e||typeof e!="object")return"";let r=typeof Element<"u"&&e instanceof Element||e?.nodeType===1?e:null;if(!r)return"";if(r.hasAttribute?.("lang"))return ie(r.getAttribute("lang"));let n=r.closest?.("[lang]");return n&&n.getAttribute?ie(n.getAttribute("lang")):""}function Be(e={}){if(typeof e?.lang=="string"&&e.lang.trim())return pe(e.lang);let t=e?.element||e?.scope||e?.host||e?.contextElement||null,r=Ho(t);if(r)return pe(r);if(typeof document<"u"&&document.documentElement){let n=ie(document.documentElement.getAttribute("lang"));if(n)return pe(n)}return I.defaultLocale}function Uo(e=[]){let t=new Set([I.defaultLocale]);if(typeof document>"u")return t;let r=ie(document.documentElement?.getAttribute?.("lang"));r&&t.add(pe(r));let n=o=>{let a=o?.querySelectorAll?.("[lang]")||[];for(let i of a){let s=ie(i.getAttribute("lang"));s&&t.add(pe(s))}};n(document);for(let o of e)o&&o!==document&&n(o);return t}async function qo(e){for(let t of e)await ke(t,"lang-detected")}function Vo(e){let t=!1;for(let r of Array.from(I.messagesByLocale.keys()))e.has(r)||(I.messagesByLocale.delete(r),t=!0);t&&Xr()}function Go(e){let t=String(e||""),r=(t.match(/^\s*/)||[""])[0],n=(t.match(/\s*$/)||[""])[0],o=r.length,a=t.length-n.length,i=a>=o?t.slice(o,a):"";return{leading:r,core:i,trailing:n}}function Jr(e){return String(e||"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Ko(e,t){let r=typeof e=="string"?e:String(e||""),n=typeof t=="string"?t:String(t||""),o=/\{(\d+)\}/g,a=Array.from(r.matchAll(o));if(!a.length)return r===n?[]:null;let i=[],s="^",u=0;for(let c of a){let p=c.index??0;s+=Jr(r.slice(u,p)),s+="([\\s\\S]*?)",i.push(Number(c[1])),u=p+c[0].length}s+=Jr(r.slice(u)),s+="$";let l=new RegExp(s).exec(n);if(!l)return null;let d=[];for(let c=1;c<l.length;c+=1){let p=i[c-1],h=l[c];if(Object.prototype.hasOwnProperty.call(d,p)&&d[p]!==h)return null;d[p]=h}return d}function Kt(e,t){if(typeof e!="string"||!e.length)return[];let r=[e];for(let[,n]of I.messagesByLocale.entries()){let o=n?.[e];typeof o=="string"&&o.length&&r.push(o)}for(let n of r){let o=Ko(n,t);if(o)return o}return[]}function tn(e){if(!e)return null;let t=I.valueToKeys.get(e);if(t&&t.size>0){for(let n of t)if(I.requestedKeys.has(n))return n}if(I.requestedKeys.has(e))return e;let r=I.messageValueToKeys.get(e);if(r){for(let n of r)if(I.requestedKeys.has(n))return n}return null}function rn(e){if(!e)return null;let t=null;for(let[r,n]of I.valueToKeys.entries()){if(typeof r!="string"||!r.length||r===e)continue;let o=e.indexOf(r);if(o!==-1)for(let a of n){if(!I.requestedKeys.has(a))continue;let i=Kt(a,r),s={key:a,matchedText:r,start:o,end:o+r.length,values:i};(!t||s.matchedText.length>t.matchedText.length)&&(t=s);break}}return t}function Yr(e,t){e.nodeValue!==t&&(I.selfWrittenTextNodes.add(e),e.nodeValue=t),I.textNodeValueMap.set(e,t)}async function Jo(e){if(!e||e.nodeType!==3)return;let t=e.parentElement||null;if(!t)return;let r=e.nodeValue;if(I.textNodeValueMap.get(e)===r)return;let{leading:n,core:o,trailing:a}=Go(r);if(!o){I.textNodeValueMap.set(e,r);return}let i=I.textNodeKeyMap.get(e)||null;if((!i||!I.requestedKeys.has(i))&&(i=tn(o)),!i){let p=rn(o);if(!p){I.textNodeValueMap.set(e,r);return}let h=Be({element:t});await ke(h,"text-node");let m=Se(p.key,p.values,{element:t},null),v=p.values.length?we(m,y=>p.values[y]):m,g=o.slice(0,p.start)+v+o.slice(p.end),f=`${n}${g}${a}`;Yr(e,f);return}I.textNodeKeyMap.set(e,i);let s=Be({element:t});await ke(s,"text-node");let u=Kt(i,o),l=Se(i,u,{element:t},null),d=u.length?we(l,p=>u[p]):l,c=`${n}${d}${a}`;Yr(e,c)}function Yo(){if(typeof document>"u")return{roots:[],elements:[]};let e=document.body||document.documentElement;if(!e)return{roots:[],elements:[]};let t=[],r=[],n=new Set,o=a=>{!a||n.has(a)||(n.add(a),t.push(a))};o(e);for(let a=0;a<t.length;a+=1){let i=t[a];if(!i||typeof i.querySelectorAll!="function")continue;let s=i.querySelectorAll("*");for(let u of s){r.push(u);let l=u?.shadowRoot;l&&o(l)}}return{roots:t,elements:r}}async function Zo(e){if(typeof document>"u"||I.requestedKeys.size===0||typeof document.createTreeWalker!="function")return;let t=[];for(let r of e){let n=document.createTreeWalker(r,NodeFilter.SHOW_TEXT);for(;n.nextNode();)t.push(n.currentNode)}for(let r of t)await Jo(r)}function Xo(e){let t=I.attributeKeyMap.get(e);return t||(t=new Map,I.attributeKeyMap.set(e,t)),t}function nn(e){let t=I.attributeValueMap.get(e);return t||(t=new Map,I.attributeValueMap.set(e,t)),t}function Zr(e,t,r){e.getAttribute(t)!==r&&e.setAttribute(t,r),nn(e).set(t,r)}async function Qo(e,t){if(!e||typeof e.getAttribute!="function")return;let r=e.getAttribute(t);if(typeof r!="string"||!r.length)return;let n=nn(e);if(n.get(t)===r)return;let o=Xo(e),a=o.get(t)||null;if((!a||!I.requestedKeys.has(a))&&(a=tn(r)),!a){let d=rn(r);if(!d){n.set(t,r);return}let c=Be({element:e});await ke(c,"attribute");let p=Se(d.key,d.values,{element:e},null),h=d.values.length?we(p,v=>d.values[v]):p,m=r.slice(0,d.start)+h+r.slice(d.end);Zr(e,t,m),o.set(t,d.key);return}o.set(t,a);let i=Be({element:e});await ke(i,"attribute");let s=Kt(a,r),u=Se(a,s,{element:e},null),l=s.length?we(u,d=>s[d]):u;Zr(e,t,l)}async function ea(e){if(!(typeof document>"u"||I.requestedKeys.size===0))for(let t of e)for(let r of Oo)t.hasAttribute(r)&&await Qo(t,r)}async function ta(){let e=I.requestedKeys.size>0,{roots:t,elements:r}=e?Yo():{roots:[],elements:[]},n=Uo(t);await qo(n),e&&(await Zo(t),await ea(r)),Vo(n)}async function ra(){I.reconcileInFlight=!0;let e=0;try{do I.reconcileDirty=!1,e+=1,await ta();while(I.reconcileDirty&&e<qr)}finally{I.reconcileInFlight=!1}I.reconcileDirty&&(xe("warn",`[i18n] Localization did not settle after ${qr} reconcile passes; continuing in the next scheduling window.`),Jt())}function Jt(){typeof window>"u"||(I.reconcileDirty=!0,!I.reconcileInFlight&&(I.reconcileTimer&&clearTimeout(I.reconcileTimer),I.reconcileTimer=setTimeout(()=>{I.reconcileTimer=null,ra().catch(e=>{xe("error","[i18n] Localization reconcile pass failed.",e)})},Ro)))}function Se(e,t=[],r={},n=null){let o=Be(r),a=je(o);a||ke(o,"msg");let i=je(o)?.messages||{},s=je(I.defaultLocale)?.messages||{},u={key:e,values:t,options:r,locale:o,defaultLocale:I.defaultLocale,messages:i,template:n};Object.defineProperty(u,"messagesByLocale",{enumerable:!0,configurable:!0,get(){return Object.fromEntries(I.messagesByLocale.entries())}});let l,d=!!a,c=o===I.defaultLocale;typeof I.provider?.translate=="function"&&(l=I.provider.translate(u));let p=null;if(l==null&&(l=i[e]),l==null&&(l=s[e],p=l==null?null:"default"),l==null&&(l=e,p="key"),d&&!c&&p){let m=`${o}::${e}`;I.missingWarnings.has(m)||(I.missingWarnings.add(m),xe("warn",`[i18n] Missing translation for locale "${o}" and key "${e}"; using ${p} fallback.`))}let h=typeof l=="string"?l:String(l);if(Kr(e,h),Array.isArray(t)&&t.length>0){let m=we(h,v=>t[v]);m!==h&&Kr(e,m)}return h}var na=(e,t,r={})=>{let n=Do(e);en(n);let o=Se(n,t,r,{strings:e,values:t});return we(o,a=>t[a])};var Q=(e,t={})=>{if(!e)return"";if(jo(e))return na(e.strings,e.values,t);let r=String(e),n=en(r),o=Se(r,[],t,null);return n&&!t?.element&&!t?.scope&&!t?.host&&!t?.contextElement&&!t?.lang&&Jt(),o};var Zt=class extends EventTarget{constructor(){super(),this.mode=null,this.compiled=null,this.log=()=>{},this.logHandler=null}},on="__PURE_DS_PDS_SINGLETON__",Xt=typeof globalThis<"u"?globalThis:window,Yt=Xt?.[on],w=Yt&&typeof Yt.addEventListener=="function"?Yt:new Zt;Xt&&(Xt[on]=w);typeof w.log!="function"&&(w.log=(e="log",t,...r)=>{if(typeof console>"u")return;let n=typeof console[e]=="function"?console[e].bind(console):typeof console.log=="function"?console.log.bind(console):null;n&&(r.length>0?n(t,...r):n(t))});typeof w.logHandler!="function"&&(w.logHandler=null);var Qt=class{constructor(){this._mode="static",this._staticPaths={tokens:"/assets/pds/styles/pds-tokens.css.js",primitives:"/assets/pds/styles/pds-primitives.css.js",components:"/assets/pds/styles/pds-components.css.js",utilities:"/assets/pds/styles/pds-utilities.css.js",styles:"/assets/pds/styles/pds-styles.css.js"}}setLiveMode(){this._mode="live"}setStaticMode(t={}){this._mode="static",this._staticPaths={...this._staticPaths,...t}}async getStylesheet(t){if(this._mode==="live")return null;try{return(await import(this._staticPaths[t]))[t]}catch(r){w.log("error",`Registry: failed to load static ${t}:`,r),w.log("error",`Registry: looking for ${this._staticPaths[t]}`),w.log("error","Registry: make sure you've run 'npm run pds:build' and configured PDS.start() with the correct static.root path");let n=new CSSStyleSheet;return n.replaceSync("/* Failed to load "+t+" */"),n}}get mode(){return this._mode}get isLive(){return this._mode==="live"}},$e=new Qt;function oa(e){try{if(typeof document>"u")return;if(typeof CSSStyleSheet<"u"&&"adoptedStyleSheets"in Document.prototype){let n=new CSSStyleSheet;n.replaceSync(e),n._pds=!0;let o=(document.adoptedStyleSheets||[]).filter(a=>a._pds!==!0);document.adoptedStyleSheets=[...o,n];return}let t="pds-runtime-stylesheet",r=document.getElementById(t);if(!r){r=document.createElement("style"),r.id=t,r.type="text/css";let n=document.head||document.getElementsByTagName("head")[0];n?n.appendChild(r):document.documentElement.appendChild(r)}r.textContent=e}catch(t){w.log("warn","installRuntimeStyles failed:",t)}}function an(e){let t=e;if(!t||typeof t!="object"){w.log("error","Runtime applyStyles requires an explicit generator instance in live mode");return}let r=t.layeredCSS||t.css||"";if(!r){t.options?.log?.("warn","Runtime: no CSS available on generator to apply");return}oa(r)}async function rt(e,t=[],r=null){try{let n=r?.primitivesStylesheet?r.primitivesStylesheet:await $e.getStylesheet("primitives");e.adoptedStyleSheets=[n,...t]}catch(n){let o=e.host?.tagName?.toLowerCase()||"unknown";w.log("error",`Adopter: <${o}> failed to adopt primitives:`,n),e.adoptedStyleSheets=t}}async function nt(e,t=["primitives"],r=[],n=null){let o=Array.isArray(r)?r.filter(Boolean):[];if(o.length){let i=(Array.isArray(e.adoptedStyleSheets)?e.adoptedStyleSheets:[]).filter(s=>!o.includes(s));e.adoptedStyleSheets=[...i,...o]}try{let i=(await Promise.all(t.map(async s=>{if(n)switch(s){case"tokens":return n.tokensStylesheet;case"primitives":return n.primitivesStylesheet;case"components":return n.componentsStylesheet;case"utilities":return n.utilitiesStylesheet;default:break}return $e.getStylesheet(s)}))).filter(s=>s!==null);e.adoptedStyleSheets=[...i,...o]}catch(a){let i=e.host?.tagName?.toLowerCase()||"unknown";w.log("error",`Adopter: <${i}> failed to adopt layers:`,a),e.adoptedStyleSheets=o}}function sn(e){let t=new CSSStyleSheet;return t.replaceSync(e),t}var aa=[{selector:".accordion"},{selector:"nav[data-dropdown]"},{selector:"label[data-toggle]"},{selector:"label[data-color]"},{selector:'input[autocomplete="one-time-code"]'},{selector:'input[type="range"]'},{selector:"form[data-required]"},{selector:"fieldset[role=group][data-open]"},{selector:"[data-clip]"},{selector:"button, a[class*='btn-']"}];function ia(e){e.dataset.enhancedAccordion||(e.dataset.enhancedAccordion="true",e.addEventListener("toggle",t=>{t.target.open&&t.target.parentElement===e&&e.querySelectorAll(":scope > details[open]").forEach(r=>{r!==t.target&&(r.open=!1)})},!0))}function sa(e){if(e.dataset.enhancedDropdown)return;e.dataset.enhancedDropdown="true";let t=e.lastElementChild,r=e.classList.contains("split-button");if(!t)return;let n=e.querySelector("[data-dropdown-toggle]")||e.querySelector("button"),o=typeof HTMLElement<"u"&&"showPopover"in HTMLElement.prototype&&"hidePopover"in HTMLElement.prototype;n&&!n.hasAttribute("type")&&n.setAttribute("type","button"),t.id||(t.id=`dropdown-${Math.random().toString(36).slice(2,9)}`);let a=t.tagName?.toLowerCase()==="menu",i=8;a&&!t.hasAttribute("role")&&t.setAttribute("role","menu"),t.hasAttribute("aria-hidden")||t.setAttribute("aria-hidden","true"),n&&(n.setAttribute("aria-haspopup","true"),n.setAttribute("aria-controls",t.id),n.setAttribute("aria-expanded","false"),n.setAttribute("popovertarget",t.id));let s=()=>!r||!a?null:t.querySelector(":scope > li[data-default]")||t.querySelector(":scope > li"),u=k=>k?k.querySelector(":scope > a, :scope > button")||k.firstElementChild:null,l=()=>{if(!r||!n)return null;let k=e.querySelector(":scope > [data-dropdown-default]");return k||(k=document.createElement("button"),k.setAttribute("type","button"),k.setAttribute("data-dropdown-default",""),k.className=n.className,e.insertBefore(k,n),k)},d=(k,F)=>{if(!k||!F)return;k.replaceChildren(...Array.from(F.childNodes).map(B=>B.cloneNode(!0)));let O=F.getAttribute("aria-label")||F.textContent?.replace(/\s+/g," ").trim()||Q("Default action");k.setAttribute("aria-label",O),k.title=O},c=()=>{if(!r)return;let k=l(),F=s(),O=u(F);if(!k||!O)return;d(k,O);let B=()=>{O&&typeof O.click=="function"&&O.click()};k.addEventListener("click",P=>{P.preventDefault(),B()})};if(!o){let k="__PDS_DROPDOWN_POPOVER_WARNED__";globalThis[k]||(globalThis[k]=!0,console.warn("[PDS] nav[data-dropdown] requires the Popover API. Add a popover polyfill (recommended: @oddbird/popover-polyfill) for browsers without support."));return}c(),t.setAttribute("popover","auto");let p=()=>{let k=t.getAttribute("style");t.style.visibility="hidden",t.style.display="inline-block",t.style.pointerEvents="none";let F=t.getBoundingClientRect(),O=Math.max(t.offsetWidth||0,t.scrollWidth||0,F.width||0,1),B=Math.max(t.offsetHeight||0,t.scrollHeight||0,F.height||0,1);return k===null?t.removeAttribute("style"):t.setAttribute("style",k),{width:O,height:B}},h=()=>{try{return t.matches(":popover-open")}catch{return!1}},m=()=>{t.setAttribute("aria-hidden","true"),n?.setAttribute("aria-expanded","false")},v=()=>{t.setAttribute("aria-hidden","false"),n?.setAttribute("aria-expanded","true")},g=()=>{let k=(e.getAttribute("data-direction")||e.getAttribute("data-dropdown-direction")||e.getAttribute("data-mode")||"auto").toLowerCase();if(k==="up"||k==="down")return k;let F=(n||e).getBoundingClientRect(),{height:O}=p(),B=Math.max(0,window.innerHeight-F.bottom),P=Math.max(0,F.top),W=B>=O,H=P>=O;return W&&!H?"down":H&&!W?"up":W&&H?"down":P>B?"up":"down"},f=()=>{if(r)return"right";let k=(e.getAttribute("data-align")||e.getAttribute("data-dropdown-align")||"auto").toLowerCase();if(k==="left"||k==="right"||k==="start"||k==="end")return k==="start"?"left":k==="end"?"right":k;let F=(n||e).getBoundingClientRect(),{width:O}=p(),B=Math.max(0,window.innerWidth-F.left),P=Math.max(0,F.right),W=B>=O,H=P>=O;return W&&!H?"left":H&&!W?"right":W&&H?"left":P>B?"right":"left"},y=(k,F=8)=>{let O=getComputedStyle(e).getPropertyValue(k).trim();if(!O)return F;let B=document.createElement("span");B.style.position="fixed",B.style.visibility="hidden",B.style.pointerEvents="none",B.style.height=O,document.body.appendChild(B);let P=Number.parseFloat(getComputedStyle(B).height);return B.remove(),Number.isFinite(P)?P:F},x=()=>{["position","left","top","right","bottom","margin-top","margin-bottom","max-width","max-inline-size","max-height","overflow"].forEach(k=>t.style.removeProperty(k))},b=()=>{let k=e.parentElement;for(;k&&k!==document.body&&k!==document.documentElement;){let F=getComputedStyle(k);if(F.transform!=="none"||F.perspective!=="none"||F.filter!=="none"||F.backdropFilter!=="none")return!0;k=k.parentElement}return!1},S=()=>{if(!h())return;let k=(n||e).getBoundingClientRect(),F=window.visualViewport,O=F?.width||document.documentElement?.clientWidth||window.innerWidth,B=F?.height||document.documentElement?.clientHeight||window.innerHeight,P=F?.offsetLeft||0,W=F?.offsetTop||0,H=Math.max(1,O-i*2),Pt=Math.max(1,B-i*2);t.style.maxWidth=`${Math.round(H)}px`,t.style.maxInlineSize=`${Math.round(H)}px`,t.style.maxHeight=`${Math.round(Pt)}px`,t.style.overflow="auto";let{width:U,height:ce}=p(),ne=y("--spacing-2",8),zr=g(),Lr=f();e.dataset.dropdownDirection=zr,e.dataset.dropdownAlign=Lr;let Xe=Lr==="right"?k.right-U:k.left;U>=H-1?Xe=P+i:Xe=Math.max(P+i,Math.min(Xe,P+O-U-i));let Nt=zr==="up"?k.top-ne-ce:k.bottom+ne;Nt=Math.max(W+i,Math.min(Nt,W+B-ce-i)),Object.assign(t.style,{position:"fixed",left:`${Math.round(Xe)}px`,top:`${Math.round(Nt)}px`,right:"auto",bottom:"auto",marginTop:"0",marginBottom:"0"})},C=null,E=()=>{C||(C=()=>S(),window.addEventListener("resize",C),window.addEventListener("scroll",C,!0))},T=()=>{C&&(window.removeEventListener("resize",C),window.removeEventListener("scroll",C,!0),C=null)},R=null,A=null,j=()=>{R||typeof document>"u"||(R=()=>{h()&&(e.dataset.dropdownDirection=g(),e.dataset.dropdownAlign=f(),A!==null&&cancelAnimationFrame(A),A=requestAnimationFrame(()=>{A=null,h()&&S()}))},document.addEventListener("pds:config-changed",R))},M=()=>{!R||typeof document>"u"||(document.removeEventListener("pds:config-changed",R),R=null,A!==null&&(cancelAnimationFrame(A),A=null))};t.addEventListener("toggle",k=>{if(k.newState==="open"){v(),S(),E(),j();return}m(),T(),M(),b()&&x()});let z=()=>{h()||(e.dataset.dropdownDirection=g(),e.dataset.dropdownAlign=f(),t.showPopover(),requestAnimationFrame(()=>S()))},L=()=>{h()&&t.hidePopover()},_=()=>{h()?L():z()};m(),t.addEventListener("click",k=>{let F=k.target instanceof Element?k.target:k.target?.parentElement;F&&F.closest("[data-dropdown-close]")&&L()}),t.addEventListener("beforetoggle",k=>{if(k.newState==="open"){e.dataset.dropdownDirection=g(),e.dataset.dropdownAlign=f();return}m(),T(),M(),b()&&x()}),e.addEventListener("keydown",k=>{k.key==="Escape"&&(L(),n?.focus())})}function la(e){if(e.dataset.enhancedToggle)return;e.dataset.enhancedToggle="true";let t=e.querySelector('input[type="checkbox"]');if(!t)return;e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("role","switch"),e.setAttribute("aria-checked",t.checked?"true":"false");let r=document.createElement("span");r.className="toggle-switch",r.setAttribute("role","presentation"),r.setAttribute("aria-hidden","true");let n=document.createElement("span");n.className="toggle-knob",r.appendChild(n),e.insertBefore(r,t.nextSibling);let o=()=>{e.setAttribute("aria-checked",t.checked?"true":"false")},a=()=>{t.disabled||(t.checked=!t.checked,o(),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})))};e.addEventListener("click",i=>{i.preventDefault(),a()}),e.addEventListener("keydown",i=>{(i.key===" "||i.key==="Enter")&&(i.preventDefault(),a())}),t.addEventListener("change",o)}function ca(e){if(e.dataset.enhancedColorInput)return;let t=e.querySelector('input[type="color"]');if(!t)return;e.dataset.enhancedColorInput="true";let r=e.querySelector(":scope > .color-control"),n=e.querySelector(":scope > .color-control > .color-swatch"),o=e.querySelector(":scope > .color-control > output");r||(r=document.createElement("span"),r.className="color-control",t.before(r)),n||(n=document.createElement("span"),n.className="color-swatch",r.appendChild(n)),t.parentElement!==n&&n.appendChild(t),o||(o=document.createElement("output"),r.appendChild(o));let a=()=>{if(t.dataset.colorUnset==="1"){o.value="",o.textContent=Q("not set"),r.dataset.value="",r.dataset.unset="1",n.dataset.unset="1";return}o.value=t.value,o.textContent=t.value,r.dataset.value=t.value,delete r.dataset.unset,delete n.dataset.unset};a();let i=()=>{t.dataset.colorUnset==="1"&&(t.dataset.colorUnset="0"),a()};t.addEventListener("input",i,{passive:!0}),t.addEventListener("change",i,{passive:!0})}function da(e){if(e.dataset.enhancedOneTimeCode)return;e.dataset.enhancedOneTimeCode="true";let t=Number.parseInt(e.getAttribute("data-otp-length")||e.getAttribute("maxlength")||"6",10),r=Number.isFinite(t)&&t>0?t:6,n=e.getAttribute("data-otp-autosubmit")!=="false",o=e.getAttribute("data-otp-format")==="alphanumeric",a=e.getAttribute("data-otp-status-id")||`${e.id||`otp-${Math.random().toString(36).slice(2,9)}`}-status`,i=v=>{let g=String(v||"").replace(/\s+/g,"");return(o?g.replace(/[^0-9a-z]/gi,""):g.replace(/\D+/g,"")).slice(0,r)};e.classList.add("input-otp"),e.dataset.otpLength=String(r),e.dataset.otpComplete="false",e.style.setProperty("--otp-digits",String(r)),e.style.setProperty("--_otp-digit","0"),(!e.hasAttribute("type")||e.getAttribute("type")?.toLowerCase()==="number")&&e.setAttribute("type","text"),e.setAttribute("maxlength",String(r)),e.hasAttribute("inputmode")||e.setAttribute("inputmode",o?"text":"numeric"),e.hasAttribute("enterkeyhint")||e.setAttribute("enterkeyhint","done"),e.hasAttribute("autocapitalize")||e.setAttribute("autocapitalize","off"),e.hasAttribute("spellcheck")||e.setAttribute("spellcheck","false"),e.hasAttribute("pattern")||e.setAttribute("pattern",o?`[0-9A-Za-z]{${r}}`:`\\d{${r}}`),!e.hasAttribute("aria-label")&&!e.labels?.length&&e.setAttribute("aria-label",Q("One-time code"));let s=e.form||e.closest("form"),u=!1,l=null,d=()=>{let v=typeof e.selectionStart=="number"?e.selectionStart:e.value.length,g=Math.max(0,Math.min(v,Math.max(r-1,0)));e.style.setProperty("--_otp-digit",String(g))},c=()=>{typeof e.scrollLeft=="number"&&(e.scrollLeft=0)};if(typeof document<"u"){l=document.getElementById(a),l||(l=document.createElement("span"),l.id=a,l.className="otp-status",l.setAttribute("aria-live","polite"),l.setAttribute("aria-atomic","true"),e.insertAdjacentElement("afterend",l));let v=new Set((e.getAttribute("aria-describedby")||"").split(/\s+/).filter(Boolean));v.add(a),e.setAttribute("aria-describedby",Array.from(v).join(" "))}let p=()=>{if(!l)return;let v=e.value.length;l.textContent=v===0?Q("Enter the verification code"):v>=r?Q("Code complete"):`${v}/${r}`},h=()=>{!n||u||!s||typeof s.checkValidity=="function"&&!s.checkValidity()||(u=!0,requestAnimationFrame(()=>{u=!1;let v=e.getAttribute("data-otp-submit-selector"),g=v?s.querySelector(v):void 0;typeof s.requestSubmit=="function"?s.requestSubmit(g||void 0):s.submit()}))},m=(v,{dispatchChange:g=!1}={})=>{let f=i(v);e.value!==f&&(e.value=f);let y=f.length===r;e.dataset.otpComplete=y?"true":"false",p(),d(),c(),g&&e.dispatchEvent(new Event("change",{bubbles:!0})),y&&h()};e.addEventListener("beforeinput",v=>{if(v.defaultPrevented||v.inputType?.startsWith("delete")||typeof v.data!="string"||v.data.length===0)return;!i(v.data)&&v.data.trim()&&v.preventDefault()}),e.addEventListener("input",()=>{m(e.value);try{let v=e.value.length;e.setSelectionRange(v,v)}catch{}d(),c()}),["focus","click","keyup","select"].forEach(v=>{e.addEventListener(v,()=>{requestAnimationFrame(()=>{d(),c()})})}),e.addEventListener("paste",v=>{let g=v.clipboardData?.getData("text")||"";g&&(v.preventDefault(),e.value=i(g),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})))}),e.addEventListener("keydown",v=>{v.key==="Enter"&&e.value.length===r&&h()}),m(e.value)}function ua(e){if(e.dataset.enhancedRange)return;let t=i=>{if(e.dataset.enhancedRangeProgrammatic)return;e.dataset.enhancedRangeProgrammatic="1";let s=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(e),"value")||Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value");s?.get&&s?.set&&Object.defineProperty(e,"value",{configurable:!0,enumerable:s.enumerable,get(){return s.get.call(this)},set(l){s.set.call(this,l),i()}}),new MutationObserver(l=>{l.some(c=>{let p=c.attributeName;return p==="value"||p==="min"||p==="max"})&&i()}).observe(e,{attributes:!0,attributeFilter:["value","min","max"]})},r=e.closest("label"),n=r?.classList.contains("range-output"),o=e.id||`range-${Math.random().toString(36).substring(2,11)}`,a=`${o}-output`;if(e.id=o,n){let i=r.querySelector("span");if(i&&!i.classList.contains("range-output-wrapper")){let s=i.getAttribute("data-range-label")||r.getAttribute("data-range-label")||"",u=document.createElement("span");u.className="range-output-wrapper",u.style.display="flex",u.style.justifyContent="space-between",u.style.alignItems="center";let l=document.createElement("span");l.textContent=s||i.textContent,u.appendChild(l);let d=document.createElement("output");d.id=a,d.setAttribute("for",o),d.style.color="var(--surface-text-secondary, var(--color-text-secondary))",d.style.fontSize="0.875rem",d.textContent=e.value,u.appendChild(d),i.textContent="",i.appendChild(u);let c=()=>{d.textContent=e.value};e.addEventListener("input",c),e.addEventListener("change",c),t(c),c()}}else{let i=e.closest(".range-container");i||(i=document.createElement("div"),i.className="range-container",e.parentNode?.insertBefore(i,e),i.appendChild(e)),i.style.position="relative";let s=document.createElement("output");s.id=a,s.setAttribute("for",o),s.className="range-bubble",s.setAttribute("aria-live","polite"),i.appendChild(s);let u=()=>{let c=parseFloat(e.min)||0,p=parseFloat(e.max)||100,h=parseFloat(e.value),m=(h-c)/(p-c);s.style.left=`calc(${m*100}% )`,s.textContent=String(h)},l=()=>s.classList.add("visible"),d=()=>s.classList.remove("visible");e.addEventListener("input",u),e.addEventListener("pointerdown",l),e.addEventListener("pointerup",d),e.addEventListener("pointerleave",d),e.addEventListener("focus",l),e.addEventListener("blur",d),e.addEventListener("change",u),t(u),u()}e.dataset.enhancedRange="1"}function pa(e){if(e.dataset.enhancedRequired)return;e.dataset.enhancedRequired="true";let t=r=>{let n;if(r.closest("[role$=group]")?n=r.closest("[role$=group]").querySelector("legend"):n=r.closest("label"),!n||n.querySelector(".required-asterisk"))return;let o=document.createElement("span");o.classList.add("required-asterisk"),o.textContent="*",o.style.marginLeft="4px";let a=n.querySelector("span, [data-label]");if(a)a.appendChild(o);else{let s=n.querySelector("input, select, textarea");s?n.insertBefore(o,s):n.appendChild(o)}let i=r.closest("form");if(i&&!i.querySelector(".required-legend")){let s=document.createElement("small");s.classList.add("required-legend"),s.textContent=Q("* Required fields"),i.insertBefore(s,i.querySelector(".form-actions")||i.lastElementChild)}};e.querySelectorAll("[required]").forEach(r=>{t(r)})}function fa(e){if(e.dataset.enhancedOpenGroup)return;e.dataset.enhancedOpenGroup="true",e.classList.add("flex","flex-wrap","buttons");let t=document.createElement("input");t.type="text",t.placeholder=Q("Add item..."),t.classList.add("input-text","input-sm"),t.style.width="auto";let r=()=>e.querySelector('input[type="radio"], input[type="checkbox"]');e.appendChild(t),t.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key==="Tab"){let o=t.value.trim();if(o){n.preventDefault();let a=r(),i=a?.type==="radio"?"radio":"checkbox",s=`open-group-${Math.random().toString(36).substring(2,11)}`,u=document.createElement("label"),l=document.createElement("span");l.setAttribute("data-label",""),l.textContent=o;let d=document.createElement("input");d.type=i,d.name=a?.name||e.getAttribute("data-name")||"open-group",d.value=o,d.id=s,u.appendChild(l),u.appendChild(d),e.insertBefore(u,t),t.value=""}}else if(n.key==="Backspace"&&t.value===""){n.preventDefault();let o=e.querySelectorAll("label");o.length>0&&o[o.length-1].remove()}})}function ga(e){if(e.dataset.enhancedClip)return;e.dataset.enhancedClip="true",e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.hasAttribute("role")||e.setAttribute("role","button");let t=()=>{let n=e.getAttribute("data-clip-open")==="true";e.setAttribute("aria-expanded",n?"true":"false")},r=()=>{let n=e.getAttribute("data-clip-open")==="true";e.setAttribute("data-clip-open",n?"false":"true"),t()};e.addEventListener("click",n=>{n.defaultPrevented||r()}),e.addEventListener("keydown",n=>{(n.key===" "||n.key==="Enter")&&(n.preventDefault(),r())}),t()}function ma(e){if(e.dataset.enhancedBtnWorking)return;e.dataset.enhancedBtnWorking="true";let t=null,r=!1;new MutationObserver(o=>{o.forEach(a=>{if(a.attributeName==="class"){let i=e.classList.contains("btn-working"),s=e.querySelector("pds-icon");if(i)if(s)t||(t=s.getAttribute("icon")),s.setAttribute("icon","circle-notch");else{let u=document.createElement("pds-icon");u.setAttribute("icon","circle-notch"),u.setAttribute("size","sm"),e.insertBefore(u,e.firstChild),r=!0}else a.oldValue?.includes("btn-working")&&s&&(r?(s.remove(),r=!1):t&&(s.setAttribute("icon",t),t=null))}})}).observe(e,{attributes:!0,attributeFilter:["class"],attributeOldValue:!0})}var ha=new Map([[".accordion",ia],["nav[data-dropdown]",sa],["label[data-toggle]",la],["label[data-color]",ca],['input[autocomplete="one-time-code"]',da],['input[type="range"]',ua],["form[data-required]",pa],["fieldset[role=group][data-open]",fa],["[data-clip]",ga],["button, a[class*='btn-']",ma]]),ot=aa.map(e=>({...e,run:ha.get(e.selector)||(()=>{})}));var ln=[{selector:".accordion",description:"Ensures only one <details> element can be open at a time within the accordion.",demoHtml:`
      <div class="accordion">
        <details>
    ...
    `.trim()}];var dn="pds",ba=/^([a-z][a-z0-9+\-.]*:)?\/\//i,cn=/^[a-z]:/i;function De(e=""){return e.endsWith("/")?e:`${e}/`}function ya(e="",t=dn){let r=e.replace(/\/+$/,"");return new RegExp(`(?:^|/)${t}$`,"i").test(r)?r:`${r}/${t}`}function va(e){return e.replace(/^\.\/+/,"")}function xa(e){return cn.test(e)?e.replace(cn,"").replace(/^\/+/,""):e}function wa(e){return e.startsWith("public/")?e.substring(7):e}function ze(e,t={}){let r=t.segment||dn,n=t.defaultRoot||`/assets/${r}/`,o=e?.public&&e.public?.root||e?.static&&e.static?.root||null;if(!o||typeof o!="string")return De(n);let a=o.trim();return a?(a=a.replace(/\\/g,"/"),a=ya(a,r),a=De(a),ba.test(a)?a:(a=va(a),a=xa(a),a.startsWith("/")||(a=wa(a),a.startsWith("/")||(a=`/${a}`),a=a.replace(/\/+/g,(i,s)=>s===0?i:"/")),De(a))):De(n)}function un(e){let t=e.replace(/['"]/g,"").trim();if(["system-ui","-apple-system","sans-serif","serif","monospace","cursive","fantasy","ui-sans-serif","ui-serif","ui-monospace","ui-rounded"].includes(t.toLowerCase()))return!0;let o=document.createElement("canvas").getContext("2d");if(!o)return!1;let a="mmmmmmmmmmlli",i="72px",s="monospace";o.font=`${i} ${s}`;let u=o.measureText(a).width;o.font=`${i} "${t}", ${s}`;let l=o.measureText(a).width;return u!==l}function ka(e){return e?e.split(",").map(n=>n.trim())[0].replace(/['"]/g,"").trim():null}async function pn(e,t={}){if(!e)return Promise.resolve();let{weights:r=[400,500,600,700],italic:n=!1}=t,o=ka(e);if(!o||un(o))return Promise.resolve();let a=encodeURIComponent(o);return document.querySelector(`link[href*="fonts.googleapis.com"][href*="${a}"]`)?(w.log("log",`Font "${o}" is already loading or loaded`),Promise.resolve()):(w.log("log",`Loading font "${o}" from Google Fonts...`),new Promise((s,u)=>{let l=document.createElement("link");l.rel="stylesheet";let d=n?`ital,wght@0,${r.join(";0,")};1,${r.join(";1,")}`:`wght@${r.join(";")}`;l.href=`https://fonts.googleapis.com/css2?family=${a}:${d}&display=swap`,l.setAttribute("data-font-loader",o),l.onload=()=>{w.log("log",`Successfully loaded font "${o}"`),s()},l.onerror=()=>{w.log("warn",`Failed to load font "${o}" from Google Fonts`),u(new Error(`Failed to load font: ${o}`))},document.head.appendChild(l),setTimeout(()=>{un(o)||w.log("warn",`Font "${o}" did not load within timeout`),s()},5e3)}))}async function er(e){if(!e)return Promise.resolve();let t=new Set;e.fontFamilyHeadings&&t.add(e.fontFamilyHeadings),e.fontFamilyBody&&t.add(e.fontFamilyBody),e.fontFamilyMono&&t.add(e.fontFamilyMono);let r=Array.from(t).map(n=>pn(n).catch(o=>{w.log("warn",`Could not load font: ${n}`,o)}));await Promise.all(r)}var rr=null;async function $a(){return rr||(rr=Promise.resolve().then(()=>(gn(),fn)).then(e=>e?.AutoDefiner||e?.default?.AutoDefiner||e?.default).then(e=>{if(typeof e!="function")throw new Error("AutoDefiner constructor not found in pure-web/auto-definer");return e})),rr}var za=/^[a-z][a-z0-9+\-.]*:\/\//i,We=(()=>{try{return import.meta.url}catch{return}})(),Le=e=>typeof e=="string"&&e.length&&!e.endsWith("/")?`${e}/`:e;function Ce(e,t={}){if(!e||za.test(e))return e;let{preferModule:r=!0}=t,n=()=>{if(!We)return null;try{return new URL(e,We).href}catch{return null}},o=()=>{if(typeof window>"u"||!window.location?.origin)return null;try{return new URL(e,window.location.origin).href}catch{return null}};return(r?n()||o():o()||n())||e}var mn=(()=>{if(We)try{let e=new URL(We);if(/\/public\/assets\/js\//.test(e.pathname))return new URL("../pds/",We).href}catch{return}})(),hn=!1;function it(e){hn||typeof document>"u"||(hn=!0,e.addEventListener("pds:ready",t=>{let r=t.detail?.mode;r&&document.documentElement.classList.add(`pds-${r}`,"pds-ready")}))}function or(e={},t={}){if(!t||typeof t!="object")return e;let r=Array.isArray(e)?[...e]:{...e};for(let[n,o]of Object.entries(t))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=or(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function nr(e=""){return String(e).toLowerCase().replace(/&/g," and ").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function fe(e){if(e==null)return e;if(typeof e=="function")return;if(typeof e!="object")return e;if(Array.isArray(e))return e.map(r=>fe(r)).filter(r=>r!==void 0);let t={};for(let r in e)if(e.hasOwnProperty(r)){let n=e[r];if(typeof n!="function"){let o=fe(n);o!==void 0&&(t[r]=o)}}return t}function at(e){let t=fe(e);return typeof structuredClone=="function"?structuredClone(t):JSON.parse(JSON.stringify(t))}function ar(e={},t={},{presets:r,defaultLog:n,validateDesignConfig:o,validateInitConfig:a}={}){let i=e&&typeof e.log=="function"?e.log:n,s=typeof e=="object"&&("colors"in e||"typography"in e||"spatialRhythm"in e||"shape"in e||"behavior"in e||"layout"in e||"advanced"in e||"a11y"in e||"components"in e||"icons"in e),u=e&&e.enhancers;u&&!Array.isArray(u)&&(u=Object.values(u));let l=u??t.enhancers??[],d=e&&e.preset,c=e&&e.design,p=e&&e.icons&&typeof e.icons=="object"?e.icons:null,h="preset"in(e||{})||"design"in(e||{})||"enhancers"in(e||{});e&&typeof e=="object"&&typeof a=="function"&&a(e,{log:i,context:"PDS.start"});let m,v=null;if(h){c&&typeof c=="object"&&typeof o=="function"&&o(c,{log:i,context:"PDS.start"});let g=String(d||"default").toLowerCase(),f=r?.[g]||Object.values(r||{}).find(O=>nr(O.name)===g||String(O.name||"").toLowerCase()===g);if(!f)throw new Error(`PDS preset not found: "${d||"default"}"`);v={id:f.id||nr(f.name),name:f.name||f.id||String(g)};let y=at(f);if(c&&typeof c=="object"||p){let O=c?fe(c):{},B=p?fe(p):null,P=B?or(O,{icons:B}):O;y=or(y,at(P))}let{mode:x,autoDefine:b,applyGlobalStyles:S,manageTheme:C,themeStorageKey:E,preloadStyles:T,criticalLayers:R,managerURL:A,manager:j,localization:M,preset:z,design:L,enhancers:_,log:k,...F}=e;m={...F,design:y,preset:v.name,log:k||n}}else if(s){typeof o=="function"&&o(e,{log:i,context:"PDS.start"});let{log:g,...f}=e;m={design:at(f),log:g||n}}else{let g=r?.default||Object.values(r||{}).find(f=>nr(f.name)==="default");if(!g)throw new Error("PDS default preset not available");v={id:g.id||"default",name:g.name||"Default"},m={design:at(g),preset:v.name,log:n}}return{generatorConfig:m,enhancers:l,presetInfo:v}}function st({manageTheme:e,themeStorageKey:t,applyResolvedTheme:r,setupSystemListenerIfNeeded:n}){let o="light",a=null;if(e&&typeof window<"u"){try{a=localStorage.getItem(t)||null}catch{a=null}try{r?.(a),n?.(a)}catch{}a?a==="system"?o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":o=a:o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}return{resolvedTheme:o,storedTheme:a}}function Ee(e,{resolvePublicAssetURL:t}){let r=!!(e?.public?.root||e?.static?.root),n=t(e);return!r&&mn&&(n=mn),Le(Ce(n))}async function lt(e,{baseEnhancers:t=[]}={}){let{autoDefineBaseURL:r="/auto-define/",autoDefinePreload:n=[],autoDefineMapper:o=null,enhancers:a=[],autoDefineOverrides:i=null,autoDefinePreferModule:s=!0}=e,u=(()=>{let d=new Map;return(t||[]).forEach(c=>d.set(c.selector,c)),(a||[]).forEach(c=>d.set(c.selector,c)),Array.from(d.values())})(),l=null;if(typeof window<"u"&&typeof document<"u"){let d=await $a(),c=x=>{switch(x){case"pds-tabpanel":return"pds-tabstrip.js";default:return`${x}.js`}},{mapper:p,enhancers:h,...m}=i&&typeof i=="object"?i:{},v=h?Array.isArray(h)?h:typeof h=="object"?Object.values(h):[]:[],g=(()=>{let x=new Map;return(u||[]).forEach(b=>{b?.selector&&x.set(b.selector,b)}),(v||[]).forEach(b=>{if(!b?.selector)return;let S=x.get(b.selector)||null;x.set(b.selector,{...S||{},...b,run:typeof b?.run=="function"?b.run:S?.run})}),Array.from(x.values())})(),y={baseURL:r&&Le(Ce(r,{preferModule:s})),predefine:n,scanExisting:!0,observeShadows:!0,patchAttachShadow:!0,debounceMs:16,enhancers:g,onError:(x,b)=>{if(typeof x=="string"&&x.startsWith("pds-")){let C=["pds-form","pds-drawer"].includes(x),E=b?.message?.includes("#pds/lit")||b?.message?.includes("Failed to resolve module specifier");C&&E?w.log("error",`\u274C PDS component <${x}> requires Lit but #pds/lit is not in import map.
              See: https://github.com/Pure-Web-Foundation/pure-ds/blob/main/readme.md#lit-components-not-working`):w.log("warn",`\u26A0\uFE0F PDS component <${x}> not found. Assets may not be installed.`)}else w.log("error",`\u274C Auto-define error for <${x}>:`,b)},...m,mapper:x=>{if(customElements.get(x))return null;if(typeof o=="function")try{let b=o(x);return b===void 0?c(x):b}catch(b){return w.log("warn","Custom autoDefine.mapper error; falling back to default:",b?.message||b),c(x)}return c(x)}};l=new d(y),n.length>0&&typeof d.define=="function"&&await d.define(...n,{baseURL:r,mapper:y.mapper,onError:y.onError})}return{autoDefiner:l,mergedEnhancers:u}}var ir=["light","dark"],sr=new Set(ir);function lr(e){let r=(Array.isArray(e?.themes)?e.themes.map(n=>String(n).toLowerCase()):ir).filter(n=>sr.has(n));return r.length?r:ir}function Ae(e,{preferDocument:t=!0}={}){let r=String(e||"").toLowerCase();if(sr.has(r))return r;if(t&&typeof document<"u"){let n=document.documentElement?.getAttribute("data-theme");if(sr.has(n))return n}return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function ge(e,t){let r=Ae(t);return lr(e).includes(r)}var yn=!1,ft="pds-live-edit-toggle",fr="pds-live-edit-toggle-style";function vn(e,t=new WeakSet){if(!e||typeof e!="object"||t.has(e))return e;t.add(e),Object.freeze(e);for(let r of Object.keys(e))vn(e[r],t);return e}function gt(e){let t=fe(e);return typeof structuredClone=="function"?structuredClone(t):JSON.parse(JSON.stringify(t))}function xn(e){return e==null||typeof e!="object"?e:vn(gt(e))}function wn(e){if(typeof document>"u"||typeof e!="function")return;if(document.body){e();return}let t=()=>{document.body&&(document.removeEventListener("DOMContentLoaded",t),e())};document.addEventListener("DOMContentLoaded",t,{once:!0})}function Ra(e={}){let t=e?.interactive!==!1;typeof document>"u"||wn(()=>{if(document.querySelector("pds-live-edit")){if(!t){let r=document.querySelector("pds-live-edit");r&&r.setAttribute("data-pds-live-settings-only","true")}}else{let r=document.createElement("pds-live-edit");t||r.setAttribute("data-pds-live-settings-only","true"),document.body.appendChild(r)}})}function pt(e=0){return new Promise(t=>{setTimeout(t,Math.max(0,Number(e)||0))})}async function He(e={}){let t=e?.mountIfMissing!==!1,r=e?.interactive!==!1,n=typeof e?.requiredMethod=="string"&&e.requiredMethod.trim()?e.requiredMethod.trim():"openDesignSettings",o=Number.isFinite(Number(e?.timeoutMs))?Number(e.timeoutMs):2400;if(typeof document>"u"||!t&&!document.querySelector("pds-live-edit"))return null;t&&Ra({interactive:r});let a=Date.now();for(;Date.now()-a<o;){let s=document.querySelector("pds-live-edit");if(!s){await pt(40);continue}if(typeof s?.[n]=="function")return s;if(typeof customElements<"u"&&typeof customElements.whenDefined=="function"){try{await Promise.race([customElements.whenDefined("pds-live-edit"),pt(80)])}catch{await pt(40)}continue}await pt(40)}let i=document.querySelector("pds-live-edit");return i&&typeof i?.[n]=="function"?i:null}function kn(){if(typeof document>"u")return;document.querySelectorAll("pds-live-edit").forEach(t=>{typeof t?.setInteractiveEditingEnabled=="function"&&t.setInteractiveEditingEnabled(!1),t.remove()})}function Ia(e){return e?typeof e.isInteractiveEditingEnabled=="function"?!!e.isInteractiveEditingEnabled():!0:!1}function Fa(){if(typeof document>"u"||document.getElementById(fr))return;let e=document.createElement("style");e.id=fr,e.textContent=`
  ...
  `,document.head.appendChild(e)}function pr(e,t){if(!e)return;e.classList.toggle("btn-primary",t),e.classList.toggle("btn-secondary",!t),e.setAttribute("aria-pressed",t?"true":"false");let r="PDS Manager";e.setAttribute("aria-label",r),e.setAttribute("title",r)}async function Pa(){if(typeof document>"u")return null;Fa();let e=document.getElementById(ft);if(!e){let t=document.createElement("nav");t.className="pds-live-edit-toggle-nav",t.setAttribute("data-dropdown",""),t.setAttribute("data-mode","auto"),t.setAttribute("data-pds-live-edit-ignore","true"),e=document.createElement("button"),e.id=ft,e.type="button",e.className="icon-only btn-secondary",e.setAttribute("data-pds-live-edit-ignore","true"),e.innerHTML='<pds-icon icon="cursor-click" size="sm"></pds-icon>';let r=document.createElement("menu");r.setAttribute("data-pds-live-edit-ignore","true");let n=(i,s,u)=>{let l=document.createElement("li"),d=document.createElement("a");d.href="#",d.dataset.pdsLiveAction=i,d.setAttribute("data-pds-live-edit-ignore","true");let c=document.createElement("pds-icon");return c.setAttribute("icon",u),c.setAttribute("size","sm"),d.append(c,document.createTextNode(` ${s}`)),l.appendChild(d),l},o=()=>{let i=document.createElement("li");i.setAttribute("data-pds-live-edit-ignore","true");let s=document.createElement("hr");return s.setAttribute("aria-hidden","true"),i.appendChild(s),i};r.appendChild(n("toggle",Q("Toggle live editing"),"pencil"));let a=n("open-settings",Q("Open Settings"),"gear");a.setAttribute("data-dropdown-close",""),r.appendChild(a),r.appendChild(n("reset-config",Q("Reset Config"),"arrow-counter-clockwise")),await Na(r),t.append(e,r),wn(()=>{document.getElementById(ft)||document.body.appendChild(t)})}return e}async function Na(e){if(e instanceof Element){if(e.__pdsLiveSharedMenuItemInFlight)return e.__pdsLiveSharedMenuItemInFlight;e.__pdsLiveSharedMenuItemInFlight=(async()=>{e.querySelectorAll("li.pds-live-shared-quick-mode-item").forEach(s=>s.remove());let t=await He({mountIfMissing:!0,interactive:!1,requiredMethod:"createSharedQuickModeMenuItem",timeoutMs:7e3});if(!t||typeof t.createSharedQuickModeMenuItem!="function")return;let r=await t.createSharedQuickModeMenuItem();if(!(r instanceof Element))return;r.classList.add("pds-live-shared-quick-mode-item");let o=e.querySelector('a[data-pds-live-action="reset-config"]')?.closest("li")||null,a=o?.previousElementSibling||null,i=a&&a.querySelector?.(":scope > hr")?a:null;if(i){e.insertBefore(r,i);return}if(o){e.insertBefore(r,o);return}e.appendChild(r)})();try{await e.__pdsLiveSharedMenuItemInFlight}finally{e.__pdsLiveSharedMenuItemInFlight=null}}}function Oa(){if(typeof document>"u")return;let e=document.getElementById(ft);if(e){let r=e.closest(".pds-live-edit-toggle-nav");r?r.remove():e.remove()}let t=document.getElementById(fr);t&&t.remove(),kn()}async function ja(){if(typeof document>"u")return;let e=await Pa();if(!e)return;let t=async i=>{if(i){let s=await He({mountIfMissing:!0});s&&typeof s.setInteractiveEditingEnabled=="function"&&s.setInteractiveEditingEnabled(!0)}else kn();pr(e,i)};t(!1);let r=e.closest(".pds-live-edit-toggle-nav")||e;e.__pdsLiveEditActionHandler&&r.removeEventListener("click",e.__pdsLiveEditActionHandler);let n=async i=>{let s=i.target?.closest?.("[data-pds-live-action]");if(!s)return;i.preventDefault();let u=String(s.dataset.pdsLiveAction||"");if(u==="toggle"){let l=await He({mountIfMissing:!1}),d=Ia(l);await t(!d);return}if(u==="open-settings"){let l=await He({mountIfMissing:!0,requiredMethod:"openDesignSettings",interactive:!1});l&&typeof l.setInteractiveEditingEnabled=="function"&&l.setInteractiveEditingEnabled(!1),l&&typeof l.openDesignSettings=="function"&&(pr(e,!1),await l.openDesignSettings());return}if(u==="reset-config"){let l=await He({mountIfMissing:!0,requiredMethod:"resetConfig",interactive:!1});pr(e,!1),l&&typeof l.resetConfig=="function"&&await l.resetConfig();return}};e.__pdsLiveEditActionHandler=n,r.addEventListener("click",n),e.__pdsLiveEditDisableHandler&&document.removeEventListener("pds:live-edit:disable",e.__pdsLiveEditDisableHandler),e.__pdsLiveEditEnableHandler&&document.removeEventListener("pds:live-edit:enable",e.__pdsLiveEditEnableHandler);let o=()=>{t(!1)},a=()=>{t(!0)};e.__pdsLiveEditDisableHandler=o,document.addEventListener("pds:live-edit:disable",o),e.__pdsLiveEditEnableHandler=a,document.addEventListener("pds:live-edit:enable",a)}function Ba(){if(typeof window>"u"||!window.localStorage)return null;try{let e=window.localStorage.getItem("pure-ds-config");if(!e)return null;let t=JSON.parse(e);if(t&&("preset"in t||"design"in t))return t}catch{return null}return null}function gr(e={},t={}){if(!t||typeof t!="object")return e;let r=Array.isArray(e)?[...e]:{...e};for(let[n,o]of Object.entries(t))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=gr(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function Da(e){let t=Ba();if(!t||!e||typeof e!="object")return e;let r=t.preset,n=t.design&&typeof t.design=="object"?t.design:null;if(!r&&!n)return e;let o="preset"in e||"design"in e||"enhancers"in e,a={...e};if(r&&(a.preset=r),n)if(o){let i=e.design&&typeof e.design=="object"?e.design:{};a.design=gr(i,n)}else a=gr(e,n);return a}function Wa(e,t={}){let{hideCategory:r=!0,itemGrid:n="45px 1fr",includeIncompatible:o=!0,disableIncompatible:a=!0,categoryName:i="Presets",theme:s,onSelect:u,iconHandler:l}=t||{},d=Ae(s??e?.theme),c=m=>{let g=h(m?.id)?.colors||{},f=g?.primary,y=g?.secondary,x=g?.accent;return f&&y&&x?`<span style="display:flex;gap:1px;flex-shrink:0;" aria-hidden="true">
      ...
      </span>`:m?.icon?`<pds-icon icon="${m.icon}" size="sm"></pds-icon>`:""},p=()=>{let m=e?.presets||{};return Object.values(m||{}).filter(v=>!!(v?.id||v?.name))},h=m=>m&&p().find(g=>String(g?.id||g?.name)===String(m))||null;return{hideCategory:r,itemGrid:n,iconHandler:typeof l=="function"?l:c,categories:{[i]:{trigger:()=>!0,getItems:(m={})=>{let v=String(m?.search||"").toLowerCase().trim();return p().filter(f=>{let y=String(f?.name||f?.id||"").toLowerCase(),x=String(f?.description||"").toLowerCase(),b=Array.isArray(f?.tags)?f.tags.map(C=>String(C).toLowerCase()):[];if(v&&!(y.includes(v)||x.includes(v)||b.some(E=>E.includes(v))))return!1;let S=ge(f,d);return!(!o&&!S)}).map(f=>{let y=f?.id||f?.name,x=ge(f,d),b=lr(f),S=b.length===1?`${b[0]} only`:`Not available in ${d} mode`,C=String(f?.description||"").trim(),E=x?C:C?`${C} - ${S}`:S;return{id:y,text:f?.name||String(y),description:E,icon:"palette",class:!x&&a?"disabled":"",disabled:!x&&a,tooltip:x?"":S}}).sort((f,y)=>String(f.text||"").localeCompare(String(y.text||"")))},action:async m=>{if(!m?.id||m?.disabled)return m?.id;let v=h(m.id);return v?typeof u=="function"?await u({preset:v,selection:m,resolvedTheme:d}):(typeof e?.applyLivePreset=="function"&&await e.applyLivePreset(v.id||m.id),v.id||m.id):m?.id}}}}}async function Ha(e,{applyResolvedTheme:t,setupSystemListenerIfNeeded:r,emitConfigChanged:n}){if(yn)return;let[o,a,i]=await Promise.all([Promise.resolve().then(()=>(Ht(),Br)),Promise.resolve().then(()=>(Ie(),Cr)),Promise.resolve().then(()=>(ur(),ut))]),s=o?.default||o?.ontology,u=o?.findComponentForElement,l=a?.enums;e.ontology=s,e.findComponentForElement=u,e.enums=l,e.common=i||{},e.presets=ee,e.configRelations=Rr,e.configSpec=Ir,e.configEditorMetadata=Nr,e.configFormSchema=Or,e.buildConfigFormSchema=ve,e.getConfigEditorMetadata=Oe,e.enhancerMetadata=ln,(!Array.isArray(e.defaultEnhancers)||e.defaultEnhancers.length===0)&&(e.defaultEnhancers=Array.isArray(ot)?ot:[]),e.applyStyles=function(d){let c=d||X.instance;an(c),typeof n=="function"&&n({mode:"live",source:"live:styles-applied"})},e.adoptLayers=function(d,c,p){return nt(d,c,p,X.instance)},e.adoptPrimitives=function(d,c){return rt(d,c,X.instance)},e.getGenerator=async function(){return X},e.buildPresetOmniboxSettings=function(d={}){return Wa(e,d)},e.applyLivePreset=async function(d,c={}){if(!d)return!1;if(!e.registry?.isLive)return e.log("warn","PDS.applyLivePreset is only available in live mode."),!1;let p=e.currentConfig||{},{design:h,preset:m,...v}=p,g={...gt(v),preset:d},f=ar(g,{},{presets:ee,defaultLog:Wt,validateDesignConfig:Bt,validateInitConfig:Dt}),y=Ae(e.theme);if(!ge(f.generatorConfig.design,y)){let C=f.presetInfo?.name||f.generatorConfig?.design?.name||d;e.log("warn",`PDS theme "${y}" not supported by preset "${C}".`)}p.theme&&!f.generatorConfig.theme&&(f.generatorConfig.theme=p.theme);let x=new X(f.generatorConfig);if(f.generatorConfig.design?.typography)try{await er(f.generatorConfig.design.typography)}catch(C){f.generatorConfig?.log?.("warn","Failed to load some fonts from Google Fonts:",C)}e.applyStyles?.(x);let b=f.presetInfo||{id:d,name:d};if(e.currentPreset=b,e.compiled=xn({...p,preset:f.generatorConfig.preset,design:f.generatorConfig.design,theme:f.generatorConfig.theme||p.theme}),e.configEditorMetadata=Oe(f.generatorConfig.design),e.configFormSchema=ve(f.generatorConfig.design),c?.persist!==!1&&typeof window<"u"){let C="pure-ds-config";try{let E=localStorage.getItem(C),T=E?JSON.parse(E):null,R={...T&&typeof T=="object"?T:{},preset:b.id||d,design:gt(f.generatorConfig.design||{})};localStorage.setItem(C,JSON.stringify(R))}catch(E){f.generatorConfig?.log?.("warn","Failed to store preset:",E)}}return!0},e.preloadCritical=function(d,c={}){if(typeof window>"u"||!document.head||!d)return;let{theme:p,layers:h=["tokens"]}=c;try{let m=p||"light";(p==="system"||!p)&&(m=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),document.documentElement.setAttribute("data-theme",m);let v=d.design?{...d,theme:m}:{design:d,theme:m},g=new X(v),f=h.map(y=>{try{return g.css?.[y]||""}catch{return""}}).filter(y=>y.trim()).join(`
`);if(f){let y=document.head.querySelector("style[data-pds-preload]");y&&y.remove();let x=document.createElement("style");x.setAttribute("data-pds-preload",""),x.textContent=f,document.head.insertBefore(x,document.head.firstChild)}}catch(m){e.log("warn","PDS preload failed:",m)}},yn=!0}async function Ua(e,t,{emitReady:r,emitConfigChanged:n,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}){if(!t||typeof t!="object")throw new Error("PDS.start({ mode: 'live', ... }) requires a valid configuration object");let i=t?.design?.icons?.externalPath||t?.icons?.externalPath||null;if(t=Da(t),typeof i=="string"&&i.trim()){let h=t?.design&&typeof t.design=="object"?t.design:{},m=h?.icons&&typeof h.icons=="object"?h.icons:{};t={...t,design:{...h,icons:{...m,externalPath:i}}}}if(await Ha(e,{applyResolvedTheme:o,setupSystemListenerIfNeeded:a,emitConfigChanged:n}),it(e),typeof document<"u"&&document.adoptedStyleSheets){let h=`
          html { opacity: 0; }
          html.pds-ready { opacity: 1; transition: opacity 0.3s ease-in; }
        `;try{if(!document.adoptedStyleSheets.some(v=>v._pdsFouc)){let v=new CSSStyleSheet;v.replaceSync(h),v._pdsFouc=!0,document.adoptedStyleSheets=[v,...document.adoptedStyleSheets]}}catch(m){if(e.log("warn","Constructable stylesheets not supported, using <style> tag fallback:",m),!document.head.querySelector("style[data-pds-fouc]")){let g=document.createElement("style");g.setAttribute("data-pds-fouc",""),g.textContent=h,document.head.insertBefore(g,document.head.firstChild)}}}let s=t.applyGlobalStyles??!0,u=t.manageTheme??!0,l=t.themeStorageKey??"pure-ds-theme",d=t.preloadStyles??!1,c=t.criticalLayers??["tokens","primitives"],p=t&&t.autoDefine||null;try{let{resolvedTheme:h}=st({manageTheme:u,themeStorageKey:l,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}),m=ar(t,{},{presets:ee,defaultLog:Wt,validateDesignConfig:Bt,validateInitConfig:Dt});if(u&&!ge(m.generatorConfig.design,h)){let R=m.presetInfo?.name||m.generatorConfig?.design?.name||m.generatorConfig?.preset||"current preset";e.log("warn",`PDS theme "${h}" not supported by preset "${R}".`)}let v=m.enhancers,{log:g,...f}=m.generatorConfig,y=gt(f);y.log=g,u&&(y.theme=h);let x=new X(y);if(y.design?.typography)try{await er(y.design.typography)}catch(R){y?.log?.("warn","Failed to load some fonts from Google Fonts:",R)}if(d&&typeof window<"u"&&document.head)try{let R=c.map(A=>{try{return x.css?.[A]||""}catch(j){return y?.log?.("warn",`Failed to generate critical CSS for layer "${A}":`,j),""}}).filter(A=>A.trim()).join(`
`);if(R){let A=document.head.querySelector("style[data-pds-critical]");A&&A.remove();let j=document.createElement("style");j.setAttribute("data-pds-critical",""),j.textContent=R;let M=document.head.querySelector('meta[charset], meta[name="viewport"]');M?M.parentNode.insertBefore(j,M.nextSibling):document.head.insertBefore(j,document.head.firstChild)}}catch(R){y?.log?.("warn","Failed to preload critical styles:",R)}e.registry.setLiveMode(),m.presetInfo?.name?y?.log?.("log",`PDS live with preset "${m.presetInfo.name}"`):y?.log?.("log","PDS live with custom config"),s&&(e.applyStyles?.(X.instance),typeof window<"u"&&setTimeout(()=>{let R=document.head.querySelector("style[data-pds-critical]");R&&R.remove();let A=document.head.querySelector("style[data-pds-preload]");A&&A.remove();let j=document.getElementById("pds-runtime-stylesheet");j&&j.remove()},100));let b=Ee(t,{resolvePublicAssetURL:ze}),S;p&&p.baseURL?S=Le(Ce(p.baseURL,{preferModule:!1})):S=`${b}components/`;let C=null,E=[];try{let R=await lt({autoDefineBaseURL:S,autoDefinePreload:p&&Array.isArray(p.predefine)&&p.predefine||[],autoDefineMapper:p&&typeof p.mapper=="function"&&p.mapper||null,enhancers:v,autoDefineOverrides:p||null,autoDefinePreferModule:!(p&&p.baseURL)},{baseEnhancers:ot});C=R.autoDefiner,E=R.mergedEnhancers||[]}catch(R){y?.log?.("error","\u274C Failed to initialize AutoDefiner/Enhancers:",R)}let T=x?.options||y;if(e.compiled=xn({mode:"live",...T,theme:h,enhancers:E}),e.configEditorMetadata=Oe(m.generatorConfig.design),e.configFormSchema=ve(m.generatorConfig.design),typeof n=="function"&&n({mode:"live",source:"live:config-applied",preset:m.generatorConfig.preset}),typeof document<"u")try{t?.liveEdit?setTimeout(()=>{ja()},0):Oa()}catch(R){y?.log?.("warn","Live editor toggle failed to start:",R)}return r({mode:"live",generator:x,config:T,theme:h,autoDefiner:C}),{generator:x,config:T,theme:h,autoDefiner:C}}catch(h){throw e.dispatchEvent(new CustomEvent("pds:error",{detail:{error:h}})),h}}function qa(e){let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):.5}function Va(e){return Array.isArray(e)?e.map(t=>t?{severity:String(t.severity||"info").toLowerCase(),message:String(t.message||""),path:t.path?String(t.path):""}:null).filter(t=>t&&t.message):[]}function q(e={}){let t=String(e.source||"unknown"),r=String(e.type||"generic"),n=qa(e.confidence),o=Va(e.issues),a=e.designPatch&&typeof e.designPatch=="object"?e.designPatch:{},i=e.template&&typeof e.template=="object"?e.template:null;return{source:t,type:r,confidence:n,issues:o,designPatch:a,template:i,meta:e.meta&&typeof e.meta=="object"?e.meta:{}}}function Ga(e){return!!(e&&typeof e=="object"&&"source"in e&&"type"in e&&"confidence"in e&&"issues"in e&&"designPatch"in e)}var Ka="../templates/templates.json",Sn="/assets/pds/templates/templates.json",Ja=["public","assets","pds","templates","templates.json"],Ya=["..","..","..","public","assets","pds","templates","templates.json"],mt=null;function $n(){return!!(typeof process<"u"&&process?.versions?.node)}function Za(e={}){return{id:String(e.id||"").trim(),name:String(e.name||e.id||"Template").trim(),description:String(e.description||"").trim(),icon:String(e.icon||"layout").trim(),file:String(e.file||"").trim(),tags:Array.isArray(e.tags)?e.tags.map(t=>String(t)):[]}}function ht(e={},t={}){let n=(Array.isArray(e)?e:Array.isArray(e?.templates)?e.templates:[]).map(Za).filter(o=>o.id&&o.file);return{version:e?.version||"1",templates:n,__catalogURL:t.catalogURL||null,__catalogFilePath:t.catalogFilePath||null}}async function Xa(e={}){let r=[e.catalogURL||globalThis?.PDS?.currentConfig?.templateCatalogURL,Ka,Sn].filter(Boolean);for(let n of r)try{let o=new URL(n,import.meta.url).href,a=await fetch(o,{credentials:"same-origin"});if(!a.ok)continue;let i=await a.json();return ht(i,{catalogURL:o})}catch{}return ht({templates:[]})}async function Qa(e={}){let t="node:fs/promises",r="node:path",n="node:url",[{readFile:o},a,{fileURLToPath:i}]=await Promise.all([import(t),import(r),import(n)]),s=[];e.catalogPath&&s.push(a.resolve(e.catalogPath)),s.push(a.resolve(process.cwd(),...Ja));let u=a.dirname(i(import.meta.url));s.push(a.resolve(u,...Ya));for(let l of s)try{let d=await o(l,"utf8"),c=JSON.parse(d);return ht(c,{catalogFilePath:l})}catch{}return ht({templates:[]})}async function ei(e,t){if(!e?.file)return"";if(!$n()){let u=t?.__catalogURL||Sn,l=new URL(e.file,u).href,d=await fetch(l,{credentials:"same-origin"});if(!d.ok)throw new Error(`Template file not found: ${e.file}`);return(await d.text()).trim()}let r="node:fs/promises",n="node:path",[{readFile:o},a]=await Promise.all([import(r),import(n)]),i=t?.__catalogFilePath?a.dirname(t.__catalogFilePath):a.resolve(process.cwd(),"public","assets","pds","templates"),s=a.resolve(i,e.file);return(await o(s,"utf8")).trim()}async function bt(e={}){return mt&&!e.forceReload||(mt=$n()?await Qa(e):await Xa(e)),mt}async function zn(e={}){return(await bt(e)).templates.map(({id:r,name:n,description:o,icon:a,file:i,tags:s})=>({id:r,name:n,description:o,icon:a,file:i,tags:s}))}async function ti(e,t={}){let r=await bt(t),n=r.templates.find(a=>a.id===e)||null;if(!n)return null;let o=await ei(n,r);return{...n,html:o}}async function Ln(e,t={}){let r=await ti(e,t);return r?q({source:"template",type:"template",confidence:1,template:{id:r.id,name:r.name,html:r.html,icon:r.icon,description:r.description}}):q({source:"template",type:"template",confidence:0,issues:[{severity:"error",message:`Unknown template: ${e}`}]})}var Cn={version:"tw2pds-layout-v4",summary:"Deterministic Tailwind\u2192PDS conversion rules focused on layout intent, semantic primitive mapping, and richer import-* fallback coverage.",governance:[{id:"layout.utilities.grid",controls:["grid","grid-cols-*","grid-auto-*"],note:"When false, grid mappings are skipped."},{id:"layout.utilities.flex",controls:["flex","flex-*","items-*","justify-*","grow"],note:"When false, flex mappings are skipped."},{id:"layout.utilities.spacing",controls:["gap-*","stack-*"],note:"When false, spacing mappings are skipped."},{id:"layout.utilities.container",controls:["container","max-w-*"],note:"When false, container mappings are skipped."}],nonPdsClassPatterns:["^group(?:[/:].*)?$","^layout-container$"],neverFallbackTags:["table","thead","tbody","tfoot","tr","th","td","caption","colgroup","col"],directMappings:[{id:"layout.flex.base",tw:"flex",pds:["flex"],gate:"flex"},{id:"layout.flex.inline",tw:"inline-flex",pds:["flex"],gate:"flex"},{id:"layout.flex.row",tw:"flex-row",pds:["flex-row"],gate:"flex"},{id:"layout.flex.col",tw:"flex-col",pds:["flex-col"],gate:"flex"},{id:"layout.flex.wrap",tw:"flex-wrap",pds:["flex-wrap"],gate:"flex"},{id:"layout.flex.grow",tw:"grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow.tw",tw:"flex-grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow1",tw:"flex-1",pds:["grow"],gate:"flex"},{id:"layout.items.start",tw:"items-start",pds:["items-start"],gate:"flex"},{id:"layout.items.center",tw:"items-center",pds:["items-center"],gate:"flex"},{id:"layout.items.end",tw:"items-end",pds:["items-end"],gate:"flex"},{id:"layout.items.stretch",tw:"items-stretch",pds:["items-stretch"],gate:"flex"},{id:"layout.items.baseline",tw:"items-baseline",pds:["items-baseline"],gate:"flex"},{id:"layout.justify.start",tw:"justify-start",pds:["justify-start"],gate:"flex"},{id:"layout.justify.center",tw:"justify-center",pds:["justify-center"],gate:"flex"},{id:"layout.justify.end",tw:"justify-end",pds:["justify-end"],gate:"flex"},{id:"layout.justify.between",tw:"justify-between",pds:["justify-between"],gate:"flex"},{id:"layout.justify.around",tw:"justify-around",pds:["justify-around"],gate:"flex"},{id:"layout.justify.evenly",tw:"justify-evenly",pds:["justify-evenly"],gate:"flex"},{id:"layout.grid.base",tw:"grid",pds:["grid"],gate:"grid"},{id:"layout.grid.cols.1",tw:"grid-cols-1",pds:["grid-cols-1"],gate:"grid"},{id:"layout.grid.cols.2",tw:"grid-cols-2",pds:["grid-cols-2"],gate:"grid"},{id:"layout.grid.cols.3",tw:"grid-cols-3",pds:["grid-cols-3"],gate:"grid"},{id:"layout.grid.cols.4",tw:"grid-cols-4",pds:["grid-cols-4"],gate:"grid"},{id:"layout.grid.cols.6",tw:"grid-cols-6",pds:["grid-cols-6"],gate:"grid"},{id:"layout.container",tw:"container",pds:["container"],gate:"container"},{id:"intent.surface.shadow",tw:"shadow",pds:["surface-elevated"]},{id:"intent.surface.shadow-md",tw:"shadow-md",pds:["surface-elevated"]},{id:"intent.surface.shadow-lg",tw:"shadow-lg",pds:["surface-elevated"]},{id:"intent.surface.base",tw:"bg-white",pds:["surface-base"]},{id:"typography.align.center",tw:"text-center",pds:["text-center"]},{id:"typography.align.left",tw:"text-left",pds:["text-left"]},{id:"typography.align.right",tw:"text-right",pds:["text-right"]},{id:"typography.text.muted.gray500",tw:"text-gray-500",pds:["text-muted"]},{id:"typography.text.muted.slate500",tw:"text-slate-500",pds:["text-muted"]}],ignoredPatterns:[{id:"style.color",pattern:"^(?:text|from|to|via|decoration|accent|caret)-|^bg-(?!cover$|center$|no-repeat$)",reason:"Visual style token skipped in favor of semantic PDS styling."},{id:"style.radius-border-shadow",pattern:"^(?:rounded|ring|border|shadow|outline)-?",reason:"Surface/shape inferred at primitive level."},{id:"style.typography",pattern:"^(?:font|leading|tracking|uppercase|lowercase|capitalize)-?",reason:"Typography atomic utilities are skipped."},{id:"style.effects",pattern:"^(?:opacity|blur|backdrop|drop-shadow|mix-blend|filter)-",reason:"Visual effects skipped unless mapped to a PDS utility."},{id:"style.transitions",pattern:"^(?:transition|duration|ease|delay|animate)-",reason:"Motion is system-defined in PDS."},{id:"style.spacing.atomic",pattern:"^(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-",reason:"Atomic spacing skipped; structural spacing intent is mapped."},{id:"style.positioning.atomic",pattern:"^(?:absolute|relative|fixed|sticky|inset(?:-[xy])?|top|right|bottom|left|z|translate(?:-[xy])?|-translate-[xy])(?:-|$)",reason:"Atomic positioning/offset utilities are skipped so PDS primitives and layout utilities control placement."}],intentRules:[{id:"intent.layout.responsive-grid-to-auto",summary:"Collapse responsive grid-cols patterns (including base+md two-step patterns) to best-fit grid-auto-*"},{id:"intent.layout.mobile-stack",summary:"Map flex-col + md/lg:flex-row to mobile-stack"},{id:"intent.component.card",summary:"Infer card/surface classes from rounded+shadow+surface signals"},{id:"intent.component.card.normalize",summary:"Detect Tailwind card utility clusters and normalize them to PDS card and surface variants."},{id:"intent.component.button",summary:"Infer btn-primary / btn-outline / icon-only from CTA patterns"},{id:"intent.component.button.normalize",summary:"Prevents import-* style classes on button-like elements and applies PDS button variants/sizes."},{id:"intent.component.button.layout-grow",summary:"Preserve CTA row width intent on button-like elements by mapping w-full/flex-1 to grow."},{id:"intent.icon.color-preserve",summary:"Preserve icon color intent by mapping Tailwind text color utilities on icon-like elements to tokenized import-* classes."},{id:"intent.component.badge.normalize",summary:"Detects Tailwind badge/pill utility clusters and normalizes them to PDS badge primitives/variants."},{id:"intent.typography.heading-semantic",summary:"Removes Tailwind heading typography/color utilities so heading semantics and PDS defaults control typography."},{id:"intent.surface.footer-inverse",summary:"Use surface-inverse for footers with explicit background intent"},{id:"intent.typography.link-treatment",summary:"Apply minimal link treatment for hover/transition-tailwind anchors"},{id:"intent.typography.link-active-preserve",summary:"Preserve anchor text color intent (including active menu states) by mapping Tailwind text utilities to tokenized import-* classes."},{id:"intent.typography.metric-paragraph-to-div",summary:"Normalize metric display lines from paragraph tags to div tags to avoid default paragraph margins in compact stat layouts."},{id:"intent.typography.metric-pair-no-stack",summary:"When a compact metric container has two consecutive typography lines, remove stack-sm so spacing follows Tailwind preflight no-margin assumptions."},{id:"intent.typography.semantic-heading-from-scale",summary:"Map large bold typography scales (text-2xl/text-3xl/text-4xl) to semantic heading tags when possible."},{id:"intent.typography.bold-to-strong",summary:"Prefer semantic strong tags for bold inline text intent instead of utility-only font-weight classes."},{id:"intent.preflight.tailwind-runtime-detected",summary:"Detect Tailwind runtime CSS injection and translate key preflight intent"},{id:"intent.preflight.list-reset",summary:"Preserve Tailwind list-reset preflight behavior via scoped fallback class"},{id:"intent.preflight.anchor-reset",summary:"Preserve Tailwind anchor reset preflight behavior via scoped fallback class"},{id:"table.strict-tags.no-classes",summary:"Never emit classes for semantic table tags (table/thead/tbody/tfoot/tr/th/td/caption/colgroup/col)"},{id:"intent.form.nested-label",summary:"Convert sibling label+control pairs into nested labels"},{id:"fallback.import-style",summary:"Generate import-* classes + local style block for unmapped utility styles"}],gapScaleMap:{"gap-0":"gap-0","gap-1":"gap-xs","gap-2":"gap-sm","gap-3":"gap-sm","gap-4":"gap-md","gap-5":"gap-md","gap-6":"gap-lg","gap-7":"gap-lg","gap-8":"gap-xl","gap-10":"gap-xl","gap-12":"gap-xl"},maxWidthMap:{"max-w-xs":"max-w-sm","max-w-sm":"max-w-sm","max-w-md":"max-w-md","max-w-lg":"max-w-lg","max-w-xl":"max-w-xl","max-w-2xl":"max-w-xl","max-w-3xl":"max-w-xl","max-w-4xl":"max-w-xl","max-w-5xl":"max-w-xl","max-w-6xl":"max-w-xl","max-w-7xl":"max-w-xl"},tailwindSizeScale:{"0":"var(--spacing-0)","0.5":"0.125rem","1":"var(--spacing-1)","1.5":"0.375rem","2":"var(--spacing-2)","2.5":"0.625rem","3":"var(--spacing-3)","3.5":"0.875rem","4":"var(--spacing-4)","5":"var(--spacing-5)","6":"var(--spacing-6)","7":"var(--spacing-7)","8":"var(--spacing-8)","9":"var(--spacing-9)","10":"var(--spacing-10)","11":"var(--spacing-11)","12":"var(--spacing-12)","14":"3.5rem","16":"4rem","20":"5rem","24":"6rem","28":"7rem","32":"8rem","36":"9rem","40":"10rem","48":"12rem"},tailwindShadeScale:["50","100","200","300","400","500","600","700","800","900"],defaultTailwindShade:"500",importStyleRules:{"mx-auto":"margin-left:auto;margin-right:auto","ml-auto":"margin-left:auto","mr-auto":"margin-right:auto","w-full":"width:100%","w-auto":"width:auto","h-full":"height:100%","h-48":"height:12rem","h-2.5":"height:0.625rem","h-10":"height:var(--spacing-10)","h-2":"height:var(--spacing-2)","w-2":"width:var(--spacing-2)","size-8":"width:var(--spacing-8);height:var(--spacing-8)","size-10":"width:var(--spacing-10);height:var(--spacing-10)","size-full":"width:100%;height:100%","min-h-screen":"min-height:100vh","overflow-hidden":"overflow:hidden","overflow-x-hidden":"overflow-x:hidden","overflow-x-auto":"overflow-x:auto","whitespace-nowrap":"white-space:nowrap",hidden:"display:none",block:"display:block",truncate:"overflow:hidden;text-overflow:ellipsis;white-space:nowrap","justify-items-center":"justify-items:center","justify-items-start":"justify-items:start","justify-items-end":"justify-items:end","justify-items-stretch":"justify-items:stretch","grid-flow-col":"grid-auto-flow:column","aspect-square":"aspect-ratio:1 / 1","bg-center":"background-position:center","bg-cover":"background-size:cover","bg-no-repeat":"background-repeat:no-repeat","transition-colors":"transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-duration:150ms"},importStyleDynamicRules:[{id:"fallback.import-style.gap-scale",pattern:"^gap-(\\d+)$",summary:"Converts gap scale utilities (including responsive variants like md:gap-6) to generated import-* fallback classes."},{id:"fallback.import-style.min-width-arbitrary",pattern:"^min-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-width utilities (e.g. min-w-[600px]) to generated import-* fallback classes."},{id:"fallback.import-style.max-width-arbitrary",pattern:"^max-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary max-width utilities (e.g. max-w-[480px]) to generated import-* fallback classes."},{id:"fallback.import-style.min-height-arbitrary",pattern:"^min-h-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-height utilities (e.g. min-h-[180px]) to generated import-* fallback classes."},{id:"fallback.import-style.grid-rows-arbitrary",pattern:"^grid-rows-\\[[^\\]]+\\]$",summary:"Converts arbitrary grid template row utilities (e.g. grid-rows-[1fr_auto]) to generated import-* fallback classes."},{id:"fallback.import-style.size-scale",pattern:"^size-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts size scale/arbitrary utilities into width+height fallback declarations."},{id:"fallback.import-style.width-height-scale",pattern:"^[wh]-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts width/height scale and arbitrary utilities to import-* classes."},{id:"fallback.import-style.spacing",pattern:"^-?(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-(.+)$",summary:"Converts spacing utilities to directional padding/margin fallback declarations, including responsive variants."},{id:"fallback.import-style.text-size",pattern:"^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$",summary:"Converts common text size utilities to import-* font-size declarations."},{id:"fallback.import-style.font-weight",pattern:"^font-(normal|medium|semibold|bold|extrabold|black)$",summary:"Converts common font weight utilities to import-* font-weight declarations."},{id:"fallback.import-style.leading-tracking",pattern:"^(leading|tracking)-(none|tight|snug|normal|relaxed|loose|tighter|wide|wider|widest)$",summary:"Converts line-height and letter-spacing utilities to import-* declarations for typography fidelity."},{id:"fallback.import-style.bg-tokenized",pattern:"^bg-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind background color utilities by mapping families like blue/purple/green/red to PDS semantic tokens."},{id:"fallback.import-style.bg-semantic",pattern:"^bg-(primary|secondary|accent)$",summary:"Safeguards semantic background utilities by mapping bg-primary/bg-secondary/bg-accent to PDS color tokens."},{id:"fallback.import-style.text-tokenized",pattern:"^text-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind text color utilities by mapping common families to PDS semantic tokens."},{id:"fallback.import-style.rounded",pattern:"^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$",summary:"Safeguards rounded utilities (including rounded-t-sm) by mapping to PDS radius tokens."},{id:"fallback.import-style.overlay-alpha",pattern:"^bg-black\\/(\\d{1,3})$",summary:"Converts alpha black overlay classes (e.g. bg-black/50) to tokenized color-mix background overlays."},{id:"fallback.import-style.text-inverse",pattern:"^text-white$",summary:"Preserves white foreground intent for text-on-image use cases using inverse-compatible tokens."},{id:"fallback.import-style.bg-arbitrary",pattern:"^bg-\\[[^\\]]+\\]$",summary:"Converts arbitrary background colors to import-* fallback classes when values are CSS-safe."},{id:"fallback.import-style.text-arbitrary",pattern:"^text-\\[[^\\]]+\\]$",summary:"Converts arbitrary text colors to import-* fallback classes when values are CSS-safe."}]};Ie();ur();var yt=class{constructor(t={},r=null){let n=t&&typeof t=="object"?t:{},o=r||(typeof document<"u"?document:new EventTarget),a=new WeakMap,i=h=>h.map(m=>String(m)).join("."),s,u=(h,m,v,g)=>{let f=i(h),y={property:m,path:f,value:v,oldValue:g};o.dispatchEvent(new CustomEvent(`change:${f}`,{detail:y,bubbles:!0,composed:!0})),o.dispatchEvent(new CustomEvent("change",{detail:{...y,state:s},bubbles:!0,composed:!0}))},l=(h,m)=>(typeof m=="function"&&o.addEventListener(h,m),s),d=(h,m)=>(typeof m=="function"&&o.removeEventListener(h,m),s),c=(h,m)=>{if(typeof m=="function"){let v=g=>{m(g),o.removeEventListener(h,v)};o.addEventListener(h,v)}return s},p=(h,m)=>{if(!h||typeof h!="object")return h;if(a.has(h))return a.get(h);let v=new Proxy(h,{get(g,f,y){if(f==="on")return l;if(f==="off")return d;if(f==="once")return c;let x=Reflect.get(g,f,y);return x&&typeof x=="object"?p(x,[...m,f]):x},set(g,f,y,x){let b=Reflect.get(g,f,x);return Object.is(b,y)?!0:Reflect.set(g,f,y,x)?(u([...m,f],f,y,b),!0):!1},deleteProperty(g,f){if(!Reflect.has(g,f))return!0;let y=g[f];return Reflect.deleteProperty(g,f)?(u([...m,f],f,void 0,y),!0):!1}});return a.set(h,v),v};return s=p(n,[]),s}};function En(e,t,r){if(!e||!t||typeof r!="object")return()=>{};let n={};return Object.entries(r).forEach(([o,a])=>{n[o]=i=>{typeof a=="function"&&a(e,i.detail.value,i.detail.oldValue)},t.on(`change:${o}`,n[o])}),()=>{Object.entries(n).forEach(([o,a])=>{t.off(`change:${o}`,a)})}}typeof w.initializing!="boolean"&&(w.initializing=!1);"currentPreset"in w||(w.currentPreset=null);typeof w.debug!="boolean"&&(w.debug=!1);"currentConfig"in w||(w.currentConfig=null);"compiled"in w||(w.compiled=null);typeof w.logHandler!="function"&&(w.logHandler=null);"mode"in w||(w.mode=null);var vt=null,xt=null,wt=null,kt=null,St=null,$t=null,Mn="__pdsLocalizationRuntime";function he(){if($t)return $t;let e=w?.[Mn];return e&&typeof e=="object"?($t=e,e):null}function ni(e){let t=e&&typeof e=="object"?e:null;$t=t,w[Mn]=t}Ur({getLogger:()=>typeof w.logHandler=="function"?w.logHandler:null,getContext:()=>{let e=w?.mode||w?.compiled?.mode||(w?.registry?.isLive?"live":"static"),t=(w?.debug||w?.currentConfig?.debug||w?.currentConfig?.design?.debug||w?.compiled?.debug||w?.compiled?.design?.debug||!1)===!0;return{mode:e,debug:t,thisArg:w}}});w.log=(e="log",t,...r)=>{xe(e,t,...r)};var G={locale:"en",messages:{},hasProvider:!1},zt=new Set;function Tn(e){return!!e&&typeof e!="string"&&typeof e=="object"&&"strTag"in e}function _n(e=[]){let t="";for(let r=0;r<=e.length-1;r+=1)t+=e[r],r<e.length-1&&(t+=`{${r}}`);return t}function oi(e,t){return String(e).replace(/\{(\d+)\}/g,(r,n)=>t(Number(n)))}function ai(e){if(!e||typeof e!="object")return{};let t={};for(let[r,n]of Object.entries(e)){if(typeof n=="string"){t[r]=n;continue}n&&typeof n=="object"&&typeof n.content=="string"&&(t[r]=n.content)}return t}function ii(e,...t){return{strTag:!0,strings:Array.from(e||[]),values:t,raw:Array.from(e?.raw||[])}}function si(e){if(!e)return"";if(Tn(e)){let r=_n(e.strings||[]),n=G.messages[r]||r;return oi(n,o=>e.values?.[o])}let t=String(e);return G.messages[t]||t}function li(e){if(!e)return;let t=Tn(e)?_n(e.strings||[]):String(e);typeof t=="string"&&t.length>0&&zt.add(t)}function Rn(e){if(!e||typeof e.msg!="function"||zt.size===0)return;let t=Array.from(zt);zt.clear();for(let r of t)try{e.msg(r)}catch{}}async function qe(){let e=he();return e||(St||(St=import(Ve("pds-localization.js")).then(r=>{if(typeof r?.msg!="function"||typeof r?.str!="function"||typeof r?.configureLocalization!="function"||typeof r?.loadLocale!="function"||typeof r?.setLocale!="function"||typeof r?.getLocalizationState!="function")throw new Error("Failed to load localization runtime exports");return ni(r),Rn(r),r}).catch(r=>{throw St=null,r})),St)}var In=(e,t={})=>{let r=he();return typeof r?.msg=="function"?r.msg(e,t):(li(e),si(e,t))},Fn=(e,...t)=>{let r=he();return typeof r?.str=="function"?r.str(e,...t):ii(e,...t)},Lt=(e=null)=>{let t=he();if(typeof t?.configureLocalization=="function")return t.configureLocalization(e);if(!e||typeof e!="object")return G.locale="en",G.messages={},G.hasProvider=!1,{locale:G.locale,messages:{...G.messages},hasProvider:G.hasProvider};typeof e.locale=="string"&&e.locale.trim()&&(G.locale=e.locale.trim()),Object.prototype.hasOwnProperty.call(e,"messages")&&(G.messages=ai(e.messages));let r=!!(e.provider||e.translate||e.loadLocale||e.setLocale);return G.hasProvider=r,r&&qe().then(n=>{n.configureLocalization(e),Rn(n)}).catch(()=>{}),{locale:G.locale,messages:{...G.messages},hasProvider:G.hasProvider}},Pn=async e=>(await qe()).loadLocale(e),Nn=async(e,t={})=>(await qe()).setLocale(e,t),On=()=>{let e=he();return typeof e?.getLocalizationState=="function"?e.getLocalizationState():{locale:G.locale,messages:{...G.messages},hasProvider:G.hasProvider}},jn=(e={})=>{let t=he();if(typeof t?.createJSONLocalization=="function")return t.createJSONLocalization(e);let r=typeof e?.locale=="string"&&e.locale.trim()?e.locale.trim().toLowerCase():"en",n=Array.isArray(e?.locales)?e.locales.map(u=>String(u||"").trim().toLowerCase()).filter(Boolean):[],o=Array.from(new Set([r,...n])),a=null,i=async()=>(a||(a=qe().then(u=>typeof u?.createJSONLocalization=="function"?u.createJSONLocalization(e):null).catch(()=>null)),a),s=async(u="loadLocale")=>{let l=await i();if(!l||typeof l!="object")return null;let d=l.provider;if(!d||typeof d!="object")return null;let c=d[u];return typeof c=="function"?c:u==="setLocale"&&typeof d.loadLocale=="function"?d.loadLocale:null};return{locale:r,locales:[...o],provider:{locales:[...o],async loadLocale(u={}){let l=await s("loadLocale");return typeof l!="function"?{}:l(u)},async setLocale(u={}){let l=await s("setLocale");return typeof l!="function"?{}:l(u)}}}};function Ve(e,t){return t&&typeof t=="string"?t:`${Ee(w.currentConfig||{},{resolvePublicAssetURL:ze})}core/${e}`}async function ci(){return Array.isArray(w.defaultEnhancers)&&w.defaultEnhancers.length>0?w.defaultEnhancers:(kt||(kt=import(Ve("pds-enhancers.js",w.currentConfig?.enhancersURL)).then(t=>{let r=Array.isArray(t?.defaultPDSEnhancers)?t.defaultPDSEnhancers:[];return w.defaultEnhancers=r,r}).catch(t=>{throw kt=null,t})),kt)}async function di(){return typeof w.ask=="function"&&w.ask!==Bn?w.ask:(xt||(xt=import(Ve("pds-ask.js",w.currentConfig?.askURL)).then(t=>{let r=t?.ask;if(typeof r!="function")throw new Error("Failed to load ask helper");return w.ask=r,r}).catch(t=>{throw xt=null,t})),xt)}async function Ge(){return typeof w.toast=="function"&&w.toast!==Me?w.toast:(wt||(wt=import(Ve("pds-toast.js",w.currentConfig?.toastURL)).then(t=>{let r=t?.toast;if(typeof r!="function")throw new Error("Failed to load toast helper");return w.toast=r,r}).catch(t=>{throw wt=null,t})),wt)}async function Bn(...e){return(await di())(...e)}async function Me(...e){return(await Ge())(...e)}Me.success=async(...e)=>(await Ge()).success(...e);Me.error=async(...e)=>(await Ge()).error(...e);Me.warning=async(...e)=>(await Ge()).warning(...e);Me.info=async(...e)=>(await Ge()).info(...e);var An=function(e="log",t,...r){w.log(e,t,...r)};function hr(e){if(e==null)return e;if(typeof e=="function")return;if(typeof e!="object")return e;if(Array.isArray(e))return e.map(r=>hr(r)).filter(r=>r!==void 0);let t={};for(let[r,n]of Object.entries(e)){let o=hr(n);o!==void 0&&(t[r]=o)}return t}function Dn(e,t=new WeakSet){if(!e||typeof e!="object"||t.has(e))return e;t.add(e),Object.freeze(e);for(let r of Object.keys(e))Dn(e[r],t);return e}function br(e){return e==null||typeof e!="object"?e:Dn(structuredClone(hr(e)))}async function ui(e,t={}){if(t?.runtimeConfig===!1||typeof fetch!="function")return null;let r=t?.runtimeConfigURL||`${e}pds-runtime-config.json`;try{let n=await fetch(r,{cache:"no-store"});return n.ok?await n.json():null}catch{return null}}w.registry=$e;w.enums=$;w.adoptLayers=nt;w.adoptPrimitives=rt;var pi=dr;w.parse=pi;var fi=dt;w.html=fi;w.State=yt;w.bindState=En;w.createStylesheet=sn;w.isLiveMode=()=>$e.isLive;w.ask=Bn;w.toast=Me;w.common=ut;w.msg=In;w.str=Fn;w.configureLocalization=Lt;w.loadLocale=Pn;w.setLocale=Nn;w.getLocalizationState=On;w.createJSONLocalization=jn;w.i18n={msg:In,str:Fn,configure:Lt,loadLocale:Pn,setLocale:Nn,getState:On,createJSONLocalization:jn};w.AutoComplete=null;w.loadAutoComplete=async()=>{if(w.AutoComplete&&typeof w.AutoComplete.connect=="function")return w.AutoComplete;let e=Ve("pds-autocomplete.js",w.currentConfig?.autoCompleteURL);return vt||(vt=import(e).then(t=>{let r=t?.AutoComplete||t?.default?.AutoComplete||t?.default||null;if(!r)throw new Error("AutoComplete export not found in module");return w.AutoComplete=r,r}).catch(t=>{throw vt=null,t})),vt};function Wn(e){let t=typeof CustomEvent=="function";try{let r=t?new CustomEvent("pds:ready",{detail:e}):new Event("pds:ready");w.dispatchEvent(r)}catch{}if(typeof document<"u")if(t){let r={detail:e,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:ready",r))}catch{}try{document.dispatchEvent(new CustomEvent("pds-ready",r))}catch{}}else{try{document.dispatchEvent(new Event("pds:ready"))}catch{}try{document.dispatchEvent(new Event("pds-ready"))}catch{}}}function Hn(e={}){let t=typeof CustomEvent=="function",r={at:Date.now(),...e};try{let n=t?new CustomEvent("pds:config-changed",{detail:r}):new Event("pds:config-changed");w.dispatchEvent(n)}catch{}if(typeof document<"u")if(t){let n={detail:r,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:config-changed",n))}catch{}}else try{document.dispatchEvent(new Event("pds:config-changed"))}catch{}}var mr="pure-ds-theme",me=null,Ue=null;function yr(e){try{if(typeof document>"u")return;let t="light";e?e==="system"?t=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":t=e:t=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",document.documentElement.setAttribute("data-theme",t)}catch{}}function vr(e){try{if(me&&Ue){try{typeof me.removeEventListener=="function"?me.removeEventListener("change",Ue):typeof me.removeListener=="function"&&me.removeListener(Ue)}catch{}me=null,Ue=null}if(e==="system"&&typeof window<"u"&&window.matchMedia){let t=window.matchMedia("(prefers-color-scheme: dark)"),r=n=>{let o=n?.matches===void 0?t.matches:n.matches;try{let a=o?"dark":"light";document.documentElement.setAttribute("data-theme",a),w.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:a,source:"system"}}))}catch{}};me=t,Ue=r,typeof t.addEventListener=="function"?t.addEventListener("change",r):typeof t.addListener=="function"&&t.addListener(r)}}catch{}}var gi=Object.getOwnPropertyDescriptor(w,"theme");gi||Object.defineProperty(w,"theme",{get(){try{return typeof window>"u"?null:localStorage.getItem(mr)||null}catch{return null}},set(e){try{if(typeof window>"u")return;let t=w.currentConfig?.design||null,r=Ae(e);if(t&&!ge(t,r)){let n=t?.name||w.currentPreset?.name||w.currentConfig?.preset||"current preset";w.log("warn",`PDS theme "${r}" not supported by preset "${n}".`),w.dispatchEvent(new CustomEvent("pds:theme:blocked",{detail:{theme:e,resolvedTheme:r,preset:n}}));return}e==null?localStorage.removeItem(mr):localStorage.setItem(mr,e),yr(e),vr(e),w.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:e,source:"api"}}))}catch{}}});w.defaultEnhancers=[];async function mi(e){w.initializing=!0;try{let t=e&&e.mode||"live",{mode:r,...n}=e||{};w.mode=t,w.logHandler=typeof n?.log=="function"?n.log:null,w.currentConfig=br(n);let o=n&&typeof n.localization=="object"&&n.localization?n.localization:null;o?(await qe(),Lt(o)):he()||Lt(null);let a;if(t==="static")a=await hi(n);else{let{localization:s,...u}=n||{},l=Ee(u,{resolvePublicAssetURL:ze}),d=u?.managerURL||u?.public?.managerURL||u?.manager?.url||new URL("core/pds-manager.js",l).href||new URL("./pds-manager.js",import.meta.url).href,{startLive:c}=await import(d);a=await c(w,u,{emitReady:Wn,emitConfigChanged:Hn,applyResolvedTheme:yr,setupSystemListenerIfNeeded:vr})}w.compiled=br(a?.config||null);let i=w?.compiled?.design?.icons?.externalPath||"/assets/img/icons/";return w.log("info",`startup ready; external icon path: ${i}`),a}finally{w.initializing=!1}}w.start=mi;async function hi(e){if(!e||typeof e!="object")throw new Error("PDS.start({ mode: 'static', ... }) requires a valid configuration object");let t=e.applyGlobalStyles??!0,r=e.manageTheme??!0,n=e.themeStorageKey??"pure-ds-theme",o=e.staticPaths??{},a=Ee(e,{resolvePublicAssetURL:ze}),i=e&&e.autoDefine||null,s;i&&i.baseURL?s=Le(Ce(i.baseURL,{preferModule:!1})):s=`${a}components/`;let u=i&&Array.isArray(i.predefine)&&i.predefine||[],l=i&&typeof i.mapper=="function"&&i.mapper||null;try{it(w);let{resolvedTheme:d}=st({manageTheme:r,themeStorageKey:n,applyResolvedTheme:yr,setupSystemListenerIfNeeded:vr}),c=await ui(a,e),p=Array.isArray(e?.enhancers)?e.enhancers:e?.enhancers&&typeof e.enhancers=="object"?Object.values(e.enhancers):[],h=c?.config?{...c.config,...e,design:e?.design||c.config.design,preset:e?.preset||c.config.preset}:{...e},m={tokens:`${a}styles/pds-tokens.css.js`,primitives:`${a}styles/pds-primitives.css.js`,components:`${a}styles/pds-components.css.js`,utilities:`${a}styles/pds-utilities.css.js`,styles:`${a}styles/pds-styles.css.js`},v=c?.paths||{};if(o={...m,...v,...o},w.registry.setStaticMode(o),t&&typeof document<"u")try{let y=await w.registry.getStylesheet("styles");if(y){y._pds=!0;let x=(document.adoptedStyleSheets||[]).filter(b=>b._pds!==!0);document.adoptedStyleSheets=[...x,y],Hn({mode:"static",source:"static:styles-applied"})}}catch(y){An.call(w,"warn","Failed to apply static styles:",y)}let g=null,f=[];try{let y=await ci(),x=await lt({autoDefineBaseURL:s,autoDefinePreload:u,autoDefineMapper:l,enhancers:p,autoDefineOverrides:i||null,autoDefinePreferModule:!(i&&i.baseURL)},{baseEnhancers:y});g=x.autoDefiner,f=x.mergedEnhancers||[]}catch(y){An.call(w,"error","\u274C Failed to initialize AutoDefiner/Enhancers (static):",y)}return w.compiled=br({mode:"static",...h,theme:d,enhancers:f}),Wn({mode:"static",config:h,theme:d,autoDefiner:g}),{config:h,theme:d,autoDefiner:g}}catch(d){throw w.dispatchEvent(new CustomEvent("pds:error",{detail:{error:d}})),d}}var bi="src/js/pds-live-manager/tailwind-conversion-rules.json",At=["base","sm","md","lg","xl","2xl"];function yi(e={}){let t=Array.isArray(e.ignoredPatterns)?e.ignoredPatterns.map(n=>({...n,pattern:n?.pattern instanceof RegExp?n.pattern:new RegExp(String(n?.pattern||""))})):[],r=Array.isArray(e.nonPdsClassPatterns)?e.nonPdsClassPatterns.map(n=>n instanceof RegExp?n:new RegExp(String(n||""))):[];return{...e,ignoredPatterns:t,nonPdsClassPatterns:r}}var J=yi(Cn),Un=J.version||"tw2pds-layout-v4",vi=new Map(J.directMappings.map(e=>[e.tw,e])),xr=new Map(Object.entries(J.gapScaleMap||{})),qn=new Map(Object.entries(J.maxWidthMap||{})),xi=J.nonPdsClassPatterns||[],wi=new Set(J.neverFallbackTags||[]),ki={...J.importStyleRules||{}},Si=J.tailwindSizeScale||{},wr=Array.isArray(J.tailwindShadeScale)?J.tailwindShadeScale.map(e=>String(e)).filter(Boolean):["50","100","200","300","400","500","600","700","800","900"],Vn=wr.includes(String(J.defaultTailwindShade||""))?String(J.defaultTailwindShade):"500",Et=1.2,$i=["container","grid","flex","gap","space","items","justify","content","place","self","col","row","w","h","min","max","p","m","rounded","border","ring","outline","shadow","bg","text","font","leading","tracking","uppercase","lowercase","capitalize","overflow","whitespace","truncate","object","aspect","opacity","blur","backdrop","transition","duration","ease","delay","animate","hidden","block","inline","absolute","relative","fixed","sticky","size"];function Gn(e="",t=""){if(!e||!t)return e;let r=new RegExp(`\\s${t}\\s*=\\s*("[^"]*"|'[^']*'|[^\\s>]+)`,"gi");return String(e).replace(r,"")}function zi(e="",t=null){let r=String(e||""),n=0;return r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(input)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*?)>/gi,(o,a,i,s,u,l,d,c,p,h,m)=>{if(s!==h)return o;let v=Gn(`${a||""}${u||""}`,"for"),g=`<${d}${c||""} id="${h}"${m||""}>`;return n+=1,`<label${v}>${l}${g}</label>`}),r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(select|textarea)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*)>([\s\S]*?)<\/\6>/gi,(o,a,i,s,u,l,d,c,p,h,m,v)=>{if(s!==h)return o;let g=Gn(`${a||""}${u||""}`,"for"),f=`<${d}${c||""} id="${h}"${m||""}>${v}</${d}>`;return n+=1,`<label${g}>${l}${f}</label>`}),t&&n>0&&(t.labelNestingCount+=n,D(t,`Nested ${n} label/control pairs.`),N(t,"intent.form.nested-label")),r}function Li(e="",t="base"){let r=String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rule";return`import-${t&&t!=="base"?`${t}-`:""}${r}`}function be(e,t,r,n="base",o=""){if(!e||!t||!r)return"";let a=Li(t,n);if(o){let i=`${n}|${o}`;e.importPseudoStyles.has(i)||e.importPseudoStyles.set(i,new Map),e.importPseudoStyles.get(i).set(a,r)}else n==="base"?e.importBaseStyles.set(a,r):(e.importResponsiveStyles.has(n)||e.importResponsiveStyles.set(n,new Map),e.importResponsiveStyles.get(n).set(a,r));return e.importedStyleCount+=1,a}function _e(e=""){return String(e||"").trim().replace(/_/g," ")}function Re(e=""){return!e||/[;{}]/.test(e)?!1:/^[-#(),.%/\sa-zA-Z0-9]+$/.test(e)}function Ke(e=""){let t=String(e||"").trim();if(!t)return null;let r=t.match(/^\[([^\]]+)\]$/);if(r){let n=_e(r[1]);return Re(n)?n:null}return Si[t]||null}function Ci(e=""){let t=Number(e);if(!Number.isFinite(t))return Vn;let r=String(t);return wr.includes(r)?r:wr.reduce((n,o)=>{let a=Math.abs(Number(n)-t);return Math.abs(Number(o)-t)<a?o:n},Vn)}function Ye(e="",t="500"){let r=String(e||"").toLowerCase(),n=Ci(t);return["blue","sky","indigo","cyan"].includes(r)?`var(--color-primary-${n})`:["purple","violet","fuchsia"].includes(r)?`var(--color-accent-${n})`:["green","emerald","lime","teal"].includes(r)?`var(--color-success-${n})`:["yellow","amber","warning"].includes(r)?`var(--color-warning-${n})`:["red","rose","pink","orange"].includes(r)?`var(--color-danger-${n})`:["slate","gray","zinc","neutral","stone"].includes(r)?`var(--color-gray-${n})`:""}function Kn(e=""){let t=_e(e);return Re(t)&&(/^#(?:[0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(t)||/^(?:rgb|hsl)a?\([^)]*\)$/.test(t))?t:""}function se(e=""){return String(e||"").split(/\s+/).map(t=>t.trim()).filter(Boolean)}function Ei(e="",t=""){if(!t)return e;let r=String(e||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return`${r} class="${t}"`;let o=n[1]||'"',a=se(n[2]);a.includes(t)||a.push(t);let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function Ai(e="",t=""){return t?new RegExp(`\\s${t}\\s*=`,"i").test(String(e||"")):!1}function Mi(e=""){let t=String(e||"").replace(/[-_]+/g," ").trim();return t?t.replace(/(^|\s)([a-z])/g,(r,n,o)=>`${n}${o.toUpperCase()}`):"Icon button"}function Ti(e="",t=null){let r=String(e||"");return r&&r.replace(/<(button|a)([^>]*)>\s*(<pds-icon\b[^>]*><\/pds-icon>)\s*<\/\1>/gi,(n,o,a,i)=>{let s=Ei(a,"icon-only");if(!Ai(s,"aria-label")){let u=String(i).match(/\sicon\s*=\s*(["'])(.*?)\1/i),l=u?String(u[2]||""):"",d=Mi(l);s+=` aria-label="${d}"`}return t&&(t.intentHits+=1,N(t,"intent.component.button.icon-only-markup")),`<${o}${s}>${i}</${o}>`})}function _i(e="",t=null){let r=String(e||"");if(!r)return r;let n=0,o=r.replace(/<p([^>]*?)>([\s\S]*?)<\/p>/gi,(a,i,s)=>{let u=String(i||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!u)return a;let l=se(u[2]||""),d=l.some(p=>/^import-text-/.test(String(p||""))),c=l.includes("text-muted")||l.some(p=>/^import-font-/.test(String(p||"")));return!d||!c?a:(n+=1,`<div${i}>${s}</div>`)});return t&&n>0&&(t.intentHits+=1,N(t,"intent.typography.metric-paragraph-to-div"),D(t,`Normalized ${n} metric text paragraph tag(s) to div.`)),o}function to(e="",t=""){if(!t)return e;let r=String(e||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=se(n[2]).filter(s=>s!==t);if(a.length===0)return r.replace(n[0],"");let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function Ri(e="",t=r=>r){let r=String(e||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=se(n[2]),i=t(Array.from(a)),s=Array.isArray(i)?i.filter(Boolean):a;if(s.length===0)return r.replace(n[0],"");let u=` class=${o}${s.join(" ")}${o}`;return r.replace(n[0],u)}function Ii(e="",t=null){let r=String(e||"");if(!r)return r;let n=0,o=r.replace(/<(div|section|article|aside)([^>]*)>\s*<(p|div)([^>]*)>[\s\S]*?<\/\3>\s*<(p|div)([^>]*)>[\s\S]*?<\/\5>\s*<\/\1>/gi,(a,i,s,u,l,d,c)=>{let p=String(s||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!p||!se(p[2]).includes("stack-sm"))return a;let m=String(l||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i),v=String(c||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!m||!v)return a;let g=se(m[2]),f=se(v[2]);if(!(g.some(b=>/^import-text-/.test(String(b||"")))&&f.some(b=>/^import-text-/.test(String(b||"")))))return a;let x=to(s,"stack-sm");return n+=1,a.replace(`<${i}${s}>`,`<${i}${x}>`)});return t&&n>0&&(t.intentHits+=1,N(t,"intent.typography.metric-pair-no-stack"),D(t,`Removed stack-sm from ${n} metric text pair container(s).`)),o}function Fi(e={}){if(!e||typeof e!="object")return{};let t=e.typography;if(t&&typeof t=="object")return t;let r=e.design?.typography;return r&&typeof r=="object"?r:{}}function Pi(e={}){let t=Fi(e),r=Number(t.fontScale);return Number.isFinite(r)?Math.max(1,Math.min(2,r)):Et}function Ni(e="",t=Et){let n={"4xl":1,"3xl":2,"2xl":3,xl:4}[e];if(!n)return"";let o=Number.isFinite(Number(t))?Math.max(1,Math.min(2,Number(t))):Et,a=Math.max(-1,Math.min(1,Math.round((o-Et)/.25))),i=n-a;return i<1?"h1":i>4?"":`h${i}`}function Oi(e="",t=null,r={}){let n=String(e||"");if(!n)return n;let o=Pi(r.config||{}),a=0,i=0,s=n.replace(/<(p|div|span)([^>]*)>([\s\S]*?)<\/\1>/gi,(u,l,d,c)=>{let p=String(d||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!p)return u;let h=se(p[2]);if(!h.includes("import-font-bold"))return u;let v=h.find(b=>/^import-text-(?:4xl|3xl|2xl|xl)$/.test(String(b||"")))||"",g=v.match(/^import-text-(4xl|3xl|2xl|xl)$/);if(g){let b=Ni(g[1],o);if(!b)return u;let S=Ri(d,C=>C.filter(E=>E!=="import-font-bold"&&E!==v));return a+=1,`<${b}${S}>${c}</${b}>`}let f=/<\/?(?:div|p|section|article|aside|main|header|footer|ul|ol|li|table|tr|td|th|h[1-6])\b/i.test(c),y=/<\/?(?:strong|b)\b/i.test(c);if(f||y)return u;let x=to(d,"import-font-bold");return i+=1,`<${l}${x}><strong>${c}</strong></${l}>`});return t&&(a>0&&(t.intentHits+=1,N(t,"intent.typography.semantic-heading-from-scale"),D(t,`Converted ${a} bold display text node(s) to semantic heading tags (fontScale=${Number(o).toFixed(2)}).`)),i>0&&(t.intentHits+=1,N(t,"intent.typography.bold-to-strong"),D(t,`Wrapped ${i} bold text node(s) in strong tags.`))),s}function ji(e=[]){if(!Array.isArray(e)||e.length===0)return"";let t=e.filter(n=>!At.includes(n));if(t.length===0||t.length>1)return"";let r=t[0];return["hover","focus","active"].includes(r)?r:""}function Jn(e,t="base",r=[]){let n=ji(r),o=ki[e];if(o)return{declaration:o,breakpoint:t,pseudo:n,ruleId:"fallback.import-style"};let a=String(e).match(/^gap-(\d+)$/);if(a){let z={0:"var(--spacing-0)",1:"var(--spacing-1)",2:"var(--spacing-2)",3:"var(--spacing-3)",4:"var(--spacing-4)",5:"var(--spacing-5)",6:"var(--spacing-6)",7:"var(--spacing-7)",8:"var(--spacing-8)",10:"var(--spacing-10)",12:"var(--spacing-12)"},L=Number(a[1]);if(z[L])return{declaration:`gap:${z[L]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.gap-scale"}}let i=String(e).match(/^(mt|mb|my)-(.+)$/);if(i){let z=i[1],L=i[2],_=Ke(L);if(_){let k="";return z==="mt"?k=`margin-top:${_}`:z==="mb"?k=`margin-bottom:${_}`:k=`margin-top:${_};margin-bottom:${_}`,{declaration:k,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.margin-scale"}}}let s=String(e).match(/^min-w-\[([^\]]+)\]$/);if(s){let z=_e(s[1]);if(Re(z))return{declaration:`min-width:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.min-width-arbitrary"}}let u=String(e).match(/^max-w-\[([^\]]+)\]$/);if(u){let z=_e(u[1]);if(Re(z))return{declaration:`max-width:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.max-width-arbitrary"}}let l=String(e).match(/^min-h-\[([^\]]+)\]$/);if(l){let z=_e(l[1]);if(Re(z))return{declaration:`min-height:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.min-height-arbitrary"}}let d=String(e).match(/^grid-rows-\[([^\]]+)\]$/);if(d){let z=_e(d[1]);if(Re(z))return{declaration:`grid-template-rows:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.grid-rows-arbitrary"}}let c=String(e).match(/^size-(.+)$/);if(c){let z=Ke(c[1]);if(z)return{declaration:`width:${z};height:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.size-scale"}}let p=String(e).match(/^w-(.+)$/);if(p){let z=Ke(p[1]);if(z)return{declaration:`width:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.width-scale"}}let h=String(e).match(/^h-(.+)$/);if(h){let z=Ke(h[1]);if(z)return{declaration:`height:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.height-scale"}}let m={xs:"var(--font-size-xs)",sm:"var(--font-size-sm)",base:"var(--font-size-md)",lg:"var(--font-size-lg)",xl:"var(--font-size-xl)","2xl":"var(--font-size-2xl)","3xl":"var(--font-size-3xl)","4xl":"var(--font-size-4xl)"},v=String(e).match(/^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$/);if(v)return{declaration:`font-size:${m[v[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-size"};let g={normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},f=String(e).match(/^font-(normal|medium|semibold|bold|extrabold|black)$/);if(f)return{declaration:`font-weight:${g[f[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.font-weight"};let y={none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"},x=String(e).match(/^leading-(none|tight|snug|normal|relaxed|loose)$/);if(x)return{declaration:`line-height:${y[x[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.line-height"};let b={tighter:"-0.05em",tight:"-0.025em",normal:"0em",wide:"0.025em",wider:"0.05em",widest:"0.1em"},S=String(e).match(/^tracking-(tighter|tight|normal|wide|wider|widest)$/);if(S)return{declaration:`letter-spacing:${b[S[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.tracking"};let C=String(e).match(/^bg-black\/(\d{1,3})$/);if(C)return{declaration:`background-color:color-mix(in srgb, var(--color-gray-900) ${Math.max(0,Math.min(100,Number(C[1])))}%, transparent)`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.overlay-alpha"};if(e==="text-white")return{declaration:"color:var(--color-gray-50)",breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-inverse"};let E=String(e).match(/^bg-(primary|secondary|accent)$/);if(E){let L={primary:"var(--color-primary-fill)",secondary:"var(--color-gray-500)",accent:"var(--color-accent-500)"}[E[1]];if(L)return{declaration:`background-color:${L}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.bg-semantic"}}let T=String(e).match(/^bg-([a-z]+)-(\d{2,3})$/);if(T){let z=Ye(T[1],T[2]);if(z)return{declaration:`background-color:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.bg-tokenized"}}let R=String(e).match(/^bg-\[([^\]]+)\]$/);if(R){let z=Kn(R[1]);if(z)return{declaration:`background-color:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.bg-arbitrary"}}let A=String(e).match(/^text-([a-z]+)-(\d{2,3})$/);if(A){let z=Ye(A[1],A[2]);if(z)return{declaration:`color:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-tokenized"}}let j=String(e).match(/^text-\[([^\]]+)\]$/);if(j){let z=Kn(j[1]);if(z)return{declaration:`color:${z}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-arbitrary"}}let M=String(e).match(/^rounded(?:-([trbl]{1,2}))?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(M){let z=M[1]||"",L=M[2]||"sm",_=L==="none"?"0":`var(--radius-${L})`,k={t:["top-left","top-right"],b:["bottom-left","bottom-right"],l:["top-left","bottom-left"],r:["top-right","bottom-right"],tl:["top-left"],tr:["top-right"],bl:["bottom-left"],br:["bottom-right"]};if(!z)return{declaration:`border-radius:${_}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.rounded"};let O=(k[z]||[]).map(B=>`border-${B}-radius:${_}`).join(";");if(O)return{declaration:O,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.rounded"}}return null}function Ct(e,t){return typeof e=="number"&&Number.isFinite(e)?`${e}px`:typeof e=="string"&&e.trim()?e.trim():`${t}px`}function Bi(e={}){let r=(e?.design&&typeof e.design=="object"?e.design:e)?.layout?.breakpoints||{};return{sm:Ct(r.sm,640),md:Ct(r.md,768),lg:Ct(r.lg,1024),xl:Ct(r.xl,1280)}}function Di(e,t){let r=Array.from(e.importBaseStyles.entries()).map(([a,i])=>`.${a}{${i};}`),n=[];for(let[a,i]of e.importResponsiveStyles.entries()){let s=t?.[a];if(!s||!i?.size)continue;let u=Array.from(i.entries()).map(([l,d])=>`.${l}{${d};}`).join(`
`);n.push(`@media (min-width: ${s}) {
${u}
}`)}for(let[a,i]of e.importPseudoStyles.entries()){let[s,u]=String(a).split("|");if(!u||!i?.size)continue;let l=Array.from(i.entries()).map(([c,p])=>`.${c}:${u}{${p};}`).join(`
`);if(!l)continue;if(s==="base"){n.push(l);continue}let d=t?.[s];d&&n.push(`@media (min-width: ${d}) {
${l}
}`)}let o=[...r,...n].filter(Boolean).join(`
`);return o.trim()?["/* pds-import: generated fallback styles for unmapped Tailwind utilities */",o].join(`
`):""}function Wi(e="",t=""){if(!t||!t.trim())return e;let r=`<style data-pds-import="tailwind-fallback">
${t}
</style>`;return/<head[^>]*>/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>
${r}`):`${r}
${e}`}function Yn(e=""){if(!e)return!1;if(e.includes(":")||e.includes("["))return!0;let t=e.split("-")[0];return $i.includes(t)}function le(e=""){let t=String(e).split(":");if(t.length===1)return{breakpoint:"base",base:t[0],variants:[]};let r=t[t.length-1],n=t.slice(0,-1);return{breakpoint:n.find(a=>At.includes(a))||"base",base:r,variants:n}}function Hi(){return{totalTailwind:0,mapped:0,ignored:0,policySkipped:0,unknown:0,intentHits:0,unknownTokens:new Map,notes:[],appliedRules:new Set,importBaseStyles:new Map,importResponsiveStyles:new Map,importPseudoStyles:new Map,importedStyleCount:0,labelNestingCount:0,removedAtomicSpacingCount:0,removedAtomicPositioningCount:0}}function Ui(e=""){let t=String(e||"").toLowerCase().replace(/\s+/g,""),r=t.includes("menu,ol,ul{list-style:none")||t.includes("ol,ul,menu{list-style:none")||t.includes("ul,ol,menu{list-style:none"),n=t.includes("a{color:inherit;text-decoration:inherit");return{listReset:r,anchorReset:n}}function qi(e=""){return String(e||"").toLowerCase().includes("cdn.tailwindcss.com")?{listReset:!0,anchorReset:!0}:{listReset:!1,anchorReset:!1}}function Vi(e="",t=null){let r=String(e||""),n={listReset:!1,anchorReset:!1,strippedRuntimeCssBlocks:0,strippedRuntimeScripts:0};return r=r.replace(/<style([^>]*)>([\s\S]*?)<\/style>/gi,(o,a,i)=>{let s=String(i||"");if(!(/tailwindcss\s+v\d/i.test(s)||/\*\s*!\s*tailwindcss/i.test(s)))return o;let l=Ui(s);return n.listReset=n.listReset||l.listReset,n.anchorReset=n.anchorReset||l.anchorReset,n.strippedRuntimeCssBlocks+=1,""}),r=r.replace(/<script([^>]*?)src\s*=\s*(?:(['"])([^"']*cdn\.tailwindcss\.com[^"']*)\2|([^\s>]*cdn\.tailwindcss\.com[^\s>]*))([^>]*)><\/script>/gi,(o,a,i,s,u)=>{let d=qi(s||u||"");return n.listReset=n.listReset||d.listReset,n.anchorReset=n.anchorReset||d.anchorReset,n.strippedRuntimeScripts+=1,""}),t&&(n.strippedRuntimeCssBlocks>0||n.strippedRuntimeScripts>0)&&(N(t,"intent.preflight.tailwind-runtime-detected"),n.strippedRuntimeCssBlocks>0&&D(t,`Detected and stripped ${n.strippedRuntimeCssBlocks} Tailwind runtime style block(s).`)),t&&n.strippedRuntimeScripts>0&&D(t,`Removed ${n.strippedRuntimeScripts} Tailwind CDN script reference(s).`),{html:r,hints:n}}function D(e,t){!e||!t||e.notes.includes(t)||e.notes.push(t)}function Gi(e,t){let r=e.unknownTokens.get(t)||0;e.unknownTokens.set(t,r+1)}function Ki(e={}){let r=(e?.design&&typeof e.design=="object"?e.design:e)?.layout?.utilities||{};return{grid:r.grid!==!1,flex:r.flex!==!1,spacing:r.spacing!==!1,container:r.container!==!1}}function Y(e,t){return t?e?.[t]!==!1:!0}function Zn(e){let t=String(e).match(/^grid-cols-(\d+)$/);return t?Number(t[1]):null}function Xn(e={}){let t=At.map(o=>({bp:o,cols:e[o]})).filter(o=>Number.isFinite(o.cols));if(t.length<2)return null;if(t.length===2){let[o,a]=t;if(o.bp==="base"&&o.cols===1&&a.cols===2)return"grid-auto-lg";if(o.bp==="base"&&o.cols===1&&a.cols>=3)return null;if(o.cols<a.cols){if(a.cols>=4)return"grid-auto-md";if(a.cols>=2)return"grid-auto-lg"}return null}let r=!0;for(let o=1;o<t.length;o+=1)if(t[o].cols<=t[o-1].cols){r=!1;break}if(!r)return null;let n=t[t.length-1]?.cols||0;return n>=4?"grid-auto-md":n>=3?"grid-auto-sm":null}function Ji(e=""){let t=String(e).match(/^text-(gray|slate|zinc|neutral|stone)-(\d{2,3})$/);if(!t)return"";let r=Number(t[2]);return Number.isFinite(r)&&r>=400&&r<=600?"text-muted":""}function Yi(e="",t=0){return!e||!Number.isFinite(t)?"":{sm:{2:"sm:grid-cols-2"},md:{3:"md:grid-cols-3"},lg:{4:"lg:grid-cols-4"}}?.[e]?.[t]||""}function Zi(e=""){let t=le(e),n=String(t?.base||"").match(/^space-y-(\d+)$/);if(!n)return"stack-md";let o=Number(n[1]);return Number.isFinite(o)?o<=1?"stack-xs":o<=2?"stack-sm":o<=4?"stack-md":"stack-lg":"stack-md"}function Xi(e=new Set){return Array.from(e).some(t=>{let r=String(t||"");return/^gap-(?:xs|sm|md|lg|xl)$/.test(r)||/^gap-[0-9]+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?gap-/.test(r)})}function Qi(e=new Set){return Array.from(e).some(t=>/^stack-(?:xs|sm|md|lg|xl)$/.test(String(t||"")))}function es(e=new Set){return Array.from(e).some(t=>{let r=String(t||"");return/^grid-cols-\d+$/.test(r)||/^grid-auto-(?:sm|md|lg|xl)$/.test(r)||/^(?:sm|md|lg|xl):grid-cols-\d+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?grid-cols-\d+$/.test(r)})}function ts(e,t=12){return Array.from(e.unknownTokens.entries()).sort((r,n)=>n[1]-r[1]).slice(0,t).map(([r])=>r)}function N(e,t){!e||!t||e.appliedRules.add(t)}function de(e=[],t){return!Array.isArray(e)||!t?!1:e.some(r=>t.test(String(r)))}function rs(e=[]){for(let t of e){let r=le(t);if(r.breakpoint!=="base")continue;let n=String(r.base).match(/^h-(.+)$/);if(!n)continue;let o=Ke(n[1]);if(!o||o==="auto")continue;let a=String(o).match(/^(-?\d+(?:\.\d+)?)rem$/);if(a){let i=Number(a[1]);if(Number.isFinite(i))return i*16}}return null}function ns(e=[],t=""){let r=t==="button",n=de(e,/^bg-/),o=de(e,/^hover:bg-/),a=de(e,/^border/),i=de(e,/^shadow/),s=e.includes("cursor-pointer"),u=de(e,/^rounded/),l=de(e,/^(?:min-w|max-w|w)-/),d=de(e,/^text-(?:white|black|\[[^\]]+\]|[a-z]+-\d{2,3})$/),c=n||o||i;if(!(r||t==="a"&&(c||a||s||u&&l)))return{shouldNormalize:!1,variant:"none",size:"base",iconOnly:!1};let m="none";a&&!n&&!o?m="outline":(c||n&&d)&&(m="primary");let v=e.includes("rounded-full")&&(e.includes("p-2")||e.includes("p-1")||e.includes("p-2.5")),g=de(e,/^size-(?:6|7|8|9|10|11|12)$/),f=v||g,y=rs(e),x=e.includes("text-sm")||e.includes("text-xs"),b=e.includes("text-lg")||e.includes("text-xl"),S="base";return y&&y<=40||x?S="sm":(y&&y>=48||b)&&(S="lg"),{shouldNormalize:!0,variant:m,size:S,iconOnly:f}}function os(e=""){let t=String(e||"").toLowerCase();return["green","emerald","lime","teal"].includes(t)?"badge-success":["blue","sky","cyan","indigo"].includes(t)?"badge-info":["yellow","amber","orange"].includes(t)?"badge-warning":["red","rose","pink"].includes(t)?"badge-danger":["gray","slate","zinc","neutral","stone"].includes(t)?"badge-secondary":["purple","violet","fuchsia","primary","accent"].includes(t)?"badge-primary":"badge-secondary"}function as(e=[],t="",r={shouldNormalize:!1}){if(r?.shouldNormalize)return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(["button","a","input","select","textarea"].includes(t))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(e.some(A=>/^badge(?:-|$)/.test(String(A))))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let n=e.map(A=>le(A)).filter(A=>A.breakpoint==="base").map(A=>String(A.base)),o=n.some(A=>/^rounded(?:-|$)/.test(A)),a=n.some(A=>/^px-/.test(A)),i=n.some(A=>/^py-/.test(A)),s=a&&i,u=n.includes("text-xs")||n.includes("text-sm"),l=n.includes("text-lg")||n.includes("text-xl"),d=n.map(A=>A.match(/^bg-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),c=n.map(A=>A.match(/^text-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),p=n.map(A=>A.match(/^border-([a-z]+)-(\d{2,3})$/)).find(Boolean),h=Number(d?.[2]),m=Number(c?.[2]),v=!!(d&&Number.isFinite(h)&&h<=300),g=n.some(A=>/^border(?:-|$)/.test(A)),f=!!(d||c||p),y=[o,s,u,v||g].filter(Boolean).length;if(!(f&&y>=3))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let b=d&&d[1]||c&&c[1]||p&&p[1]||"",S=os(b),C=g&&!v,E=u?"badge-sm":l?"badge-lg":"",T=v?{family:b,bgShade:Number.isFinite(h)?h:200,textShade:Number.isFinite(m)?m:700}:null;return{shouldNormalize:!0,variantClass:T?"":S,outline:C,sizeClass:E,pastel:T}}function is(e="",t=0){let r=String(e||"").toLowerCase(),n=Number(t);return r==="white"?"surface-base":["gray","slate","zinc","neutral","stone"].includes(r)?Number.isFinite(n)&&n<=100?"surface-base":"surface-subtle":["blue","sky","cyan","indigo","primary","info"].includes(r)?"surface-info":["purple","violet","fuchsia","accent"].includes(r)?"surface-primary":["green","emerald","lime","teal","success"].includes(r)?"surface-success":["yellow","amber","orange","warning"].includes(r)?"surface-warning":["red","rose","pink","danger"].includes(r)?"surface-danger":"surface-base"}function ss(e=[],t="",r={shouldNormalize:!1},n={shouldNormalize:!1}){if(r?.shouldNormalize||n?.shouldNormalize)return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(!new Set(["div","section","article","aside","li"]).has(t))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(e.some(g=>/^card(?:-|$)/.test(String(g))))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let a=e.map(g=>le(g)).filter(g=>g.breakpoint==="base").map(g=>String(g.base)),i=a.some(g=>/^rounded(?:-|$)/.test(g)),s=a.some(g=>/^border(?:$|-)/.test(g)),u=a.some(g=>/^shadow(?:$|-)/.test(g)),l=a.some(g=>/^(?:p|px|py|pt|pb|pl|pr)-/.test(g)),d=a.map(g=>g.match(/^bg-([a-z]+)-?(\d{2,3})?$/)).find(Boolean),c=a.includes("bg-white")||!!d;if(!([i,s||u,c,l].filter(Boolean).length>=3))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let m="card-basic";u?m="card-elevated":s&&(m="card-outlined");let v="";return u?v="surface-elevated":d?v=is(d[1],d[2]):c&&(v="surface-base"),{shouldNormalize:!0,cardVariantClass:m,surfaceClass:v}}function ls({tagName:e,originalClassValue:t,policy:r,summary:n,preflightHints:o={}}){if(wi.has(e))return N(n,"table.strict-tags.no-classes"),"";let a=String(t).split(/\s+/).filter(Boolean),i=ns(a,e),s=as(a,e,i),u=ss(a,e,i,s),l=/^h[1-6]$/.test(e),d=["i","svg"].includes(e)||a.some(M=>/^fa(?:[a-z-]+)?$/i.test(String(M||""))||/^fa-/.test(String(M||""))),c=new Set,p={},h={},m=!1,v="",g="",f=!1,y="";a.forEach(M=>{let z=le(M),L=z.base;if(xi.some(P=>P.test(L))){n.ignored+=1,N(n,"cleanup.non-pds-class");return}let _=Yn(M)||Yn(L);if(_&&(n.totalTailwind+=1),/^space-y-/.test(L)){m=!0,v=v||M,g=g||Zi(M),n.ignored+=1,N(n,"layout.spacing.space-y-to-stack");return}if(/^space-x-/.test(L)){let P=String(L).match(/^space-x-(\d+)$/);if(P){let W=`gap-${P[1]}`,H=xr.get(W);if(H&&Y(r,"spacing")){c.add(H),f=!0,y=y||M,n.mapped+=1,n.intentHits+=1,N(n,"layout.spacing.space-x-to-gap");return}}n.ignored+=1,N(n,"style.spacing.atomic");return}if(/^grid-cols-\d+$/.test(L)&&z.breakpoint!=="base"){let P=Zn(L);if(Number.isFinite(P)&&Y(r,"grid")){p[z.breakpoint]=P,n.mapped+=1,N(n,"intent.layout.responsive-grid-to-auto");return}if(!Y(r,"grid")){n.policySkipped+=1,D(n,"Skipped responsive grid mapping because layout.utilities.grid=false.");return}}if(/^flex-(?:row|col)$/.test(L)&&z.breakpoint!=="base"){if(Y(r,"flex")){h[z.breakpoint]=L,n.mapped+=1,N(n,"intent.layout.mobile-stack");return}n.policySkipped+=1,D(n,"Skipped responsive flex mapping because layout.utilities.flex=false.");return}if(/^grid-cols-\d+$/.test(L)&&z.breakpoint==="base"){let P=Zn(L);Number.isFinite(P)&&Y(r,"grid")&&(p.base=P)}let k=vi.get(L);if(k&&z.breakpoint==="base"){if(!Y(r,k.gate)){n.policySkipped+=1,D(n,`Skipped ${L} because layout.utilities.${k.gate}=false.`);return}k.pds.forEach(P=>{P&&c.add(P)}),n.mapped+=1,N(n,k.id);return}if(xr.has(L)&&z.breakpoint==="base"){if(!Y(r,"spacing")){n.policySkipped+=1,D(n,"Skipped gap utility because layout.utilities.spacing=false.");return}c.add(xr.get(L)),n.mapped+=1,N(n,"layout.spacing.gap-scale");return}if(qn.has(L)&&z.breakpoint==="base"){if(!Y(r,"container")){n.policySkipped+=1,D(n,"Skipped max-width utility because layout.utilities.container=false.");return}c.add(qn.get(L)),n.mapped+=1,N(n,"layout.container.max-width");return}if(i.shouldNormalize&&_){let P=String(L||"");if(z.breakpoint==="base"&&["flex-1","grow","flex-grow"].includes(P)){c.add("grow"),n.mapped+=1,n.intentHits+=1,N(n,"intent.component.button.layout-grow");return}if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(P)||P.startsWith("hover:")){n.ignored+=1,N(n,"intent.component.button.normalize");return}}if(l&&/^(?:text-(?:xs|sm|base|lg|xl|\dxl|white|black|\[[^\]]+\]|[a-z]+-\d{2,3})|font-|leading-|tracking-|uppercase|lowercase|capitalize)/.test(L)){n.ignored+=1,n.intentHits+=1,N(n,"intent.typography.heading-semantic");return}if(s.shouldNormalize&&_){let P=String(L||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(P)||P.startsWith("hover:")){n.ignored+=1,N(n,"intent.component.badge.normalize");return}}if(u.shouldNormalize&&_){let P=String(L||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)/.test(P)||P.startsWith("hover:")){n.ignored+=1,N(n,"intent.component.card.normalize");return}}let F=Ji(L);if(F&&z.breakpoint==="base"){c.add(F),n.mapped+=1,n.intentHits+=1,N(n,"intent.typography.text-neutral-to-muted");return}if(/^text-(?:white|black|[a-z]+-\d{2,3}|\[[^\]]+\])$/.test(L)){if(d||e==="a"&&!i.shouldNormalize){let W=Jn(L,z.breakpoint,z.variants);if(W){let H=be(n,`${e}-color-${L}`,W.declaration,W.breakpoint,W.pseudo);if(H){c.add(H),n.mapped+=1,n.intentHits+=1,N(n,d?"intent.icon.color-preserve":"intent.typography.link-active-preserve");return}}}n.ignored+=1,N(n,"style.color");return}let B=Jn(L,z.breakpoint,z.variants);if(B){let P=be(n,L,B.declaration,B.breakpoint,B.pseudo);if(P){c.add(P),n.mapped+=1,n.intentHits+=1,N(n,B.ruleId),z.breakpoint!=="base"&&D(n,`Generated responsive import fallback for ${M}.`);return}}for(let P of J.ignoredPatterns)if(P.pattern.test(L)){n.ignored+=1,N(n,P.id),P.id==="style.spacing.atomic"&&(n.removedAtomicSpacingCount+=1),P.id==="style.positioning.atomic"&&(n.removedAtomicPositioningCount+=1);return}if(_){n.unknown+=1,Gi(n,M);return}c.add(M)}),m&&Y(r,"spacing")&&(c.add(g||"stack-md"),n.mapped+=1,n.intentHits+=1,D(n,`Mapped ${v} to ${g||"stack-md"}.`)),f&&Y(r,"spacing")&&D(n,`Mapped ${y} to gap utility.`);let x=Xn(p);if(x&&Y(r,"grid")?(c.delete("grid-cols-1"),c.delete("grid-cols-2"),c.delete("grid-cols-3"),c.delete("grid-cols-4"),c.delete("grid-cols-6"),c.add("grid"),c.add(x),n.intentHits+=1,N(n,"intent.layout.responsive-grid-to-auto"),D(n,`Collapsed responsive grid columns to ${x}.`)):Y(r,"grid")&&At.filter(z=>z!=="base"&&Number.isFinite(p[z])).forEach(z=>{let L=p[z],_=Yi(z,L);if(_){c.add("grid"),c.add(_),n.intentHits+=1,N(n,"intent.layout.responsive-grid-to-auto"),D(n,`Mapped ${z}:grid-cols-${L} to ${_}.`);return}let k=be(n,`grid-cols-${L}`,`grid-template-columns:repeat(${L}, minmax(0, 1fr))`,z);k&&(c.add("grid"),c.add(k),n.intentHits+=1,N(n,"fallback.import-style.grid-cols-responsive"),D(n,`Mapped ${z}:grid-cols-${L} to responsive import fallback for exact columns.`))}),Y(r,"flex")&&a.includes("flex-col")&&(h.md==="flex-row"||h.lg==="flex-row")&&(c.delete("flex-col"),c.delete("flex-row"),c.add("mobile-stack"),n.intentHits+=1,N(n,"intent.layout.mobile-stack"),D(n,"Mapped flex-col + breakpoint flex-row to mobile-stack.")),(c.has("flex")||c.has("inline-flex"))&&Y(r,"spacing")&&(Xi(c)||Qi(c)||f||m||(c.add("gap-sm"),n.intentHits+=1,N(n,"layout.spacing.flex-min-gap"),D(n,"Added gap-sm fallback for flex container without explicit spacing."))),a.some(M=>/^grid-cols-\d+$/.test(le(M).base))&&c.has("grid")&&!es(c)){let M=Xn(p);M?(c.add(M),n.intentHits+=1,N(n,"intent.layout.responsive-grid-to-auto"),D(n,`Applied grid safety fallback ${M} to avoid bare grid output.`)):Number.isFinite(p.base)&&p.base>1?(c.add(`grid-cols-${p.base}`),n.intentHits+=1,N(n,"intent.layout.grid-safety-fallback"),D(n,`Applied grid safety fallback grid-cols-${p.base} to preserve explicit grid intent.`)):(c.add("mobile-stack"),n.intentHits+=1,N(n,"intent.layout.grid-safety-fallback.mobile-stack"),D(n,"Applied mobile-stack safety fallback to avoid bare grid output when explicit grid intent was present."))}let C=a.some(M=>/^(?:bg-white|shadow|shadow-md|shadow-lg)$/.test(M)),E=a.some(M=>/^rounded/.test(M));if(["div","section","article","li","aside"].includes(e)&&C&&E&&(c.add("card"),!c.has("surface-elevated")&&a.some(M=>/^shadow/.test(M))&&c.add("surface-elevated"),!c.has("surface-base")&&a.includes("bg-white")&&c.add("surface-base"),n.intentHits+=1,N(n,"intent.component.card")),e==="button"||e==="a"){let M=a.some(_=>/^bg-(?:[a-z]+-)?[4567]00$/.test(_))&&a.includes("text-white"),z=a.some(_=>/^border/.test(_))&&!M,L=a.includes("p-2")&&a.includes("rounded-full");M?(c.delete("surface-base"),c.delete("surface-elevated"),c.add("btn-primary"),n.intentHits+=1,N(n,"intent.component.button.primary")):z&&(c.add("btn-outline"),n.intentHits+=1,N(n,"intent.component.button.outline")),L&&(c.add("icon-only"),N(n,"intent.component.button.icon-only"))}if(i.shouldNormalize){for(let z of Array.from(c))String(z).startsWith("import-")&&c.delete(z);["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","surface-base","surface-elevated","surface-subtle","card"].forEach(z=>c.delete(z)),i.variant==="primary"?(c.add("btn-primary"),N(n,"intent.component.button.primary")):i.variant==="outline"&&(c.add("btn-outline"),N(n,"intent.component.button.outline")),i.size==="sm"?(c.add("btn-sm"),N(n,"intent.component.button.size-sm")):i.size==="lg"&&(c.add("btn-lg"),N(n,"intent.component.button.size-lg")),i.iconOnly&&(c.add("icon-only"),N(n,"intent.component.button.icon-only")),n.intentHits+=1,N(n,"intent.component.button.normalize")}if(s.shouldNormalize){for(let z of Array.from(c))String(z).startsWith("import-")&&c.delete(z);if(["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","grow","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","text-muted","surface-base","surface-elevated","surface-subtle","card"].forEach(z=>c.delete(z)),c.add("badge"),s.variantClass&&c.add(s.variantClass),s.outline&&c.add("badge-outline"),s.sizeClass&&c.add(s.sizeClass),s.pastel&&s.pastel.family){let z=Ye(s.pastel.family,String(s.pastel.bgShade||200)),L=Ye(s.pastel.family,String(s.pastel.textShade||700));if(z&&L){let _=`badge-pastel-${s.pastel.family}-${s.pastel.bgShade}-${s.pastel.textShade}`,k=be(n,_,`background-color:${z};color:${L}`,"base");k&&(c.add(k),N(n,"intent.component.badge.pastel-preserve"),D(n,`Preserved pastel badge tone using ${k}.`))}}n.intentHits+=1,N(n,"intent.component.badge.normalize"),D(n,"Normalized badge/pill utility cluster to PDS badge classes.")}if(u.shouldNormalize){for(let z of Array.from(c))String(z).startsWith("import-")&&c.delete(z);["surface-base","surface-subtle","surface-elevated","surface-sunken","surface-overlay","surface-inverse","surface-primary","surface-secondary","surface-success","surface-warning","surface-danger","surface-info","card-basic","card-elevated","card-outlined","card-interactive"].forEach(z=>c.delete(z)),c.add("card"),u.cardVariantClass&&c.add(u.cardVariantClass),u.surfaceClass&&c.add(u.surfaceClass),n.intentHits+=1,N(n,"intent.component.card.normalize"),D(n,"Normalized card utility cluster to PDS card/surface classes.")}if(e==="a"&&!i.shouldNormalize&&a.some(z=>z.includes("hover:text")||z==="transition-colors")){let z=be(n,"link-reset","text-decoration:none");z&&c.add(z),n.intentHits+=1,N(n,"intent.typography.link-treatment")}if(e==="footer"&&(c.has("surface-base")||a.some(z=>/^bg-/.test(z)))&&(c.delete("surface-base"),c.delete("surface-subtle"),c.add("surface-inverse"),n.intentHits+=1,N(n,"intent.surface.footer-inverse")),o?.listReset&&["ul","ol","menu"].includes(e)){let M=be(n,"list-reset","list-style:none;margin:0;padding:0");M&&(c.add(M),n.intentHits+=1,N(n,"intent.preflight.list-reset"))}if(o?.anchorReset&&e==="a"&&!i.shouldNormalize){let M=be(n,"anchor-reset","color:inherit;text-decoration:inherit");M&&(c.add(M),n.intentHits+=1,N(n,"intent.preflight.anchor-reset"))}let A=new Set(["div","section","article","aside","nav","main","header","footer","form","fieldset","ul","ol","li"]),j=a.some(M=>{let z=le(M).base;return/^(?:flex|grid|container|gap-|space-[xy]-|items-|justify-|content-|place-|self-|w-|h-|min-|max-)/.test(z)});return c.size===0&&A.has(e)&&j&&(c.add("stack-sm"),D(n,`Added stack-sm fallback for <${e}> with unmapped classes.`)),Array.from(c).join(" ")}function cs(e="",t={}){let r=String(e||""),n=Ki(t.config||{}),o=Bi(t.config||{}),a=Hi(),i=Vi(r,a),u=zi(i.html,a).replace(/<([a-zA-Z][\w:-]*)([^>]*?)\sclass\s*=\s*(["'])(.*?)\3([^>]*)>/gs,(S,C,E,T,R,A)=>{let j=ls({tagName:String(C||"").toLowerCase(),originalClassValue:R,policy:n,summary:a,preflightHints:i.hints}),M=String(j||"").trim();return M?`<${C}${E} class=${T}${M}${T}${A}>`:`<${C}${E}${A}>`}),l=Oi(Ii(_i(Ti(u,a),a),a),a,{config:t.config||{}}),d=Di(a,o),c=Wi(l,d);d&&D(a,`Generated ${a.importedStyleCount} import-* fallback style mappings.`),(a.removedAtomicSpacingCount>0||a.removedAtomicPositioningCount>0)&&D(a,`Removed atomic utilities by policy: spacing=${a.removedAtomicSpacingCount}, positioning=${a.removedAtomicPositioningCount}.`);let p=ts(a,16),h=a.mapped+a.ignored+a.policySkipped,m=a.totalTailwind>0?h/a.totalTailwind:1,v=a.totalTailwind>0?a.unknown/a.totalTailwind:0,g=.42+m*.45+Math.min(a.intentHits,4)*.025-v*.18,f=Math.max(.15,Math.min(.96,Number(g.toFixed(2)))),y=[`pds-import: rulebook=${Un} confidence=${Math.round(f*100)}%`,`pds-import: tailwind=${a.totalTailwind} mapped=${a.mapped} ignored=${a.ignored} policySkipped=${a.policySkipped} unknown=${a.unknown}`];p.length&&y.push(`pds-import: unknown-tailwind=${p.join(", ")}`),a.notes.length&&y.push(`pds-import: notes=${a.notes.join(" | ")}`);let x=`<!-- ${y.join(` -->
<!-- `)} -->
${c}`,b=[];return a.unknown>0&&b.push({severity:"warning",message:`Converted with ${a.unknown} unknown Tailwind utilities requiring manual review.`}),a.policySkipped>0&&b.push({severity:"info",message:`Skipped ${a.policySkipped} utility mappings due to PDS config policy.`}),p.length&&b.push({severity:"info",message:`Top unknown utilities: ${p.slice(0,8).join(", ")}`}),{html:x,confidence:f,issues:b,meta:{rulebookVersion:Un,coverage:{tailwind:a.totalTailwind,mapped:a.mapped,ignored:a.ignored,policySkipped:a.policySkipped,unknown:a.unknown,importedStyles:a.importedStyleCount,nestedLabelPairs:a.labelNestingCount},unknownTailwindTokens:p,notes:a.notes,appliedRules:Array.from(a.appliedRules),policy:n,importStyleSheetInjected:!!d,breakpoints:o}}}function ds(){return{rulesJsonPath:bi,...J,directMappings:J.directMappings.map(e=>({id:e.id,tw:e.tw,pds:e.pds,gate:e.gate||null})),ignoredPatterns:J.ignoredPatterns.map(e=>({id:e.id,pattern:String(e.pattern),reason:e.reason}))}}function us(e){let t=String(e||"").match(/#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})\b/);return t?t[0]:null}function ps(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ro(e){return/<\s*[a-z][^>]*>/i.test(String(e||""))}function fs(e){let t=String(e||"").trim().toLowerCase();if(!t)return null;let r=Number.parseFloat(t);return Number.isFinite(r)?t.endsWith("rem")||t.endsWith("em")?r*16:t.endsWith("px")||/^[0-9.\-]+$/.test(t)?r:null:null}function te(e){let t=String(e||"").trim();if(!t)return"";let r=t.match(/#(?:[0-9a-f]{3,8})\b/i);if(r)return r[0].toLowerCase();let n=t.match(/rgba?\([^)]*\)/i);if(n)return n[0];let o=t.match(/hsla?\([^)]*\)/i);return o?o[0]:""}function gs(e=""){let t=String(e||"").trim();if(!t||typeof window>"u"||typeof document>"u")return"";let r=document.documentElement;if(!r)return"";let n=window.getComputedStyle(r);return String(n.getPropertyValue(t)||"").trim()}function ms(e=""){let t=String(e||"").trim(),r=te(t);if(r)return r;let n=t.match(/var\(\s*(--[^\s,)]+)\s*(?:,[^)]+)?\)/i);if(!n)return"";let o=gs(n[1]);return te(o)}function hs(e=""){let t=String(e||"").trim();if(!t)return"";let r=t.split(":").pop()||t;if(r==="bg-white")return"#ffffff";if(r==="bg-black")return"#000000";let n=r.match(/^bg-black\/(\d{1,3})$/i);if(n)return`rgba(0,0,0,${Math.max(0,Math.min(100,Number(n[1])))/100})`;let o=r.match(/^bg-\[([^\]]+)\]$/i);if(o)return te(o[1]);let a=r.match(/^bg-([a-z]+)-(\d{2,3})$/i);if(!a)return"";let i=Ye(a[1],a[2]);return i?ms(i):""}function Qn(e=""){return String(e||"").split(/\s+/).map(r=>r.trim()).filter(Boolean).map(r=>hs(r)).filter(Boolean)}function bs(e=""){let t=[],r=String(e||""),n=/([^{}]+)\{([^{}]*)\}/g,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim(),i=String(o[2]||"").trim();a&&i&&t.push({selector:a,body:i}),o=n.exec(r)}return t}function ys(e=""){let t=String(e||"").toLowerCase();return t?/(^|\s|,)(html|body|:root|main)(\s|,|$)|#app\b|#root\b|\.app\b|\.page\b/.test(t):!1}function vs(e=""){let t=String(e||"").trim().match(/rgba?\(\s*([0-9.]+)\s*,\s*([0-9.]+)\s*,\s*([0-9.]+)(?:\s*,\s*([0-9.]+))?\s*\)/i);if(!t)return null;let r=Number.parseFloat(t[1]),n=Number.parseFloat(t[2]),o=Number.parseFloat(t[3]),a=t[4]==null?1:Number.parseFloat(t[4]);return[r,n,o,a].every(i=>Number.isFinite(i))?{r:Math.max(0,Math.min(255,r)),g:Math.max(0,Math.min(255,n)),b:Math.max(0,Math.min(255,o)),a:Math.max(0,Math.min(1,a))}:null}function xs(e=""){let t=String(e||"").trim().match(/^#([0-9a-f]{3,8})$/i);if(!t)return null;let r=t[1].toLowerCase();if(r.length===3){let[n,o,a]=r.split("");return{r:Number.parseInt(`${n}${n}`,16),g:Number.parseInt(`${o}${o}`,16),b:Number.parseInt(`${a}${a}`,16),a:1}}return r.length===6||r.length===8?{r:Number.parseInt(r.slice(0,2),16),g:Number.parseInt(r.slice(2,4),16),b:Number.parseInt(r.slice(4,6),16),a:r.length===8?Number.parseInt(r.slice(6,8),16)/255:1}:null}function no(e=""){let t=te(e);return t?t.startsWith("#")?xs(t):t.startsWith("rgb")?vs(t):null:null}function ws(e){if(!e)return null;let t=a=>{let i=Number(a)/255;return i<=.03928?i/12.92:((i+.055)/1.055)**2.4},r=t(e.r),n=t(e.g),o=t(e.b);return .2126*r+.7152*n+.0722*o}function eo(e=""){let t=String(e||"").trim().toLowerCase();if(!t||t==="transparent")return!0;let r=no(t);return r&&Number.isFinite(r.a)?r.a<=.04:!1}function ks(e=[],t=[]){let r=e.map(u=>te(u)).filter(u=>u&&!eo(u)),n=Je(r);if(n)return{color:n,source:"root"};let o=t.map(u=>te(u)).filter(u=>u&&!eo(u)),a=o.filter(u=>{let l=no(u),d=ws(l);return Number.isFinite(d)?d>=.72:!1}),i=Je(a);if(i)return{color:i,source:"fallback-bright"};let s=Je(o);return s?{color:s,source:"fallback"}:{color:"",source:"none"}}function Te(e,t=new Map){let r=String(e||""),n=/([a-z-]+)\s*:\s*([^;{}]+)/gi,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim().toLowerCase(),i=String(o[2]||"").trim();a&&i&&(t.has(a)||t.set(a,[]),t.get(a).push(i)),o=n.exec(r)}return t}function Ss(e=""){let t=String(e||""),r=new Map,n=[],o=[],a=[],i=[],s=[],u=[],l=[],d=/#(?:[0-9a-f]{3,8})\b|rgba?\([^)]*\)|hsla?\([^)]*\)/gi,c=p=>{(String(p||"").match(d)||[]).forEach(m=>{let v=te(m);v&&n.push(v)})};if(typeof DOMParser<"u"&&ro(t))try{let h=new DOMParser().parseFromString(t,"text/html");Array.from(h.querySelectorAll("style")).map(x=>x.textContent||"").forEach(x=>{Te(x,r),c(x),bs(x).forEach(b=>{if(!ys(b.selector))return;let S=Te(b.body,new Map),C=Z(S,["background","background-color"]).map(E=>te(E)).filter(Boolean);o.push(...C)})}),Array.from(h.querySelectorAll("[style]")).forEach(x=>{let b=x.getAttribute("style")||"";Te(b,r),c(b)}),["html","body","main","#app","#root",".app",".page"].forEach(x=>{let b=h.querySelector(x);if(!b)return;let S=b.getAttribute("style")||"";if(!S)return;let C=Te(S,new Map),E=Z(C,["background","background-color"]).map(R=>te(R)).filter(Boolean);o.push(...E);let T=Qn(b.getAttribute("class")||"");a.push(...T)}),Array.from(h.querySelectorAll("[class]")).forEach(x=>{let b=se(x.getAttribute("class")||"");u.push(...b);let S=Qn(x.getAttribute("class")||"");i.push(...S);let C=String(x.tagName||"").toLowerCase(),E=C==="button"||C==="a",T=b.some(R=>/^bg-/.test(String(le(R).base||"")));E&&T&&S.length&&s.push(...S)});let y=h.body?.textContent||"";y.trim()&&l.push(y),c(h.documentElement?.outerHTML||t)}catch{Te(t,r),c(t),l.push(t)}else Te(t,r),c(t),l.push(t);return{declarations:r,colorValues:n,rootBackgroundColors:o,rootClassBackgroundColors:a,classBackgroundColors:i,buttonBackgroundColors:s,classTokens:u,textCorpus:l.join(`
`)}}function Je(e=[]){let t=new Map;e.forEach(o=>{let a=String(o||"").trim();a&&t.set(a,(t.get(a)||0)+1)});let r="",n=-1;return t.forEach((o,a)=>{o>n&&(r=a,n=o)}),r}function Z(e,t=[]){return t.flatMap(r=>e.get(r)||[])}function $s(e,t){if(!e||!t)return null;let r=String(t).split(".").filter(Boolean),n=e;for(let o of r){if(!n||n.type!=="object"||!n.properties||typeof n.properties!="object")return null;n=n.properties[o]}return n||null}function zs(e={}){let t=e&&typeof e=="object"?e:{},r=w?.configRelations&&typeof w.configRelations=="object"?w.configRelations:{},n=new Set(Object.keys(r)),o=null;if(typeof w?.buildConfigFormSchema=="function")try{o=w.buildConfigFormSchema(t)?.schema||null}catch{o=null}return!o&&w?.configFormSchema?.schema&&(o=w.configFormSchema.schema),{design:t,schema:o,allowedPaths:n}}function Ls(e,t){if(!e)return t;if(Array.isArray(e.oneOf)&&e.oneOf.length){let r=e.oneOf.map(n=>n?.const).filter(n=>n!=null);if(r.length){if(typeof t=="string"){let n=r.find(o=>String(o).toLowerCase()===t.toLowerCase());if(n!==void 0)return n}if(typeof t=="number"){let n=r.map(o=>Number(o)).filter(o=>Number.isFinite(o));if(n.length)return n.reduce((o,a)=>Math.abs(a-t)<Math.abs(o-t)?a:o,n[0])}return r[0]}}if(e.type==="number"||e.type==="integer"){let r=Number(t);return Number.isFinite(r)?e.type==="integer"?Math.round(r):r:void 0}return e.type==="boolean"?!!t:e.type==="string"?String(t||"").trim():t}function Cs(e,t,r){let n=String(t||"").split(".").filter(Boolean);if(!n.length)return;let o=e;for(let a=0;a<n.length;a+=1){let i=n[a];if(a===n.length-1){o[i]=r;return}(!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))&&(o[i]={}),o=o[i]}}function V(e,t,r){if(r==null||r===""||e.allowedPaths.size&&!e.allowedPaths.has(t))return;let n=$s(e.schema,t),o=Ls(n,r);o==null||o===""||(Cs(e.patch,t,o),e.inferredPaths.add(t))}function ye(e=[]){let t=e.map(n=>fs(n)).filter(n=>Number.isFinite(n));if(!t.length)return null;t.sort((n,o)=>n-o);let r=Math.floor(t.length/2);return t.length%2?t[r]:(t[r-1]+t[r])/2}function Es(e=[]){let t=e.map(r=>String(r||"").split(",")[0]||"").map(r=>r.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean);return Je(t)}function As(e){let t=Number(e);return Number.isFinite(t)?t<=.75?"hairline":t<=1.5?"thin":t<=2.5?"medium":"thick":"thin"}function Ms(e=""){let r=String(le(e).base||"").toLowerCase().match(/^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(!r)return null;let n=r[1]||"DEFAULT",o={none:0,xs:2,sm:4,DEFAULT:6,md:8,lg:12,xl:16,"2xl":24,"3xl":32};return n==="full"?null:Number.isFinite(o[n])?o[n]:null}function Ts(e=[]){let t=e.map(n=>Ms(n)).filter(n=>Number.isFinite(n));if(!t.length)return null;t.sort((n,o)=>n-o);let r=Math.floor(t.length/2);return t.length%2?t[r]:(t[r-1]+t[r])/2}function kr(e={}){let t=String(e.html||"");if(!t.trim())return q({source:"html-inference",type:String(e.sourceType||"design-inference"),confidence:0,issues:[{severity:"warning",message:"No HTML or guideline text provided for design extraction."}],designPatch:{},meta:{extractedPathCount:0,extractedPaths:[]}});let r=zs(e.config||{}),n=Ss(t),o={patch:{},inferredPaths:new Set,allowedPaths:r.allowedPaths,schema:r.schema},a=Z(n.declarations,["color"]).map(U=>te(U)).filter(Boolean),i=Z(n.declarations,["background","background-color"]).map(U=>te(U)).filter(Boolean),s=[...i,...a,...n.colorValues].filter(Boolean),u=Array.from(new Set(s)),l=[...n.rootBackgroundColors||[]],d=[...n.rootClassBackgroundColors||[]],c=l.length?l:d,p=[...i,...n.classBackgroundColors||[]],h=ks(c,p),m=h.color;V(o,"colors.background",m||i[0]||u[0]);let v=u.filter(U=>U&&U!==m),f=Je(n.buttonBackgroundColors||[])||v[0]||u[0],y=v.filter(U=>U&&U!==f);V(o,"colors.primary",f),V(o,"colors.secondary",y[0]||f||u[0]),V(o,"colors.accent",y[1]||y[0]||f||u[0]);let x=Z(n.declarations,["font-family"]),b=Es(x);V(o,"typography.fontFamilyBody",b),V(o,"typography.fontFamilyHeadings",b),V(o,"typography.fontFamilyMono",/mono|code/i.test(n.textCorpus)?"JetBrains Mono":"");let S=Z(n.declarations,["font-size"]),C=ye(S);V(o,"typography.baseSize",C);let E=Z(n.declarations,["padding","padding-top","padding-right","padding-bottom","padding-left","margin","margin-top","margin-right","margin-bottom","margin-left","gap","row-gap","column-gap"]),T=ye(E);V(o,"spatialRhythm.baseUnit",T),V(o,"spatialRhythm.inputPadding",T),V(o,"spatialRhythm.buttonPadding",T);let R=Z(n.declarations,["border-radius"]),A=ye(R)||Ts(n.classTokens||[]);V(o,"shape.radiusSize",A);let j=Z(n.declarations,["border-width","border-top-width","border-right-width","border-bottom-width","border-left-width"]),M=ye(j);V(o,"shape.borderWidth",As(M));let z=Z(n.declarations,["max-width"]),L=ye(z);V(o,"layout.containerMaxWidth",L),V(o,"layout.maxWidth",L);let _=Z(n.declarations,["min-height","height"]),k=ye(_);V(o,"layout.buttonMinHeight",k),V(o,"layout.inputMinHeight",k);let F=Z(n.declarations,["transition-duration"]),O=ye(F.map(U=>{let ce=String(U||"").trim().toLowerCase(),ne=Number.parseFloat(ce);return Number.isFinite(ne)?ce.endsWith("ms")?ne:ce.endsWith("s")?ne*1e3:ne:null}));V(o,"behavior.transitionSpeed",O);let P=Z(n.declarations,["box-shadow"]).length>0;V(o,"layers.baseShadowOpacity",P?.2:.08);let W=Array.from(o.inferredPaths),H=W.reduce((U,ce)=>{let ne=ce.split(".")[0];return U[ne]=(U[ne]||0)+1,U},{}),Pt=W.length?Math.min(.92,.35+W.length*.02):.25;return q({source:"html-inference",type:String(e.sourceType||"design-inference"),confidence:Pt,issues:W.length?[]:[{severity:"warning",message:"Could not infer enough design signals from input."}],designPatch:o.patch,meta:{extractedPathCount:W.length,extractedPaths:W,categoryCoverage:H,colorSampleSize:u.length,backgroundInference:{source:h.source,candidates:{root:c.length,declaration:i.length,classBased:(n.classBackgroundColors||[]).length}}}})}function oo(e={}){let t=String(e.input||"").trim(),r=String(e.sourceType||"unknown");if(!t)return q({source:r,type:r,confidence:0,issues:[{severity:"error",message:"No input provided."}],meta:{conversionMode:"none"}});if(ro(t)){let n=Mt({html:t,config:e.config||{}});return q({source:r,type:r,confidence:n.confidence,issues:n.issues,template:n.template,meta:{...n.meta||{},conversionMode:"html-to-pds"}})}return q({source:r,type:r,confidence:.48,issues:[{severity:"info",message:"Input is not HTML; generated text-based preview template."}],template:{id:`${r}-text-import`,name:"Imported Guideline Text",html:`<article class="card surface-base stack-sm"><h3>Imported Guidelines</h3><pre>${ps(t)}</pre></article>`},meta:{conversionMode:"text-preview"}})}function Mt(e={}){let t=String(e.html||"").trim();if(!t)return q({source:"tailwind",type:"tailwind-html",confidence:0,issues:[{severity:"error",message:"No HTML provided."}]});let r=cs(t,{config:e.config||{}});return q({source:"tailwind",type:"tailwind-html",confidence:r.confidence,issues:r.issues,template:{id:"tailwind-import",name:"Converted Tailwind Markup",html:r.html},meta:r.meta})}function Sr(e={}){let t=String(e.text||"").trim();if(!t)return q({source:"brand",type:"brand-guidelines",confidence:0,issues:[{severity:"error",message:"No brand guideline text provided."}]});let r=us(t),n={colors:{},typography:{}},o=[];return r?n.colors.primary=r:o.push({severity:"warning",message:"No HEX color found; primary color was not inferred."}),/serif/i.test(t)&&(n.typography.fontFamilyBody="Georgia, serif"),/sans[-\s]?serif/i.test(t)&&(n.typography.fontFamilyBody="Inter, Arial, sans-serif"),/mono|monospace/i.test(t)&&(n.typography.fontFamilyMono="JetBrains Mono, monospace"),q({source:"brand",type:"brand-guidelines",confidence:r?.68:.52,issues:o,designPatch:n,meta:{inferred:{primaryColor:r}}})}var $r="convert-only",ao="adopt-design-and-convert";function _s(e){return String(e||"").trim().toLowerCase()===ao?ao:$r}function io(...e){let t=e.flat().filter(Boolean);if(!t.length)return[];let r=new Set;return t.filter(n=>{let o=`${String(n?.severity||"info")}::${String(n?.path||"")}::${String(n?.message||"")}`;return r.has(o)?!1:(r.add(o),!0)})}function so(e=[]){let t=e.map(r=>Number(r)).filter(r=>Number.isFinite(r));return t.length?Math.max(0,Math.min(1,t.reduce((r,n)=>r+n,0)/t.length)):0}function Ze(e={},t={}){return{...e&&typeof e=="object"?e:{},...t&&typeof t=="object"?t:{}}}function uo(e={},t={}){if(!t||typeof t!="object")return e;let r=Array.isArray(e)?[...e]:{...e};return Object.entries(t).forEach(([n,o])=>{o&&typeof o=="object"&&!Array.isArray(o)?r[n]=uo(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o}),r}function lo(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e||{}))}function Rs(e={}){let t=Number(e?.ratio),r=Number(e?.min),n=Number.isFinite(t)?t.toFixed(2):"n/a",o=Number.isFinite(r)?r.toFixed(2):"n/a";return{severity:"error",path:String(e?.path||"/colors"),message:`${String(e?.message||"Color contrast validation failed.")} (ratio=${n}, required=${o})`}}function co(e={},t={},r={}){if(!(t&&typeof t=="object"?Object.keys(t):[]).length)return{ok:!0,blocked:!1,issues:[],report:{ok:!0,issues:[]}};let o=Number(r.minContrast),a=Number.isFinite(o)?o:4.5,i=uo(lo(e||{}),lo(t||{})),s=Dr(i,{minContrast:a,minMutedContrast:3,extendedChecks:!0}),u=Array.isArray(s?.issues)?s.issues.map(l=>Rs(l)):[];return{ok:!!s?.ok,blocked:!s?.ok,issues:u,report:{ok:!!s?.ok,minContrast:a,issues:Array.isArray(s?.issues)?s.issues:[]}}}function Is(){return[{id:"template",name:"Templates"},{id:"tailwind-html",name:"Tailwind HTML"},{id:"brand-guidelines",name:"Brand Guidelines"},{id:"figma-json",name:"Figma Tokens JSON (planned)"},{id:"ux-pilot",name:"UX Pilot (planned)"},{id:"google-stitch",name:"Google Stitch (planned)"}]}async function Fs(e={}){let t=String(e.sourceType||""),r=_s(e.importMode),n=String(e.input||""),o=e.config||null;if(t==="template"){let a=Ln(e.templateId,e);return a.meta=Ze(a.meta,{importMode:r}),a}if(t==="tailwind-html"){let a=Mt({html:n,config:o});if(r===$r)return a.meta=Ze(a.meta,{importMode:r}),a;let i=kr({html:n,config:o,sourceType:t}),s=co(o||{},i.designPatch||{}),u=s.blocked?{}:i.designPatch,l=s.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...s.issues]:[];return q({source:a.source||"tailwind",type:t,confidence:so([a.confidence,i.confidence]),issues:io(a.issues,i.issues,l),template:a.template,designPatch:u,meta:Ze(a.meta,{importMode:r,inference:i.meta,validation:s.report,validationBlocked:s.blocked})})}if(t==="brand-guidelines"){let a=oo({input:n,sourceType:t,config:o});if(r===$r)return a.meta=Ze(a.meta,{importMode:r}),a;let i=Sr({text:n}),s=kr({html:n,config:o,sourceType:t}),u={...i.designPatch&&typeof i.designPatch=="object"?i.designPatch:{},...s.designPatch&&typeof s.designPatch=="object"?s.designPatch:{}},l=co(o||{},u||{}),d=l.blocked?{}:u,c=l.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...l.issues]:[];return q({source:"brand",type:t,confidence:so([a.confidence,i.confidence,s.confidence]),issues:io(a.issues,i.issues,s.issues,c),template:a.template,designPatch:d,meta:Ze(a.meta,{importMode:r,inference:s.meta,brandHeuristics:i.meta,validation:l.report,validationBlocked:l.blocked})})}return t==="figma-json"||t==="ux-pilot"||t==="google-stitch"?q({source:t,type:t,confidence:0,issues:[{severity:"info",message:`${t} adapter is not implemented yet in this phase.`}],meta:{importMode:r}}):q({source:t||"unknown",type:"unknown",confidence:0,issues:[{severity:"error",message:"Unsupported import source type."}],meta:{importMode:r}})}var Ps="pds-live-import-history";var ae="imports",Tt=null;function Ns(){return typeof globalThis<"u"&&typeof globalThis.indexedDB<"u"}function re(e){return typeof e=="string"?e:""}function _t(e){return Array.isArray(e)?e:[]}function Rt(e){return e&&typeof e=="object"?e:{}}function It(){return Ns()?Tt||(Tt=new Promise((e,t)=>{let r=globalThis.indexedDB.open(Ps,1);r.onupgradeneeded=()=>{let n=r.result;if(!n.objectStoreNames.contains(ae)){let o=n.createObjectStore(ae,{keyPath:"id",autoIncrement:!0});o.createIndex("createdAt","createdAt",{unique:!1}),o.createIndex("sourceType","sourceType",{unique:!1}),o.createIndex("fileName","fileName",{unique:!1})}},r.onsuccess=()=>e(r.result),r.onerror=()=>t(r.error||new Error("Failed to open import history database."))}),Tt):Promise.resolve(null)}function Ft(e){return new Promise((t,r)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>r(e.error||new Error("IndexedDB operation failed."))})}function Os(e={}){let t=Date.now(),r=Number.isFinite(Number(e.createdAt))?Number(e.createdAt):t,n=new Date(r).toISOString(),o=_t(e.issues).map(u=>({severity:re(u?.severity||"info"),message:re(u?.message||"")})),a=_t(e.notes).filter(u=>typeof u=="string"),i=_t(e.unknownTailwindTokens).filter(u=>typeof u=="string"),s=_t(e.appliedRules).filter(u=>typeof u=="string");return{createdAt:r,createdAtIso:n,sourceType:re(e.sourceType||"unknown"),importMode:re(e.importMode||"convert-only"),source:re(e.source||"unknown"),type:re(e.type||"unknown"),fileName:re(e.fileName||""),fileSize:Number.isFinite(Number(e.fileSize))?Number(e.fileSize):0,mimeType:re(e.mimeType||""),fileContents:re(e.fileContents||""),convertedHtml:re(e.convertedHtml||""),confidence:Number.isFinite(Number(e.confidence))?Number(e.confidence):0,notes:a,issues:o,coverage:Rt(e.coverage),unknownTailwindTokens:i,appliedRules:s,importStyleSheetInjected:!!e.importStyleSheetInjected,templateName:re(e.templateName||""),designPatch:Rt(e.designPatch),meta:Rt(e.meta),resultSnapshot:Rt(e.resultSnapshot)}}async function js(e={}){let t=await It();if(!t)return null;let r=Os(e),o=t.transaction(ae,"readwrite").objectStore(ae);return{id:await Ft(o.add(r)),...r}}async function Bs(e={}){let t=await It();if(!t)return[];let r=Number.isFinite(Number(e.limit))?Math.max(1,Number(e.limit)):30,o=t.transaction(ae,"readonly").objectStore(ae);return(await Ft(o.getAll())||[]).sort((i,s)=>Number(s?.createdAt||0)-Number(i?.createdAt||0)).slice(0,r)}async function Ds(e){let t=await It();if(!t)return null;let r=Number(e);if(!Number.isFinite(r))return null;let o=t.transaction(ae,"readonly").objectStore(ae);return await Ft(o.get(r))||null}async function Ws(){let e=await It();if(!e)return;let r=e.transaction(ae,"readwrite").objectStore(ae);await Ft(r.clear())}export{Ws as clearLiveImportHistory,Sr as convertBrandGuidelinesToPatch,Mt as convertTailwindHtmlToPds,q as createImportResult,ds as describeTailwindConversionRules,Ds as getLiveImportHistoryEntry,Is as getLiveImportSources,Ga as isImportResult,Bs as listLiveImportHistory,zn as listLiveTemplates,pn as loadGoogleFont,bt as loadLiveTemplateCatalog,Fs as runLiveImport,js as saveLiveImportHistory,Ua as startLive};
