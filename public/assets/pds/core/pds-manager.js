...
${[...n,...a,...d,i,s,p].join("")}}
`}#re(e,r){if(!e?.dark)return"";let n=[],o=(u,g="")=>{Object.entries(u).forEach(([m,y])=>{typeof y=="object"&&y!==null?o(y,`${g}${m}-`):typeof y=="string"&&n.push(`    --color-${g}${m}: ${y};
...
`}#de(){let{shape:e={},spatialRhythm:r={},inputPadding:n,buttonPadding:o,focusRingWidth:a,focusRingOpacity:i,borderWidthThin:s,sectionSpacing:p,buttonMinHeight:d,inputMinHeight:c}=this.options.design,l=typeof e.borderWidth=="number"?e.borderWidth:typeof e.borderWidth=="string"?v.BorderWidths[e.borderWidth]??null:null,u=r.inputPadding??n??.75,g=r.buttonPadding??o??1,m=a||3,y=s||l||v.BorderWidths.thin,f=r.sectionSpacing??p??2,h=d||30;return`/* Mobile-First Form Styles - Generated from Design Config */
form {
  margin: 0;
  width: 100%;
}
...
`}#xe(){let{layout:e={}}=this.options.design,r=e.breakpoints||{sm:640,md:768,lg:1024,xl:1280},n=e.gridSystem||{},o=n.columns||[1,2,3,4,6],a=n.autoFitBreakpoints||{sm:"150px",md:"250px",lg:"350px",xl:"450px"},i=this.#z(e),s=[`
/* ============================================================================
   Layout Utilities
...
`}#ke(){let{layout:e={},a11y:r={}}=this.options.design,n=e.breakpoints||{sm:640,md:768,lg:1024,xl:1280},o=r.minTouchTarget||v.TouchTargetSizes.standard;return`/* Mobile-First Responsive Design */
...
`),u.push(this.#te(e,s)),u.join("")}#Ce(){let{advanced:e={},a11y:r={},layout:n={}}=this.options.design,o=e.tabSize||v.TabSizes.standard,a=r.minTouchTarget||v.TouchTargetSizes.standard,i=n.breakpoints||{sm:640,md:768,lg:1024,xl:1280};return`@layer primitives {
  /* Base HTML reset */
  *, *::before, *::after {
...
`}};function lr(t={},e={}){let r=Number(e.minContrast||4.5),n=Number(e.minMutedContrast||3),o=!!e.extendedChecks,a=d=>{let c=String(d||"").replace("#",""),l=c.length===3?c.split("").map(g=>g+g).join(""):c,u=parseInt(l||"0",16);return{r:u>>16&255,g:u>>8&255,b:u&255}},i=d=>{let{r:c,g:l,b:u}=a(d),g=[c/255,l/255,u/255].map(m=>m<=.03928?m/12.92:Math.pow((m+.055)/1.055,2.4));return .2126*g[0]+.7152*g[1]+.0722*g[2]},s=(d,c)=>{if(!d||!c)return 0;let l=i(d),u=i(c),g=Math.max(l,u),m=Math.min(l,u);return(g+.05)/(m+.05)},p=[];try{let c=new K({design:structuredClone(t)}).tokens.colors,l={surfaceBg:c.surface?.base,surfaceText:c.gray?.[900]||"#000000",surfaceTextSecondary:c.gray?.[700]||c.gray?.[800]||c.gray?.[900],surfaceTextMuted:c.gray?.[500]||c.gray?.[600]||c.gray?.[700],surfaceElevated:c.surface?.elevated||c.surface?.base,primaryFill:c.interactive?.light?.fill||c.primary?.[600],primaryText:c.interactive?.light?.text||c.primary?.[600],accentFill:c.accent?.[600]||c.accent?.[500],successFill:c.success?.[600]||c.success?.[500],warningFill:c.warning?.[600]||c.warning?.[500],dangerFill:c.danger?.[600]||c.danger?.[500],infoFill:c.info?.[600]||c.info?.[500]},u=h=>Math.max(s(h,"#ffffff"),s(h,"#000000")),g=s(l.primaryFill,"#ffffff");g<r&&p.push({path:"/colors/primary",message:`Primary button contrast too low in light theme (${g.toFixed(2)} < ${r}). Choose a darker primary.`,ratio:g,min:r,context:"light/btn-primary"});let m=s(l.surfaceBg,l.surfaceText);if(m<r&&p.push({path:"/colors/background",message:`Base text contrast on surface (light) is too low (${m.toFixed(2)} < ${r}). Adjust background or secondary (gray).`,ratio:m,min:r,context:"light/surface-text"}),o){let h=s(l.surfaceBg,l.surfaceTextSecondary);h<r&&p.push({path:"/colors/secondary",message:`Secondary text contrast on base surface (light) is too low (${h.toFixed(2)} < ${r}).`,ratio:h,min:r,context:"light/surface-text-secondary"});let w=s(l.surfaceBg,l.surfaceTextMuted);w<n&&p.push({path:"/colors/secondary",message:`Muted text contrast on base surface (light) is too low (${w.toFixed(2)} < ${n}).`,ratio:w,min:n,context:"light/surface-text-muted"});let x=s(l.surfaceElevated,l.surfaceText);x<r&&p.push({path:"/colors/background",message:`Elevated surface text contrast (light) is too low (${x.toFixed(2)} < ${r}).`,ratio:x,min:r,context:"light/surface-elevated-text"})}let y=s(l.primaryText,l.surfaceBg);y<r&&p.push({path:"/colors/primary",message:`Primary text on surface is too low for outline/link styles (light) (${y.toFixed(2)} < ${r}). Choose a darker primary or lighter surface.`,ratio:y,min:r,context:"light/outline"}),o&&[{path:"/colors/accent",key:"accent",value:l.accentFill},{path:"/colors/success",key:"success",value:l.successFill},{path:"/colors/warning",key:"warning",value:l.warningFill},{path:"/colors/danger",key:"danger",value:l.dangerFill},{path:"/colors/info",key:"info",value:l.infoFill}].forEach(w=>{if(!w?.value)return;let x=u(w.value);x<r&&p.push({path:w.path,message:`${w.key} fill color cannot achieve accessible text contrast (${x.toFixed(2)} < ${r}) with either white or black text.`,ratio:x,min:r,context:`light/${w.key}-fill`})});let f=c.dark;if(f){let h={surfaceBg:f.surface?.base||c.surface?.inverse,surfaceText:f.gray?.[50]||f.gray?.[100]||"#ffffff",surfaceTextMuted:f.gray?.[300]||f.gray?.[400]||f.gray?.[500],primaryFill:c.interactive?.dark?.fill||f.primary?.[600],primaryText:c.interactive?.dark?.text||f.primary?.[600]},w=s(h.primaryFill,"#ffffff");w<r&&p.push({path:"/colors/darkMode/primary",message:`Primary button contrast too low in dark theme (${w.toFixed(2)} < ${r}). Override darkMode.primary or pick a brighter hue.`,ratio:w,min:r,context:"dark/btn-primary"});let x=s(h.primaryText,h.surfaceBg);if(x<r&&p.push({path:"/colors/darkMode/primary",message:`Primary text on surface is too low for outline/link styles (dark) (${x.toFixed(2)} < ${r}). Override darkMode.primary/background.`,ratio:x,min:r,context:"dark/outline"}),o){let S=s(h.surfaceBg,h.surfaceText);S<r&&p.push({path:"/colors/darkMode/background",message:`Base text contrast on surface (dark) is too low (${S.toFixed(2)} < ${r}).`,ratio:S,min:r,context:"dark/surface-text"});let A=s(h.surfaceBg,h.surfaceTextMuted);A<n&&p.push({path:"/colors/darkMode/secondary",message:`Muted text contrast on surface (dark) is too low (${A.toFixed(2)} < ${n}).`,ratio:A,min:n,context:"dark/surface-text-muted"})}}}catch(d){p.push({path:"/",message:`Validation failed: ${String(d?.message||d)}`,ratio:0,min:0})}return{ok:p.length===0,issues:p}}var kt=class{constructor(){this._mode="static",this._staticPaths={tokens:"/assets/pds/styles/pds-tokens.css.js",primitives:"/assets/pds/styles/pds-primitives.css.js",components:"/assets/pds/styles/pds-components.css.js",utilities:"/assets/pds/styles/pds-utilities.css.js",styles:"/assets/pds/styles/pds-styles.css.js"}}setLiveMode(){this._mode="live"}setStaticMode(e={}){this._mode="static",this._staticPaths={...this._staticPaths,...e}}async getStylesheet(e){if(this._mode==="live")return null;try{return(await import(this._staticPaths[e]))[e]}catch(r){console.error(`[PDS Registry] Failed to load static ${e}:`,r),console.error(`[PDS Registry] Looking for: ${this._staticPaths[e]}`),console.error("[PDS Registry] Make sure you've run 'npm run pds:build' and configured PDS.start() with the correct static.root path");let n=new CSSStyleSheet;return n.replaceSync("/* Failed to load "+e+" */"),n}}get mode(){return this._mode}get isLive(){return this._mode==="live"}},ge=new kt;function hn(t){try{if(typeof document>"u")return;if(typeof CSSStyleSheet<"u"&&"adoptedStyleSheets"in Document.prototype){let n=new CSSStyleSheet;n.replaceSync(t),n._pds=!0;let o=(document.adoptedStyleSheets||[]).filter(a=>a._pds!==!0);document.adoptedStyleSheets=[...o,n];return}let e="pds-runtime-stylesheet",r=document.getElementById(e);if(!r){r=document.createElement("style"),r.id=e,r.type="text/css";let n=document.head||document.getElementsByTagName("head")[0];n?n.appendChild(r):document.documentElement.appendChild(r)}r.textContent=t}catch(e){console.warn("installRuntimeStyles failed:",e)}}function cr(t){let e=t;if(!e||typeof e!="object"){console.error("[Runtime] applyStyles requires an explicit generator instance in live mode");return}let r=e.layeredCSS||e.css||"";if(!r){e.options?.log?.("warn","[Runtime] No CSS available on generator to apply");return}hn(r)}async function Oe(t,e=[],r=null){try{let n=r?.primitivesStylesheet?r.primitivesStylesheet:await ge.getStylesheet("primitives");t.adoptedStyleSheets=[n,...e]}catch(n){let o=t.host?.tagName?.toLowerCase()||"unknown";console.error(`[PDS Adopter] <${o}> failed to adopt primitives:`,n),t.adoptedStyleSheets=e}}async function De(t,e=["primitives"],r=[],n=null){let o=Array.isArray(r)?r.filter(Boolean):[];if(o.length){let i=(Array.isArray(t.adoptedStyleSheets)?t.adoptedStyleSheets:[]).filter(s=>!o.includes(s));t.adoptedStyleSheets=[...i,...o]}try{let i=(await Promise.all(e.map(async s=>{if(n)switch(s){case"tokens":return n.tokensStylesheet;case"primitives":return n.primitivesStylesheet;case"components":return n.componentsStylesheet;case"utilities":return n.utilitiesStylesheet;default:break}return ge.getStylesheet(s)}))).filter(s=>s!==null);t.adoptedStyleSheets=[...i,...o]}catch(a){let i=t.host?.tagName?.toLowerCase()||"unknown";console.error(`[PDS Adopter] <${i}> failed to adopt layers:`,a),t.adoptedStyleSheets=o}}function dr(t){let e=new CSSStyleSheet;return e.replaceSync(t),e}var bn=[{selector:".accordion"},{selector:"nav[data-dropdown]"},{selector:"label[data-toggle]"},{selector:"label[data-color]"},{selector:'input[type="range"]'},{selector:"form[data-required]"},{selector:"fieldset[role=group][data-open]"},{selector:"[data-clip]"},{selector:"button, a[class*='btn-']"}];function yn(t){t.dataset.enhancedAccordion||(t.dataset.enhancedAccordion="true",t.addEventListener("toggle",e=>{e.target.open&&e.target.parentElement===t&&t.querySelectorAll(":scope > details[open]").forEach(r=>{r!==e.target&&(r.open=!1)})},!0))}function vn(t){if(t.dataset.enhancedDropdown)return;t.dataset.enhancedDropdown="true";let e=t.lastElementChild;if(!e)return;let r=t.querySelector("[data-dropdown-toggle]")||t.querySelector("button");r&&!r.hasAttribute("type")&&r.setAttribute("type","button"),e.id||(e.id=`dropdown-${Math.random().toString(36).slice(2,9)}`);let n=e.tagName?.toLowerCase()==="menu",o=8;n&&!e.hasAttribute("role")&&e.setAttribute("role","menu"),e.hasAttribute("aria-hidden")||e.setAttribute("aria-hidden","true"),r&&(r.setAttribute("aria-haspopup","true"),r.setAttribute("aria-controls",e.id),r.setAttribute("aria-expanded","false"));let a=()=>{let $=e.getAttribute("style");e.style.visibility="hidden",e.style.display="inline-block",e.style.pointerEvents="none";let z=e.getBoundingClientRect(),P=Math.max(e.offsetWidth||0,e.scrollWidth||0,z.width||0,1),C=Math.max(e.offsetHeight||0,e.scrollHeight||0,z.height||0,1);return $===null?e.removeAttribute("style"):e.setAttribute("style",$),{width:P,height:C}},i=()=>{let $=(t.getAttribute("data-direction")||t.getAttribute("data-dropdown-direction")||t.getAttribute("data-mode")||"auto").toLowerCase();if($==="up"||$==="down")return $;let z=(r||t).getBoundingClientRect(),{height:P}=a(),C=Math.max(0,window.innerHeight-z.bottom),b=Math.max(0,z.top),k=C>=P,E=b>=P;return k&&!E?"down":E&&!k?"up":k&&E?"down":b>C?"up":"down"},s=()=>{let $=(t.getAttribute("data-align")||t.getAttribute("data-dropdown-align")||"auto").toLowerCase();if($==="left"||$==="right"||$==="start"||$==="end")return $==="start"?"left":$==="end"?"right":$;let z=(r||t).getBoundingClientRect(),{width:P}=a(),C=Math.max(0,window.innerWidth-z.left),b=Math.max(0,z.right),k=C>=P,E=b>=P;return k&&!E?"left":E&&!k?"right":k&&E?"left":b>C?"right":"left"},p=($,z=8)=>{let P=getComputedStyle(t).getPropertyValue($).trim();if(!P)return z;let C=document.createElement("span");C.style.position="fixed",C.style.visibility="hidden",C.style.pointerEvents="none",C.style.height=P,document.body.appendChild(C);let b=Number.parseFloat(getComputedStyle(C).height);return C.remove(),Number.isFinite(b)?b:z},d=()=>{e.style.removeProperty("position"),e.style.removeProperty("left"),e.style.removeProperty("top"),e.style.removeProperty("right"),e.style.removeProperty("bottom"),e.style.removeProperty("margin-top"),e.style.removeProperty("margin-bottom"),e.style.removeProperty("max-width"),e.style.removeProperty("max-inline-size"),e.style.removeProperty("max-height"),e.style.removeProperty("overflow")},c=$=>{if(!$)return null;if($.parentElement)return $.parentElement;let z=$.getRootNode?.();return z instanceof ShadowRoot?z.host:null},l=()=>{let $=c(e);for(;$&&$!==document.documentElement;){let z=getComputedStyle($),P=z.contain||"",C=z.willChange||"";if(z.transform!=="none"||z.perspective!=="none"||z.filter!=="none"||z.backdropFilter!=="none"||P.includes("paint")||P.includes("layout")||P.includes("strict")||P.includes("content")||C.includes("transform")||C.includes("perspective")||C.includes("filter"))return!0;$=c($)}return!1},u=()=>{e.getAttribute("aria-hidden")==="false"&&(d(),requestAnimationFrame(()=>{requestAnimationFrame(()=>{g()})}))},g=()=>{if(e.getAttribute("aria-hidden")!=="false")return;if(l()){d();return}let $=(r||t).getBoundingClientRect(),z=window.visualViewport,P=z?.width||document.documentElement?.clientWidth||window.innerWidth,C=z?.height||document.documentElement?.clientHeight||window.innerHeight,b=z?.offsetLeft||0,k=z?.offsetTop||0,E=Math.max(1,P-o*2),T=Math.max(1,C-o*2);e.style.maxWidth=`${Math.round(E)}px`,e.style.maxInlineSize=`${Math.round(E)}px`,e.style.maxHeight=`${Math.round(T)}px`,e.style.overflow="auto";let{width:B,height:W}=a(),V=p("--spacing-2",8),N=i(),_=s();t.dataset.dropdownDirection=N,t.dataset.dropdownAlign=_;let Y=_==="right"?$.right-B:$.left;B>=E-1?Y=b+o:Y=Math.max(b+o,Math.min(Y,b+P-B-o));let Se=N==="up"?$.top-V-W:$.bottom+V;Se=Math.max(k+o,Math.min(Se,k+C-W-o)),e.style.position="fixed",e.style.left=`${Math.round(Y)}px`,e.style.top=`${Math.round(Se)}px`,e.style.right="auto",e.style.bottom="auto",e.style.marginTop="0",e.style.marginBottom="0"},m=null,y=()=>{m||(m=()=>g(),window.addEventListener("resize",m),window.addEventListener("scroll",m,!0))},f=()=>{m&&(window.removeEventListener("resize",m),window.removeEventListener("scroll",m,!0),m=null)},h=null,w=null,x=()=>{h||typeof document>"u"||(h=()=>{e.getAttribute("aria-hidden")==="false"&&(t.dataset.dropdownDirection=i(),t.dataset.dropdownAlign=s(),w!==null&&cancelAnimationFrame(w),w=requestAnimationFrame(()=>{w=null,e.getAttribute("aria-hidden")==="false"&&g()}))},document.addEventListener("pds:config-changed",h))},S=()=>{!h||typeof document>"u"||(document.removeEventListener("pds:config-changed",h),h=null,w!==null&&(cancelAnimationFrame(w),w=null))},A=null,L=()=>{t.dataset.dropdownDirection=i(),t.dataset.dropdownAlign=s(),e.setAttribute("aria-hidden","false"),r?.setAttribute("aria-expanded","true"),y(),x(),u(),A||(A=$=>{($.composedPath?$.composedPath():[$.target]).some(C=>C===t)||F()},setTimeout(()=>{document.addEventListener("click",A)},0))},F=()=>{e.setAttribute("aria-hidden","true"),r?.setAttribute("aria-expanded","false"),f(),S(),d(),A&&(document.removeEventListener("click",A),A=null)},I=()=>{e.getAttribute("aria-hidden")==="false"?F():L()};r?.addEventListener("click",$=>{$.preventDefault(),$.stopPropagation(),I()}),t.addEventListener("keydown",$=>{$.key==="Escape"&&(F(),r?.focus())}),t.addEventListener("focusout",$=>{$.relatedTarget&&(($.composedPath?$.composedPath():[$.relatedTarget]).some(C=>C===t)||F())})}function xn(t){if(t.dataset.enhancedToggle)return;t.dataset.enhancedToggle="true";let e=t.querySelector('input[type="checkbox"]');if(!e)return;t.hasAttribute("tabindex")||t.setAttribute("tabindex","0"),t.setAttribute("role","switch"),t.setAttribute("aria-checked",e.checked?"true":"false");let r=document.createElement("span");r.className="toggle-switch",r.setAttribute("role","presentation"),r.setAttribute("aria-hidden","true");let n=document.createElement("span");n.className="toggle-knob",r.appendChild(n),t.insertBefore(r,e.nextSibling);let o=()=>{t.setAttribute("aria-checked",e.checked?"true":"false")},a=()=>{e.disabled||(e.checked=!e.checked,o(),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})))};t.addEventListener("click",i=>{i.preventDefault(),a()}),t.addEventListener("keydown",i=>{(i.key===" "||i.key==="Enter")&&(i.preventDefault(),a())}),e.addEventListener("change",o)}function wn(t){if(t.dataset.enhancedColorInput)return;let e=t.querySelector('input[type="color"]');if(!e)return;t.dataset.enhancedColorInput="true";let r=t.querySelector(":scope > .color-control"),n=t.querySelector(":scope > .color-control > .color-swatch"),o=t.querySelector(":scope > .color-control > output");r||(r=document.createElement("span"),r.className="color-control",e.before(r)),n||(n=document.createElement("span"),n.className="color-swatch",r.appendChild(n)),e.parentElement!==n&&n.appendChild(e),o||(o=document.createElement("output"),r.appendChild(o));let a=()=>{if(e.dataset.colorUnset==="1"){o.value="",o.textContent="not set",r.dataset.value="",r.dataset.unset="1",n.dataset.unset="1";return}o.value=e.value,o.textContent=e.value,r.dataset.value=e.value,delete r.dataset.unset,delete n.dataset.unset};a();let i=()=>{e.dataset.colorUnset==="1"&&(e.dataset.colorUnset="0"),a()};e.addEventListener("input",i,{passive:!0}),e.addEventListener("change",i,{passive:!0})}function kn(t){if(t.dataset.enhancedRange)return;let e=i=>{if(t.dataset.enhancedRangeProgrammatic)return;t.dataset.enhancedRangeProgrammatic="1";let s=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(t),"value")||Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value");s?.get&&s?.set&&Object.defineProperty(t,"value",{configurable:!0,enumerable:s.enumerable,get(){return s.get.call(this)},set(d){s.set.call(this,d),i()}}),new MutationObserver(d=>{d.some(l=>{let u=l.attributeName;return u==="value"||u==="min"||u==="max"})&&i()}).observe(t,{attributes:!0,attributeFilter:["value","min","max"]})},r=t.closest("label"),n=r?.classList.contains("range-output"),o=t.id||`range-${Math.random().toString(36).substring(2,11)}`,a=`${o}-output`;if(t.id=o,n){let i=r.querySelector("span");if(i&&!i.classList.contains("range-output-wrapper")){let s=document.createElement("span");s.className="range-output-wrapper",s.style.display="flex",s.style.justifyContent="space-between",s.style.alignItems="center";let p=document.createElement("span");p.textContent=i.textContent,s.appendChild(p);let d=document.createElement("output");d.id=a,d.setAttribute("for",o),d.style.color="var(--surface-text-secondary, var(--color-text-secondary))",d.style.fontSize="0.875rem",d.textContent=t.value,s.appendChild(d),i.textContent="",i.appendChild(s);let c=()=>{d.textContent=t.value};t.addEventListener("input",c),t.addEventListener("change",c),e(c),c()}}else{let i=t.closest(".range-container");i||(i=document.createElement("div"),i.className="range-container",t.parentNode?.insertBefore(i,t),i.appendChild(t)),i.style.position="relative";let s=document.createElement("output");s.id=a,s.setAttribute("for",o),s.className="range-bubble",s.setAttribute("aria-live","polite"),i.appendChild(s);let p=()=>{let l=parseFloat(t.min)||0,u=parseFloat(t.max)||100,g=parseFloat(t.value),m=(g-l)/(u-l);s.style.left=`calc(${m*100}% )`,s.textContent=String(g)},d=()=>s.classList.add("visible"),c=()=>s.classList.remove("visible");t.addEventListener("input",p),t.addEventListener("pointerdown",d),t.addEventListener("pointerup",c),t.addEventListener("pointerleave",c),t.addEventListener("focus",d),t.addEventListener("blur",c),t.addEventListener("change",p),e(p),p()}t.dataset.enhancedRange="1"}function Sn(t){if(t.dataset.enhancedRequired)return;t.dataset.enhancedRequired="true";let e=r=>{let n;if(r.closest("[role$=group]")?n=r.closest("[role$=group]").querySelector("legend"):n=r.closest("label"),!n||n.querySelector(".required-asterisk"))return;let o=document.createElement("span");o.classList.add("required-asterisk"),o.textContent="*",o.style.marginLeft="4px";let a=n.querySelector("span, [data-label]");if(a)a.appendChild(o);else{let s=n.querySelector("input, select, textarea");s?n.insertBefore(o,s):n.appendChild(o)}let i=r.closest("form");if(i&&!i.querySelector(".required-legend")){let s=document.createElement("small");s.classList.add("required-legend"),s.textContent="* Required fields",i.insertBefore(s,i.querySelector(".form-actions")||i.lastElementChild)}};t.querySelectorAll("[required]").forEach(r=>{e(r)})}function $n(t){if(t.dataset.enhancedOpenGroup)return;t.dataset.enhancedOpenGroup="true",t.classList.add("flex","flex-wrap","buttons");let e=document.createElement("input");e.type="text",e.placeholder="Add item...",e.classList.add("input-text","input-sm"),e.style.width="auto";let r=()=>t.querySelector('input[type="radio"], input[type="checkbox"]');t.appendChild(e),e.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key==="Tab"){let o=e.value.trim();if(o){n.preventDefault();let a=r(),i=a?.type==="radio"?"radio":"checkbox",s=`open-group-${Math.random().toString(36).substring(2,11)}`,p=document.createElement("label"),d=document.createElement("span");d.setAttribute("data-label",""),d.textContent=o;let c=document.createElement("input");c.type=i,c.name=a?.name||t.getAttribute("data-name")||"open-group",c.value=o,c.id=s,p.appendChild(d),p.appendChild(c),t.insertBefore(p,e),e.value=""}}else if(n.key==="Backspace"&&e.value===""){n.preventDefault();let o=t.querySelectorAll("label");o.length>0&&o[o.length-1].remove()}})}function Cn(t){if(t.dataset.enhancedClip)return;t.dataset.enhancedClip="true",t.hasAttribute("tabindex")||t.setAttribute("tabindex","0"),t.hasAttribute("role")||t.setAttribute("role","button");let e=()=>{let n=t.getAttribute("data-clip-open")==="true";t.setAttribute("aria-expanded",n?"true":"false")},r=()=>{let n=t.getAttribute("data-clip-open")==="true";t.setAttribute("data-clip-open",n?"false":"true"),e()};t.addEventListener("click",n=>{n.defaultPrevented||r()}),t.addEventListener("keydown",n=>{(n.key===" "||n.key==="Enter")&&(n.preventDefault(),r())}),e()}function zn(t){if(t.dataset.enhancedBtnWorking)return;t.dataset.enhancedBtnWorking="true";let e=null,r=!1;new MutationObserver(o=>{o.forEach(a=>{if(a.attributeName==="class"){let i=t.classList.contains("btn-working"),s=t.querySelector("pds-icon");if(i)if(s)e||(e=s.getAttribute("icon")),s.setAttribute("icon","circle-notch");else{let p=document.createElement("pds-icon");p.setAttribute("icon","circle-notch"),p.setAttribute("size","sm"),t.insertBefore(p,t.firstChild),r=!0}else a.oldValue?.includes("btn-working")&&s&&(r?(s.remove(),r=!1):e&&(s.setAttribute("icon",e),e=null))}})}).observe(t,{attributes:!0,attributeFilter:["class"],attributeOldValue:!0})}var Mn=new Map([[".accordion",yn],["nav[data-dropdown]",vn],["label[data-toggle]",xn],["label[data-color]",wn],['input[type="range"]',kn],["form[data-required]",Sn],["fieldset[role=group][data-open]",$n],["[data-clip]",Cn],["button, a[class*='btn-']",zn]]),We=bn.map(t=>({...t,run:Mn.get(t.selector)||(()=>{})}));var pr=[{selector:".accordion",description:"Ensures only one <details> element can be open at a time within the accordion.",demoHtml:`
      <div class="accordion">
        <details>
    ...
    `.trim()}];var gr="pds",En=/^([a-z][a-z0-9+\-.]*:)?\/\//i,ur=/^[a-z]:/i;function Ae(t=""){return t.endsWith("/")?t:`${t}/`}function Tn(t="",e=gr){let r=t.replace(/\/+$/,"");return new RegExp(`(?:^|/)${e}$`,"i").test(r)?r:`${r}/${e}`}function An(t){return t.replace(/^\.\/+/,"")}function Ln(t){return ur.test(t)?t.replace(ur,"").replace(/^\/+/,""):t}function Rn(t){return t.startsWith("public/")?t.substring(7):t}function me(t,e={}){let r=e.segment||gr,n=e.defaultRoot||`/assets/${r}/`,o=t?.public&&t.public?.root||t?.static&&t.static?.root||null;if(!o||typeof o!="string")return Ae(n);let a=o.trim();return a?(a=a.replace(/\\/g,"/"),a=Tn(a,r),a=Ae(a),En.test(a)?a:(a=An(a),a=Ln(a),a.startsWith("/")||(a=Rn(a),a.startsWith("/")||(a=`/${a}`),a=a.replace(/\/+/g,(i,s)=>s===0?i:"/")),Ae(a))):Ae(n)}function mr(t){let e=t.replace(/['"]/g,"").trim();if(["system-ui","-apple-system","sans-serif","serif","monospace","cursive","fantasy","ui-sans-serif","ui-serif","ui-monospace","ui-rounded"].includes(e.toLowerCase()))return!0;let o=document.createElement("canvas").getContext("2d");if(!o)return!1;let a="mmmmmmmmmmlli",i="72px",s="monospace";o.font=`${i} ${s}`;let p=o.measureText(a).width;o.font=`${i} "${e}", ${s}`;let d=o.measureText(a).width;return p!==d}function Fn(t){return t?t.split(",").map(n=>n.trim())[0].replace(/['"]/g,"").trim():null}async function fr(t,e={}){if(!t)return Promise.resolve();let{weights:r=[400,500,600,700],italic:n=!1}=e,o=Fn(t);if(!o||mr(o))return Promise.resolve();let a=encodeURIComponent(o);return document.querySelector(`link[href*="fonts.googleapis.com"][href*="${a}"]`)?(console.log(`Font "${o}" is already loading or loaded`),Promise.resolve()):(console.log(`Loading font "${o}" from Google Fonts...`),new Promise((s,p)=>{let d=document.createElement("link");d.rel="stylesheet";let c=n?`ital,wght@0,${r.join(";0,")};1,${r.join(";1,")}`:`wght@${r.join(";")}`;d.href=`https://fonts.googleapis.com/css2?family=${a}:${c}&display=swap`,d.setAttribute("data-font-loader",o),d.onload=()=>{console.log(`Successfully loaded font "${o}"`),s()},d.onerror=()=>{console.warn(`Failed to load font "${o}" from Google Fonts`),p(new Error(`Failed to load font: ${o}`))},document.head.appendChild(d),setTimeout(()=>{mr(o)||console.warn(`Font "${o}" did not load within timeout`),s()},5e3)}))}async function St(t){if(!t)return Promise.resolve();let e=new Set;t.fontFamilyHeadings&&e.add(t.fontFamilyHeadings),t.fontFamilyBody&&e.add(t.fontFamilyBody),t.fontFamilyMono&&e.add(t.fontFamilyMono);let r=Array.from(e).map(n=>fr(n).catch(o=>{console.warn(`Could not load font: ${n}`,o)}));await Promise.all(r)}async function Pn(...t){let e={};t.length&&typeof t[t.length-1]=="object"&&(e=t.pop()||{});let r=t,{baseURL:n,mapper:o=d=>`${d}.js`,onError:a=(d,c)=>console.error(`[defineWebComponents] ${d}:`,c)}=e,i=n?new URL(n,typeof location<"u"?location.href:import.meta.url):new URL("./",import.meta.url),s=d=>d.toLowerCase().replace(/(^|-)([a-z])/g,(c,l,u)=>u.toUpperCase()),p=async d=>{try{if(customElements.get(d))return{tag:d,status:"already-defined"};let c=o(d),u=await import(c instanceof URL?c.href:new URL(c,i).href),g=u?.default??u?.[s(d)];if(!g){if(customElements.get(d))return{tag:d,status:"self-defined"};throw new Error(`No export found for ${d}. Expected default export or named export "${s(d)}".`)}return customElements.get(d)?{tag:d,status:"race-already-defined"}:(customElements.define(d,g),{tag:d,status:"defined"})}catch(c){throw a(d,c),c}};return Promise.all(r.map(p))}var He=class{constructor(e={}){let{baseURL:r,mapper:n,onError:o,predicate:a=()=>!0,attributeModule:i="data-module",root:s=document,scanExisting:p=!0,debounceMs:d=16,observeShadows:c=!0,enhancers:l=[],patchAttachShadow:u=!0}=e,g=new Set,m=new Set,y=new Set,f=new Map,h=new WeakMap,w=new WeakMap,x=0,S=!1,A=null,L=k=>{if(!k||!l.length)return;let E=w.get(k);E||(E=new Set,w.set(k,E));for(let T of l)if(!(!T.selector||!T.run)&&!E.has(T.selector))try{k.matches&&k.matches(T.selector)&&(T.run(k),E.add(T.selector))}catch(B){console.warn(`[AutoDefiner] Error applying enhancer for selector "${T.selector}":`,B)}},F=(k,E)=>{if(!S&&!(!k||!k.includes("-"))&&!customElements.get(k)&&!m.has(k)&&!y.has(k)){if(E&&E.getAttribute){let T=E.getAttribute(i);T&&!f.has(k)&&f.set(k,T)}g.add(k),I()}},I=()=>{x||(x=setTimeout(P,d))},$=k=>{if(k){if(k.nodeType===1){let E=k,T=E.tagName?.toLowerCase();T&&T.includes("-")&&!customElements.get(T)&&a(T,E)&&F(T,E),L(E),c&&E.shadowRoot&&z(E.shadowRoot)}k.querySelectorAll&&k.querySelectorAll("*").forEach(E=>{let T=E.tagName?.toLowerCase();T&&T.includes("-")&&!customElements.get(T)&&a(T,E)&&F(T,E),L(E),c&&E.shadowRoot&&z(E.shadowRoot)})}},z=k=>{if(!k||h.has(k))return;$(k);let E=new MutationObserver(T=>{for(let B of T)B.addedNodes?.forEach(W=>{$(W)}),B.type==="attributes"&&B.target&&$(B.target)});E.observe(k,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[i,...l.map(T=>T.selector).filter(T=>T.startsWith("data-"))]}),h.set(k,E)};async function P(){if(clearTimeout(x),x=0,!g.size)return;let k=Array.from(g);g.clear(),k.forEach(E=>m.add(E));try{let E=T=>f.get(T)??(n?n(T):`${T}.js`);await Pn(...k,{baseURL:r,mapper:E,onError:(T,B)=>{y.add(T),o?.(T,B)}})}catch{}finally{k.forEach(E=>m.delete(E))}}let C=s===document?document.documentElement:s,b=new MutationObserver(k=>{for(let E of k)E.addedNodes?.forEach(T=>{$(T)}),E.type==="attributes"&&E.target&&$(E.target)});if(b.observe(C,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[i,...l.map(k=>k.selector).filter(k=>k.startsWith("data-"))]}),c&&u&&Element.prototype.attachShadow){let k=Element.prototype.attachShadow;Element.prototype.attachShadow=function(T){let B=k.call(this,T);if(T&&T.mode==="open"){z(B);let W=this.tagName?.toLowerCase();W&&W.includes("-")&&!customElements.get(W)&&F(W,this)}return B},A=()=>Element.prototype.attachShadow=k}return p&&$(C),{stop(){S=!0,b.disconnect(),A&&A(),x&&(clearTimeout(x),x=0),h.forEach(k=>k.disconnect())},flush:P}}static async define(...e){let r={};e.length&&typeof e[e.length-1]=="object"&&(r=e.pop()||{});let n=e,{baseURL:o,mapper:a=c=>`${c}.js`,onError:i=(c,l)=>console.error(`[defineWebComponents] ${c}:`,l)}=r,s=o?new URL(o,typeof location<"u"?location.href:import.meta.url):new URL("./",import.meta.url),p=c=>c.toLowerCase().replace(/(^|-)([a-z])/g,(l,u,g)=>g.toUpperCase()),d=async c=>{try{if(customElements.get(c))return{tag:c,status:"already-defined"};let l=a(c),g=await import(l instanceof URL?l.href:new URL(l,s).href),m=g?.default??g?.[p(c)];if(!m){if(customElements.get(c))return{tag:c,status:"self-defined"};throw new Error(`No export found for ${c}. Expected default export or named export "${p(c)}".`)}return customElements.get(c)?{tag:c,status:"race-already-defined"}:(customElements.define(c,m),{tag:c,status:"defined"})}catch(l){throw i(c,l),l}};return Promise.all(n.map(d))}};var Nn=/^[a-z][a-z0-9+\-.]*:\/\//i,Le=(()=>{try{return import.meta.url}catch{return}})(),fe=t=>typeof t=="string"&&t.length&&!t.endsWith("/")?`${t}/`:t;function he(t,e={}){if(!t||Nn.test(t))return t;let{preferModule:r=!0}=e,n=()=>{if(!Le)return null;try{return new URL(t,Le).href}catch{return null}},o=()=>{if(typeof window>"u"||!window.location?.origin)return null;try{return new URL(t,window.location.origin).href}catch{return null}};return(r?n()||o():o()||n())||t}var hr=(()=>{if(Le)try{let t=new URL(Le);if(/\/public\/assets\/js\//.test(t.pathname))return new URL("../pds/",Le).href}catch{return}})(),br=!1;function Ue(t){br||typeof document>"u"||(br=!0,t.addEventListener("pds:ready",e=>{let r=e.detail?.mode;r&&document.documentElement.classList.add(`pds-${r}`,"pds-ready")}))}function Ct(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};for(let[n,o]of Object.entries(e))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=Ct(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function $t(t=""){return String(t).toLowerCase().replace(/&/g," and ").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function ie(t){if(t==null)return t;if(typeof t=="function")return;if(typeof t!="object")return t;if(Array.isArray(t))return t.map(r=>ie(r)).filter(r=>r!==void 0);let e={};for(let r in t)if(t.hasOwnProperty(r)){let n=t[r];if(typeof n!="function"){let o=ie(n);o!==void 0&&(e[r]=o)}}return e}function zt(t={},e={},{presets:r,defaultLog:n,validateDesignConfig:o,validateInitConfig:a}={}){let i=t&&typeof t.log=="function"?t.log:n,s=typeof t=="object"&&("colors"in t||"typography"in t||"spatialRhythm"in t||"shape"in t||"behavior"in t||"layout"in t||"advanced"in t||"a11y"in t||"components"in t||"icons"in t),p=t&&t.enhancers;p&&!Array.isArray(p)&&(p=Object.values(p));let d=p??e.enhancers??[],c=t&&t.preset,l=t&&t.design,u=t&&t.icons&&typeof t.icons=="object"?t.icons:null,g="preset"in(t||{})||"design"in(t||{})||"enhancers"in(t||{});t&&typeof t=="object"&&typeof a=="function"&&a(t,{log:i,context:"PDS.start"});let m,y=null;if(g){l&&typeof l=="object"&&typeof o=="function"&&o(l,{log:i,context:"PDS.start"});let f=String(c||"default").toLowerCase(),h=r?.[f]||Object.values(r||{}).find(B=>$t(B.name)===f||String(B.name||"").toLowerCase()===f);if(!h)throw new Error(`PDS preset not found: "${c||"default"}"`);y={id:h.id||$t(h.name),name:h.name||h.id||String(f)};let w=structuredClone(h);if(l&&typeof l=="object"||u){let B=l?ie(l):{},W=u?ie(u):null,V=W?Ct(B,{icons:W}):B;w=Ct(w,structuredClone(V))}let{mode:x,autoDefine:S,applyGlobalStyles:A,manageTheme:L,themeStorageKey:F,preloadStyles:I,criticalLayers:$,managerURL:z,manager:P,preset:C,design:b,enhancers:k,log:E,...T}=t;m={...T,design:w,preset:y.name,log:E||n}}else if(s){typeof o=="function"&&o(t,{log:i,context:"PDS.start"});let{log:f,...h}=t;m={design:structuredClone(h),log:f||n}}else{let f=r?.default||Object.values(r||{}).find(h=>$t(h.name)==="default");if(!f)throw new Error("PDS default preset not available");y={id:f.id||"default",name:f.name||"Default"},m={design:structuredClone(f),preset:y.name,log:n}}return{generatorConfig:m,enhancers:d,presetInfo:y}}function qe({manageTheme:t,themeStorageKey:e,applyResolvedTheme:r,setupSystemListenerIfNeeded:n}){let o="light",a=null;if(t&&typeof window<"u"){try{a=localStorage.getItem(e)||null}catch{a=null}try{r?.(a),n?.(a)}catch{}a?a==="system"?o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":o=a:o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}return{resolvedTheme:o,storedTheme:a}}function be(t,{resolvePublicAssetURL:e}){let r=!!(t?.public?.root||t?.static?.root),n=e(t);return!r&&hr&&(n=hr),fe(he(n))}async function Ge(t,{baseEnhancers:e=[]}={}){let{autoDefineBaseURL:r="/auto-define/",autoDefinePreload:n=[],autoDefineMapper:o=null,enhancers:a=[],autoDefineOverrides:i=null,autoDefinePreferModule:s=!0}=t,p=(()=>{let c=new Map;return(e||[]).forEach(l=>c.set(l.selector,l)),(a||[]).forEach(l=>c.set(l.selector,l)),Array.from(c.values())})(),d=null;if(typeof window<"u"&&typeof document<"u"){let c=He,l=x=>{switch(x){case"pds-tabpanel":return"pds-tabstrip.js";default:return`${x}.js`}},{mapper:u,enhancers:g,...m}=i&&typeof i=="object"?i:{},y=g?Array.isArray(g)?g:typeof g=="object"?Object.values(g):[]:[],f=(()=>{let x=new Map;return(p||[]).forEach(S=>{S?.selector&&x.set(S.selector,S)}),(y||[]).forEach(S=>{if(!S?.selector)return;let A=x.get(S.selector)||null;x.set(S.selector,{...A||{},...S,run:typeof S?.run=="function"?S.run:A?.run})}),Array.from(x.values())})(),w={baseURL:r&&fe(he(r,{preferModule:s})),predefine:n,scanExisting:!0,observeShadows:!0,patchAttachShadow:!0,debounceMs:16,enhancers:f,onError:(x,S)=>{if(typeof x=="string"&&x.startsWith("pds-")){let L=["pds-form","pds-drawer"].includes(x),F=S?.message?.includes("#pds/lit")||S?.message?.includes("Failed to resolve module specifier");L&&F?console.error(`\u274C PDS component <${x}> requires Lit but #pds/lit is not in import map.
              See: https://github.com/Pure-Web-Foundation/pure-ds/blob/main/readme.md#lit-components-not-working`):console.warn(`\u26A0\uFE0F PDS component <${x}> not found. Assets may not be installed.`)}else console.error(`\u274C Auto-define error for <${x}>:`,S)},...m,mapper:x=>{if(customElements.get(x))return null;if(typeof o=="function")try{let S=o(x);return S===void 0?l(x):S}catch(S){return console.warn("Custom autoDefine.mapper error; falling back to default:",S?.message||S),l(x)}return l(x)}};d=new c(w),n.length>0&&typeof c.define=="function"&&await c.define(...n,{baseURL:r,mapper:w.mapper,onError:w.onError})}return{autoDefiner:d,mergedEnhancers:p}}var Mt=["light","dark"],Et=new Set(Mt);function Tt(t){let r=(Array.isArray(t?.themes)?t.themes.map(n=>String(n).toLowerCase()):Mt).filter(n=>Et.has(n));return r.length?r:Mt}function ye(t,{preferDocument:e=!0}={}){let r=String(t||"").toLowerCase();if(Et.has(r))return r;if(e&&typeof document<"u"){let n=document.documentElement?.getAttribute("data-theme");if(Et.has(n))return n}return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function se(t,e){let r=ye(e);return Tt(t).includes(r)}var vr=!1,Ke="pds-live-edit-toggle",Ft="pds-live-edit-toggle-style";function xr(t,e=new WeakSet){if(!t||typeof t!="object"||e.has(t))return t;e.add(t),Object.freeze(t);for(let r of Object.keys(t))xr(t[r],e);return t}function wr(t){return t==null||typeof t!="object"?t:xr(structuredClone(ie(t)))}function kr(t){if(typeof document>"u"||typeof t!="function")return;if(document.body){t();return}let e=()=>{document.body&&(document.removeEventListener("DOMContentLoaded",e),t())};document.addEventListener("DOMContentLoaded",e,{once:!0})}function jn(t={}){let e=t?.interactive!==!1;typeof document>"u"||kr(()=>{if(document.querySelector("pds-live-edit")){if(!e){let r=document.querySelector("pds-live-edit");r&&r.setAttribute("data-pds-live-settings-only","true")}}else{let r=document.createElement("pds-live-edit");e||r.setAttribute("data-pds-live-settings-only","true"),document.body.appendChild(r)}})}function Je(t=0){return new Promise(e=>{setTimeout(e,Math.max(0,Number(t)||0))})}async function Re(t={}){let e=t?.mountIfMissing!==!1,r=t?.interactive!==!1,n=typeof t?.requiredMethod=="string"&&t.requiredMethod.trim()?t.requiredMethod.trim():"openDesignSettings",o=Number.isFinite(Number(t?.timeoutMs))?Number(t.timeoutMs):2400;if(typeof document>"u"||!e&&!document.querySelector("pds-live-edit"))return null;e&&jn({interactive:r});let a=Date.now();for(;Date.now()-a<o;){let s=document.querySelector("pds-live-edit");if(!s){await Je(40);continue}if(typeof s?.[n]=="function")return s;if(typeof customElements<"u"&&typeof customElements.whenDefined=="function"){try{await Promise.race([customElements.whenDefined("pds-live-edit"),Je(80)])}catch{await Je(40)}continue}await Je(40)}let i=document.querySelector("pds-live-edit");return i&&typeof i?.[n]=="function"?i:null}function Sr(){if(typeof document>"u")return;document.querySelectorAll("pds-live-edit").forEach(e=>{typeof e?.setInteractiveEditingEnabled=="function"&&e.setInteractiveEditingEnabled(!1),e.remove()})}function Bn(t){return t?typeof t.isInteractiveEditingEnabled=="function"?!!t.isInteractiveEditingEnabled():!0:!1}function _n(){if(typeof document>"u"||document.getElementById(Ft))return;let t=document.createElement("style");t.id=Ft,t.textContent=`
  ...
  `,document.head.appendChild(t)}function Rt(t,e){if(!t)return;t.classList.toggle("btn-primary",e),t.classList.toggle("btn-secondary",!e),t.setAttribute("aria-pressed",e?"true":"false");let r="PDS Manager";t.setAttribute("aria-label",r),t.setAttribute("title",r)}async function On(){if(typeof document>"u")return null;_n();let t=document.getElementById(Ke);if(!t){let e=document.createElement("nav");e.className="pds-live-edit-toggle-nav",e.setAttribute("data-dropdown",""),e.setAttribute("data-mode","auto"),e.setAttribute("data-pds-live-edit-ignore","true"),t=document.createElement("button"),t.id=Ke,t.type="button",t.className="icon-only btn-secondary",t.setAttribute("data-pds-live-edit-ignore","true"),t.innerHTML='<pds-icon icon="cursor-click" size="sm"></pds-icon>';let r=document.createElement("menu");r.setAttribute("data-pds-live-edit-ignore","true");let n=(a,i,s)=>{let p=document.createElement("li"),d=document.createElement("a");d.href="#",d.dataset.pdsLiveAction=a,d.setAttribute("data-pds-live-edit-ignore","true");let c=document.createElement("pds-icon");return c.setAttribute("icon",s),c.setAttribute("size","sm"),d.append(c,document.createTextNode(` ${i}`)),p.appendChild(d),p},o=()=>{let a=document.createElement("li");a.setAttribute("data-pds-live-edit-ignore","true");let i=document.createElement("hr");return i.setAttribute("aria-hidden","true"),a.appendChild(i),a};r.appendChild(n("toggle","Toggle live editing","pencil")),r.appendChild(n("open-settings","Open Settings","gear")),r.appendChild(o()),r.appendChild(n("reset-config","Reset Config","arrow-counter-clockwise")),await Dn(r),e.append(t,r),kr(()=>{document.getElementById(Ke)||document.body.appendChild(e)})}return t}async function Dn(t){if(t instanceof Element){if(t.__pdsLiveSharedMenuItemInFlight)return t.__pdsLiveSharedMenuItemInFlight;t.__pdsLiveSharedMenuItemInFlight=(async()=>{t.querySelectorAll("li.pds-live-shared-quick-mode-item").forEach(s=>s.remove());let e=await Re({mountIfMissing:!0,interactive:!1,requiredMethod:"createSharedQuickModeMenuItem",timeoutMs:7e3});if(!e||typeof e.createSharedQuickModeMenuItem!="function")return;let r=await e.createSharedQuickModeMenuItem();if(!(r instanceof Element))return;r.classList.add("pds-live-shared-quick-mode-item");let o=t.querySelector('a[data-pds-live-action="reset-config"]')?.closest("li")||null,a=o?.previousElementSibling||null,i=a&&a.querySelector?.(":scope > hr")?a:null;if(i){t.insertBefore(r,i);return}if(o){t.insertBefore(r,o);return}t.appendChild(r)})();try{await t.__pdsLiveSharedMenuItemInFlight}finally{t.__pdsLiveSharedMenuItemInFlight=null}}}function Wn(){if(typeof document>"u")return;let t=document.getElementById(Ke);if(t){let r=t.closest(".pds-live-edit-toggle-nav");r?r.remove():t.remove()}let e=document.getElementById(Ft);e&&e.remove(),Sr()}async function Hn(){if(typeof document>"u")return;let t=await On();if(!t)return;let e=async i=>{if(i){let s=await Re({mountIfMissing:!0});s&&typeof s.setInteractiveEditingEnabled=="function"&&s.setInteractiveEditingEnabled(!0)}else Sr();Rt(t,i)};e(!1);let r=t.closest(".pds-live-edit-toggle-nav")||t;t.__pdsLiveEditActionHandler&&r.removeEventListener("click",t.__pdsLiveEditActionHandler);let n=async i=>{let s=i.target?.closest?.("[data-pds-live-action]");if(!s)return;i.preventDefault();let p=String(s.dataset.pdsLiveAction||"");if(p==="toggle"){let d=await Re({mountIfMissing:!1}),c=Bn(d);await e(!c);return}if(p==="open-settings"){let d=await Re({mountIfMissing:!0,requiredMethod:"openDesignSettings",interactive:!1});d&&typeof d.setInteractiveEditingEnabled=="function"&&d.setInteractiveEditingEnabled(!1),d&&typeof d.openDesignSettings=="function"&&(Rt(t,!1),await d.openDesignSettings());return}if(p==="reset-config"){let d=await Re({mountIfMissing:!0,requiredMethod:"resetConfig",interactive:!1});Rt(t,!1),d&&typeof d.resetConfig=="function"&&await d.resetConfig();return}};t.__pdsLiveEditActionHandler=n,r.addEventListener("click",n),t.__pdsLiveEditDisableHandler&&document.removeEventListener("pds:live-edit:disable",t.__pdsLiveEditDisableHandler),t.__pdsLiveEditEnableHandler&&document.removeEventListener("pds:live-edit:enable",t.__pdsLiveEditEnableHandler);let o=()=>{e(!1)},a=()=>{e(!0)};t.__pdsLiveEditDisableHandler=o,document.addEventListener("pds:live-edit:disable",o),t.__pdsLiveEditEnableHandler=a,document.addEventListener("pds:live-edit:enable",a)}function Un(){if(typeof window>"u"||!window.localStorage)return null;try{let t=window.localStorage.getItem("pure-ds-config");if(!t)return null;let e=JSON.parse(t);if(e&&("preset"in e||"design"in e))return e}catch{return null}return null}function Pt(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};for(let[n,o]of Object.entries(e))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=Pt(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function qn(t){let e=Un();if(!e||!t||typeof t!="object")return t;let r=e.preset,n=e.design&&typeof e.design=="object"?e.design:null;if(!r&&!n)return t;let o="preset"in t||"design"in t||"enhancers"in t,a={...t};if(r&&(a.preset=r),n)if(o){let i=t.design&&typeof t.design=="object"?t.design:{};a.design=Pt(i,n)}else a=Pt(t,n);return a}function Gn(t,e={}){let{hideCategory:r=!0,itemGrid:n="45px 1fr",includeIncompatible:o=!0,disableIncompatible:a=!0,categoryName:i="Presets",theme:s,onSelect:p,iconHandler:d}=e||{},c=ye(s??t?.theme),l=m=>{let f=g(m?.id)?.colors||{},h=f?.primary,w=f?.secondary,x=f?.accent;return h&&w&&x?`<span style="display:flex;gap:1px;flex-shrink:0;" aria-hidden="true">
      ...
      </span>`:m?.icon?`<pds-icon icon="${m.icon}" size="sm"></pds-icon>`:""},u=()=>{let m=t?.presets||{};return Object.values(m||{}).filter(y=>!!(y?.id||y?.name))},g=m=>m&&u().find(f=>String(f?.id||f?.name)===String(m))||null;return{hideCategory:r,itemGrid:n,iconHandler:typeof d=="function"?d:l,categories:{[i]:{trigger:()=>!0,getItems:(m={})=>{let y=String(m?.search||"").toLowerCase().trim();return u().filter(h=>{let w=String(h?.name||h?.id||"").toLowerCase(),x=String(h?.description||"").toLowerCase(),S=Array.isArray(h?.tags)?h.tags.map(L=>String(L).toLowerCase()):[];if(y&&!(w.includes(y)||x.includes(y)||S.some(F=>F.includes(y))))return!1;let A=se(h,c);return!(!o&&!A)}).map(h=>{let w=h?.id||h?.name,x=se(h,c),S=Tt(h),A=S.length===1?`${S[0]} only`:`Not available in ${c} mode`,L=String(h?.description||"").trim(),F=x?L:L?`${L} - ${A}`:A;return{id:w,text:h?.name||String(w),description:F,icon:"palette",class:!x&&a?"disabled":"",disabled:!x&&a,tooltip:x?"":A}}).sort((h,w)=>String(h.text||"").localeCompare(String(w.text||"")))},action:async m=>{if(!m?.id||m?.disabled)return m?.id;let y=g(m.id);return y?typeof p=="function"?await p({preset:y,selection:m,resolvedTheme:c}):(typeof t?.applyLivePreset=="function"&&await t.applyLivePreset(y.id||m.id),y.id||m.id):m?.id}}}}}async function Vn(t,{applyResolvedTheme:e,setupSystemListenerIfNeeded:r,emitConfigChanged:n}){if(vr)return;let[o,a,i]=await Promise.all([Promise.resolve().then(()=>(wt(),sr)),Promise.resolve().then(()=>(Ce(),Yt)),Promise.resolve().then(()=>(Lt(),Ye))]),s=o?.default||o?.ontology,p=o?.findComponentForElement,d=a?.enums;t.ontology=s,t.findComponentForElement=p,t.enums=d,t.common=i||{},t.presets=X,t.configRelations=er,t.configSpec=tr,t.configEditorMetadata=or,t.configFormSchema=ar,t.buildConfigFormSchema=ue,t.getConfigEditorMetadata=Te,t.enhancerMetadata=pr,(!Array.isArray(t.defaultEnhancers)||t.defaultEnhancers.length===0)&&(t.defaultEnhancers=Array.isArray(We)?We:[]),t.applyStyles=function(c){let l=c||K.instance;cr(l),typeof n=="function"&&n({mode:"live",source:"live:styles-applied"})},t.adoptLayers=function(c,l,u){return De(c,l,u,K.instance)},t.adoptPrimitives=function(c,l){return Oe(c,l,K.instance)},t.getGenerator=async function(){return K},t.buildPresetOmniboxSettings=function(c={}){return Gn(t,c)},t.applyLivePreset=async function(c,l={}){if(!c)return!1;if(!t.registry?.isLive)return console.warn("PDS.applyLivePreset is only available in live mode."),!1;let u=t.currentConfig||{},{design:g,preset:m,...y}=u,f={...structuredClone(ie(y)),preset:c},h=zt(f,{},{presets:X,defaultLog:xt,validateDesignConfig:yt,validateInitConfig:vt}),w=ye(t.theme);if(!se(h.generatorConfig.design,w)){let L=h.presetInfo?.name||h.generatorConfig?.design?.name||c;console.warn(`PDS theme "${w}" not supported by preset "${L}".`)}u.theme&&!h.generatorConfig.theme&&(h.generatorConfig.theme=u.theme);let x=new K(h.generatorConfig);if(h.generatorConfig.design?.typography)try{await St(h.generatorConfig.design.typography)}catch(L){h.generatorConfig?.log?.("warn","Failed to load some fonts from Google Fonts:",L)}t.applyStyles?.(x);let S=h.presetInfo||{id:c,name:c};if(t.currentPreset=S,t.compiled=wr({...u,preset:h.generatorConfig.preset,design:h.generatorConfig.design,theme:h.generatorConfig.theme||u.theme}),t.configEditorMetadata=Te(h.generatorConfig.design),t.configFormSchema=ue(h.generatorConfig.design),l?.persist!==!1&&typeof window<"u"){let L="pure-ds-config";try{let F=localStorage.getItem(L),I=F?JSON.parse(F):null,$={...I&&typeof I=="object"?I:{},preset:S.id||c,design:structuredClone(h.generatorConfig.design||{})};localStorage.setItem(L,JSON.stringify($))}catch(F){h.generatorConfig?.log?.("warn","Failed to store preset:",F)}}return!0},t.preloadCritical=function(c,l={}){if(typeof window>"u"||!document.head||!c)return;let{theme:u,layers:g=["tokens"]}=l;try{let m=u||"light";(u==="system"||!u)&&(m=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),document.documentElement.setAttribute("data-theme",m);let y=c.design?{...c,theme:m}:{design:c,theme:m},f=new K(y),h=g.map(w=>{try{return f.css?.[w]||""}catch{return""}}).filter(w=>w.trim()).join(`
`);if(h){let w=document.head.querySelector("style[data-pds-preload]");w&&w.remove();let x=document.createElement("style");x.setAttribute("data-pds-preload",""),x.textContent=h,document.head.insertBefore(x,document.head.firstChild)}}catch(m){console.warn("PDS preload failed:",m)}},vr=!0}async function Yn(t,e,{emitReady:r,emitConfigChanged:n,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}){if(!e||typeof e!="object")throw new Error("PDS.start({ mode: 'live', ... }) requires a valid configuration object");let i=e?.design?.icons?.externalPath||e?.icons?.externalPath||null;if(e=qn(e),typeof i=="string"&&i.trim()){let g=e?.design&&typeof e.design=="object"?e.design:{},m=g?.icons&&typeof g.icons=="object"?g.icons:{};e={...e,design:{...g,icons:{...m,externalPath:i}}}}if(await Vn(t,{applyResolvedTheme:o,setupSystemListenerIfNeeded:a,emitConfigChanged:n}),Ue(t),typeof document<"u"&&document.adoptedStyleSheets){let g=`
          html { opacity: 0; }
          html.pds-ready { opacity: 1; transition: opacity 0.3s ease-in; }
        `;try{if(!document.adoptedStyleSheets.some(y=>y._pdsFouc)){let y=new CSSStyleSheet;y.replaceSync(g),y._pdsFouc=!0,document.adoptedStyleSheets=[y,...document.adoptedStyleSheets]}}catch(m){if(console.warn("Constructable stylesheets not supported, using <style> tag fallback:",m),!document.head.querySelector("style[data-pds-fouc]")){let f=document.createElement("style");f.setAttribute("data-pds-fouc",""),f.textContent=g,document.head.insertBefore(f,document.head.firstChild)}}}let s=e.applyGlobalStyles??!0,p=e.manageTheme??!0,d=e.themeStorageKey??"pure-ds-theme",c=e.preloadStyles??!1,l=e.criticalLayers??["tokens","primitives"],u=e&&e.autoDefine||null;try{let{resolvedTheme:g}=qe({manageTheme:p,themeStorageKey:d,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}),m=zt(e,{},{presets:X,defaultLog:xt,validateDesignConfig:yt,validateInitConfig:vt});if(p&&!se(m.generatorConfig.design,g)){let $=m.presetInfo?.name||m.generatorConfig?.design?.name||m.generatorConfig?.preset||"current preset";console.warn(`PDS theme "${g}" not supported by preset "${$}".`)}let y=m.enhancers,{log:f,...h}=m.generatorConfig,w=structuredClone(h);w.log=f,p&&(w.theme=g);let x=new K(w);if(w.design?.typography)try{await St(w.design.typography)}catch($){w?.log?.("warn","Failed to load some fonts from Google Fonts:",$)}if(c&&typeof window<"u"&&document.head)try{let $=l.map(z=>{try{return x.css?.[z]||""}catch(P){return w?.log?.("warn",`Failed to generate critical CSS for layer "${z}":`,P),""}}).filter(z=>z.trim()).join(`
`);if($){let z=document.head.querySelector("style[data-pds-critical]");z&&z.remove();let P=document.createElement("style");P.setAttribute("data-pds-critical",""),P.textContent=$;let C=document.head.querySelector('meta[charset], meta[name="viewport"]');C?C.parentNode.insertBefore(P,C.nextSibling):document.head.insertBefore(P,document.head.firstChild)}}catch($){w?.log?.("warn","Failed to preload critical styles:",$)}t.registry.setLiveMode(),m.presetInfo?.name?w?.log?.("log",`PDS live with preset "${m.presetInfo.name}"`):w?.log?.("log","PDS live with custom config"),s&&(t.applyStyles?.(K.instance),typeof window<"u"&&setTimeout(()=>{let $=document.head.querySelector("style[data-pds-critical]");$&&$.remove();let z=document.head.querySelector("style[data-pds-preload]");z&&z.remove();let P=document.getElementById("pds-runtime-stylesheet");P&&P.remove()},100));let S=be(e,{resolvePublicAssetURL:me}),A;u&&u.baseURL?A=fe(he(u.baseURL,{preferModule:!1})):A=`${S}components/`;let L=null,F=[];try{let $=await Ge({autoDefineBaseURL:A,autoDefinePreload:u&&Array.isArray(u.predefine)&&u.predefine||[],autoDefineMapper:u&&typeof u.mapper=="function"&&u.mapper||null,enhancers:y,autoDefineOverrides:u||null,autoDefinePreferModule:!(u&&u.baseURL)},{baseEnhancers:We});L=$.autoDefiner,F=$.mergedEnhancers||[]}catch($){w?.log?.("error","\u274C Failed to initialize AutoDefiner/Enhancers:",$)}let I=x?.options||w;if(t.compiled=wr({mode:"live",...I,theme:g,enhancers:F}),t.configEditorMetadata=Te(m.generatorConfig.design),t.configFormSchema=ue(m.generatorConfig.design),typeof n=="function"&&n({mode:"live",source:"live:config-applied",preset:m.generatorConfig.preset}),typeof document<"u")try{e?.liveEdit?setTimeout(()=>{Hn()},0):Wn()}catch($){w?.log?.("warn","Live editor toggle failed to start:",$)}return r({mode:"live",generator:x,config:I,theme:g,autoDefiner:L}),{generator:x,config:I,theme:g,autoDefiner:L}}catch(g){throw t.dispatchEvent(new CustomEvent("pds:error",{detail:{error:g}})),g}}function Jn(t){let e=Number(t);return Number.isFinite(e)?Math.max(0,Math.min(1,e)):.5}function Kn(t){return Array.isArray(t)?t.map(e=>e?{severity:String(e.severity||"info").toLowerCase(),message:String(e.message||""),path:e.path?String(e.path):""}:null).filter(e=>e&&e.message):[]}function O(t={}){let e=String(t.source||"unknown"),r=String(t.type||"generic"),n=Jn(t.confidence),o=Kn(t.issues),a=t.designPatch&&typeof t.designPatch=="object"?t.designPatch:{},i=t.template&&typeof t.template=="object"?t.template:null;return{source:e,type:r,confidence:n,issues:o,designPatch:a,template:i,meta:t.meta&&typeof t.meta=="object"?t.meta:{}}}function Xn(t){return!!(t&&typeof t=="object"&&"source"in t&&"type"in t&&"confidence"in t&&"issues"in t&&"designPatch"in t)}var Zn="../templates/templates.json",$r="/assets/pds/templates/templates.json",Qn=["public","assets","pds","templates","templates.json"],eo=["..","..","..","public","assets","pds","templates","templates.json"],Xe=null;function Cr(){return!!(typeof process<"u"&&process?.versions?.node)}function to(t={}){return{id:String(t.id||"").trim(),name:String(t.name||t.id||"Template").trim(),description:String(t.description||"").trim(),icon:String(t.icon||"layout").trim(),file:String(t.file||"").trim(),tags:Array.isArray(t.tags)?t.tags.map(e=>String(e)):[]}}function Ze(t={},e={}){let n=(Array.isArray(t)?t:Array.isArray(t?.templates)?t.templates:[]).map(to).filter(o=>o.id&&o.file);return{version:t?.version||"1",templates:n,__catalogURL:e.catalogURL||null,__catalogFilePath:e.catalogFilePath||null}}async function ro(t={}){let r=[t.catalogURL||globalThis?.PDS?.currentConfig?.templateCatalogURL,Zn,$r].filter(Boolean);for(let n of r)try{let o=new URL(n,import.meta.url).href,a=await fetch(o,{credentials:"same-origin"});if(!a.ok)continue;let i=await a.json();return Ze(i,{catalogURL:o})}catch{}return Ze({templates:[]})}async function no(t={}){let e="node:fs/promises",r="node:path",n="node:url",[{readFile:o},a,{fileURLToPath:i}]=await Promise.all([import(e),import(r),import(n)]),s=[];t.catalogPath&&s.push(a.resolve(t.catalogPath)),s.push(a.resolve(process.cwd(),...Qn));let p=a.dirname(i(import.meta.url));s.push(a.resolve(p,...eo));for(let d of s)try{let c=await o(d,"utf8"),l=JSON.parse(c);return Ze(l,{catalogFilePath:d})}catch{}return Ze({templates:[]})}async function oo(t,e){if(!t?.file)return"";if(!Cr()){let p=e?.__catalogURL||$r,d=new URL(t.file,p).href,c=await fetch(d,{credentials:"same-origin"});if(!c.ok)throw new Error(`Template file not found: ${t.file}`);return(await c.text()).trim()}let r="node:fs/promises",n="node:path",[{readFile:o},a]=await Promise.all([import(r),import(n)]),i=e?.__catalogFilePath?a.dirname(e.__catalogFilePath):a.resolve(process.cwd(),"public","assets","pds","templates"),s=a.resolve(i,t.file);return(await o(s,"utf8")).trim()}async function Qe(t={}){return Xe&&!t.forceReload||(Xe=Cr()?await no(t):await ro(t)),Xe}async function zr(t={}){return(await Qe(t)).templates.map(({id:r,name:n,description:o,icon:a,file:i,tags:s})=>({id:r,name:n,description:o,icon:a,file:i,tags:s}))}async function ao(t,e={}){let r=await Qe(e),n=r.templates.find(a=>a.id===t)||null;if(!n)return null;let o=await oo(n,r);return{...n,html:o}}async function Mr(t,e={}){let r=await ao(t,e);return r?O({source:"template",type:"template",confidence:1,template:{id:r.id,name:r.name,html:r.html,icon:r.icon,description:r.description}}):O({source:"template",type:"template",confidence:0,issues:[{severity:"error",message:`Unknown template: ${t}`}]})}var Er={version:"tw2pds-layout-v4",summary:"Deterministic Tailwind\u2192PDS conversion rules focused on layout intent, semantic primitive mapping, and richer import-* fallback coverage.",governance:[{id:"layout.utilities.grid",controls:["grid","grid-cols-*","grid-auto-*"],note:"When false, grid mappings are skipped."},{id:"layout.utilities.flex",controls:["flex","flex-*","items-*","justify-*","grow"],note:"When false, flex mappings are skipped."},{id:"layout.utilities.spacing",controls:["gap-*","stack-*"],note:"When false, spacing mappings are skipped."},{id:"layout.utilities.container",controls:["container","max-w-*"],note:"When false, container mappings are skipped."}],nonPdsClassPatterns:["^group(?:[/:].*)?$","^layout-container$"],neverFallbackTags:["table","thead","tbody","tfoot","tr","th","td","caption","colgroup","col"],directMappings:[{id:"layout.flex.base",tw:"flex",pds:["flex"],gate:"flex"},{id:"layout.flex.inline",tw:"inline-flex",pds:["flex"],gate:"flex"},{id:"layout.flex.row",tw:"flex-row",pds:["flex-row"],gate:"flex"},{id:"layout.flex.col",tw:"flex-col",pds:["flex-col"],gate:"flex"},{id:"layout.flex.wrap",tw:"flex-wrap",pds:["flex-wrap"],gate:"flex"},{id:"layout.flex.grow",tw:"grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow.tw",tw:"flex-grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow1",tw:"flex-1",pds:["grow"],gate:"flex"},{id:"layout.items.start",tw:"items-start",pds:["items-start"],gate:"flex"},{id:"layout.items.center",tw:"items-center",pds:["items-center"],gate:"flex"},{id:"layout.items.end",tw:"items-end",pds:["items-end"],gate:"flex"},{id:"layout.items.stretch",tw:"items-stretch",pds:["items-stretch"],gate:"flex"},{id:"layout.items.baseline",tw:"items-baseline",pds:["items-baseline"],gate:"flex"},{id:"layout.justify.start",tw:"justify-start",pds:["justify-start"],gate:"flex"},{id:"layout.justify.center",tw:"justify-center",pds:["justify-center"],gate:"flex"},{id:"layout.justify.end",tw:"justify-end",pds:["justify-end"],gate:"flex"},{id:"layout.justify.between",tw:"justify-between",pds:["justify-between"],gate:"flex"},{id:"layout.justify.around",tw:"justify-around",pds:["justify-around"],gate:"flex"},{id:"layout.justify.evenly",tw:"justify-evenly",pds:["justify-evenly"],gate:"flex"},{id:"layout.grid.base",tw:"grid",pds:["grid"],gate:"grid"},{id:"layout.grid.cols.1",tw:"grid-cols-1",pds:["grid-cols-1"],gate:"grid"},{id:"layout.grid.cols.2",tw:"grid-cols-2",pds:["grid-cols-2"],gate:"grid"},{id:"layout.grid.cols.3",tw:"grid-cols-3",pds:["grid-cols-3"],gate:"grid"},{id:"layout.grid.cols.4",tw:"grid-cols-4",pds:["grid-cols-4"],gate:"grid"},{id:"layout.grid.cols.6",tw:"grid-cols-6",pds:["grid-cols-6"],gate:"grid"},{id:"layout.container",tw:"container",pds:["container"],gate:"container"},{id:"intent.surface.shadow",tw:"shadow",pds:["surface-elevated"]},{id:"intent.surface.shadow-md",tw:"shadow-md",pds:["surface-elevated"]},{id:"intent.surface.shadow-lg",tw:"shadow-lg",pds:["surface-elevated"]},{id:"intent.surface.base",tw:"bg-white",pds:["surface-base"]},{id:"typography.align.center",tw:"text-center",pds:["text-center"]},{id:"typography.align.left",tw:"text-left",pds:["text-left"]},{id:"typography.align.right",tw:"text-right",pds:["text-right"]},{id:"typography.text.muted.gray500",tw:"text-gray-500",pds:["text-muted"]},{id:"typography.text.muted.slate500",tw:"text-slate-500",pds:["text-muted"]}],ignoredPatterns:[{id:"style.color",pattern:"^(?:text|from|to|via|decoration|accent|caret)-|^bg-(?!cover$|center$|no-repeat$)",reason:"Visual style token skipped in favor of semantic PDS styling."},{id:"style.radius-border-shadow",pattern:"^(?:rounded|ring|border|shadow|outline)-?",reason:"Surface/shape inferred at primitive level."},{id:"style.typography",pattern:"^(?:font|leading|tracking|uppercase|lowercase|capitalize)-?",reason:"Typography atomic utilities are skipped."},{id:"style.effects",pattern:"^(?:opacity|blur|backdrop|drop-shadow|mix-blend|filter)-",reason:"Visual effects skipped unless mapped to a PDS utility."},{id:"style.transitions",pattern:"^(?:transition|duration|ease|delay|animate)-",reason:"Motion is system-defined in PDS."},{id:"style.spacing.atomic",pattern:"^(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-",reason:"Atomic spacing skipped; structural spacing intent is mapped."},{id:"style.positioning.atomic",pattern:"^(?:absolute|relative|fixed|sticky|inset(?:-[xy])?|top|right|bottom|left|z|translate(?:-[xy])?|-translate-[xy])(?:-|$)",reason:"Atomic positioning/offset utilities are skipped so PDS primitives and layout utilities control placement."}],intentRules:[{id:"intent.layout.responsive-grid-to-auto",summary:"Collapse responsive grid-cols patterns (including base+md two-step patterns) to best-fit grid-auto-*"},{id:"intent.layout.mobile-stack",summary:"Map flex-col + md/lg:flex-row to mobile-stack"},{id:"intent.component.card",summary:"Infer card/surface classes from rounded+shadow+surface signals"},{id:"intent.component.card.normalize",summary:"Detect Tailwind card utility clusters and normalize them to PDS card and surface variants."},{id:"intent.component.button",summary:"Infer btn-primary / btn-outline / icon-only from CTA patterns"},{id:"intent.component.button.normalize",summary:"Prevents import-* style classes on button-like elements and applies PDS button variants/sizes."},{id:"intent.component.button.layout-grow",summary:"Preserve CTA row width intent on button-like elements by mapping w-full/flex-1 to grow."},{id:"intent.icon.color-preserve",summary:"Preserve icon color intent by mapping Tailwind text color utilities on icon-like elements to tokenized import-* classes."},{id:"intent.component.badge.normalize",summary:"Detects Tailwind badge/pill utility clusters and normalizes them to PDS badge primitives/variants."},{id:"intent.typography.heading-semantic",summary:"Removes Tailwind heading typography/color utilities so heading semantics and PDS defaults control typography."},{id:"intent.surface.footer-inverse",summary:"Use surface-inverse for footers with explicit background intent"},{id:"intent.typography.link-treatment",summary:"Apply minimal link treatment for hover/transition-tailwind anchors"},{id:"intent.typography.link-active-preserve",summary:"Preserve anchor text color intent (including active menu states) by mapping Tailwind text utilities to tokenized import-* classes."},{id:"intent.typography.metric-paragraph-to-div",summary:"Normalize metric display lines from paragraph tags to div tags to avoid default paragraph margins in compact stat layouts."},{id:"intent.typography.metric-pair-no-stack",summary:"When a compact metric container has two consecutive typography lines, remove stack-sm so spacing follows Tailwind preflight no-margin assumptions."},{id:"intent.typography.semantic-heading-from-scale",summary:"Map large bold typography scales (text-2xl/text-3xl/text-4xl) to semantic heading tags when possible."},{id:"intent.typography.bold-to-strong",summary:"Prefer semantic strong tags for bold inline text intent instead of utility-only font-weight classes."},{id:"intent.preflight.tailwind-runtime-detected",summary:"Detect Tailwind runtime CSS injection and translate key preflight intent"},{id:"intent.preflight.list-reset",summary:"Preserve Tailwind list-reset preflight behavior via scoped fallback class"},{id:"intent.preflight.anchor-reset",summary:"Preserve Tailwind anchor reset preflight behavior via scoped fallback class"},{id:"table.strict-tags.no-classes",summary:"Never emit classes for semantic table tags (table/thead/tbody/tfoot/tr/th/td/caption/colgroup/col)"},{id:"intent.form.nested-label",summary:"Convert sibling label+control pairs into nested labels"},{id:"fallback.import-style",summary:"Generate import-* classes + local style block for unmapped utility styles"}],gapScaleMap:{"gap-0":"gap-0","gap-1":"gap-xs","gap-2":"gap-sm","gap-3":"gap-sm","gap-4":"gap-md","gap-5":"gap-md","gap-6":"gap-lg","gap-7":"gap-lg","gap-8":"gap-xl","gap-10":"gap-xl","gap-12":"gap-xl"},maxWidthMap:{"max-w-xs":"max-w-sm","max-w-sm":"max-w-sm","max-w-md":"max-w-md","max-w-lg":"max-w-lg","max-w-xl":"max-w-xl","max-w-2xl":"max-w-xl","max-w-3xl":"max-w-xl","max-w-4xl":"max-w-xl","max-w-5xl":"max-w-xl","max-w-6xl":"max-w-xl","max-w-7xl":"max-w-xl"},tailwindSizeScale:{"0":"var(--spacing-0)","0.5":"0.125rem","1":"var(--spacing-1)","1.5":"0.375rem","2":"var(--spacing-2)","2.5":"0.625rem","3":"var(--spacing-3)","3.5":"0.875rem","4":"var(--spacing-4)","5":"var(--spacing-5)","6":"var(--spacing-6)","7":"var(--spacing-7)","8":"var(--spacing-8)","9":"var(--spacing-9)","10":"var(--spacing-10)","11":"var(--spacing-11)","12":"var(--spacing-12)","14":"3.5rem","16":"4rem","20":"5rem","24":"6rem","28":"7rem","32":"8rem","36":"9rem","40":"10rem","48":"12rem"},tailwindShadeScale:["50","100","200","300","400","500","600","700","800","900"],defaultTailwindShade:"500",importStyleRules:{"mx-auto":"margin-left:auto;margin-right:auto","ml-auto":"margin-left:auto","mr-auto":"margin-right:auto","w-full":"width:100%","w-auto":"width:auto","h-full":"height:100%","h-48":"height:12rem","h-2.5":"height:0.625rem","h-10":"height:var(--spacing-10)","h-2":"height:var(--spacing-2)","w-2":"width:var(--spacing-2)","size-8":"width:var(--spacing-8);height:var(--spacing-8)","size-10":"width:var(--spacing-10);height:var(--spacing-10)","size-full":"width:100%;height:100%","min-h-screen":"min-height:100vh","overflow-hidden":"overflow:hidden","overflow-x-hidden":"overflow-x:hidden","overflow-x-auto":"overflow-x:auto","whitespace-nowrap":"white-space:nowrap",hidden:"display:none",block:"display:block",truncate:"overflow:hidden;text-overflow:ellipsis;white-space:nowrap","justify-items-center":"justify-items:center","justify-items-start":"justify-items:start","justify-items-end":"justify-items:end","justify-items-stretch":"justify-items:stretch","grid-flow-col":"grid-auto-flow:column","aspect-square":"aspect-ratio:1 / 1","bg-center":"background-position:center","bg-cover":"background-size:cover","bg-no-repeat":"background-repeat:no-repeat","transition-colors":"transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-duration:150ms"},importStyleDynamicRules:[{id:"fallback.import-style.gap-scale",pattern:"^gap-(\\d+)$",summary:"Converts gap scale utilities (including responsive variants like md:gap-6) to generated import-* fallback classes."},{id:"fallback.import-style.min-width-arbitrary",pattern:"^min-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-width utilities (e.g. min-w-[600px]) to generated import-* fallback classes."},{id:"fallback.import-style.max-width-arbitrary",pattern:"^max-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary max-width utilities (e.g. max-w-[480px]) to generated import-* fallback classes."},{id:"fallback.import-style.min-height-arbitrary",pattern:"^min-h-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-height utilities (e.g. min-h-[180px]) to generated import-* fallback classes."},{id:"fallback.import-style.grid-rows-arbitrary",pattern:"^grid-rows-\\[[^\\]]+\\]$",summary:"Converts arbitrary grid template row utilities (e.g. grid-rows-[1fr_auto]) to generated import-* fallback classes."},{id:"fallback.import-style.size-scale",pattern:"^size-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts size scale/arbitrary utilities into width+height fallback declarations."},{id:"fallback.import-style.width-height-scale",pattern:"^[wh]-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts width/height scale and arbitrary utilities to import-* classes."},{id:"fallback.import-style.spacing",pattern:"^-?(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-(.+)$",summary:"Converts spacing utilities to directional padding/margin fallback declarations, including responsive variants."},{id:"fallback.import-style.text-size",pattern:"^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$",summary:"Converts common text size utilities to import-* font-size declarations."},{id:"fallback.import-style.font-weight",pattern:"^font-(normal|medium|semibold|bold|extrabold|black)$",summary:"Converts common font weight utilities to import-* font-weight declarations."},{id:"fallback.import-style.leading-tracking",pattern:"^(leading|tracking)-(none|tight|snug|normal|relaxed|loose|tighter|wide|wider|widest)$",summary:"Converts line-height and letter-spacing utilities to import-* declarations for typography fidelity."},{id:"fallback.import-style.bg-tokenized",pattern:"^bg-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind background color utilities by mapping families like blue/purple/green/red to PDS semantic tokens."},{id:"fallback.import-style.bg-semantic",pattern:"^bg-(primary|secondary|accent)$",summary:"Safeguards semantic background utilities by mapping bg-primary/bg-secondary/bg-accent to PDS color tokens."},{id:"fallback.import-style.text-tokenized",pattern:"^text-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind text color utilities by mapping common families to PDS semantic tokens."},{id:"fallback.import-style.rounded",pattern:"^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$",summary:"Safeguards rounded utilities (including rounded-t-sm) by mapping to PDS radius tokens."},{id:"fallback.import-style.overlay-alpha",pattern:"^bg-black\\/(\\d{1,3})$",summary:"Converts alpha black overlay classes (e.g. bg-black/50) to tokenized color-mix background overlays."},{id:"fallback.import-style.text-inverse",pattern:"^text-white$",summary:"Preserves white foreground intent for text-on-image use cases using inverse-compatible tokens."},{id:"fallback.import-style.bg-arbitrary",pattern:"^bg-\\[[^\\]]+\\]$",summary:"Converts arbitrary background colors to import-* fallback classes when values are CSS-safe."},{id:"fallback.import-style.text-arbitrary",pattern:"^text-\\[[^\\]]+\\]$",summary:"Converts arbitrary text colors to import-* fallback classes when values are CSS-safe."}]};Ce();Lt();var jt=class extends EventTarget{},Ar="__PURE_DS_PDS_SINGLETON__",Bt=typeof globalThis<"u"?globalThis:window,Nt=Bt?.[Ar],M=Nt&&typeof Nt.addEventListener=="function"?Nt:new jt;Bt&&(Bt[Ar]=M);typeof M.initializing!="boolean"&&(M.initializing=!1);"currentPreset"in M||(M.currentPreset=null);typeof M.debug!="boolean"&&(M.debug=!1);"currentConfig"in M||(M.currentConfig=null);"compiled"in M||(M.compiled=null);var et=null,tt=null,rt=null,nt=null;function ot(t,e){return e&&typeof e=="string"?e:`${be(M.currentConfig||{},{resolvePublicAssetURL:me})}core/${t}`}async function so(){return Array.isArray(M.defaultEnhancers)&&M.defaultEnhancers.length>0?M.defaultEnhancers:(nt||(nt=import(ot("pds-enhancers.js",M.currentConfig?.enhancersURL)).then(e=>{let r=Array.isArray(e?.defaultPDSEnhancers)?e.defaultPDSEnhancers:[];return M.defaultEnhancers=r,r}).catch(e=>{throw nt=null,e})),nt)}async function lo(){return typeof M.ask=="function"&&M.ask!==Lr?M.ask:(tt||(tt=import(ot("pds-ask.js",M.currentConfig?.askURL)).then(e=>{let r=e?.ask;if(typeof r!="function")throw new Error("Failed to load ask helper");return M.ask=r,r}).catch(e=>{throw tt=null,e})),tt)}async function Pe(){return typeof M.toast=="function"&&M.toast!==ve?M.toast:(rt||(rt=import(ot("pds-toast.js",M.currentConfig?.toastURL)).then(e=>{let r=e?.toast;if(typeof r!="function")throw new Error("Failed to load toast helper");return M.toast=r,r}).catch(e=>{throw rt=null,e})),rt)}async function Lr(...t){return(await lo())(...t)}async function ve(...t){return(await Pe())(...t)}ve.success=async(...t)=>(await Pe()).success(...t);ve.error=async(...t)=>(await Pe()).error(...t);ve.warning=async(...t)=>(await Pe()).warning(...t);ve.info=async(...t)=>(await Pe()).info(...t);var Tr=function(t="log",e,...r){let n=!!(M.registry&&!M.registry.isLive),o=(this?.debug||this?.design?.debug||M.debug||!1)===!0;if(n){if(!M.debug)return}else if(!o&&t!=="error"&&t!=="warn")return;let a=console[t]||console.log;r.length>0?a(e,...r):a(e)};function _t(t){if(t==null)return t;if(typeof t=="function")return;if(typeof t!="object")return t;if(Array.isArray(t))return t.map(r=>_t(r)).filter(r=>r!==void 0);let e={};for(let[r,n]of Object.entries(t)){let o=_t(n);o!==void 0&&(e[r]=o)}return e}function Rr(t,e=new WeakSet){if(!t||typeof t!="object"||e.has(t))return t;e.add(t),Object.freeze(t);for(let r of Object.keys(t))Rr(t[r],e);return t}function Ot(t){return t==null||typeof t!="object"?t:Rr(structuredClone(_t(t)))}async function co(t,e={}){if(e?.runtimeConfig===!1||typeof fetch!="function")return null;let r=e?.runtimeConfigURL||`${t}pds-runtime-config.json`;try{let n=await fetch(r,{cache:"no-store"});return n.ok?await n.json():null}catch{return null}}M.registry=ge;M.enums=v;M.adoptLayers=De;M.adoptPrimitives=Oe;M.parse=At;M.createStylesheet=dr;M.isLiveMode=()=>ge.isLive;M.ask=Lr;M.toast=ve;M.common=Ye;M.AutoComplete=null;M.loadAutoComplete=async()=>{if(M.AutoComplete&&typeof M.AutoComplete.connect=="function")return M.AutoComplete;let t=ot("pds-autocomplete.js",M.currentConfig?.autoCompleteURL);return et||(et=import(t).then(e=>{let r=e?.AutoComplete||e?.default?.AutoComplete||e?.default||null;if(!r)throw new Error("AutoComplete export not found in module");return M.AutoComplete=r,r}).catch(e=>{throw et=null,e})),et};function Fr(t){let e=typeof CustomEvent=="function";try{let r=e?new CustomEvent("pds:ready",{detail:t}):new Event("pds:ready");M.dispatchEvent(r)}catch{}if(typeof document<"u")if(e){let r={detail:t,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:ready",r))}catch{}try{document.dispatchEvent(new CustomEvent("pds-ready",r))}catch{}}else{try{document.dispatchEvent(new Event("pds:ready"))}catch{}try{document.dispatchEvent(new Event("pds-ready"))}catch{}}}function Pr(t={}){let e=typeof CustomEvent=="function",r={at:Date.now(),...t};try{let n=e?new CustomEvent("pds:config-changed",{detail:r}):new Event("pds:config-changed");M.dispatchEvent(n)}catch{}if(typeof document<"u")if(e){let n={detail:r,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:config-changed",n))}catch{}}else try{document.dispatchEvent(new Event("pds:config-changed"))}catch{}}var It="pure-ds-theme",le=null,Fe=null;function Dt(t){try{if(typeof document>"u")return;let e="light";t?t==="system"?e=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e=t:e=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",document.documentElement.setAttribute("data-theme",e)}catch{}}function Wt(t){try{if(le&&Fe){try{typeof le.removeEventListener=="function"?le.removeEventListener("change",Fe):typeof le.removeListener=="function"&&le.removeListener(Fe)}catch{}le=null,Fe=null}if(t==="system"&&typeof window<"u"&&window.matchMedia){let e=window.matchMedia("(prefers-color-scheme: dark)"),r=n=>{let o=n?.matches===void 0?e.matches:n.matches;try{let a=o?"dark":"light";document.documentElement.setAttribute("data-theme",a),M.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:a,source:"system"}}))}catch{}};le=e,Fe=r,typeof e.addEventListener=="function"?e.addEventListener("change",r):typeof e.addListener=="function"&&e.addListener(r)}}catch{}}var po=Object.getOwnPropertyDescriptor(M,"theme");po||Object.defineProperty(M,"theme",{get(){try{return typeof window>"u"?null:localStorage.getItem(It)||null}catch{return null}},set(t){try{if(typeof window>"u")return;let e=M.currentConfig?.design||null,r=ye(t);if(e&&!se(e,r)){let n=e?.name||M.currentPreset?.name||M.currentConfig?.preset||"current preset";console.warn(`PDS theme "${r}" not supported by preset "${n}".`),M.dispatchEvent(new CustomEvent("pds:theme:blocked",{detail:{theme:t,resolvedTheme:r,preset:n}}));return}t==null?localStorage.removeItem(It):localStorage.setItem(It,t),Dt(t),Wt(t),M.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:t,source:"api"}}))}catch{}}});M.defaultEnhancers=[];async function uo(t){M.initializing=!0;try{let e=t&&t.mode||"live",{mode:r,...n}=t||{};M.currentConfig=Ot(n);let o;if(e==="static")o=await go(n);else{let i=be(n,{resolvePublicAssetURL:me}),s=n?.managerURL||n?.public?.managerURL||n?.manager?.url||new URL("core/pds-manager.js",i).href||new URL("./pds-manager.js",import.meta.url).href,{startLive:p}=await import(s);o=await p(M,n,{emitReady:Fr,emitConfigChanged:Pr,applyResolvedTheme:Dt,setupSystemListenerIfNeeded:Wt})}M.compiled=Ot(o?.config||null);let a=M?.compiled?.design?.icons?.externalPath||"/assets/img/icons/";return typeof console<"u"&&typeof console.info=="function"&&console.info(`[PDS] startup ready; external icon path: ${a}`),o}finally{M.initializing=!1}}M.start=uo;async function go(t){if(!t||typeof t!="object")throw new Error("PDS.start({ mode: 'static', ... }) requires a valid configuration object");let e=t.applyGlobalStyles??!0,r=t.manageTheme??!0,n=t.themeStorageKey??"pure-ds-theme",o=t.staticPaths??{},a=be(t,{resolvePublicAssetURL:me}),i=t&&t.autoDefine||null,s;i&&i.baseURL?s=fe(he(i.baseURL,{preferModule:!1})):s=`${a}components/`;let p=i&&Array.isArray(i.predefine)&&i.predefine||[],d=i&&typeof i.mapper=="function"&&i.mapper||null;try{Ue(M);let{resolvedTheme:c}=qe({manageTheme:r,themeStorageKey:n,applyResolvedTheme:Dt,setupSystemListenerIfNeeded:Wt}),l=await co(a,t),u=Array.isArray(t?.enhancers)?t.enhancers:t?.enhancers&&typeof t.enhancers=="object"?Object.values(t.enhancers):[],g=l?.config?{...l.config,...t,design:t?.design||l.config.design,preset:t?.preset||l.config.preset}:{...t},m={tokens:`${a}styles/pds-tokens.css.js`,primitives:`${a}styles/pds-primitives.css.js`,components:`${a}styles/pds-components.css.js`,utilities:`${a}styles/pds-utilities.css.js`,styles:`${a}styles/pds-styles.css.js`},y=l?.paths||{};if(o={...m,...y,...o},M.registry.setStaticMode(o),e&&typeof document<"u")try{let w=await M.registry.getStylesheet("styles");if(w){w._pds=!0;let x=(document.adoptedStyleSheets||[]).filter(S=>S._pds!==!0);document.adoptedStyleSheets=[...x,w],Pr({mode:"static",source:"static:styles-applied"})}}catch(w){Tr.call(M,"warn","Failed to apply static styles:",w)}let f=null,h=[];try{let w=await so(),x=await Ge({autoDefineBaseURL:s,autoDefinePreload:p,autoDefineMapper:d,enhancers:u,autoDefineOverrides:i||null,autoDefinePreferModule:!(i&&i.baseURL)},{baseEnhancers:w});f=x.autoDefiner,h=x.mergedEnhancers||[]}catch(w){Tr.call(M,"error","\u274C Failed to initialize AutoDefiner/Enhancers (static):",w)}return M.compiled=Ot({mode:"static",...g,theme:c,enhancers:h}),Fr({mode:"static",config:g,theme:c,autoDefiner:f}),{config:g,theme:c,autoDefiner:f}}catch(c){throw M.dispatchEvent(new CustomEvent("pds:error",{detail:{error:c}})),c}}var mo="src/js/pds-live-manager/tailwind-conversion-rules.json",st=["base","sm","md","lg","xl","2xl"];function fo(t={}){let e=Array.isArray(t.ignoredPatterns)?t.ignoredPatterns.map(n=>({...n,pattern:n?.pattern instanceof RegExp?n.pattern:new RegExp(String(n?.pattern||""))})):[],r=Array.isArray(t.nonPdsClassPatterns)?t.nonPdsClassPatterns.map(n=>n instanceof RegExp?n:new RegExp(String(n||""))):[];return{...t,ignoredPatterns:e,nonPdsClassPatterns:r}}var U=fo(Er),Nr=U.version||"tw2pds-layout-v4",ho=new Map(U.directMappings.map(t=>[t.tw,t])),Ht=new Map(Object.entries(U.gapScaleMap||{})),Ir=new Map(Object.entries(U.maxWidthMap||{})),bo=U.nonPdsClassPatterns||[],yo=new Set(U.neverFallbackTags||[]),vo={...U.importStyleRules||{}},xo=U.tailwindSizeScale||{},Ut=Array.isArray(U.tailwindShadeScale)?U.tailwindShadeScale.map(t=>String(t)).filter(Boolean):["50","100","200","300","400","500","600","700","800","900"],jr=Ut.includes(String(U.defaultTailwindShade||""))?String(U.defaultTailwindShade):"500",it=1.2,wo=["container","grid","flex","gap","space","items","justify","content","place","self","col","row","w","h","min","max","p","m","rounded","border","ring","outline","shadow","bg","text","font","leading","tracking","uppercase","lowercase","capitalize","overflow","whitespace","truncate","object","aspect","opacity","blur","backdrop","transition","duration","ease","delay","animate","hidden","block","inline","absolute","relative","fixed","sticky","size"];function Br(t="",e=""){if(!t||!e)return t;let r=new RegExp(`\\s${e}\\s*=\\s*("[^"]*"|'[^']*'|[^\\s>]+)`,"gi");return String(t).replace(r,"")}function ko(t="",e=null){let r=String(t||""),n=0;return r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(input)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*?)>/gi,(o,a,i,s,p,d,c,l,u,g,m)=>{if(s!==g)return o;let y=Br(`${a||""}${p||""}`,"for"),f=`<${c}${l||""} id="${g}"${m||""}>`;return n+=1,`<label${y}>${d}${f}</label>`}),r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(select|textarea)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*)>([\s\S]*?)<\/\6>/gi,(o,a,i,s,p,d,c,l,u,g,m,y)=>{if(s!==g)return o;let f=Br(`${a||""}${p||""}`,"for"),h=`<${c}${l||""} id="${g}"${m||""}>${y}</${c}>`;return n+=1,`<label${f}>${d}${h}</label>`}),e&&n>0&&(e.labelNestingCount+=n,j(e,`Nested ${n} label/control pairs.`),R(e,"intent.form.nested-label")),r}function So(t="",e="base"){let r=String(t||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rule";return`import-${e&&e!=="base"?`${e}-`:""}${r}`}function ce(t,e,r,n="base",o=""){if(!t||!e||!r)return"";let a=So(e,n);if(o){let i=`${n}|${o}`;t.importPseudoStyles.has(i)||t.importPseudoStyles.set(i,new Map),t.importPseudoStyles.get(i).set(a,r)}else n==="base"?t.importBaseStyles.set(a,r):(t.importResponsiveStyles.has(n)||t.importResponsiveStyles.set(n,new Map),t.importResponsiveStyles.get(n).set(a,r));return t.importedStyleCount+=1,a}function we(t=""){return String(t||"").trim().replace(/_/g," ")}function ke(t=""){return!t||/[;{}]/.test(t)?!1:/^[-#(),.%/\sa-zA-Z0-9]+$/.test(t)}function Ne(t=""){let e=String(t||"").trim();if(!e)return null;let r=e.match(/^\[([^\]]+)\]$/);if(r){let n=we(r[1]);return ke(n)?n:null}return xo[e]||null}function $o(t=""){let e=Number(t);if(!Number.isFinite(e))return jr;let r=String(e);return Ut.includes(r)?r:Ut.reduce((n,o)=>{let a=Math.abs(Number(n)-e);return Math.abs(Number(o)-e)<a?o:n},jr)}function je(t="",e="500"){let r=String(t||"").toLowerCase(),n=$o(e);return["blue","sky","indigo","cyan"].includes(r)?`var(--color-primary-${n})`:["purple","violet","fuchsia"].includes(r)?`var(--color-accent-${n})`:["green","emerald","lime","teal"].includes(r)?`var(--color-success-${n})`:["yellow","amber","warning"].includes(r)?`var(--color-warning-${n})`:["red","rose","pink","orange"].includes(r)?`var(--color-danger-${n})`:["slate","gray","zinc","neutral","stone"].includes(r)?`var(--color-gray-${n})`:""}function _r(t=""){let e=we(t);return ke(e)&&(/^#(?:[0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(e)||/^(?:rgb|hsl)a?\([^)]*\)$/.test(e))?e:""}function te(t=""){return String(t||"").split(/\s+/).map(e=>e.trim()).filter(Boolean)}function Co(t="",e=""){if(!e)return t;let r=String(t||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return`${r} class="${e}"`;let o=n[1]||'"',a=te(n[2]);a.includes(e)||a.push(e);let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function zo(t="",e=""){return e?new RegExp(`\\s${e}\\s*=`,"i").test(String(t||"")):!1}function Mo(t=""){let e=String(t||"").replace(/[-_]+/g," ").trim();return e?e.replace(/(^|\s)([a-z])/g,(r,n,o)=>`${n}${o.toUpperCase()}`):"Icon button"}function Eo(t="",e=null){let r=String(t||"");return r&&r.replace(/<(button|a)([^>]*)>\s*(<pds-icon\b[^>]*><\/pds-icon>)\s*<\/\1>/gi,(n,o,a,i)=>{let s=Co(a,"icon-only");if(!zo(s,"aria-label")){let p=String(i).match(/\sicon\s*=\s*(["'])(.*?)\1/i),d=p?String(p[2]||""):"",c=Mo(d);s+=` aria-label="${c}"`}return e&&(e.intentHits+=1,R(e,"intent.component.button.icon-only-markup")),`<${o}${s}>${i}</${o}>`})}function To(t="",e=null){let r=String(t||"");if(!r)return r;let n=0,o=r.replace(/<p([^>]*?)>([\s\S]*?)<\/p>/gi,(a,i,s)=>{let p=String(i||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!p)return a;let d=te(p[2]||""),c=d.some(u=>/^import-text-/.test(String(u||""))),l=d.includes("text-muted")||d.some(u=>/^import-font-/.test(String(u||"")));return!c||!l?a:(n+=1,`<div${i}>${s}</div>`)});return e&&n>0&&(e.intentHits+=1,R(e,"intent.typography.metric-paragraph-to-div"),j(e,`Normalized ${n} metric text paragraph tag(s) to div.`)),o}function Gr(t="",e=""){if(!e)return t;let r=String(t||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=te(n[2]).filter(s=>s!==e);if(a.length===0)return r.replace(n[0],"");let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function Ao(t="",e=r=>r){let r=String(t||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=te(n[2]),i=e(Array.from(a)),s=Array.isArray(i)?i.filter(Boolean):a;if(s.length===0)return r.replace(n[0],"");let p=` class=${o}${s.join(" ")}${o}`;return r.replace(n[0],p)}function Lo(t="",e=null){let r=String(t||"");if(!r)return r;let n=0,o=r.replace(/<(div|section|article|aside)([^>]*)>\s*<(p|div)([^>]*)>[\s\S]*?<\/\3>\s*<(p|div)([^>]*)>[\s\S]*?<\/\5>\s*<\/\1>/gi,(a,i,s,p,d,c,l)=>{let u=String(s||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!u||!te(u[2]).includes("stack-sm"))return a;let m=String(d||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i),y=String(l||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!m||!y)return a;let f=te(m[2]),h=te(y[2]);if(!(f.some(S=>/^import-text-/.test(String(S||"")))&&h.some(S=>/^import-text-/.test(String(S||"")))))return a;let x=Gr(s,"stack-sm");return n+=1,a.replace(`<${i}${s}>`,`<${i}${x}>`)});return e&&n>0&&(e.intentHits+=1,R(e,"intent.typography.metric-pair-no-stack"),j(e,`Removed stack-sm from ${n} metric text pair container(s).`)),o}function Ro(t={}){if(!t||typeof t!="object")return{};let e=t.typography;if(e&&typeof e=="object")return e;let r=t.design?.typography;return r&&typeof r=="object"?r:{}}function Fo(t={}){let e=Ro(t),r=Number(e.fontScale);return Number.isFinite(r)?Math.max(1,Math.min(2,r)):it}function Po(t="",e=it){let n={"4xl":1,"3xl":2,"2xl":3,xl:4}[t];if(!n)return"";let o=Number.isFinite(Number(e))?Math.max(1,Math.min(2,Number(e))):it,a=Math.max(-1,Math.min(1,Math.round((o-it)/.25))),i=n-a;return i<1?"h1":i>4?"":`h${i}`}function No(t="",e=null,r={}){let n=String(t||"");if(!n)return n;let o=Fo(r.config||{}),a=0,i=0,s=n.replace(/<(p|div|span)([^>]*)>([\s\S]*?)<\/\1>/gi,(p,d,c,l)=>{let u=String(c||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!u)return p;let g=te(u[2]);if(!g.includes("import-font-bold"))return p;let y=g.find(S=>/^import-text-(?:4xl|3xl|2xl|xl)$/.test(String(S||"")))||"",f=y.match(/^import-text-(4xl|3xl|2xl|xl)$/);if(f){let S=Po(f[1],o);if(!S)return p;let A=Ao(c,L=>L.filter(F=>F!=="import-font-bold"&&F!==y));return a+=1,`<${S}${A}>${l}</${S}>`}let h=/<\/?(?:div|p|section|article|aside|main|header|footer|ul|ol|li|table|tr|td|th|h[1-6])\b/i.test(l),w=/<\/?(?:strong|b)\b/i.test(l);if(h||w)return p;let x=Gr(c,"import-font-bold");return i+=1,`<${d}${x}><strong>${l}</strong></${d}>`});return e&&(a>0&&(e.intentHits+=1,R(e,"intent.typography.semantic-heading-from-scale"),j(e,`Converted ${a} bold display text node(s) to semantic heading tags (fontScale=${Number(o).toFixed(2)}).`)),i>0&&(e.intentHits+=1,R(e,"intent.typography.bold-to-strong"),j(e,`Wrapped ${i} bold text node(s) in strong tags.`))),s}function Io(t=[]){if(!Array.isArray(t)||t.length===0)return"";let e=t.filter(n=>!st.includes(n));if(e.length===0||e.length>1)return"";let r=e[0];return["hover","focus","active"].includes(r)?r:""}function Or(t,e="base",r=[]){let n=Io(r),o=vo[t];if(o)return{declaration:o,breakpoint:e,pseudo:n,ruleId:"fallback.import-style"};let a=String(t).match(/^gap-(\d+)$/);if(a){let b={0:"var(--spacing-0)",1:"var(--spacing-1)",2:"var(--spacing-2)",3:"var(--spacing-3)",4:"var(--spacing-4)",5:"var(--spacing-5)",6:"var(--spacing-6)",7:"var(--spacing-7)",8:"var(--spacing-8)",10:"var(--spacing-10)",12:"var(--spacing-12)"},k=Number(a[1]);if(b[k])return{declaration:`gap:${b[k]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.gap-scale"}}let i=String(t).match(/^(mt|mb|my)-(.+)$/);if(i){let b=i[1],k=i[2],E=Ne(k);if(E){let T="";return b==="mt"?T=`margin-top:${E}`:b==="mb"?T=`margin-bottom:${E}`:T=`margin-top:${E};margin-bottom:${E}`,{declaration:T,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.margin-scale"}}}let s=String(t).match(/^min-w-\[([^\]]+)\]$/);if(s){let b=we(s[1]);if(ke(b))return{declaration:`min-width:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.min-width-arbitrary"}}let p=String(t).match(/^max-w-\[([^\]]+)\]$/);if(p){let b=we(p[1]);if(ke(b))return{declaration:`max-width:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.max-width-arbitrary"}}let d=String(t).match(/^min-h-\[([^\]]+)\]$/);if(d){let b=we(d[1]);if(ke(b))return{declaration:`min-height:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.min-height-arbitrary"}}let c=String(t).match(/^grid-rows-\[([^\]]+)\]$/);if(c){let b=we(c[1]);if(ke(b))return{declaration:`grid-template-rows:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.grid-rows-arbitrary"}}let l=String(t).match(/^size-(.+)$/);if(l){let b=Ne(l[1]);if(b)return{declaration:`width:${b};height:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.size-scale"}}let u=String(t).match(/^w-(.+)$/);if(u){let b=Ne(u[1]);if(b)return{declaration:`width:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.width-scale"}}let g=String(t).match(/^h-(.+)$/);if(g){let b=Ne(g[1]);if(b)return{declaration:`height:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.height-scale"}}let m={xs:"var(--font-size-xs)",sm:"var(--font-size-sm)",base:"var(--font-size-md)",lg:"var(--font-size-lg)",xl:"var(--font-size-xl)","2xl":"var(--font-size-2xl)","3xl":"var(--font-size-3xl)","4xl":"var(--font-size-4xl)"},y=String(t).match(/^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$/);if(y)return{declaration:`font-size:${m[y[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-size"};let f={normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},h=String(t).match(/^font-(normal|medium|semibold|bold|extrabold|black)$/);if(h)return{declaration:`font-weight:${f[h[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.font-weight"};let w={none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"},x=String(t).match(/^leading-(none|tight|snug|normal|relaxed|loose)$/);if(x)return{declaration:`line-height:${w[x[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.line-height"};let S={tighter:"-0.05em",tight:"-0.025em",normal:"0em",wide:"0.025em",wider:"0.05em",widest:"0.1em"},A=String(t).match(/^tracking-(tighter|tight|normal|wide|wider|widest)$/);if(A)return{declaration:`letter-spacing:${S[A[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.tracking"};let L=String(t).match(/^bg-black\/(\d{1,3})$/);if(L)return{declaration:`background-color:color-mix(in srgb, var(--color-gray-900) ${Math.max(0,Math.min(100,Number(L[1])))}%, transparent)`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.overlay-alpha"};if(t==="text-white")return{declaration:"color:var(--color-gray-50)",breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-inverse"};let F=String(t).match(/^bg-(primary|secondary|accent)$/);if(F){let k={primary:"var(--color-primary-fill)",secondary:"var(--color-gray-500)",accent:"var(--color-accent-500)"}[F[1]];if(k)return{declaration:`background-color:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.bg-semantic"}}let I=String(t).match(/^bg-([a-z]+)-(\d{2,3})$/);if(I){let b=je(I[1],I[2]);if(b)return{declaration:`background-color:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.bg-tokenized"}}let $=String(t).match(/^bg-\[([^\]]+)\]$/);if($){let b=_r($[1]);if(b)return{declaration:`background-color:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.bg-arbitrary"}}let z=String(t).match(/^text-([a-z]+)-(\d{2,3})$/);if(z){let b=je(z[1],z[2]);if(b)return{declaration:`color:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-tokenized"}}let P=String(t).match(/^text-\[([^\]]+)\]$/);if(P){let b=_r(P[1]);if(b)return{declaration:`color:${b}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-arbitrary"}}let C=String(t).match(/^rounded(?:-([trbl]{1,2}))?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(C){let b=C[1]||"",k=C[2]||"sm",E=k==="none"?"0":`var(--radius-${k})`,T={t:["top-left","top-right"],b:["bottom-left","bottom-right"],l:["top-left","bottom-left"],r:["top-right","bottom-right"],tl:["top-left"],tr:["top-right"],bl:["bottom-left"],br:["bottom-right"]};if(!b)return{declaration:`border-radius:${E}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.rounded"};let W=(T[b]||[]).map(V=>`border-${V}-radius:${E}`).join(";");if(W)return{declaration:W,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.rounded"}}return null}function at(t,e){return typeof t=="number"&&Number.isFinite(t)?`${t}px`:typeof t=="string"&&t.trim()?t.trim():`${e}px`}function jo(t={}){let r=(t?.design&&typeof t.design=="object"?t.design:t)?.layout?.breakpoints||{};return{sm:at(r.sm,640),md:at(r.md,768),lg:at(r.lg,1024),xl:at(r.xl,1280)}}function Bo(t,e){let r=Array.from(t.importBaseStyles.entries()).map(([a,i])=>`.${a}{${i};}`),n=[];for(let[a,i]of t.importResponsiveStyles.entries()){let s=e?.[a];if(!s||!i?.size)continue;let p=Array.from(i.entries()).map(([d,c])=>`.${d}{${c};}`).join(`
...
`):""}function _o(t="",e=""){if(!e||!e.trim())return t;let r=`<style data-pds-import="tailwind-fallback">
${e}
</style>`;return/<head[^>]*>/i.test(t)?t.replace(/<head([^>]*)>/i,`<head$1>
${r}`):`${r}
${t}`}function Dr(t=""){if(!t)return!1;if(t.includes(":")||t.includes("["))return!0;let e=t.split("-")[0];return wo.includes(e)}function re(t=""){let e=String(t).split(":");if(e.length===1)return{breakpoint:"base",base:e[0],variants:[]};let r=e[e.length-1],n=e.slice(0,-1);return{breakpoint:n.find(a=>st.includes(a))||"base",base:r,variants:n}}function Oo(){return{totalTailwind:0,mapped:0,ignored:0,policySkipped:0,unknown:0,intentHits:0,unknownTokens:new Map,notes:[],appliedRules:new Set,importBaseStyles:new Map,importResponsiveStyles:new Map,importPseudoStyles:new Map,importedStyleCount:0,labelNestingCount:0,removedAtomicSpacingCount:0,removedAtomicPositioningCount:0}}function Do(t=""){let e=String(t||"").toLowerCase().replace(/\s+/g,""),r=e.includes("menu,ol,ul{list-style:none")||e.includes("ol,ul,menu{list-style:none")||e.includes("ul,ol,menu{list-style:none"),n=e.includes("a{color:inherit;text-decoration:inherit");return{listReset:r,anchorReset:n}}function Wo(t=""){return String(t||"").toLowerCase().includes("cdn.tailwindcss.com")?{listReset:!0,anchorReset:!0}:{listReset:!1,anchorReset:!1}}function Ho(t="",e=null){let r=String(t||""),n={listReset:!1,anchorReset:!1,strippedRuntimeCssBlocks:0,strippedRuntimeScripts:0};return r=r.replace(/<style([^>]*)>([\s\S]*?)<\/style>/gi,(o,a,i)=>{let s=String(i||"");if(!(/tailwindcss\s+v\d/i.test(s)||/\*\s*!\s*tailwindcss/i.test(s)))return o;let d=Do(s);return n.listReset=n.listReset||d.listReset,n.anchorReset=n.anchorReset||d.anchorReset,n.strippedRuntimeCssBlocks+=1,""}),r=r.replace(/<script([^>]*?)src\s*=\s*(?:(['"])([^"']*cdn\.tailwindcss\.com[^"']*)\2|([^\s>]*cdn\.tailwindcss\.com[^\s>]*))([^>]*)><\/script>/gi,(o,a,i,s,p)=>{let c=Wo(s||p||"");return n.listReset=n.listReset||c.listReset,n.anchorReset=n.anchorReset||c.anchorReset,n.strippedRuntimeScripts+=1,""}),e&&(n.strippedRuntimeCssBlocks>0||n.strippedRuntimeScripts>0)&&(R(e,"intent.preflight.tailwind-runtime-detected"),n.strippedRuntimeCssBlocks>0&&j(e,`Detected and stripped ${n.strippedRuntimeCssBlocks} Tailwind runtime style block(s).`)),e&&n.strippedRuntimeScripts>0&&j(e,`Removed ${n.strippedRuntimeScripts} Tailwind CDN script reference(s).`),{html:r,hints:n}}function j(t,e){!t||!e||t.notes.includes(e)||t.notes.push(e)}function Uo(t,e){let r=t.unknownTokens.get(e)||0;t.unknownTokens.set(e,r+1)}function qo(t={}){let r=(t?.design&&typeof t.design=="object"?t.design:t)?.layout?.utilities||{};return{grid:r.grid!==!1,flex:r.flex!==!1,spacing:r.spacing!==!1,container:r.container!==!1}}function G(t,e){return e?t?.[e]!==!1:!0}function Wr(t){let e=String(t).match(/^grid-cols-(\d+)$/);return e?Number(e[1]):null}function Hr(t={}){let e=st.map(o=>({bp:o,cols:t[o]})).filter(o=>Number.isFinite(o.cols));if(e.length<2)return null;if(e.length===2){let[o,a]=e;if(o.bp==="base"&&o.cols===1&&a.cols===2)return"grid-auto-lg";if(o.bp==="base"&&o.cols===1&&a.cols>=3)return null;if(o.cols<a.cols){if(a.cols>=4)return"grid-auto-md";if(a.cols>=2)return"grid-auto-lg"}return null}let r=!0;for(let o=1;o<e.length;o+=1)if(e[o].cols<=e[o-1].cols){r=!1;break}if(!r)return null;let n=e[e.length-1]?.cols||0;return n>=4?"grid-auto-md":n>=3?"grid-auto-sm":null}function Go(t=""){let e=String(t).match(/^text-(gray|slate|zinc|neutral|stone)-(\d{2,3})$/);if(!e)return"";let r=Number(e[2]);return Number.isFinite(r)&&r>=400&&r<=600?"text-muted":""}function Vo(t="",e=0){return!t||!Number.isFinite(e)?"":{sm:{2:"sm:grid-cols-2"},md:{3:"md:grid-cols-3"},lg:{4:"lg:grid-cols-4"}}?.[t]?.[e]||""}function Yo(t=""){let e=re(t),n=String(e?.base||"").match(/^space-y-(\d+)$/);if(!n)return"stack-md";let o=Number(n[1]);return Number.isFinite(o)?o<=1?"stack-xs":o<=2?"stack-sm":o<=4?"stack-md":"stack-lg":"stack-md"}function Jo(t=new Set){return Array.from(t).some(e=>{let r=String(e||"");return/^gap-(?:xs|sm|md|lg|xl)$/.test(r)||/^gap-[0-9]+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?gap-/.test(r)})}function Ko(t=new Set){return Array.from(t).some(e=>/^stack-(?:xs|sm|md|lg|xl)$/.test(String(e||"")))}function Xo(t=new Set){return Array.from(t).some(e=>{let r=String(e||"");return/^grid-cols-\d+$/.test(r)||/^grid-auto-(?:sm|md|lg|xl)$/.test(r)||/^(?:sm|md|lg|xl):grid-cols-\d+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?grid-cols-\d+$/.test(r)})}function Zo(t,e=12){return Array.from(t.unknownTokens.entries()).sort((r,n)=>n[1]-r[1]).slice(0,e).map(([r])=>r)}function R(t,e){!t||!e||t.appliedRules.add(e)}function ne(t=[],e){return!Array.isArray(t)||!e?!1:t.some(r=>e.test(String(r)))}function Qo(t=[]){for(let e of t){let r=re(e);if(r.breakpoint!=="base")continue;let n=String(r.base).match(/^h-(.+)$/);if(!n)continue;let o=Ne(n[1]);if(!o||o==="auto")continue;let a=String(o).match(/^(-?\d+(?:\.\d+)?)rem$/);if(a){let i=Number(a[1]);if(Number.isFinite(i))return i*16}}return null}function ea(t=[],e=""){let r=e==="button",n=ne(t,/^bg-/),o=ne(t,/^hover:bg-/),a=ne(t,/^border/),i=ne(t,/^shadow/),s=t.includes("cursor-pointer"),p=ne(t,/^rounded/),d=ne(t,/^(?:min-w|max-w|w)-/),c=ne(t,/^text-(?:white|black|\[[^\]]+\]|[a-z]+-\d{2,3})$/),l=n||o||i;if(!(r||e==="a"&&(l||a||s||p&&d)))return{shouldNormalize:!1,variant:"none",size:"base",iconOnly:!1};let m="none";a&&!n&&!o?m="outline":(l||n&&c)&&(m="primary");let y=t.includes("rounded-full")&&(t.includes("p-2")||t.includes("p-1")||t.includes("p-2.5")),f=ne(t,/^size-(?:6|7|8|9|10|11|12)$/),h=y||f,w=Qo(t),x=t.includes("text-sm")||t.includes("text-xs"),S=t.includes("text-lg")||t.includes("text-xl"),A="base";return w&&w<=40||x?A="sm":(w&&w>=48||S)&&(A="lg"),{shouldNormalize:!0,variant:m,size:A,iconOnly:h}}function ta(t=""){let e=String(t||"").toLowerCase();return["green","emerald","lime","teal"].includes(e)?"badge-success":["blue","sky","cyan","indigo"].includes(e)?"badge-info":["yellow","amber","orange"].includes(e)?"badge-warning":["red","rose","pink"].includes(e)?"badge-danger":["gray","slate","zinc","neutral","stone"].includes(e)?"badge-secondary":["purple","violet","fuchsia","primary","accent"].includes(e)?"badge-primary":"badge-secondary"}function ra(t=[],e="",r={shouldNormalize:!1}){if(r?.shouldNormalize)return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(["button","a","input","select","textarea"].includes(e))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(t.some(z=>/^badge(?:-|$)/.test(String(z))))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let n=t.map(z=>re(z)).filter(z=>z.breakpoint==="base").map(z=>String(z.base)),o=n.some(z=>/^rounded(?:-|$)/.test(z)),a=n.some(z=>/^px-/.test(z)),i=n.some(z=>/^py-/.test(z)),s=a&&i,p=n.includes("text-xs")||n.includes("text-sm"),d=n.includes("text-lg")||n.includes("text-xl"),c=n.map(z=>z.match(/^bg-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),l=n.map(z=>z.match(/^text-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),u=n.map(z=>z.match(/^border-([a-z]+)-(\d{2,3})$/)).find(Boolean),g=Number(c?.[2]),m=Number(l?.[2]),y=!!(c&&Number.isFinite(g)&&g<=300),f=n.some(z=>/^border(?:-|$)/.test(z)),h=!!(c||l||u),w=[o,s,p,y||f].filter(Boolean).length;if(!(h&&w>=3))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let S=c&&c[1]||l&&l[1]||u&&u[1]||"",A=ta(S),L=f&&!y,F=p?"badge-sm":d?"badge-lg":"",I=y?{family:S,bgShade:Number.isFinite(g)?g:200,textShade:Number.isFinite(m)?m:700}:null;return{shouldNormalize:!0,variantClass:I?"":A,outline:L,sizeClass:F,pastel:I}}function na(t="",e=0){let r=String(t||"").toLowerCase(),n=Number(e);return r==="white"?"surface-base":["gray","slate","zinc","neutral","stone"].includes(r)?Number.isFinite(n)&&n<=100?"surface-base":"surface-subtle":["blue","sky","cyan","indigo","primary","info"].includes(r)?"surface-info":["purple","violet","fuchsia","accent"].includes(r)?"surface-primary":["green","emerald","lime","teal","success"].includes(r)?"surface-success":["yellow","amber","orange","warning"].includes(r)?"surface-warning":["red","rose","pink","danger"].includes(r)?"surface-danger":"surface-base"}function oa(t=[],e="",r={shouldNormalize:!1},n={shouldNormalize:!1}){if(r?.shouldNormalize||n?.shouldNormalize)return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(!new Set(["div","section","article","aside","li"]).has(e))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(t.some(f=>/^card(?:-|$)/.test(String(f))))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let a=t.map(f=>re(f)).filter(f=>f.breakpoint==="base").map(f=>String(f.base)),i=a.some(f=>/^rounded(?:-|$)/.test(f)),s=a.some(f=>/^border(?:$|-)/.test(f)),p=a.some(f=>/^shadow(?:$|-)/.test(f)),d=a.some(f=>/^(?:p|px|py|pt|pb|pl|pr)-/.test(f)),c=a.map(f=>f.match(/^bg-([a-z]+)-?(\d{2,3})?$/)).find(Boolean),l=a.includes("bg-white")||!!c;if(!([i,s||p,l,d].filter(Boolean).length>=3))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let m="card-basic";p?m="card-elevated":s&&(m="card-outlined");let y="";return p?y="surface-elevated":c?y=na(c[1],c[2]):l&&(y="surface-base"),{shouldNormalize:!0,cardVariantClass:m,surfaceClass:y}}function aa({tagName:t,originalClassValue:e,policy:r,summary:n,preflightHints:o={}}){if(yo.has(t))return R(n,"table.strict-tags.no-classes"),"";let a=String(e).split(/\s+/).filter(Boolean),i=ea(a,t),s=ra(a,t,i),p=oa(a,t,i,s),d=/^h[1-6]$/.test(t),c=["i","svg"].includes(t)||a.some(C=>/^fa(?:[a-z-]+)?$/i.test(String(C||""))||/^fa-/.test(String(C||""))),l=new Set,u={},g={},m=!1,y="",f="",h=!1,w="";a.forEach(C=>{let b=re(C),k=b.base;if(bo.some(N=>N.test(k))){n.ignored+=1,R(n,"cleanup.non-pds-class");return}let E=Dr(C)||Dr(k);if(E&&(n.totalTailwind+=1),/^space-y-/.test(k)){m=!0,y=y||C,f=f||Yo(C),n.ignored+=1,R(n,"layout.spacing.space-y-to-stack");return}if(/^space-x-/.test(k)){let N=String(k).match(/^space-x-(\d+)$/);if(N){let _=`gap-${N[1]}`,Y=Ht.get(_);if(Y&&G(r,"spacing")){l.add(Y),h=!0,w=w||C,n.mapped+=1,n.intentHits+=1,R(n,"layout.spacing.space-x-to-gap");return}}n.ignored+=1,R(n,"style.spacing.atomic");return}if(/^grid-cols-\d+$/.test(k)&&b.breakpoint!=="base"){let N=Wr(k);if(Number.isFinite(N)&&G(r,"grid")){u[b.breakpoint]=N,n.mapped+=1,R(n,"intent.layout.responsive-grid-to-auto");return}if(!G(r,"grid")){n.policySkipped+=1,j(n,"Skipped responsive grid mapping because layout.utilities.grid=false.");return}}if(/^flex-(?:row|col)$/.test(k)&&b.breakpoint!=="base"){if(G(r,"flex")){g[b.breakpoint]=k,n.mapped+=1,R(n,"intent.layout.mobile-stack");return}n.policySkipped+=1,j(n,"Skipped responsive flex mapping because layout.utilities.flex=false.");return}if(/^grid-cols-\d+$/.test(k)&&b.breakpoint==="base"){let N=Wr(k);Number.isFinite(N)&&G(r,"grid")&&(u.base=N)}let T=ho.get(k);if(T&&b.breakpoint==="base"){if(!G(r,T.gate)){n.policySkipped+=1,j(n,`Skipped ${k} because layout.utilities.${T.gate}=false.`);return}T.pds.forEach(N=>{N&&l.add(N)}),n.mapped+=1,R(n,T.id);return}if(Ht.has(k)&&b.breakpoint==="base"){if(!G(r,"spacing")){n.policySkipped+=1,j(n,"Skipped gap utility because layout.utilities.spacing=false.");return}l.add(Ht.get(k)),n.mapped+=1,R(n,"layout.spacing.gap-scale");return}if(Ir.has(k)&&b.breakpoint==="base"){if(!G(r,"container")){n.policySkipped+=1,j(n,"Skipped max-width utility because layout.utilities.container=false.");return}l.add(Ir.get(k)),n.mapped+=1,R(n,"layout.container.max-width");return}if(i.shouldNormalize&&E){let N=String(k||"");if(b.breakpoint==="base"&&["flex-1","grow","flex-grow"].includes(N)){l.add("grow"),n.mapped+=1,n.intentHits+=1,R(n,"intent.component.button.layout-grow");return}if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.button.normalize");return}}if(d&&/^(?:text-(?:xs|sm|base|lg|xl|\dxl|white|black|\[[^\]]+\]|[a-z]+-\d{2,3})|font-|leading-|tracking-|uppercase|lowercase|capitalize)/.test(k)){n.ignored+=1,n.intentHits+=1,R(n,"intent.typography.heading-semantic");return}if(s.shouldNormalize&&E){let N=String(k||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.badge.normalize");return}}if(p.shouldNormalize&&E){let N=String(k||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.card.normalize");return}}let B=Go(k);if(B&&b.breakpoint==="base"){l.add(B),n.mapped+=1,n.intentHits+=1,R(n,"intent.typography.text-neutral-to-muted");return}if(/^text-(?:white|black|[a-z]+-\d{2,3}|\[[^\]]+\])$/.test(k)){if(c||t==="a"&&!i.shouldNormalize){let _=Or(k,b.breakpoint,b.variants);if(_){let Y=ce(n,`${t}-color-${k}`,_.declaration,_.breakpoint,_.pseudo);if(Y){l.add(Y),n.mapped+=1,n.intentHits+=1,R(n,c?"intent.icon.color-preserve":"intent.typography.link-active-preserve");return}}}n.ignored+=1,R(n,"style.color");return}let V=Or(k,b.breakpoint,b.variants);if(V){let N=ce(n,k,V.declaration,V.breakpoint,V.pseudo);if(N){l.add(N),n.mapped+=1,n.intentHits+=1,R(n,V.ruleId),b.breakpoint!=="base"&&j(n,`Generated responsive import fallback for ${C}.`);return}}for(let N of U.ignoredPatterns)if(N.pattern.test(k)){n.ignored+=1,R(n,N.id),N.id==="style.spacing.atomic"&&(n.removedAtomicSpacingCount+=1),N.id==="style.positioning.atomic"&&(n.removedAtomicPositioningCount+=1);return}if(E){n.unknown+=1,Uo(n,C);return}l.add(C)}),m&&G(r,"spacing")&&(l.add(f||"stack-md"),n.mapped+=1,n.intentHits+=1,j(n,`Mapped ${y} to ${f||"stack-md"}.`)),h&&G(r,"spacing")&&j(n,`Mapped ${w} to gap utility.`);let x=Hr(u);if(x&&G(r,"grid")?(l.delete("grid-cols-1"),l.delete("grid-cols-2"),l.delete("grid-cols-3"),l.delete("grid-cols-4"),l.delete("grid-cols-6"),l.add("grid"),l.add(x),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Collapsed responsive grid columns to ${x}.`)):G(r,"grid")&&st.filter(b=>b!=="base"&&Number.isFinite(u[b])).forEach(b=>{let k=u[b],E=Vo(b,k);if(E){l.add("grid"),l.add(E),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Mapped ${b}:grid-cols-${k} to ${E}.`);return}let T=ce(n,`grid-cols-${k}`,`grid-template-columns:repeat(${k}, minmax(0, 1fr))`,b);T&&(l.add("grid"),l.add(T),n.intentHits+=1,R(n,"fallback.import-style.grid-cols-responsive"),j(n,`Mapped ${b}:grid-cols-${k} to responsive import fallback for exact columns.`))}),G(r,"flex")&&a.includes("flex-col")&&(g.md==="flex-row"||g.lg==="flex-row")&&(l.delete("flex-col"),l.delete("flex-row"),l.add("mobile-stack"),n.intentHits+=1,R(n,"intent.layout.mobile-stack"),j(n,"Mapped flex-col + breakpoint flex-row to mobile-stack.")),(l.has("flex")||l.has("inline-flex"))&&G(r,"spacing")&&(Jo(l)||Ko(l)||h||m||(l.add("gap-sm"),n.intentHits+=1,R(n,"layout.spacing.flex-min-gap"),j(n,"Added gap-sm fallback for flex container without explicit spacing."))),a.some(C=>/^grid-cols-\d+$/.test(re(C).base))&&l.has("grid")&&!Xo(l)){let C=Hr(u);C?(l.add(C),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Applied grid safety fallback ${C} to avoid bare grid output.`)):Number.isFinite(u.base)&&u.base>1?(l.add(`grid-cols-${u.base}`),n.intentHits+=1,R(n,"intent.layout.grid-safety-fallback"),j(n,`Applied grid safety fallback grid-cols-${u.base} to preserve explicit grid intent.`)):(l.add("mobile-stack"),n.intentHits+=1,R(n,"intent.layout.grid-safety-fallback.mobile-stack"),j(n,"Applied mobile-stack safety fallback to avoid bare grid output when explicit grid intent was present."))}let L=a.some(C=>/^(?:bg-white|shadow|shadow-md|shadow-lg)$/.test(C)),F=a.some(C=>/^rounded/.test(C));if(["div","section","article","li","aside"].includes(t)&&L&&F&&(l.add("card"),!l.has("surface-elevated")&&a.some(C=>/^shadow/.test(C))&&l.add("surface-elevated"),!l.has("surface-base")&&a.includes("bg-white")&&l.add("surface-base"),n.intentHits+=1,R(n,"intent.component.card")),t==="button"||t==="a"){let C=a.some(E=>/^bg-(?:[a-z]+-)?[4567]00$/.test(E))&&a.includes("text-white"),b=a.some(E=>/^border/.test(E))&&!C,k=a.includes("p-2")&&a.includes("rounded-full");C?(l.delete("surface-base"),l.delete("surface-elevated"),l.add("btn-primary"),n.intentHits+=1,R(n,"intent.component.button.primary")):b&&(l.add("btn-outline"),n.intentHits+=1,R(n,"intent.component.button.outline")),k&&(l.add("icon-only"),R(n,"intent.component.button.icon-only"))}if(i.shouldNormalize){for(let b of Array.from(l))String(b).startsWith("import-")&&l.delete(b);["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","surface-base","surface-elevated","surface-subtle","card"].forEach(b=>l.delete(b)),i.variant==="primary"?(l.add("btn-primary"),R(n,"intent.component.button.primary")):i.variant==="outline"&&(l.add("btn-outline"),R(n,"intent.component.button.outline")),i.size==="sm"?(l.add("btn-sm"),R(n,"intent.component.button.size-sm")):i.size==="lg"&&(l.add("btn-lg"),R(n,"intent.component.button.size-lg")),i.iconOnly&&(l.add("icon-only"),R(n,"intent.component.button.icon-only")),n.intentHits+=1,R(n,"intent.component.button.normalize")}if(s.shouldNormalize){for(let b of Array.from(l))String(b).startsWith("import-")&&l.delete(b);if(["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","grow","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","text-muted","surface-base","surface-elevated","surface-subtle","card"].forEach(b=>l.delete(b)),l.add("badge"),s.variantClass&&l.add(s.variantClass),s.outline&&l.add("badge-outline"),s.sizeClass&&l.add(s.sizeClass),s.pastel&&s.pastel.family){let b=je(s.pastel.family,String(s.pastel.bgShade||200)),k=je(s.pastel.family,String(s.pastel.textShade||700));if(b&&k){let E=`badge-pastel-${s.pastel.family}-${s.pastel.bgShade}-${s.pastel.textShade}`,T=ce(n,E,`background-color:${b};color:${k}`,"base");T&&(l.add(T),R(n,"intent.component.badge.pastel-preserve"),j(n,`Preserved pastel badge tone using ${T}.`))}}n.intentHits+=1,R(n,"intent.component.badge.normalize"),j(n,"Normalized badge/pill utility cluster to PDS badge classes.")}if(p.shouldNormalize){for(let b of Array.from(l))String(b).startsWith("import-")&&l.delete(b);["surface-base","surface-subtle","surface-elevated","surface-sunken","surface-overlay","surface-inverse","surface-primary","surface-secondary","surface-success","surface-warning","surface-danger","surface-info","card-basic","card-elevated","card-outlined","card-interactive"].forEach(b=>l.delete(b)),l.add("card"),p.cardVariantClass&&l.add(p.cardVariantClass),p.surfaceClass&&l.add(p.surfaceClass),n.intentHits+=1,R(n,"intent.component.card.normalize"),j(n,"Normalized card utility cluster to PDS card/surface classes.")}if(t==="a"&&!i.shouldNormalize&&a.some(b=>b.includes("hover:text")||b==="transition-colors")){let b=ce(n,"link-reset","text-decoration:none");b&&l.add(b),n.intentHits+=1,R(n,"intent.typography.link-treatment")}if(t==="footer"&&(l.has("surface-base")||a.some(b=>/^bg-/.test(b)))&&(l.delete("surface-base"),l.delete("surface-subtle"),l.add("surface-inverse"),n.intentHits+=1,R(n,"intent.surface.footer-inverse")),o?.listReset&&["ul","ol","menu"].includes(t)){let C=ce(n,"list-reset","list-style:none;margin:0;padding:0");C&&(l.add(C),n.intentHits+=1,R(n,"intent.preflight.list-reset"))}if(o?.anchorReset&&t==="a"&&!i.shouldNormalize){let C=ce(n,"anchor-reset","color:inherit;text-decoration:inherit");C&&(l.add(C),n.intentHits+=1,R(n,"intent.preflight.anchor-reset"))}let z=new Set(["div","section","article","aside","nav","main","header","footer","form","fieldset","ul","ol","li"]),P=a.some(C=>{let b=re(C).base;return/^(?:flex|grid|container|gap-|space-[xy]-|items-|justify-|content-|place-|self-|w-|h-|min-|max-)/.test(b)});return l.size===0&&z.has(t)&&P&&(l.add("stack-sm"),j(n,`Added stack-sm fallback for <${t}> with unmapped classes.`)),Array.from(l).join(" ")}function ia(t="",e={}){let r=String(t||""),n=qo(e.config||{}),o=jo(e.config||{}),a=Oo(),i=Ho(r,a),p=ko(i.html,a).replace(/<([a-zA-Z][\w:-]*)([^>]*?)\sclass\s*=\s*(["'])(.*?)\3([^>]*)>/gs,(A,L,F,I,$,z)=>{let P=aa({tagName:String(L||"").toLowerCase(),originalClassValue:$,policy:n,summary:a,preflightHints:i.hints}),C=String(P||"").trim();return C?`<${L}${F} class=${I}${C}${I}${z}>`:`<${L}${F}${z}>`}),d=No(Lo(To(Eo(p,a),a),a),a,{config:e.config||{}}),c=Bo(a,o),l=_o(d,c);c&&j(a,`Generated ${a.importedStyleCount} import-* fallback style mappings.`),(a.removedAtomicSpacingCount>0||a.removedAtomicPositioningCount>0)&&j(a,`Removed atomic utilities by policy: spacing=${a.removedAtomicSpacingCount}, positioning=${a.removedAtomicPositioningCount}.`);let u=Zo(a,16),g=a.mapped+a.ignored+a.policySkipped,m=a.totalTailwind>0?g/a.totalTailwind:1,y=a.totalTailwind>0?a.unknown/a.totalTailwind:0,f=.42+m*.45+Math.min(a.intentHits,4)*.025-y*.18,h=Math.max(.15,Math.min(.96,Number(f.toFixed(2)))),w=[`pds-import: rulebook=${Nr} confidence=${Math.round(h*100)}%`,`pds-import: tailwind=${a.totalTailwind} mapped=${a.mapped} ignored=${a.ignored} policySkipped=${a.policySkipped} unknown=${a.unknown}`];u.length&&w.push(`pds-import: unknown-tailwind=${u.join(", ")}`),a.notes.length&&w.push(`pds-import: notes=${a.notes.join(" | ")}`);let x=`<!-- ${w.join(` -->
<!-- `)} -->
${l}`,S=[];return a.unknown>0&&S.push({severity:"warning",message:`Converted with ${a.unknown} unknown Tailwind utilities requiring manual review.`}),a.policySkipped>0&&S.push({severity:"info",message:`Skipped ${a.policySkipped} utility mappings due to PDS config policy.`}),u.length&&S.push({severity:"info",message:`Top unknown utilities: ${u.slice(0,8).join(", ")}`}),{html:x,confidence:h,issues:S,meta:{rulebookVersion:Nr,coverage:{tailwind:a.totalTailwind,mapped:a.mapped,ignored:a.ignored,policySkipped:a.policySkipped,unknown:a.unknown,importedStyles:a.importedStyleCount,nestedLabelPairs:a.labelNestingCount},unknownTailwindTokens:u,notes:a.notes,appliedRules:Array.from(a.appliedRules),policy:n,importStyleSheetInjected:!!c,breakpoints:o}}}function sa(){return{rulesJsonPath:mo,...U,directMappings:U.directMappings.map(t=>({id:t.id,tw:t.tw,pds:t.pds,gate:t.gate||null})),ignoredPatterns:U.ignoredPatterns.map(t=>({id:t.id,pattern:String(t.pattern),reason:t.reason}))}}function la(t){let e=String(t||"").match(/#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})\b/);return e?e[0]:null}function ca(t){return String(t||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Vr(t){return/<\s*[a-z][^>]*>/i.test(String(t||""))}function da(t){let e=String(t||"").trim().toLowerCase();if(!e)return null;let r=Number.parseFloat(e);return Number.isFinite(r)?e.endsWith("rem")||e.endsWith("em")?r*16:e.endsWith("px")||/^[0-9.\-]+$/.test(e)?r:null:null}function Z(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/#(?:[0-9a-f]{3,8})\b/i);if(r)return r[0].toLowerCase();let n=e.match(/rgba?\([^)]*\)/i);if(n)return n[0];let o=e.match(/hsla?\([^)]*\)/i);return o?o[0]:""}function pa(t=""){let e=String(t||"").trim();if(!e||typeof window>"u"||typeof document>"u")return"";let r=document.documentElement;if(!r)return"";let n=window.getComputedStyle(r);return String(n.getPropertyValue(e)||"").trim()}function ua(t=""){let e=String(t||"").trim(),r=Z(e);if(r)return r;let n=e.match(/var\(\s*(--[^\s,)]+)\s*(?:,[^)]+)?\)/i);if(!n)return"";let o=pa(n[1]);return Z(o)}function ga(t=""){let e=String(t||"").trim();if(!e)return"";let r=e.split(":").pop()||e;if(r==="bg-white")return"#ffffff";if(r==="bg-black")return"#000000";let n=r.match(/^bg-black\/(\d{1,3})$/i);if(n)return`rgba(0,0,0,${Math.max(0,Math.min(100,Number(n[1])))/100})`;let o=r.match(/^bg-\[([^\]]+)\]$/i);if(o)return Z(o[1]);let a=r.match(/^bg-([a-z]+)-(\d{2,3})$/i);if(!a)return"";let i=je(a[1],a[2]);return i?ua(i):""}function Ur(t=""){return String(t||"").split(/\s+/).map(r=>r.trim()).filter(Boolean).map(r=>ga(r)).filter(Boolean)}function ma(t=""){let e=[],r=String(t||""),n=/([^{}]+)\{([^{}]*)\}/g,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim(),i=String(o[2]||"").trim();a&&i&&e.push({selector:a,body:i}),o=n.exec(r)}return e}function fa(t=""){let e=String(t||"").toLowerCase();return e?/(^|\s|,)(html|body|:root|main)(\s|,|$)|#app\b|#root\b|\.app\b|\.page\b/.test(e):!1}function ha(t=""){let e=String(t||"").trim().match(/rgba?\(\s*([0-9.]+)\s*,\s*([0-9.]+)\s*,\s*([0-9.]+)(?:\s*,\s*([0-9.]+))?\s*\)/i);if(!e)return null;let r=Number.parseFloat(e[1]),n=Number.parseFloat(e[2]),o=Number.parseFloat(e[3]),a=e[4]==null?1:Number.parseFloat(e[4]);return[r,n,o,a].every(i=>Number.isFinite(i))?{r:Math.max(0,Math.min(255,r)),g:Math.max(0,Math.min(255,n)),b:Math.max(0,Math.min(255,o)),a:Math.max(0,Math.min(1,a))}:null}function ba(t=""){let e=String(t||"").trim().match(/^#([0-9a-f]{3,8})$/i);if(!e)return null;let r=e[1].toLowerCase();if(r.length===3){let[n,o,a]=r.split("");return{r:Number.parseInt(`${n}${n}`,16),g:Number.parseInt(`${o}${o}`,16),b:Number.parseInt(`${a}${a}`,16),a:1}}return r.length===6||r.length===8?{r:Number.parseInt(r.slice(0,2),16),g:Number.parseInt(r.slice(2,4),16),b:Number.parseInt(r.slice(4,6),16),a:r.length===8?Number.parseInt(r.slice(6,8),16)/255:1}:null}function Yr(t=""){let e=Z(t);return e?e.startsWith("#")?ba(e):e.startsWith("rgb")?ha(e):null:null}function ya(t){if(!t)return null;let e=a=>{let i=Number(a)/255;return i<=.03928?i/12.92:((i+.055)/1.055)**2.4},r=e(t.r),n=e(t.g),o=e(t.b);return .2126*r+.7152*n+.0722*o}function qr(t=""){let e=String(t||"").trim().toLowerCase();if(!e||e==="transparent")return!0;let r=Yr(e);return r&&Number.isFinite(r.a)?r.a<=.04:!1}function va(t=[],e=[]){let r=t.map(p=>Z(p)).filter(p=>p&&!qr(p)),n=Ie(r);if(n)return{color:n,source:"root"};let o=e.map(p=>Z(p)).filter(p=>p&&!qr(p)),a=o.filter(p=>{let d=Yr(p),c=ya(d);return Number.isFinite(c)?c>=.72:!1}),i=Ie(a);if(i)return{color:i,source:"fallback-bright"};let s=Ie(o);return s?{color:s,source:"fallback"}:{color:"",source:"none"}}function xe(t,e=new Map){let r=String(t||""),n=/([a-z-]+)\s*:\s*([^;{}]+)/gi,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim().toLowerCase(),i=String(o[2]||"").trim();a&&i&&(e.has(a)||e.set(a,[]),e.get(a).push(i)),o=n.exec(r)}return e}function xa(t=""){let e=String(t||""),r=new Map,n=[],o=[],a=[],i=[],s=[],p=[],d=[],c=/#(?:[0-9a-f]{3,8})\b|rgba?\([^)]*\)|hsla?\([^)]*\)/gi,l=u=>{(String(u||"").match(c)||[]).forEach(m=>{let y=Z(m);y&&n.push(y)})};if(typeof DOMParser<"u"&&Vr(e))try{let g=new DOMParser().parseFromString(e,"text/html");Array.from(g.querySelectorAll("style")).map(x=>x.textContent||"").forEach(x=>{xe(x,r),l(x),ma(x).forEach(S=>{if(!fa(S.selector))return;let A=xe(S.body,new Map),L=J(A,["background","background-color"]).map(F=>Z(F)).filter(Boolean);o.push(...L)})}),Array.from(g.querySelectorAll("[style]")).forEach(x=>{let S=x.getAttribute("style")||"";xe(S,r),l(S)}),["html","body","main","#app","#root",".app",".page"].forEach(x=>{let S=g.querySelector(x);if(!S)return;let A=S.getAttribute("style")||"";if(!A)return;let L=xe(A,new Map),F=J(L,["background","background-color"]).map($=>Z($)).filter(Boolean);o.push(...F);let I=Ur(S.getAttribute("class")||"");a.push(...I)}),Array.from(g.querySelectorAll("[class]")).forEach(x=>{let S=te(x.getAttribute("class")||"");p.push(...S);let A=Ur(x.getAttribute("class")||"");i.push(...A);let L=String(x.tagName||"").toLowerCase(),F=L==="button"||L==="a",I=S.some($=>/^bg-/.test(String(re($).base||"")));F&&I&&A.length&&s.push(...A)});let w=g.body?.textContent||"";w.trim()&&d.push(w),l(g.documentElement?.outerHTML||e)}catch{xe(e,r),l(e),d.push(e)}else xe(e,r),l(e),d.push(e);return{declarations:r,colorValues:n,rootBackgroundColors:o,rootClassBackgroundColors:a,classBackgroundColors:i,buttonBackgroundColors:s,classTokens:p,textCorpus:d.join(`
`)}}function Ie(t=[]){let e=new Map;t.forEach(o=>{let a=String(o||"").trim();a&&e.set(a,(e.get(a)||0)+1)});let r="",n=-1;return e.forEach((o,a)=>{o>n&&(r=a,n=o)}),r}function J(t,e=[]){return e.flatMap(r=>t.get(r)||[])}function wa(t,e){if(!t||!e)return null;let r=String(e).split(".").filter(Boolean),n=t;for(let o of r){if(!n||n.type!=="object"||!n.properties||typeof n.properties!="object")return null;n=n.properties[o]}return n||null}function ka(t={}){let e=t&&typeof t=="object"?t:{},r=M?.configRelations&&typeof M.configRelations=="object"?M.configRelations:{},n=new Set(Object.keys(r)),o=null;if(typeof M?.buildConfigFormSchema=="function")try{o=M.buildConfigFormSchema(e)?.schema||null}catch{o=null}return!o&&M?.configFormSchema?.schema&&(o=M.configFormSchema.schema),{design:e,schema:o,allowedPaths:n}}function Sa(t,e){if(!t)return e;if(Array.isArray(t.oneOf)&&t.oneOf.length){let r=t.oneOf.map(n=>n?.const).filter(n=>n!=null);if(r.length){if(typeof e=="string"){let n=r.find(o=>String(o).toLowerCase()===e.toLowerCase());if(n!==void 0)return n}if(typeof e=="number"){let n=r.map(o=>Number(o)).filter(o=>Number.isFinite(o));if(n.length)return n.reduce((o,a)=>Math.abs(a-e)<Math.abs(o-e)?a:o,n[0])}return r[0]}}if(t.type==="number"||t.type==="integer"){let r=Number(e);return Number.isFinite(r)?t.type==="integer"?Math.round(r):r:void 0}return t.type==="boolean"?!!e:t.type==="string"?String(e||"").trim():e}function $a(t,e,r){let n=String(e||"").split(".").filter(Boolean);if(!n.length)return;let o=t;for(let a=0;a<n.length;a+=1){let i=n[a];if(a===n.length-1){o[i]=r;return}(!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))&&(o[i]={}),o=o[i]}}function D(t,e,r){if(r==null||r===""||t.allowedPaths.size&&!t.allowedPaths.has(e))return;let n=wa(t.schema,e),o=Sa(n,r);o==null||o===""||($a(t.patch,e,o),t.inferredPaths.add(e))}function de(t=[]){let e=t.map(n=>da(n)).filter(n=>Number.isFinite(n));if(!e.length)return null;e.sort((n,o)=>n-o);let r=Math.floor(e.length/2);return e.length%2?e[r]:(e[r-1]+e[r])/2}function Ca(t=[]){let e=t.map(r=>String(r||"").split(",")[0]||"").map(r=>r.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean);return Ie(e)}function za(t){let e=Number(t);return Number.isFinite(e)?e<=.75?"hairline":e<=1.5?"thin":e<=2.5?"medium":"thick":"thin"}function Ma(t=""){let r=String(re(t).base||"").toLowerCase().match(/^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(!r)return null;let n=r[1]||"DEFAULT",o={none:0,xs:2,sm:4,DEFAULT:6,md:8,lg:12,xl:16,"2xl":24,"3xl":32};return n==="full"?null:Number.isFinite(o[n])?o[n]:null}function Ea(t=[]){let e=t.map(n=>Ma(n)).filter(n=>Number.isFinite(n));if(!e.length)return null;e.sort((n,o)=>n-o);let r=Math.floor(e.length/2);return e.length%2?e[r]:(e[r-1]+e[r])/2}function qt(t={}){let e=String(t.html||"");if(!e.trim())return O({source:"html-inference",type:String(t.sourceType||"design-inference"),confidence:0,issues:[{severity:"warning",message:"No HTML or guideline text provided for design extraction."}],designPatch:{},meta:{extractedPathCount:0,extractedPaths:[]}});let r=ka(t.config||{}),n=xa(e),o={patch:{},inferredPaths:new Set,allowedPaths:r.allowedPaths,schema:r.schema},a=J(n.declarations,["color"]).map(q=>Z(q)).filter(Boolean),i=J(n.declarations,["background","background-color"]).map(q=>Z(q)).filter(Boolean),s=[...i,...a,...n.colorValues].filter(Boolean),p=Array.from(new Set(s)),d=[...n.rootBackgroundColors||[]],c=[...n.rootClassBackgroundColors||[]],l=d.length?d:c,u=[...i,...n.classBackgroundColors||[]],g=va(l,u),m=g.color;D(o,"colors.background",m||i[0]||p[0]);let y=p.filter(q=>q&&q!==m),h=Ie(n.buttonBackgroundColors||[])||y[0]||p[0],w=y.filter(q=>q&&q!==h);D(o,"colors.primary",h),D(o,"colors.secondary",w[0]||h||p[0]),D(o,"colors.accent",w[1]||w[0]||h||p[0]);let x=J(n.declarations,["font-family"]),S=Ca(x);D(o,"typography.fontFamilyBody",S),D(o,"typography.fontFamilyHeadings",S),D(o,"typography.fontFamilyMono",/mono|code/i.test(n.textCorpus)?"JetBrains Mono":"");let A=J(n.declarations,["font-size"]),L=de(A);D(o,"typography.baseSize",L);let F=J(n.declarations,["padding","padding-top","padding-right","padding-bottom","padding-left","margin","margin-top","margin-right","margin-bottom","margin-left","gap","row-gap","column-gap"]),I=de(F);D(o,"spatialRhythm.baseUnit",I),D(o,"spatialRhythm.inputPadding",I),D(o,"spatialRhythm.buttonPadding",I);let $=J(n.declarations,["border-radius"]),z=de($)||Ea(n.classTokens||[]);D(o,"shape.radiusSize",z);let P=J(n.declarations,["border-width","border-top-width","border-right-width","border-bottom-width","border-left-width"]),C=de(P);D(o,"shape.borderWidth",za(C));let b=J(n.declarations,["max-width"]),k=de(b);D(o,"layout.containerMaxWidth",k),D(o,"layout.maxWidth",k);let E=J(n.declarations,["min-height","height"]),T=de(E);D(o,"layout.buttonMinHeight",T),D(o,"layout.inputMinHeight",T);let B=J(n.declarations,["transition-duration"]),W=de(B.map(q=>{let $e=String(q||"").trim().toLowerCase(),oe=Number.parseFloat($e);return Number.isFinite(oe)?$e.endsWith("ms")?oe:$e.endsWith("s")?oe*1e3:oe:null}));D(o,"behavior.transitionSpeed",W);let N=J(n.declarations,["box-shadow"]).length>0;D(o,"layers.baseShadowOpacity",N?.2:.08);let _=Array.from(o.inferredPaths),Y=_.reduce((q,$e)=>{let oe=$e.split(".")[0];return q[oe]=(q[oe]||0)+1,q},{}),Se=_.length?Math.min(.92,.35+_.length*.02):.25;return O({source:"html-inference",type:String(t.sourceType||"design-inference"),confidence:Se,issues:_.length?[]:[{severity:"warning",message:"Could not infer enough design signals from input."}],designPatch:o.patch,meta:{extractedPathCount:_.length,extractedPaths:_,categoryCoverage:Y,colorSampleSize:p.length,backgroundInference:{source:g.source,candidates:{root:l.length,declaration:i.length,classBased:(n.classBackgroundColors||[]).length}}}})}function Jr(t={}){let e=String(t.input||"").trim(),r=String(t.sourceType||"unknown");if(!e)return O({source:r,type:r,confidence:0,issues:[{severity:"error",message:"No input provided."}],meta:{conversionMode:"none"}});if(Vr(e)){let n=lt({html:e,config:t.config||{}});return O({source:r,type:r,confidence:n.confidence,issues:n.issues,template:n.template,meta:{...n.meta||{},conversionMode:"html-to-pds"}})}return O({source:r,type:r,confidence:.48,issues:[{severity:"info",message:"Input is not HTML; generated text-based preview template."}],template:{id:`${r}-text-import`,name:"Imported Guideline Text",html:`<article class="card surface-base stack-sm"><h3>Imported Guidelines</h3><pre>${ca(e)}</pre></article>`},meta:{conversionMode:"text-preview"}})}function lt(t={}){let e=String(t.html||"").trim();if(!e)return O({source:"tailwind",type:"tailwind-html",confidence:0,issues:[{severity:"error",message:"No HTML provided."}]});let r=ia(e,{config:t.config||{}});return O({source:"tailwind",type:"tailwind-html",confidence:r.confidence,issues:r.issues,template:{id:"tailwind-import",name:"Converted Tailwind Markup",html:r.html},meta:r.meta})}function Gt(t={}){let e=String(t.text||"").trim();if(!e)return O({source:"brand",type:"brand-guidelines",confidence:0,issues:[{severity:"error",message:"No brand guideline text provided."}]});let r=la(e),n={colors:{},typography:{}},o=[];return r?n.colors.primary=r:o.push({severity:"warning",message:"No HEX color found; primary color was not inferred."}),/serif/i.test(e)&&(n.typography.fontFamilyBody="Georgia, serif"),/sans[-\s]?serif/i.test(e)&&(n.typography.fontFamilyBody="Inter, Arial, sans-serif"),/mono|monospace/i.test(e)&&(n.typography.fontFamilyMono="JetBrains Mono, monospace"),O({source:"brand",type:"brand-guidelines",confidence:r?.68:.52,issues:o,designPatch:n,meta:{inferred:{primaryColor:r}}})}var Vt="convert-only",Kr="adopt-design-and-convert";function Ta(t){return String(t||"").trim().toLowerCase()===Kr?Kr:Vt}function Xr(...t){let e=t.flat().filter(Boolean);if(!e.length)return[];let r=new Set;return e.filter(n=>{let o=`${String(n?.severity||"info")}::${String(n?.path||"")}::${String(n?.message||"")}`;return r.has(o)?!1:(r.add(o),!0)})}function Zr(t=[]){let e=t.map(r=>Number(r)).filter(r=>Number.isFinite(r));return e.length?Math.max(0,Math.min(1,e.reduce((r,n)=>r+n,0)/e.length)):0}function Be(t={},e={}){return{...t&&typeof t=="object"?t:{},...e&&typeof e=="object"?e:{}}}function tn(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};return Object.entries(e).forEach(([n,o])=>{o&&typeof o=="object"&&!Array.isArray(o)?r[n]=tn(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o}),r}function Qr(t){if(typeof structuredClone=="function")try{return structuredClone(t)}catch{}return JSON.parse(JSON.stringify(t||{}))}function Aa(t={}){let e=Number(t?.ratio),r=Number(t?.min),n=Number.isFinite(e)?e.toFixed(2):"n/a",o=Number.isFinite(r)?r.toFixed(2):"n/a";return{severity:"error",path:String(t?.path||"/colors"),message:`${String(t?.message||"Color contrast validation failed.")} (ratio=${n}, required=${o})`}}function en(t={},e={},r={}){if(!(e&&typeof e=="object"?Object.keys(e):[]).length)return{ok:!0,blocked:!1,issues:[],report:{ok:!0,issues:[]}};let o=Number(r.minContrast),a=Number.isFinite(o)?o:4.5,i=tn(Qr(t||{}),Qr(e||{})),s=lr(i,{minContrast:a,minMutedContrast:3,extendedChecks:!0}),p=Array.isArray(s?.issues)?s.issues.map(d=>Aa(d)):[];return{ok:!!s?.ok,blocked:!s?.ok,issues:p,report:{ok:!!s?.ok,minContrast:a,issues:Array.isArray(s?.issues)?s.issues:[]}}}function La(){return[{id:"template",name:"Templates"},{id:"tailwind-html",name:"Tailwind HTML"},{id:"brand-guidelines",name:"Brand Guidelines"},{id:"figma-json",name:"Figma Tokens JSON (planned)"},{id:"ux-pilot",name:"UX Pilot (planned)"},{id:"google-stitch",name:"Google Stitch (planned)"}]}async function Ra(t={}){let e=String(t.sourceType||""),r=Ta(t.importMode),n=String(t.input||""),o=t.config||null;if(e==="template"){let a=Mr(t.templateId,t);return a.meta=Be(a.meta,{importMode:r}),a}if(e==="tailwind-html"){let a=lt({html:n,config:o});if(r===Vt)return a.meta=Be(a.meta,{importMode:r}),a;let i=qt({html:n,config:o,sourceType:e}),s=en(o||{},i.designPatch||{}),p=s.blocked?{}:i.designPatch,d=s.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...s.issues]:[];return O({source:a.source||"tailwind",type:e,confidence:Zr([a.confidence,i.confidence]),issues:Xr(a.issues,i.issues,d),template:a.template,designPatch:p,meta:Be(a.meta,{importMode:r,inference:i.meta,validation:s.report,validationBlocked:s.blocked})})}if(e==="brand-guidelines"){let a=Jr({input:n,sourceType:e,config:o});if(r===Vt)return a.meta=Be(a.meta,{importMode:r}),a;let i=Gt({text:n}),s=qt({html:n,config:o,sourceType:e}),p={...i.designPatch&&typeof i.designPatch=="object"?i.designPatch:{},...s.designPatch&&typeof s.designPatch=="object"?s.designPatch:{}},d=en(o||{},p||{}),c=d.blocked?{}:p,l=d.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...d.issues]:[];return O({source:"brand",type:e,confidence:Zr([a.confidence,i.confidence,s.confidence]),issues:Xr(a.issues,i.issues,s.issues,l),template:a.template,designPatch:c,meta:Be(a.meta,{importMode:r,inference:s.meta,brandHeuristics:i.meta,validation:d.report,validationBlocked:d.blocked})})}return e==="figma-json"||e==="ux-pilot"||e==="google-stitch"?O({source:e,type:e,confidence:0,issues:[{severity:"info",message:`${e} adapter is not implemented yet in this phase.`}],meta:{importMode:r}}):O({source:e||"unknown",type:"unknown",confidence:0,issues:[{severity:"error",message:"Unsupported import source type."}],meta:{importMode:r}})}var Fa="pds-live-import-history";var ee="imports",ct=null;function Pa(){return typeof globalThis<"u"&&typeof globalThis.indexedDB<"u"}function Q(t){return typeof t=="string"?t:""}function dt(t){return Array.isArray(t)?t:[]}function pt(t){return t&&typeof t=="object"?t:{}}function ut(){return Pa()?ct||(ct=new Promise((t,e)=>{let r=globalThis.indexedDB.open(Fa,1);r.onupgradeneeded=()=>{let n=r.result;if(!n.objectStoreNames.contains(ee)){let o=n.createObjectStore(ee,{keyPath:"id",autoIncrement:!0});o.createIndex("createdAt","createdAt",{unique:!1}),o.createIndex("sourceType","sourceType",{unique:!1}),o.createIndex("fileName","fileName",{unique:!1})}},r.onsuccess=()=>t(r.result),r.onerror=()=>e(r.error||new Error("Failed to open import history database."))}),ct):Promise.resolve(null)}function gt(t){return new Promise((e,r)=>{t.onsuccess=()=>e(t.result),t.onerror=()=>r(t.error||new Error("IndexedDB operation failed."))})}function Na(t={}){let e=Date.now(),r=Number.isFinite(Number(t.createdAt))?Number(t.createdAt):e,n=new Date(r).toISOString(),o=dt(t.issues).map(p=>({severity:Q(p?.severity||"info"),message:Q(p?.message||"")})),a=dt(t.notes).filter(p=>typeof p=="string"),i=dt(t.unknownTailwindTokens).filter(p=>typeof p=="string"),s=dt(t.appliedRules).filter(p=>typeof p=="string");return{createdAt:r,createdAtIso:n,sourceType:Q(t.sourceType||"unknown"),importMode:Q(t.importMode||"convert-only"),source:Q(t.source||"unknown"),type:Q(t.type||"unknown"),fileName:Q(t.fileName||""),fileSize:Number.isFinite(Number(t.fileSize))?Number(t.fileSize):0,mimeType:Q(t.mimeType||""),fileContents:Q(t.fileContents||""),convertedHtml:Q(t.convertedHtml||""),confidence:Number.isFinite(Number(t.confidence))?Number(t.confidence):0,notes:a,issues:o,coverage:pt(t.coverage),unknownTailwindTokens:i,appliedRules:s,importStyleSheetInjected:!!t.importStyleSheetInjected,templateName:Q(t.templateName||""),designPatch:pt(t.designPatch),meta:pt(t.meta),resultSnapshot:pt(t.resultSnapshot)}}async function Ia(t={}){let e=await ut();if(!e)return null;let r=Na(t),o=e.transaction(ee,"readwrite").objectStore(ee);return{id:await gt(o.add(r)),...r}}async function ja(t={}){let e=await ut();if(!e)return[];let r=Number.isFinite(Number(t.limit))?Math.max(1,Number(t.limit)):30,o=e.transaction(ee,"readonly").objectStore(ee);return(await gt(o.getAll())||[]).sort((i,s)=>Number(s?.createdAt||0)-Number(i?.createdAt||0)).slice(0,r)}async function Ba(t){let e=await ut();if(!e)return null;let r=Number(t);if(!Number.isFinite(r))return null;let o=e.transaction(ee,"readonly").objectStore(ee);return await gt(o.get(r))||null}async function _a(){let t=await ut();if(!t)return;let r=t.transaction(ee,"readwrite").objectStore(ee);await gt(r.clear())}export{_a as clearLiveImportHistory,Gt as convertBrandGuidelinesToPatch,lt as convertTailwindHtmlToPds,O as createImportResult,sa as describeTailwindConversionRules,Ba as getLiveImportHistoryEntry,La as getLiveImportSources,Xn as isImportResult,ja as listLiveImportHistory,zr as listLiveTemplates,fr as loadGoogleFont,Qe as loadLiveTemplateCatalog,Ra as runLiveImport,Ia as saveLiveImportHistory,Yn as startLive};
