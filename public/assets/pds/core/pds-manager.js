...
`}#de(){let{shape:e={},spatialRhythm:r={},inputPadding:o,buttonPadding:n,focusRingWidth:a,focusRingOpacity:i,borderWidthThin:l,sectionSpacing:c,buttonMinHeight:d,inputMinHeight:s}=this.options.design,p=typeof e.borderWidth=="number"?e.borderWidth:typeof e.borderWidth=="string"?m.BorderWidths[e.borderWidth]??null:null,u=r.inputPadding??o??.75,f=r.buttonPadding??n??1,h=a||3,y=l||p||m.BorderWidths.thin,g=r.sectionSpacing??c??2,b=d||30;return`/* Mobile-First Form Styles - Generated from Design Config */
form {
  margin: 0;
  width: 100%;
}
