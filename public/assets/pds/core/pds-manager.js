...
`)}),`${r.join("")}
`}#te(e,r){if(!e?.dark)return"";let n=[],o=(m,k="")=>{Object.entries(m).forEach(([A,C])=>{typeof C=="object"&&C!==null?o(C,`${k}${A}-`):typeof C=="string"&&n.push(`  --color-${k}${A}: ${C};
`)})};Object.entries(e.dark).forEach(([m,k])=>{m!=="surfaceSmart"&&typeof k=="object"&&k!==null&&o(k,`${m}-`)});let a=[];e.dark.surfaceSmart&&(a.push(`  /* Smart Surface Tokens (dark mode, context-aware) */
`),Object.entries(e.dark.surfaceSmart).forEach(([m,k])=>{a.push(`  --surface-${m}-bg: ${k.bg};
`),a.push(`  --surface-${m}-text: ${k.text};
`),a.push(`  --surface-${m}-text-secondary: ${k.textSecondary};
`),a.push(`  --surface-${m}-text-muted: ${k.textMuted};
`),a.push(`  --surface-${m}-icon: ${k.icon};
`),a.push(`  --surface-${m}-icon-subtle: ${k.iconSubtle};
`),a.push(`  --surface-${m}-shadow: ${k.shadow};
`),a.push(`  --surface-${m}-border: ${k.border};
`)}),a.push(`
...
`),Object.entries(e.surfaceAccent.dark).forEach(([m,k])=>{d.push(`  --surface-${m}-accent-text: ${k.text};
`),d.push(`  --surface-${m}-accent-text-hover: ${k.textHover};
...
`),Object.entries(e.surfaceStatus.dark).forEach(([m,k])=>{Object.entries(k).forEach(([A,C])=>{y.push(`  --surface-${A}-${m}-text: ${C.text};
`),y.push(`  --surface-${A}-${m}-text-hover: ${C.textHover};
`)})}));let b=[`  /* Semantic Callout Display Tokens (dark mode) */
`];for(let m of["success","info","warning","danger"])b.push(`  --color-${m}-display-bg: color-mix(in oklab, var(--color-${m}-400) 12%, var(--color-surface-base));
`),b.push(`  --color-${m}-display-border: var(--color-${m}-400);
`),b.push(`  --color-${m}-display-text: var(--color-${m}-100);
`);let $=`  --color-text-primary: var(--color-gray-100);
...
`,f=`  /* Backdrop tokens - dark mode */
  ...
  /* Legacy alias for backwards compatibility */
  --backdrop-background: var(--backdrop-bg);
`,g=this.#oe(e),h=r?[this.#y(r)]:[];return`html[data-theme="dark"] {
${[...n,...a,...h,$,...i,...s,...d,...l,...p,...c,...u,...y,...b,f,g].join("")}}
`}#re(e,r){if(!e?.dark)return"";let n=[],o=(m,k="")=>{Object.entries(m).forEach(([A,C])=>{typeof C=="object"&&C!==null?o(C,`${k}${A}-`):typeof C=="string"&&n.push(`    --color-${k}${A}: ${C};
`)})};Object.entries(e.dark).forEach(([m,k])=>{m!=="surfaceSmart"&&typeof k=="object"&&k!==null&&o(k,`${m}-`)});let a=[];e.dark.surfaceSmart&&(a.push(`    /* Smart Surface Tokens (dark mode, context-aware) */
`),Object.entries(e.dark.surfaceSmart).forEach(([m,k])=>{a.push(`    --surface-${m}-bg: ${k.bg};
`),a.push(`    --surface-${m}-text: ${k.text};
`),a.push(`    --surface-${m}-text-secondary: ${k.textSecondary};
...
`,`    --color-input-disabled-text: var(--color-gray-600);
`,`    --color-code-bg: var(--color-gray-800);
`,...i].join(""),f=`    /* Backdrop tokens - dark mode */
    --backdrop-bg: linear-gradient(
        135deg,
        rgba(0, 0, 0, 0.6),
        rgba(0, 0, 0, 0.4)
    ...
    /* Legacy alias for backwards compatibility */
    --backdrop-background: var(--backdrop-bg);
`,g=this.#ne(e),h=r?[this.#y(r)]:[];return`
       html[data-theme="dark"] {
${[...n,...a,...h,$,...s,...d,...l,...p,...c,...u,...y,...b,f,g].join("")}       }
...
`}#de(){let{shape:e={},spatialRhythm:r={},inputPadding:n,buttonPadding:o,focusRingWidth:a,focusRingOpacity:i,borderWidthThin:s,sectionSpacing:d,buttonMinHeight:l,inputMinHeight:p}=this.options.design,c=typeof e.borderWidth=="number"?e.borderWidth:typeof e.borderWidth=="string"?S.BorderWidths[e.borderWidth]??null:null,u=r.inputPadding??n??.75,y=r.buttonPadding??o??1,b=a||3,$=s||c||S.BorderWidths.thin,f=r.sectionSpacing??d??2,g=l||30;return`/* Mobile-First Form Styles - Generated from Design Config */
form {
  margin: 0;
  width: 100%;
}
...
input, textarea, select {
  ...
  &:invalid {
    ...
    &:focus {
      box-shadow: 0 0 0 ${b}px color-mix(in oklab, var(--color-danger-fill) ${Math.round((i||.3)*100)}%, transparent);
    }
  }
}
...
:is(
  ...
  input[type="checkbox"]:focus + label:not(fieldset label):not(label[data-toggle]) {
    outline: none;
    box-shadow: 0 0 0 ${b}px color-mix(in oklab, var(--color-focus-ring, var(--color-primary-500)) ${Math.round((i||.3)*100)}%, transparent);
  }
...
button, .btn, input[type="submit"], input[type="button"], input[type="reset"] {
  ...
  --btn-target-h: max(${g}px, calc(var(--font-size-base) + (var(--btn-pad-y) * 2) + (var(--border-width-medium) * 2)));
  display: inline-flex;
  gap: var(--spacing-1);
  align-items: center;
  justify-content: center;
...
.btn-sm {
  ...
  --btn-target-h: max(calc(${g}px * 0.85), calc(var(--font-size-sm) + (var(--btn-pad-y) * 2) + (var(--border-width-medium) * 2)));
...
.btn-xs {
  ...
  --btn-target-h: max(calc(${g}px * 0.7), calc(var(--font-size-xs) + (var(--btn-pad-y) * 2) + (var(--border-width-medium) * 2)));
...
.btn-lg {
  ...
  --btn-target-h: max(calc(${g}px * 1.15), calc(var(--font-size-lg) + (var(--btn-pad-y) * 2) + (var(--border-width-medium) * 2)));
...
`}#ye(){let{layout:e={}}=this.options.design,r=e.buttonMinHeight||30,n=e.buttonPadding||1,o=`max(calc(var(--spacing-1) * ${n}), var(--spacing-2))`,a=`calc(max(calc(var(--spacing-1) * ${n}), var(--spacing-2)) * 0.85)`,i=`calc(max(calc(var(--spacing-1) * ${n}), var(--spacing-2)) * 0.7)`,s=`calc(max(calc(var(--spacing-1) * ${n}), var(--spacing-2)) * 1.15)`,d=.72,l=`calc(${o} * ${d})`,p=`calc(${a} * ${d})`,c=`calc(${i} * ${d})`,u=`calc(${s} * ${d})`,y=`${r}px`,b=`calc(${r}px * 0.85)`,$=`calc(${r}px * 0.7)`,f=`calc(${r}px * 1.15)`,g=`max(${y}, calc(var(--font-size-base) + (${o} * 2) + (var(--border-width-medium) * 2)))`,h=`max(${b}, calc(var(--font-size-sm) + (${a} * 2) + (var(--border-width-medium) * 2)))`,v=`max(${$}, calc(var(--font-size-xs) + (${i} * 2) + (var(--border-width-medium) * 2)))`,m=`max(${f}, calc(var(--font-size-lg) + (${s} * 2) + (var(--border-width-medium) * 2)))`;return`/* Icon System */
