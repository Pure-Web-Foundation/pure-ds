...
`)}),`${r.join("")}
`}#te(e,r){if(!e?.dark)return"";let n=[],o=(m,w="")=>{Object.entries(m).forEach(([A,C])=>{typeof C=="object"&&C!==null?o(C,`${w}${A}-`):typeof C=="string"&&n.push(`  --color-${w}${A}: ${C};
`)})};Object.entries(e.dark).forEach(([m,w])=>{m!=="surfaceSmart"&&typeof w=="object"&&w!==null&&o(w,`${m}-`)});let a=[];e.dark.surfaceSmart&&(a.push(`  /* Smart Surface Tokens (dark mode, context-aware) */
`),Object.entries(e.dark.surfaceSmart).forEach(([m,w])=>{a.push(`  --surface-${m}-bg: ${w.bg};
`),a.push(`  --surface-${m}-text: ${w.text};
`),a.push(`  --surface-${m}-text-secondary: ${w.textSecondary};
`),a.push(`  --surface-${m}-text-muted: ${w.textMuted};
`),a.push(`  --surface-${m}-icon: ${w.icon};
`),a.push(`  --surface-${m}-icon-subtle: ${w.iconSubtle};
`),a.push(`  --surface-${m}-shadow: ${w.shadow};
`),a.push(`  --surface-${m}-border: ${w.border};
`)}),a.push(`
...
`),Object.entries(e.surfaceAccent.dark).forEach(([m,w])=>{d.push(`  --surface-${m}-accent-text: ${w.text};
`),d.push(`  --surface-${m}-accent-text-hover: ${w.textHover};
...
`));let u=[];e.successInteractive?.dark&&(u.push(`  /* Success Role Colors (dark mode) */
`),u.push(`  --color-success-fill: ${e.successInteractive.dark.fill};
`),u.push(`  --color-success-fill-hover: ${e.successInteractive.dark.fillHover};
`),u.push(`  --color-success-fill-active: ${e.successInteractive.dark.fillActive};
`),u.push(`  --color-success-text: ${e.successInteractive.dark.text};
`),u.push(`  --color-success-text-hover: ${e.successInteractive.dark.textHover};
`),u.push(`  --color-success-contrast: ${e.successInteractive.dark.contrast};
...
`));let p=[];e.infoInteractive?.dark&&(p.push(`  /* Info Role Colors (dark mode) */
`),p.push(`  --color-info-fill: ${e.infoInteractive.dark.fill};
`),p.push(`  --color-info-fill-hover: ${e.infoInteractive.dark.fillHover};
`),p.push(`  --color-info-fill-active: ${e.infoInteractive.dark.fillActive};
`),p.push(`  --color-info-text: ${e.infoInteractive.dark.text};
`),p.push(`  --color-info-text-hover: ${e.infoInteractive.dark.textHover};
`),p.push(`  --color-info-contrast: ${e.infoInteractive.dark.contrast};
`));let b=[];e.surfaceStatus?.dark&&(b.push(`  /* Surface-Aware Status Text Tokens (dark mode) */
`),Object.entries(e.surfaceStatus.dark).forEach(([m,w])=>{Object.entries(w).forEach(([A,C])=>{b.push(`  --surface-${A}-${m}-text: ${C.text};
`),b.push(`  --surface-${A}-${m}-text-hover: ${C.textHover};
`)})}));let h=[`  /* Semantic Callout Display Tokens (dark mode) */
`];for(let m of["success","info","warning","danger"])h.push(`  --color-${m}-display-bg: color-mix(in oklab, var(--color-${m}-400) 12%, var(--color-surface-base));
`),h.push(`  --color-${m}-display-border: var(--color-${m}-400);
`),h.push(`  --color-${m}-display-text: var(--color-${m}-100);
...
`,g=`  /* Backdrop tokens - dark mode */
  ...
  /* Legacy alias for backwards compatibility */
  --backdrop-background: var(--backdrop-bg);
`,f=this.#oe(e),y=r?[this.#y(r)]:[];return`html[data-theme="dark"] {
${[...n,...a,...y,S,...i,...s,...d,...l,...u,...c,...p,...b,...h,g,f].join("")}}
`}#re(e,r){if(!e?.dark)return"";let n=[],o=(m,w="")=>{Object.entries(m).forEach(([A,C])=>{typeof C=="object"&&C!==null?o(C,`${w}${A}-`):typeof C=="string"&&n.push(`    --color-${w}${A}: ${C};
`)})};Object.entries(e.dark).forEach(([m,w])=>{m!=="surfaceSmart"&&typeof w=="object"&&w!==null&&o(w,`${m}-`)});let a=[];e.dark.surfaceSmart&&(a.push(`    /* Smart Surface Tokens (dark mode, context-aware) */
`),Object.entries(e.dark.surfaceSmart).forEach(([m,w])=>{a.push(`    --surface-${m}-bg: ${w.bg};
`),a.push(`    --surface-${m}-text: ${w.text};
`),a.push(`    --surface-${m}-text-secondary: ${w.textSecondary};
...
`,...i].join(""),g=`    /* Backdrop tokens - dark mode */
    ...
    /* Legacy alias for backwards compatibility */
    --backdrop-background: var(--backdrop-bg);
`,f=this.#ne(e),y=r?[this.#y(r)]:[];return`
       html[data-theme="dark"] {
${[...n,...a,...y,S,...s,...d,...l,...u,...c,...p,...b,...h,g,f].join("")}       }
...
`}#de(){let{shape:e={},spatialRhythm:r={},inputPadding:n,buttonPadding:o,focusRingWidth:a,focusRingOpacity:i,borderWidthThin:s,sectionSpacing:d,buttonMinHeight:l,inputMinHeight:u}=this.options.design,c=typeof e.borderWidth=="number"?e.borderWidth:typeof e.borderWidth=="string"?$.BorderWidths[e.borderWidth]??null:null,p=r.inputPadding??n??.75,b=r.buttonPadding??o??1,h=a||3,S=s||c||$.BorderWidths.thin,g=r.sectionSpacing??d??2,f=l||30;return`/* Mobile-First Form Styles - Generated from Design Config */
form {
  margin: 0;
  width: 100%;
}
...
:is(
  ...
  padding: calc(var(--spacing-1) * ${b*.6}) calc(var(--spacing-4) * 0.85);
  border: var(--border-width-medium) solid var(--color-border);
  border-radius: var(--radius-md);
  font-family: var(--font-family-body);
  font-size: var(--font-size-sm);
...
button, .btn, input[type="submit"], input[type="button"], input[type="reset"] {
  --btn-pad-y: max(calc(var(--spacing-1) * ${b}), var(--spacing-2));
...
.btn-sm {
  --btn-pad-y: calc(max(calc(var(--spacing-1) * ${b}), var(--spacing-2)) * 0.85);
...
.btn-xs {
  --btn-pad-y: calc(max(calc(var(--spacing-1) * ${b}), var(--spacing-2)) * 0.7);
...
.btn-lg {
  --btn-pad-y: calc(max(calc(var(--spacing-1) * ${b}), var(--spacing-2)) * 1.15);
...
`}#ue(){let{layout:e={}}=this.options.design,r=e.breakpoints||{sm:640,md:768,lg:1024,xl:1280};return`/* Table Styles - Mobile First */
...
`}#ye(){let{layout:e={}}=this.options.design,r=e.buttonMinHeight||30,n=e.buttonPadding||1,o=`max(calc(var(--spacing-1) * ${n}), var(--spacing-2))`,a=`calc(max(calc(var(--spacing-1) * ${n}), var(--spacing-2)) * 0.85)`,i=`calc(max(calc(var(--spacing-1) * ${n}), var(--spacing-2)) * 0.7)`,s=`calc(max(calc(var(--spacing-1) * ${n}), var(--spacing-2)) * 1.15)`,d=.72,l=`calc(${o} * ${d})`,u=`calc(${a} * ${d})`,c=`calc(${i} * ${d})`,p=`calc(${s} * ${d})`,b=`${r}px`,h=`calc(${r}px * 0.85)`,S=`calc(${r}px * 0.7)`,g=`calc(${r}px * 1.15)`,f=`max(${b}, calc(var(--font-size-base) + (${o} * 2) + (var(--border-width-medium) * 2)))`,y=`max(${h}, calc(var(--font-size-sm) + (${a} * 2) + (var(--border-width-medium) * 2)))`,v=`max(${S}, calc(var(--font-size-xs) + (${i} * 2) + (var(--border-width-medium) * 2)))`,m=`max(${g}, calc(var(--font-size-lg) + (${s} * 2) + (var(--border-width-medium) * 2)))`;return`/* Icon System */
...
`}#s(e){let r=parseInt(e.slice(1,3),16)/255,n=parseInt(e.slice(3,5),16)/255,o=parseInt(e.slice(5,7),16)/255,a=Math.max(r,n,o),i=Math.min(r,n,o),s,d,l=(a+i)/2;if(a===i)s=d=0;else{let u=a-i;switch(d=l>.5?u/(2-a-i):u/(a+i),a){case r:s=(n-o)/u+(n<o?6:0);break;case n:s=(o-r)/u+2;break;case o:s=(r-n)/u+4;break}s/=6}return{h:s*360,s:d*100,l:l*100}}#t(e,r,n){e=e/360,r=r/100,n=n/100;let o=(l,u,c)=>(c<0&&(c+=1),c>1&&(c-=1),c<1/6?l+(u-l)*6*c:c<1/2?u:c<2/3?l+(u-l)*(2/3-c)*6:l),a,i,s;if(r===0)a=i=s=n;else{let l=n<.5?n*(1+r):n+r-n*r,u=2*n-l;a=o(u,l,e+1/3),i=o(u,l,e),s=o(u,l,e-1/3)}let d=l=>{let u=Math.round(l*255).toString(16);return u.length===1?"0"+u:u};return`#${d(a)}${d(i)}${d(s)}`}getTokens(){return this.tokens}exportCSS(){return this.layeredCSS}#Se(){this.#e={tokens:this.#$e(),primitives:this.#Le(),components:this.#ze(),utilities:this.#Ce()},this.options.debug&&this.options.log?.("debug","[Generator] Layer sizes:",{tokens:`${(this.#e.tokens.length/1024).toFixed(2)} KB`,primitives:`${(this.#e.primitives.length/1024).toFixed(2)} KB`,components:`${(this.#e.components.length/1024).toFixed(2)} KB`,utilities:`${(this.#e.utilities.length/1024).toFixed(2)} KB`})}#$e(){let{colors:e,spacing:r,radius:n,borderWidths:o,typography:a,shadows:i,darkShadows:s,layout:d,transitions:l,zIndex:u,icons:c}=this.tokens,p=[`@layer tokens {
       :root {
          ${this.#q(e)}
          ${this.#G(r)}
          ${this.#K(n)}
...
`),p.push(this.#te(e,s)),p.join("")}#Le(){let{advanced:e={},a11y:r={},layout:n={}}=this.options.design,o=e.tabSize||$.TabSizes.standard,a=r.minTouchTarget||$.TouchTargetSizes.standard,i=n.breakpoints||{sm:640,md:768,lg:1024,xl:1280};return`@layer primitives {
  /* Base HTML reset */
  *, *::before, *::after {
    box-sizing: border-box;
  }
...
`}};function Fr(t={},e={}){let r=Number(e.minContrast||4.5),n=Number(e.minMutedContrast||3),o=!!e.extendedChecks,a=e.warnOnHueDrift!==!1,i=Number.isFinite(Number(e.maxHueDrift))?Number(e.maxHueDrift):35,s=Number.isFinite(Number(e.minSaturationForHueWarning))?Number(e.minSaturationForHueWarning):18,d=g=>{let y=String(g||"").trim().match(/^#?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/);if(!y)return null;let v=y[1];return`#${(v.length===3?v.split("").map(w=>w+w).join(""):v).toLowerCase()}`},l=g=>{let f=d(g);if(!f)return null;let y=f.replace("#",""),v=y.length===3?y.split("").map(w=>w+w).join(""):y,m=parseInt(v||"0",16);return{r:m>>16&255,g:m>>8&255,b:m&255}},u=g=>{let f=l(g);if(!f)return 0;let{r:y,g:v,b:m}=f,w=[y/255,v/255,m/255].map(A=>A<=.03928?A/12.92:Math.pow((A+.055)/1.055,2.4));return .2126*w[0]+.7152*w[1]+.0722*w[2]},c=(g,f)=>{if(!g||!f)return 0;let y=u(g),v=u(f),m=Math.max(y,v),w=Math.min(y,v);return(m+.05)/(w+.05)},p=g=>{let f=l(g);if(!f)return null;let y=f.r/255,v=f.g/255,m=f.b/255,w=Math.max(y,v,m),A=Math.min(y,v,m),C=w-A,R=0;C!==0&&(w===y?R=(v-m)/C%6:w===v?R=(m-y)/C+2:R=(y-v)/C+4,R*=60,R<0&&(R+=360));let z=(w+A)/2,M=C===0?0:C/(1-Math.abs(2*z-1));return{h:R,s:M*100,l:z*100}},b=(g,f)=>{if(!Number.isFinite(g)||!Number.isFinite(f))return null;let y=Math.abs(g-f);return Math.min(y,360-y)},h=[],S=[];try{let f=new X({design:structuredClone(t)}).tokens.colors,y={surfaceBg:f.surface?.base,surfaceText:f.gray?.[900]||"#000000",surfaceTextSecondary:f.gray?.[700]||f.gray?.[800]||f.gray?.[900],surfaceTextMuted:f.gray?.[500]||f.gray?.[600]||f.gray?.[700],surfaceElevated:f.surface?.elevated||f.surface?.base,primaryFill:f.interactive?.light?.fill||f.primary?.[600],primaryText:f.interactive?.light?.text||f.primary?.[600],accentFill:f.accent?.[600]||f.accent?.[500],successFill:f.success?.[600]||f.success?.[500],warningFill:f.warning?.[600]||f.warning?.[500],dangerFill:f.danger?.[600]||f.danger?.[500],infoFill:f.info?.[600]||f.info?.[500]},v=R=>Math.max(c(R,"#ffffff"),c(R,"#000000")),m=c(y.primaryFill,"#ffffff");m<r&&h.push({path:"/colors/primary",message:`Primary button contrast too low in light theme (${m.toFixed(2)} < ${r}). Choose a darker primary.`,ratio:m,min:r,context:"light/btn-primary"});let w=c(y.surfaceBg,y.surfaceText);if(w<r&&h.push({path:"/colors/background",message:`Base text contrast on surface (light) is too low (${w.toFixed(2)} < ${r}). Adjust background or secondary (gray).`,ratio:w,min:r,context:"light/surface-text"}),o){let R=c(y.surfaceBg,y.surfaceTextSecondary);R<r&&h.push({path:"/colors/secondary",message:`Secondary text contrast on base surface (light) is too low (${R.toFixed(2)} < ${r}).`,ratio:R,min:r,context:"light/surface-text-secondary"});let z=c(y.surfaceBg,y.surfaceTextMuted);z<n&&h.push({path:"/colors/secondary",message:`Muted text contrast on base surface (light) is too low (${z.toFixed(2)} < ${n}).`,ratio:z,min:n,context:"light/surface-text-muted"});let M=c(y.surfaceElevated,y.surfaceText);M<r&&h.push({path:"/colors/background",message:`Elevated surface text contrast (light) is too low (${M.toFixed(2)} < ${r}).`,ratio:M,min:r,context:"light/surface-elevated-text"})}let A=c(y.primaryText,y.surfaceBg);A<r&&h.push({path:"/colors/primary",message:`Primary text on surface is too low for outline/link styles (light) (${A.toFixed(2)} < ${r}). Choose a darker primary or lighter surface.`,ratio:A,min:r,context:"light/outline"}),o&&[{path:"/colors/accent",key:"accent",value:y.accentFill},{path:"/colors/success",key:"success",value:y.successFill},{path:"/colors/warning",key:"warning",value:y.warningFill},{path:"/colors/danger",key:"danger",value:y.dangerFill},{path:"/colors/info",key:"info",value:y.infoFill}].forEach(z=>{if(!z?.value)return;let M=v(z.value);M<r&&h.push({path:z.path,message:`${z.key} fill color cannot achieve accessible text contrast (${M.toFixed(2)} < ${r}) with either white or black text.`,ratio:M,min:r,context:`light/${z.key}-fill`})});let C=f.dark;if(C){let R={surfaceBg:C.surface?.base||f.surface?.inverse,surfaceText:C.gray?.[50]||C.gray?.[100]||"#ffffff",surfaceTextMuted:C.gray?.[300]||C.gray?.[400]||C.gray?.[500],primaryFill:f.interactive?.dark?.fill||C.primary?.[600],primaryText:f.interactive?.dark?.text||C.primary?.[600]},z=c(R.primaryFill,"#ffffff");z<r&&h.push({path:"/colors/darkMode/primary",message:`Primary button contrast too low in dark theme (${z.toFixed(2)} < ${r}). Override darkMode.primary or pick a brighter hue.`,ratio:z,min:r,context:"dark/btn-primary"});let M=c(R.primaryText,R.surfaceBg);if(M<r&&h.push({path:"/colors/darkMode/primary",message:`Primary text on surface is too low for outline/link styles (dark) (${M.toFixed(2)} < ${r}). Override darkMode.primary/background.`,ratio:M,min:r,context:"dark/outline"}),o){let P=c(R.surfaceBg,R.surfaceText);P<r&&h.push({path:"/colors/darkMode/background",message:`Base text contrast on surface (dark) is too low (${P.toFixed(2)} < ${r}).`,ratio:P,min:r,context:"dark/surface-text"});let E=c(R.surfaceBg,R.surfaceTextMuted);E<n&&h.push({path:"/colors/darkMode/secondary",message:`Muted text contrast on surface (dark) is too low (${E.toFixed(2)} < ${n}).`,ratio:E,min:n,context:"dark/surface-text-muted"})}}if(a){let R=t?.colors||{},z=R?.darkMode||{};["primary","secondary","accent"].forEach(P=>{let E=R?.[P],k=z?.[P];if(!E||!k)return;let L=p(E),T=p(k);if(!L||!T||L.s<s&&T.s<s)return;let I=b(L.h,T.h);I==null||I<=i||S.push({path:`/colors/darkMode/${P}`,message:`Dark mode ${P} hue drifts ${I.toFixed(1)}deg from light ${P} (${L.h.toFixed(1)}deg -> ${T.h.toFixed(1)}deg). This may reduce cross-theme brand identity consistency.`,context:`dark/identity-hue-${P}`})})}}catch(g){h.push({path:"/",message:`Validation failed: ${String(g?.message||g)}`,ratio:0,min:0})}return{ok:h.length===0,issues:h,warnings:S}}var po=new Set(["log","warn","error","debug","info"]),fo="__PURE_DS_PDS_SINGLETON__",Ht=null,Wt=null;function Nr(){try{let e=(typeof globalThis<"u"?globalThis:window)?.[fo];if(e&&typeof e=="object")return e}catch{return null}return null}function go(t){return!t||typeof t!="object"?null:{mode:t.mode==="live"||t.mode==="static"?t.mode:null,debug:t.debug===!0,thisArg:t.thisArg}}function mo(t){if(typeof t!="string")return"log";let e=t.toLowerCase();return po.has(e)?e:"log"}function ho(){if(typeof Wt=="function")try{let e=go(Wt());if(e)return e}catch{}let t=Nr();if(t){let e=t?.mode||t?.compiled?.mode||(t?.registry?.isLive?"live":"static"),r=(t?.debug||t?.currentConfig?.debug||t?.currentConfig?.design?.debug||t?.compiled?.debug||t?.compiled?.design?.debug||!1)===!0;return{mode:e,debug:r,thisArg:t}}return{mode:null,debug:!1}}function bo(){if(typeof Ht=="function")try{let e=Ht();if(typeof e=="function")return e}catch{}let t=Nr();return typeof t?.logHandler=="function"?t.logHandler:null}function Pr(t,e,...r){if(typeof console>"u")return;let n=typeof console[t]=="function"?console[t].bind(console):typeof console.log=="function"?console.log.bind(console):null;n&&(r.length>0?n(e,...r):n(e))}function yo(t,e){let r=e?.debug===!0;return!(e?.mode==="static"&&!r||!r&&t!=="error"&&t!=="warn")}function jr({getLogger:t,getContext:e}={}){Ht=typeof t=="function"?t:null,Wt=typeof e=="function"?e:null}function tt(t="log",e,...r){let n=mo(t),o=ho(),a=bo();if(a)try{a.call(o?.thisArg,n,e,...r);return}catch(i){Pr("error","Custom log handler failed:",i)}yo(n,o)&&Pr(n,e,...r)}var vo="en",F={defaultLocale:vo,provider:null,messagesByLocale:new Map,loadingByLocale:new Map,observer:null,reconcileTimer:null,requestedKeys:new Set,textNodeKeyMap:new WeakMap,attributeKeyMap:new WeakMap,valueToKeys:new Map,missingWarnings:new Set},xo=["title","placeholder","aria-label","aria-description","aria-placeholder","aria-roledescription","alt","label"],wo=t=>!!t&&typeof t!="string"&&typeof t=="object"&&"strTag"in t;function oe(t){return String(t||"").trim().toLowerCase()}function ko(t){let e=oe(t);return e?e.split("-")[0]||e:""}function ue(t){let e=oe(t);if(!e)return F.defaultLocale;let r=F.provider?.resolveLocale;if(typeof r=="function"){let n=oe(r(t));if(n)return n}return e}function So(t){let e="";for(let r=0;r<=t.length-1;r+=1)e+=t[r],r<t.length-1&&(e+=`{${r}}`);return e}function ye(t,e){return String(t).replace(/\{(\d+)\}/g,(r,n)=>e(Number(n)))}function Ut(t){if(!t||typeof t!="object")return{};let e={};for(let[r,n]of Object.entries(t)){if(typeof n=="string"){e[r]=n;continue}n&&typeof n=="object"&&typeof n.content=="string"&&(e[r]=n.content)}return e}function $o(t){let e=oe(t);if(!e)return[F.defaultLocale];let r=ko(e);return!r||r===e?[e]:[e,r]}function Or(t,e){let r=ue(t);F.messagesByLocale.set(r,Ut(e))}function Hr(t){typeof t=="string"&&t.length>0&&F.requestedKeys.add(t)}function Br(t,e){if(typeof t!="string"||!t.length)return;let r=typeof e=="string"?e:String(e||"");r.length&&(F.valueToKeys.has(r)||F.valueToKeys.set(r,new Set),F.valueToKeys.get(r).add(t))}function Oe(t){let e=$o(t);for(let r of e)if(F.messagesByLocale.has(r))return{locale:r,messages:F.messagesByLocale.get(r)};return null}async function ve(t,e="explicit"){let r=ue(t),n=Oe(r);if(n)return n.messages;let o=r;if(F.loadingByLocale.has(o))return F.loadingByLocale.get(o);if(!F.provider)return{};let a=F.provider.loadLocale||F.provider.setLocale||null;if(typeof a!="function")return{};let i={locale:r,defaultLocale:F.defaultLocale,reason:e,loadedLocales:Array.from(F.messagesByLocale.keys()),messages:{...Oe(r)?.messages||{}},load:e==="set-default"||e==="explicit-load"},s;try{s=a(i)}catch{return{}}if(s&&typeof s.then=="function"){let l=s.then(u=>{let c=Ut(u);return Or(r,c),c}).catch(()=>({})).finally(()=>{F.loadingByLocale.delete(o)});return F.loadingByLocale.set(o,l),l}let d=Ut(s);return Or(r,d),d}function Lo(t){if(!t||typeof t!="object")return"";let r=typeof Element<"u"&&t instanceof Element||t?.nodeType===1?t:null;if(!r)return"";if(r.hasAttribute?.("lang"))return oe(r.getAttribute("lang"));let n=r.closest?.("[lang]");return n&&n.getAttribute?oe(n.getAttribute("lang")):""}function Be(t={}){if(typeof t?.lang=="string"&&t.lang.trim())return ue(t.lang);let e=t?.element||t?.scope||t?.host||t?.contextElement||null,r=Lo(e);if(r)return ue(r);if(typeof document<"u"&&document.documentElement){let n=oe(document.documentElement.getAttribute("lang"));if(n)return ue(n)}return F.defaultLocale}function zo(){let t=new Set([F.defaultLocale]);if(typeof document>"u")return t;let e=oe(document.documentElement?.getAttribute?.("lang"));e&&t.add(ue(e));let r=document.querySelectorAll?.("[lang]")||[];for(let n of r){let o=oe(n.getAttribute("lang"));o&&t.add(ue(o))}return t}async function Co(t){for(let e of t)await ve(e,"lang-detected")}function Eo(t){for(let e of Array.from(F.messagesByLocale.keys()))t.has(e)||F.messagesByLocale.delete(e)}function Mo(t){let e=String(t||""),r=(e.match(/^\s*/)||[""])[0],n=(e.match(/\s*$/)||[""])[0],o=r.length,a=e.length-n.length,i=a>=o?e.slice(o,a):"";return{leading:r,core:i,trailing:n}}function Dr(t){return String(t||"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Ao(t,e){let r=typeof t=="string"?t:String(t||""),n=typeof e=="string"?e:String(e||""),o=/\{(\d+)\}/g,a=Array.from(r.matchAll(o));if(!a.length)return r===n?[]:null;let i=[],s="^",d=0;for(let c of a){let p=c.index??0;s+=Dr(r.slice(d,p)),s+="([\\s\\S]*?)",i.push(Number(c[1])),d=p+c[0].length}s+=Dr(r.slice(d)),s+="$";let l=new RegExp(s).exec(n);if(!l)return null;let u=[];for(let c=1;c<l.length;c+=1){let p=i[c-1],b=l[c];if(Object.prototype.hasOwnProperty.call(u,p)&&u[p]!==b)return null;u[p]=b}return u}function qt(t,e){if(typeof t!="string"||!t.length)return[];let r=[t];for(let[,n]of F.messagesByLocale.entries()){let o=n?.[t];typeof o=="string"&&o.length&&r.push(o)}for(let n of r){let o=Ao(n,e);if(o)return o}return[]}function Wr(t){if(!t)return null;let e=F.valueToKeys.get(t);if(e&&e.size>0){for(let n of e)if(F.requestedKeys.has(n))return n}if(F.requestedKeys.has(t))return t;let r=Array.from(F.messagesByLocale.entries());for(let n of F.requestedKeys)for(let[,o]of r)if(o&&o[n]===t)return n;return null}function Ur(t){if(!t)return null;let e=null;for(let[r,n]of F.valueToKeys.entries()){if(typeof r!="string"||!r.length||r===t)continue;let o=t.indexOf(r);if(o!==-1)for(let a of n){if(!F.requestedKeys.has(a))continue;let i=qt(a,r),s={key:a,matchedText:r,start:o,end:o+r.length,values:i};(!e||s.matchedText.length>e.matchedText.length)&&(e=s);break}}return e}async function To(t){if(!t||t.nodeType!==3)return;let e=t.parentElement||null;if(!e)return;let{leading:r,core:n,trailing:o}=Mo(t.nodeValue);if(!n)return;let a=F.textNodeKeyMap.get(t)||null;if((!a||!F.requestedKeys.has(a))&&(a=Wr(n)),!a){let c=Ur(n);if(!c)return;let p=Be({element:e});await ve(p,"text-node");let b=xe(c.key,c.values,{element:e},null),h=c.values.length?ye(b,f=>c.values[f]):b,S=n.slice(0,c.start)+h+n.slice(c.end),g=`${r}${S}${o}`;g!==t.nodeValue&&(t.nodeValue=g);return}F.textNodeKeyMap.set(t,a);let i=Be({element:e});await ve(i,"text-node");let s=qt(a,n),d=xe(a,s,{element:e},null),l=s.length?ye(d,c=>s[c]):d,u=`${r}${l}${o}`;u!==t.nodeValue&&(t.nodeValue=u)}async function Ro(){if(typeof document>"u"||F.requestedKeys.size===0)return;let t=document.body||document.documentElement;if(!t||typeof document.createTreeWalker!="function")return;let e=[],r=new Set,n=a=>{!a||r.has(a)||(r.add(a),e.push(a))};n(t);for(let a=0;a<e.length;a+=1){let i=e[a];if(!i||typeof i.querySelectorAll!="function")continue;let s=i.querySelectorAll("*");for(let d of s){let l=d?.shadowRoot;l&&n(l)}}let o=[];for(let a of e){let i=document.createTreeWalker(a,NodeFilter.SHOW_TEXT);for(;i.nextNode();)o.push(i.currentNode)}for(let a of o)await To(a)}function Io(t){let e=F.attributeKeyMap.get(t);return e||(e=new Map,F.attributeKeyMap.set(t,e)),e}async function _o(t,e){if(!t||typeof t.getAttribute!="function")return;let r=t.getAttribute(e);if(typeof r!="string"||!r.length)return;let n=Io(t),o=n.get(e)||null;if((!o||!F.requestedKeys.has(o))&&(o=Wr(r)),!o){let l=Ur(r);if(!l)return;let u=Be({element:t});await ve(u,"attribute");let c=xe(l.key,l.values,{element:t},null),p=l.values.length?ye(c,h=>l.values[h]):c,b=r.slice(0,l.start)+p+r.slice(l.end);b!==r&&t.setAttribute(e,b),n.set(e,l.key);return}n.set(e,o);let a=Be({element:t});await ve(a,"attribute");let i=qt(o,r),s=xe(o,i,{element:t},null),d=i.length?ye(s,l=>i[l]):s;d!==r&&t.setAttribute(e,d)}async function Fo(){if(typeof document>"u"||F.requestedKeys.size===0)return;let t=document.body||document.documentElement;if(!t)return;let e=[],r=new Set,n=o=>{!o||r.has(o)||(r.add(o),e.push(o))};n(t);for(let o=0;o<e.length;o+=1){let a=e[o];if(!a||typeof a.querySelectorAll!="function")continue;let i=a.querySelectorAll("*");for(let s of i){let d=s?.shadowRoot;d&&n(d)}}for(let o of e){if(!o||typeof o.querySelectorAll!="function")continue;let a=o.querySelectorAll("*");for(let i of a)for(let s of xo)i.hasAttribute(s)&&await _o(i,s)}}async function Po(){let t=zo();await Co(t),await Ro(),await Fo(),Eo(t)}function No(){typeof window>"u"||(F.reconcileTimer&&clearTimeout(F.reconcileTimer),F.reconcileTimer=setTimeout(()=>{F.reconcileTimer=null,Po()},16))}function xe(t,e=[],r={},n=null){let o=Be(r),a=Oe(o);a||ve(o,"msg");let i=Oe(o)?.messages||{},s=Oe(F.defaultLocale)?.messages||{},d={key:t,values:e,options:r,locale:o,defaultLocale:F.defaultLocale,messages:i,messagesByLocale:Object.fromEntries(Array.from(F.messagesByLocale.entries())),template:n},l,u=!!a,c=o===F.defaultLocale;typeof F.provider?.translate=="function"&&(l=F.provider.translate(d));let p=null;if(l==null&&(l=i[t]),l==null&&(l=s[t],p=l==null?null:"default"),l==null&&(l=t,p="key"),u&&!c&&p){let h=`${o}::${t}`;F.missingWarnings.has(h)||(F.missingWarnings.add(h),tt("warn",`[i18n] Missing translation for locale "${o}" and key "${t}"; using ${p} fallback.`))}let b=typeof l=="string"?l:String(l);if(Br(t,b),Array.isArray(e)&&e.length>0){let h=ye(b,S=>e[S]);h!==b&&Br(t,h)}return b}var jo=(t,e,r={})=>{let n=So(t);Hr(n);let o=xe(n,e,r,{strings:t,values:e});return ye(o,a=>e[a])};var se=(t,e={})=>{if(!t)return"";if(wo(t))return jo(t.strings,t.values,e);let r=String(t);Hr(r);let n=xe(r,[],e,null);return!e?.element&&!e?.scope&&!e?.host&&!e?.contextElement&&!e?.lang&&No(),n};var Gt=class extends EventTarget{constructor(){super(),this.mode=null,this.compiled=null,this.log=()=>{},this.logHandler=null}},qr="__PURE_DS_PDS_SINGLETON__",Kt=typeof globalThis<"u"?globalThis:window,Vt=Kt?.[qr],x=Vt&&typeof Vt.addEventListener=="function"?Vt:new Gt;Kt&&(Kt[qr]=x);typeof x.log!="function"&&(x.log=(t="log",e,...r)=>{if(typeof console>"u")return;let n=typeof console[t]=="function"?console[t].bind(console):typeof console.log=="function"?console.log.bind(console):null;n&&(r.length>0?n(e,...r):n(e))});typeof x.logHandler!="function"&&(x.logHandler=null);var Jt=class{constructor(){this._mode="static",this._staticPaths={tokens:"/assets/pds/styles/pds-tokens.css.js",primitives:"/assets/pds/styles/pds-primitives.css.js",components:"/assets/pds/styles/pds-components.css.js",utilities:"/assets/pds/styles/pds-utilities.css.js",styles:"/assets/pds/styles/pds-styles.css.js"}}setLiveMode(){this._mode="live"}setStaticMode(e={}){this._mode="static",this._staticPaths={...this._staticPaths,...e}}async getStylesheet(e){if(this._mode==="live")return null;try{return(await import(this._staticPaths[e]))[e]}catch(r){x.log("error",`Registry: failed to load static ${e}:`,r),x.log("error",`Registry: looking for ${this._staticPaths[e]}`),x.log("error","Registry: make sure you've run 'npm run pds:build' and configured PDS.start() with the correct static.root path");let n=new CSSStyleSheet;return n.replaceSync("/* Failed to load "+e+" */"),n}}get mode(){return this._mode}get isLive(){return this._mode==="live"}},we=new Jt;function Oo(t){try{if(typeof document>"u")return;if(typeof CSSStyleSheet<"u"&&"adoptedStyleSheets"in Document.prototype){let n=new CSSStyleSheet;n.replaceSync(t),n._pds=!0;let o=(document.adoptedStyleSheets||[]).filter(a=>a._pds!==!0);document.adoptedStyleSheets=[...o,n];return}let e="pds-runtime-stylesheet",r=document.getElementById(e);if(!r){r=document.createElement("style"),r.id=e,r.type="text/css";let n=document.head||document.getElementsByTagName("head")[0];n?n.appendChild(r):document.documentElement.appendChild(r)}r.textContent=t}catch(e){x.log("warn","installRuntimeStyles failed:",e)}}function Vr(t){let e=t;if(!e||typeof e!="object"){x.log("error","Runtime applyStyles requires an explicit generator instance in live mode");return}let r=e.layeredCSS||e.css||"";if(!r){e.options?.log?.("warn","Runtime: no CSS available on generator to apply");return}Oo(r)}async function rt(t,e=[],r=null){try{let n=r?.primitivesStylesheet?r.primitivesStylesheet:await we.getStylesheet("primitives");t.adoptedStyleSheets=[n,...e]}catch(n){let o=t.host?.tagName?.toLowerCase()||"unknown";x.log("error",`Adopter: <${o}> failed to adopt primitives:`,n),t.adoptedStyleSheets=e}}async function nt(t,e=["primitives"],r=[],n=null){let o=Array.isArray(r)?r.filter(Boolean):[];if(o.length){let i=(Array.isArray(t.adoptedStyleSheets)?t.adoptedStyleSheets:[]).filter(s=>!o.includes(s));t.adoptedStyleSheets=[...i,...o]}try{let i=(await Promise.all(e.map(async s=>{if(n)switch(s){case"tokens":return n.tokensStylesheet;case"primitives":return n.primitivesStylesheet;case"components":return n.componentsStylesheet;case"utilities":return n.utilitiesStylesheet;default:break}return we.getStylesheet(s)}))).filter(s=>s!==null);t.adoptedStyleSheets=[...i,...o]}catch(a){let i=t.host?.tagName?.toLowerCase()||"unknown";x.log("error",`Adopter: <${i}> failed to adopt layers:`,a),t.adoptedStyleSheets=o}}function Gr(t){let e=new CSSStyleSheet;return e.replaceSync(t),e}var Bo=[{selector:".accordion"},{selector:"nav[data-dropdown]"},{selector:"label[data-toggle]"},{selector:"label[data-color]"},{selector:'input[type="range"]'},{selector:"form[data-required]"},{selector:"fieldset[role=group][data-open]"},{selector:"[data-clip]"},{selector:"button, a[class*='btn-']"}];function Do(t){t.dataset.enhancedAccordion||(t.dataset.enhancedAccordion="true",t.addEventListener("toggle",e=>{e.target.open&&e.target.parentElement===t&&t.querySelectorAll(":scope > details[open]").forEach(r=>{r!==e.target&&(r.open=!1)})},!0))}function Ho(t){if(t.dataset.enhancedDropdown)return;t.dataset.enhancedDropdown="true";let e=t.lastElementChild;if(!e)return;let r=t.querySelector("[data-dropdown-toggle]")||t.querySelector("button"),n=typeof HTMLElement<"u"&&"showPopover"in HTMLElement.prototype&&"hidePopover"in HTMLElement.prototype;r&&!r.hasAttribute("type")&&r.setAttribute("type","button"),e.id||(e.id=`dropdown-${Math.random().toString(36).slice(2,9)}`);let o=e.tagName?.toLowerCase()==="menu",a=8;if(o&&!e.hasAttribute("role")&&e.setAttribute("role","menu"),e.hasAttribute("aria-hidden")||e.setAttribute("aria-hidden","true"),r&&(r.setAttribute("aria-haspopup","true"),r.setAttribute("aria-controls",e.id),r.setAttribute("aria-expanded","false")),!n){let z="__PDS_DROPDOWN_POPOVER_WARNED__";globalThis[z]||(globalThis[z]=!0,console.warn("[PDS] nav[data-dropdown] requires the Popover API. Add a popover polyfill (recommended: @oddbird/popover-polyfill) for browsers without support."));return}e.setAttribute("popover","auto");let i=()=>{let z=e.getAttribute("style");e.style.visibility="hidden",e.style.display="inline-block",e.style.pointerEvents="none";let M=e.getBoundingClientRect(),P=Math.max(e.offsetWidth||0,e.scrollWidth||0,M.width||0,1),E=Math.max(e.offsetHeight||0,e.scrollHeight||0,M.height||0,1);return z===null?e.removeAttribute("style"):e.setAttribute("style",z),{width:P,height:E}},s=()=>{try{return e.matches(":popover-open")}catch{return!1}},d=()=>{e.setAttribute("aria-hidden","true"),r?.setAttribute("aria-expanded","false")},l=()=>{e.setAttribute("aria-hidden","false"),r?.setAttribute("aria-expanded","true")},u=()=>{let z=(t.getAttribute("data-direction")||t.getAttribute("data-dropdown-direction")||t.getAttribute("data-mode")||"auto").toLowerCase();if(z==="up"||z==="down")return z;let M=(r||t).getBoundingClientRect(),{height:P}=i(),E=Math.max(0,window.innerHeight-M.bottom),k=Math.max(0,M.top),L=E>=P,T=k>=P;return L&&!T?"down":T&&!L?"up":L&&T?"down":k>E?"up":"down"},c=()=>{let z=(t.getAttribute("data-align")||t.getAttribute("data-dropdown-align")||"auto").toLowerCase();if(z==="left"||z==="right"||z==="start"||z==="end")return z==="start"?"left":z==="end"?"right":z;let M=(r||t).getBoundingClientRect(),{width:P}=i(),E=Math.max(0,window.innerWidth-M.left),k=Math.max(0,M.right),L=E>=P,T=k>=P;return L&&!T?"left":T&&!L?"right":L&&T?"left":k>E?"right":"left"},p=(z,M=8)=>{let P=getComputedStyle(t).getPropertyValue(z).trim();if(!P)return M;let E=document.createElement("span");E.style.position="fixed",E.style.visibility="hidden",E.style.pointerEvents="none",E.style.height=P,document.body.appendChild(E);let k=Number.parseFloat(getComputedStyle(E).height);return E.remove(),Number.isFinite(k)?k:M},b=()=>{["position","left","top","right","bottom","margin-top","margin-bottom","max-width","max-inline-size","max-height","overflow"].forEach(z=>e.style.removeProperty(z))},h=()=>{if(!s())return;let z=(r||t).getBoundingClientRect(),M=window.visualViewport,P=M?.width||document.documentElement?.clientWidth||window.innerWidth,E=M?.height||document.documentElement?.clientHeight||window.innerHeight,k=M?.offsetLeft||0,L=M?.offsetTop||0,T=Math.max(1,P-a*2),I=Math.max(1,E-a*2);e.style.maxWidth=`${Math.round(T)}px`,e.style.maxInlineSize=`${Math.round(T)}px`,e.style.maxHeight=`${Math.round(I)}px`,e.style.overflow="auto";let{width:O,height:B}=i(),K=p("--spacing-2",8),N=u(),D=c();t.dataset.dropdownDirection=N,t.dataset.dropdownAlign=D;let Y=D==="right"?z.right-O:z.left;O>=T-1?Y=k+a:Y=Math.max(k+a,Math.min(Y,k+P-O-a));let Re=N==="up"?z.top-K-B:z.bottom+K;Re=Math.max(L+a,Math.min(Re,L+E-B-a)),Object.assign(e.style,{position:"fixed",left:`${Math.round(Y)}px`,top:`${Math.round(Re)}px`,right:"auto",bottom:"auto",marginTop:"0",marginBottom:"0"})},S=null,g=()=>{S||(S=()=>h(),window.addEventListener("resize",S),window.addEventListener("scroll",S,!0))},f=()=>{S&&(window.removeEventListener("resize",S),window.removeEventListener("scroll",S,!0),S=null)},y=null,v=null,m=()=>{y||typeof document>"u"||(y=()=>{s()&&(t.dataset.dropdownDirection=u(),t.dataset.dropdownAlign=c(),v!==null&&cancelAnimationFrame(v),v=requestAnimationFrame(()=>{v=null,s()&&h()}))},document.addEventListener("pds:config-changed",y))},w=()=>{!y||typeof document>"u"||(document.removeEventListener("pds:config-changed",y),y=null,v!==null&&(cancelAnimationFrame(v),v=null))};e.addEventListener("toggle",z=>{if(z.newState==="open"){l(),h(),g(),m();return}d(),f(),w(),b()});let A=()=>{s()||(t.dataset.dropdownDirection=u(),t.dataset.dropdownAlign=c(),e.showPopover(),requestAnimationFrame(()=>h()))},C=()=>{s()&&e.hidePopover()},R=()=>{s()?C():A()};d(),e.addEventListener("click",z=>{let M=z.target instanceof Element?z.target:z.target?.parentElement;M&&M.closest("[data-dropdown-close]")&&C()}),r?.addEventListener("click",z=>{z.preventDefault(),z.stopPropagation(),R()}),t.addEventListener("keydown",z=>{z.key==="Escape"&&(C(),r?.focus())})}function Wo(t){if(t.dataset.enhancedToggle)return;t.dataset.enhancedToggle="true";let e=t.querySelector('input[type="checkbox"]');if(!e)return;t.hasAttribute("tabindex")||t.setAttribute("tabindex","0"),t.setAttribute("role","switch"),t.setAttribute("aria-checked",e.checked?"true":"false");let r=document.createElement("span");r.className="toggle-switch",r.setAttribute("role","presentation"),r.setAttribute("aria-hidden","true");let n=document.createElement("span");n.className="toggle-knob",r.appendChild(n),t.insertBefore(r,e.nextSibling);let o=()=>{t.setAttribute("aria-checked",e.checked?"true":"false")},a=()=>{e.disabled||(e.checked=!e.checked,o(),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})))};t.addEventListener("click",i=>{i.preventDefault(),a()}),t.addEventListener("keydown",i=>{(i.key===" "||i.key==="Enter")&&(i.preventDefault(),a())}),e.addEventListener("change",o)}function Uo(t){if(t.dataset.enhancedColorInput)return;let e=t.querySelector('input[type="color"]');if(!e)return;t.dataset.enhancedColorInput="true";let r=t.querySelector(":scope > .color-control"),n=t.querySelector(":scope > .color-control > .color-swatch"),o=t.querySelector(":scope > .color-control > output");r||(r=document.createElement("span"),r.className="color-control",e.before(r)),n||(n=document.createElement("span"),n.className="color-swatch",r.appendChild(n)),e.parentElement!==n&&n.appendChild(e),o||(o=document.createElement("output"),r.appendChild(o));let a=()=>{if(e.dataset.colorUnset==="1"){o.value="",o.textContent=se("not set"),r.dataset.value="",r.dataset.unset="1",n.dataset.unset="1";return}o.value=e.value,o.textContent=e.value,r.dataset.value=e.value,delete r.dataset.unset,delete n.dataset.unset};a();let i=()=>{e.dataset.colorUnset==="1"&&(e.dataset.colorUnset="0"),a()};e.addEventListener("input",i,{passive:!0}),e.addEventListener("change",i,{passive:!0})}function qo(t){if(t.dataset.enhancedRange)return;let e=i=>{if(t.dataset.enhancedRangeProgrammatic)return;t.dataset.enhancedRangeProgrammatic="1";let s=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(t),"value")||Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value");s?.get&&s?.set&&Object.defineProperty(t,"value",{configurable:!0,enumerable:s.enumerable,get(){return s.get.call(this)},set(l){s.set.call(this,l),i()}}),new MutationObserver(l=>{l.some(c=>{let p=c.attributeName;return p==="value"||p==="min"||p==="max"})&&i()}).observe(t,{attributes:!0,attributeFilter:["value","min","max"]})},r=t.closest("label"),n=r?.classList.contains("range-output"),o=t.id||`range-${Math.random().toString(36).substring(2,11)}`,a=`${o}-output`;if(t.id=o,n){let i=r.querySelector("span");if(i&&!i.classList.contains("range-output-wrapper")){let s=i.getAttribute("data-range-label")||r.getAttribute("data-range-label")||"",d=document.createElement("span");d.className="range-output-wrapper",d.style.display="flex",d.style.justifyContent="space-between",d.style.alignItems="center";let l=document.createElement("span");l.textContent=s||i.textContent,d.appendChild(l);let u=document.createElement("output");u.id=a,u.setAttribute("for",o),u.style.color="var(--surface-text-secondary, var(--color-text-secondary))",u.style.fontSize="0.875rem",u.textContent=t.value,d.appendChild(u),i.textContent="",i.appendChild(d);let c=()=>{u.textContent=t.value};t.addEventListener("input",c),t.addEventListener("change",c),e(c),c()}}else{let i=t.closest(".range-container");i||(i=document.createElement("div"),i.className="range-container",t.parentNode?.insertBefore(i,t),i.appendChild(t)),i.style.position="relative";let s=document.createElement("output");s.id=a,s.setAttribute("for",o),s.className="range-bubble",s.setAttribute("aria-live","polite"),i.appendChild(s);let d=()=>{let c=parseFloat(t.min)||0,p=parseFloat(t.max)||100,b=parseFloat(t.value),h=(b-c)/(p-c);s.style.left=`calc(${h*100}% )`,s.textContent=String(b)},l=()=>s.classList.add("visible"),u=()=>s.classList.remove("visible");t.addEventListener("input",d),t.addEventListener("pointerdown",l),t.addEventListener("pointerup",u),t.addEventListener("pointerleave",u),t.addEventListener("focus",l),t.addEventListener("blur",u),t.addEventListener("change",d),e(d),d()}t.dataset.enhancedRange="1"}function Vo(t){if(t.dataset.enhancedRequired)return;t.dataset.enhancedRequired="true";let e=r=>{let n;if(r.closest("[role$=group]")?n=r.closest("[role$=group]").querySelector("legend"):n=r.closest("label"),!n||n.querySelector(".required-asterisk"))return;let o=document.createElement("span");o.classList.add("required-asterisk"),o.textContent="*",o.style.marginLeft="4px";let a=n.querySelector("span, [data-label]");if(a)a.appendChild(o);else{let s=n.querySelector("input, select, textarea");s?n.insertBefore(o,s):n.appendChild(o)}let i=r.closest("form");if(i&&!i.querySelector(".required-legend")){let s=document.createElement("small");s.classList.add("required-legend"),s.textContent=se("* Required fields"),i.insertBefore(s,i.querySelector(".form-actions")||i.lastElementChild)}};t.querySelectorAll("[required]").forEach(r=>{e(r)})}function Go(t){if(t.dataset.enhancedOpenGroup)return;t.dataset.enhancedOpenGroup="true",t.classList.add("flex","flex-wrap","buttons");let e=document.createElement("input");e.type="text",e.placeholder=se("Add item..."),e.classList.add("input-text","input-sm"),e.style.width="auto";let r=()=>t.querySelector('input[type="radio"], input[type="checkbox"]');t.appendChild(e),e.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key==="Tab"){let o=e.value.trim();if(o){n.preventDefault();let a=r(),i=a?.type==="radio"?"radio":"checkbox",s=`open-group-${Math.random().toString(36).substring(2,11)}`,d=document.createElement("label"),l=document.createElement("span");l.setAttribute("data-label",""),l.textContent=o;let u=document.createElement("input");u.type=i,u.name=a?.name||t.getAttribute("data-name")||"open-group",u.value=o,u.id=s,d.appendChild(l),d.appendChild(u),t.insertBefore(d,e),e.value=""}}else if(n.key==="Backspace"&&e.value===""){n.preventDefault();let o=t.querySelectorAll("label");o.length>0&&o[o.length-1].remove()}})}function Ko(t){if(t.dataset.enhancedClip)return;t.dataset.enhancedClip="true",t.hasAttribute("tabindex")||t.setAttribute("tabindex","0"),t.hasAttribute("role")||t.setAttribute("role","button");let e=()=>{let n=t.getAttribute("data-clip-open")==="true";t.setAttribute("aria-expanded",n?"true":"false")},r=()=>{let n=t.getAttribute("data-clip-open")==="true";t.setAttribute("data-clip-open",n?"false":"true"),e()};t.addEventListener("click",n=>{n.defaultPrevented||r()}),t.addEventListener("keydown",n=>{(n.key===" "||n.key==="Enter")&&(n.preventDefault(),r())}),e()}function Jo(t){if(t.dataset.enhancedBtnWorking)return;t.dataset.enhancedBtnWorking="true";let e=null,r=!1;new MutationObserver(o=>{o.forEach(a=>{if(a.attributeName==="class"){let i=t.classList.contains("btn-working"),s=t.querySelector("pds-icon");if(i)if(s)e||(e=s.getAttribute("icon")),s.setAttribute("icon","circle-notch");else{let d=document.createElement("pds-icon");d.setAttribute("icon","circle-notch"),d.setAttribute("size","sm"),t.insertBefore(d,t.firstChild),r=!0}else a.oldValue?.includes("btn-working")&&s&&(r?(s.remove(),r=!1):e&&(s.setAttribute("icon",e),e=null))}})}).observe(t,{attributes:!0,attributeFilter:["class"],attributeOldValue:!0})}var Yo=new Map([[".accordion",Do],["nav[data-dropdown]",Ho],["label[data-toggle]",Wo],["label[data-color]",Uo],['input[type="range"]',qo],["form[data-required]",Vo],["fieldset[role=group][data-open]",Go],["[data-clip]",Ko],["button, a[class*='btn-']",Jo]]),ot=Bo.map(t=>({...t,run:Yo.get(t.selector)||(()=>{})}));var Kr=[{selector:".accordion",description:"Ensures only one <details> element can be open at a time within the accordion.",demoHtml:`
      <div class="accordion">
        <details>
    ...
    `.trim()}];var Yr="pds",Zo=/^([a-z][a-z0-9+\-.]*:)?\/\//i,Jr=/^[a-z]:/i;function De(t=""){return t.endsWith("/")?t:`${t}/`}function Xo(t="",e=Yr){let r=t.replace(/\/+$/,"");return new RegExp(`(?:^|/)${e}$`,"i").test(r)?r:`${r}/${e}`}function Qo(t){return t.replace(/^\.\/+/,"")}function ea(t){return Jr.test(t)?t.replace(Jr,"").replace(/^\/+/,""):t}function ta(t){return t.startsWith("public/")?t.substring(7):t}function ke(t,e={}){let r=e.segment||Yr,n=e.defaultRoot||`/assets/${r}/`,o=t?.public&&t.public?.root||t?.static&&t.static?.root||null;if(!o||typeof o!="string")return De(n);let a=o.trim();return a?(a=a.replace(/\\/g,"/"),a=Xo(a,r),a=De(a),Zo.test(a)?a:(a=Qo(a),a=ea(a),a.startsWith("/")||(a=ta(a),a.startsWith("/")||(a=`/${a}`),a=a.replace(/\/+/g,(i,s)=>s===0?i:"/")),De(a))):De(n)}function Zr(t){let e=t.replace(/['"]/g,"").trim();if(["system-ui","-apple-system","sans-serif","serif","monospace","cursive","fantasy","ui-sans-serif","ui-serif","ui-monospace","ui-rounded"].includes(e.toLowerCase()))return!0;let o=document.createElement("canvas").getContext("2d");if(!o)return!1;let a="mmmmmmmmmmlli",i="72px",s="monospace";o.font=`${i} ${s}`;let d=o.measureText(a).width;o.font=`${i} "${e}", ${s}`;let l=o.measureText(a).width;return d!==l}function ra(t){return t?t.split(",").map(n=>n.trim())[0].replace(/['"]/g,"").trim():null}async function Xr(t,e={}){if(!t)return Promise.resolve();let{weights:r=[400,500,600,700],italic:n=!1}=e,o=ra(t);if(!o||Zr(o))return Promise.resolve();let a=encodeURIComponent(o);return document.querySelector(`link[href*="fonts.googleapis.com"][href*="${a}"]`)?(x.log("log",`Font "${o}" is already loading or loaded`),Promise.resolve()):(x.log("log",`Loading font "${o}" from Google Fonts...`),new Promise((s,d)=>{let l=document.createElement("link");l.rel="stylesheet";let u=n?`ital,wght@0,${r.join(";0,")};1,${r.join(";1,")}`:`wght@${r.join(";")}`;l.href=`https://fonts.googleapis.com/css2?family=${a}:${u}&display=swap`,l.setAttribute("data-font-loader",o),l.onload=()=>{x.log("log",`Successfully loaded font "${o}"`),s()},l.onerror=()=>{x.log("warn",`Failed to load font "${o}" from Google Fonts`),d(new Error(`Failed to load font: ${o}`))},document.head.appendChild(l),setTimeout(()=>{Zr(o)||x.log("warn",`Font "${o}" did not load within timeout`),s()},5e3)}))}async function Yt(t){if(!t)return Promise.resolve();let e=new Set;t.fontFamilyHeadings&&e.add(t.fontFamilyHeadings),t.fontFamilyBody&&e.add(t.fontFamilyBody),t.fontFamilyMono&&e.add(t.fontFamilyMono);let r=Array.from(e).map(n=>Xr(n).catch(o=>{x.log("warn",`Could not load font: ${n}`,o)}));await Promise.all(r)}var Xt=null;async function oa(){return Xt||(Xt=Promise.resolve().then(()=>(en(),Qr)).then(t=>t?.AutoDefiner||t?.default?.AutoDefiner||t?.default).then(t=>{if(typeof t!="function")throw new Error("AutoDefiner constructor not found in pure-web/auto-definer");return t})),Xt}var aa=/^[a-z][a-z0-9+\-.]*:\/\//i,He=(()=>{try{return import.meta.url}catch{return}})(),Se=t=>typeof t=="string"&&t.length&&!t.endsWith("/")?`${t}/`:t;function $e(t,e={}){if(!t||aa.test(t))return t;let{preferModule:r=!0}=e,n=()=>{if(!He)return null;try{return new URL(t,He).href}catch{return null}},o=()=>{if(typeof window>"u"||!window.location?.origin)return null;try{return new URL(t,window.location.origin).href}catch{return null}};return(r?n()||o():o()||n())||t}var tn=(()=>{if(He)try{let t=new URL(He);if(/\/public\/assets\/js\//.test(t.pathname))return new URL("../pds/",He).href}catch{return}})(),rn=!1;function it(t){rn||typeof document>"u"||(rn=!0,t.addEventListener("pds:ready",e=>{let r=e.detail?.mode;r&&document.documentElement.classList.add(`pds-${r}`,"pds-ready")}))}function er(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};for(let[n,o]of Object.entries(e))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=er(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function Qt(t=""){return String(t).toLowerCase().replace(/&/g," and ").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function pe(t){if(t==null)return t;if(typeof t=="function")return;if(typeof t!="object")return t;if(Array.isArray(t))return t.map(r=>pe(r)).filter(r=>r!==void 0);let e={};for(let r in t)if(t.hasOwnProperty(r)){let n=t[r];if(typeof n!="function"){let o=pe(n);o!==void 0&&(e[r]=o)}}return e}function at(t){let e=pe(t);return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}function tr(t={},e={},{presets:r,defaultLog:n,validateDesignConfig:o,validateInitConfig:a}={}){let i=t&&typeof t.log=="function"?t.log:n,s=typeof t=="object"&&("colors"in t||"typography"in t||"spatialRhythm"in t||"shape"in t||"behavior"in t||"layout"in t||"advanced"in t||"a11y"in t||"components"in t||"icons"in t),d=t&&t.enhancers;d&&!Array.isArray(d)&&(d=Object.values(d));let l=d??e.enhancers??[],u=t&&t.preset,c=t&&t.design,p=t&&t.icons&&typeof t.icons=="object"?t.icons:null,b="preset"in(t||{})||"design"in(t||{})||"enhancers"in(t||{});t&&typeof t=="object"&&typeof a=="function"&&a(t,{log:i,context:"PDS.start"});let h,S=null;if(b){c&&typeof c=="object"&&typeof o=="function"&&o(c,{log:i,context:"PDS.start"});let g=String(u||"default").toLowerCase(),f=r?.[g]||Object.values(r||{}).find(B=>Qt(B.name)===g||String(B.name||"").toLowerCase()===g);if(!f)throw new Error(`PDS preset not found: "${u||"default"}"`);S={id:f.id||Qt(f.name),name:f.name||f.id||String(g)};let y=at(f);if(c&&typeof c=="object"||p){let B=c?pe(c):{},K=p?pe(p):null,N=K?er(B,{icons:K}):B;y=er(y,at(N))}let{mode:v,autoDefine:m,applyGlobalStyles:w,manageTheme:A,themeStorageKey:C,preloadStyles:R,criticalLayers:z,managerURL:M,manager:P,localization:E,preset:k,design:L,enhancers:T,log:I,...O}=t;h={...O,design:y,preset:S.name,log:I||n}}else if(s){typeof o=="function"&&o(t,{log:i,context:"PDS.start"});let{log:g,...f}=t;h={design:at(f),log:g||n}}else{let g=r?.default||Object.values(r||{}).find(f=>Qt(f.name)==="default");if(!g)throw new Error("PDS default preset not available");S={id:g.id||"default",name:g.name||"Default"},h={design:at(g),preset:S.name,log:n}}return{generatorConfig:h,enhancers:l,presetInfo:S}}function st({manageTheme:t,themeStorageKey:e,applyResolvedTheme:r,setupSystemListenerIfNeeded:n}){let o="light",a=null;if(t&&typeof window<"u"){try{a=localStorage.getItem(e)||null}catch{a=null}try{r?.(a),n?.(a)}catch{}a?a==="system"?o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":o=a:o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}return{resolvedTheme:o,storedTheme:a}}function Le(t,{resolvePublicAssetURL:e}){let r=!!(t?.public?.root||t?.static?.root),n=e(t);return!r&&tn&&(n=tn),Se($e(n))}async function lt(t,{baseEnhancers:e=[]}={}){let{autoDefineBaseURL:r="/auto-define/",autoDefinePreload:n=[],autoDefineMapper:o=null,enhancers:a=[],autoDefineOverrides:i=null,autoDefinePreferModule:s=!0}=t,d=(()=>{let u=new Map;return(e||[]).forEach(c=>u.set(c.selector,c)),(a||[]).forEach(c=>u.set(c.selector,c)),Array.from(u.values())})(),l=null;if(typeof window<"u"&&typeof document<"u"){let u=await oa(),c=v=>{switch(v){case"pds-tabpanel":return"pds-tabstrip.js";default:return`${v}.js`}},{mapper:p,enhancers:b,...h}=i&&typeof i=="object"?i:{},S=b?Array.isArray(b)?b:typeof b=="object"?Object.values(b):[]:[],g=(()=>{let v=new Map;return(d||[]).forEach(m=>{m?.selector&&v.set(m.selector,m)}),(S||[]).forEach(m=>{if(!m?.selector)return;let w=v.get(m.selector)||null;v.set(m.selector,{...w||{},...m,run:typeof m?.run=="function"?m.run:w?.run})}),Array.from(v.values())})(),y={baseURL:r&&Se($e(r,{preferModule:s})),predefine:n,scanExisting:!0,observeShadows:!0,patchAttachShadow:!0,debounceMs:16,enhancers:g,onError:(v,m)=>{if(typeof v=="string"&&v.startsWith("pds-")){let A=["pds-form","pds-drawer"].includes(v),C=m?.message?.includes("#pds/lit")||m?.message?.includes("Failed to resolve module specifier");A&&C?x.log("error",`\u274C PDS component <${v}> requires Lit but #pds/lit is not in import map.
              See: https://github.com/Pure-Web-Foundation/pure-ds/blob/main/readme.md#lit-components-not-working`):x.log("warn",`\u26A0\uFE0F PDS component <${v}> not found. Assets may not be installed.`)}else x.log("error",`\u274C Auto-define error for <${v}>:`,m)},...h,mapper:v=>{if(customElements.get(v))return null;if(typeof o=="function")try{let m=o(v);return m===void 0?c(v):m}catch(m){return x.log("warn","Custom autoDefine.mapper error; falling back to default:",m?.message||m),c(v)}return c(v)}};l=new u(y),n.length>0&&typeof u.define=="function"&&await u.define(...n,{baseURL:r,mapper:y.mapper,onError:y.onError})}return{autoDefiner:l,mergedEnhancers:d}}var rr=["light","dark"],nr=new Set(rr);function or(t){let r=(Array.isArray(t?.themes)?t.themes.map(n=>String(n).toLowerCase()):rr).filter(n=>nr.has(n));return r.length?r:rr}function ze(t,{preferDocument:e=!0}={}){let r=String(t||"").toLowerCase();if(nr.has(r))return r;if(e&&typeof document<"u"){let n=document.documentElement?.getAttribute("data-theme");if(nr.has(n))return n}return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function fe(t,e){let r=ze(e);return or(t).includes(r)}var on=!1,ft="pds-live-edit-toggle",cr="pds-live-edit-toggle-style";function an(t,e=new WeakSet){if(!t||typeof t!="object"||e.has(t))return t;e.add(t),Object.freeze(t);for(let r of Object.keys(t))an(t[r],e);return t}function gt(t){let e=pe(t);return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}function sn(t){return t==null||typeof t!="object"?t:an(gt(t))}function ln(t){if(typeof document>"u"||typeof t!="function")return;if(document.body){t();return}let e=()=>{document.body&&(document.removeEventListener("DOMContentLoaded",e),t())};document.addEventListener("DOMContentLoaded",e,{once:!0})}function fa(t={}){let e=t?.interactive!==!1;typeof document>"u"||ln(()=>{if(document.querySelector("pds-live-edit")){if(!e){let r=document.querySelector("pds-live-edit");r&&r.setAttribute("data-pds-live-settings-only","true")}}else{let r=document.createElement("pds-live-edit");e||r.setAttribute("data-pds-live-settings-only","true"),document.body.appendChild(r)}})}function pt(t=0){return new Promise(e=>{setTimeout(e,Math.max(0,Number(t)||0))})}async function We(t={}){let e=t?.mountIfMissing!==!1,r=t?.interactive!==!1,n=typeof t?.requiredMethod=="string"&&t.requiredMethod.trim()?t.requiredMethod.trim():"openDesignSettings",o=Number.isFinite(Number(t?.timeoutMs))?Number(t.timeoutMs):2400;if(typeof document>"u"||!e&&!document.querySelector("pds-live-edit"))return null;e&&fa({interactive:r});let a=Date.now();for(;Date.now()-a<o;){let s=document.querySelector("pds-live-edit");if(!s){await pt(40);continue}if(typeof s?.[n]=="function")return s;if(typeof customElements<"u"&&typeof customElements.whenDefined=="function"){try{await Promise.race([customElements.whenDefined("pds-live-edit"),pt(80)])}catch{await pt(40)}continue}await pt(40)}let i=document.querySelector("pds-live-edit");return i&&typeof i?.[n]=="function"?i:null}function cn(){if(typeof document>"u")return;document.querySelectorAll("pds-live-edit").forEach(e=>{typeof e?.setInteractiveEditingEnabled=="function"&&e.setInteractiveEditingEnabled(!1),e.remove()})}function ga(t){return t?typeof t.isInteractiveEditingEnabled=="function"?!!t.isInteractiveEditingEnabled():!0:!1}function ma(){if(typeof document>"u"||document.getElementById(cr))return;let t=document.createElement("style");t.id=cr,t.textContent=`
  ...
  `,document.head.appendChild(t)}function lr(t,e){if(!t)return;t.classList.toggle("btn-primary",e),t.classList.toggle("btn-secondary",!e),t.setAttribute("aria-pressed",e?"true":"false");let r="PDS Manager";t.setAttribute("aria-label",r),t.setAttribute("title",r)}async function ha(){if(typeof document>"u")return null;ma();let t=document.getElementById(ft);if(!t){let e=document.createElement("nav");e.className="pds-live-edit-toggle-nav",e.setAttribute("data-dropdown",""),e.setAttribute("data-mode","auto"),e.setAttribute("data-pds-live-edit-ignore","true"),t=document.createElement("button"),t.id=ft,t.type="button",t.className="icon-only btn-secondary",t.setAttribute("data-pds-live-edit-ignore","true"),t.innerHTML='<pds-icon icon="cursor-click" size="sm"></pds-icon>';let r=document.createElement("menu");r.setAttribute("data-pds-live-edit-ignore","true");let n=(i,s,d)=>{let l=document.createElement("li"),u=document.createElement("a");u.href="#",u.dataset.pdsLiveAction=i,u.setAttribute("data-pds-live-edit-ignore","true");let c=document.createElement("pds-icon");return c.setAttribute("icon",d),c.setAttribute("size","sm"),u.append(c,document.createTextNode(` ${s}`)),l.appendChild(u),l},o=()=>{let i=document.createElement("li");i.setAttribute("data-pds-live-edit-ignore","true");let s=document.createElement("hr");return s.setAttribute("aria-hidden","true"),i.appendChild(s),i};r.appendChild(n("toggle",se("Toggle live editing"),"pencil"));let a=n("open-settings",se("Open Settings"),"gear");a.setAttribute("data-dropdown-close",""),r.appendChild(a),r.appendChild(n("reset-config",se("Reset Config"),"arrow-counter-clockwise")),await ba(r),e.append(t,r),ln(()=>{document.getElementById(ft)||document.body.appendChild(e)})}return t}async function ba(t){if(t instanceof Element){if(t.__pdsLiveSharedMenuItemInFlight)return t.__pdsLiveSharedMenuItemInFlight;t.__pdsLiveSharedMenuItemInFlight=(async()=>{t.querySelectorAll("li.pds-live-shared-quick-mode-item").forEach(s=>s.remove());let e=await We({mountIfMissing:!0,interactive:!1,requiredMethod:"createSharedQuickModeMenuItem",timeoutMs:7e3});if(!e||typeof e.createSharedQuickModeMenuItem!="function")return;let r=await e.createSharedQuickModeMenuItem();if(!(r instanceof Element))return;r.classList.add("pds-live-shared-quick-mode-item");let o=t.querySelector('a[data-pds-live-action="reset-config"]')?.closest("li")||null,a=o?.previousElementSibling||null,i=a&&a.querySelector?.(":scope > hr")?a:null;if(i){t.insertBefore(r,i);return}if(o){t.insertBefore(r,o);return}t.appendChild(r)})();try{await t.__pdsLiveSharedMenuItemInFlight}finally{t.__pdsLiveSharedMenuItemInFlight=null}}}function ya(){if(typeof document>"u")return;let t=document.getElementById(ft);if(t){let r=t.closest(".pds-live-edit-toggle-nav");r?r.remove():t.remove()}let e=document.getElementById(cr);e&&e.remove(),cn()}async function va(){if(typeof document>"u")return;let t=await ha();if(!t)return;let e=async i=>{if(i){let s=await We({mountIfMissing:!0});s&&typeof s.setInteractiveEditingEnabled=="function"&&s.setInteractiveEditingEnabled(!0)}else cn();lr(t,i)};e(!1);let r=t.closest(".pds-live-edit-toggle-nav")||t;t.__pdsLiveEditActionHandler&&r.removeEventListener("click",t.__pdsLiveEditActionHandler);let n=async i=>{let s=i.target?.closest?.("[data-pds-live-action]");if(!s)return;i.preventDefault();let d=String(s.dataset.pdsLiveAction||"");if(d==="toggle"){let l=await We({mountIfMissing:!1}),u=ga(l);await e(!u);return}if(d==="open-settings"){let l=await We({mountIfMissing:!0,requiredMethod:"openDesignSettings",interactive:!1});l&&typeof l.setInteractiveEditingEnabled=="function"&&l.setInteractiveEditingEnabled(!1),l&&typeof l.openDesignSettings=="function"&&(lr(t,!1),await l.openDesignSettings());return}if(d==="reset-config"){let l=await We({mountIfMissing:!0,requiredMethod:"resetConfig",interactive:!1});lr(t,!1),l&&typeof l.resetConfig=="function"&&await l.resetConfig();return}};t.__pdsLiveEditActionHandler=n,r.addEventListener("click",n),t.__pdsLiveEditDisableHandler&&document.removeEventListener("pds:live-edit:disable",t.__pdsLiveEditDisableHandler),t.__pdsLiveEditEnableHandler&&document.removeEventListener("pds:live-edit:enable",t.__pdsLiveEditEnableHandler);let o=()=>{e(!1)},a=()=>{e(!0)};t.__pdsLiveEditDisableHandler=o,document.addEventListener("pds:live-edit:disable",o),t.__pdsLiveEditEnableHandler=a,document.addEventListener("pds:live-edit:enable",a)}function xa(){if(typeof window>"u"||!window.localStorage)return null;try{let t=window.localStorage.getItem("pure-ds-config");if(!t)return null;let e=JSON.parse(t);if(e&&("preset"in e||"design"in e))return e}catch{return null}return null}function dr(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};for(let[n,o]of Object.entries(e))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=dr(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function wa(t){let e=xa();if(!e||!t||typeof t!="object")return t;let r=e.preset,n=e.design&&typeof e.design=="object"?e.design:null;if(!r&&!n)return t;let o="preset"in t||"design"in t||"enhancers"in t,a={...t};if(r&&(a.preset=r),n)if(o){let i=t.design&&typeof t.design=="object"?t.design:{};a.design=dr(i,n)}else a=dr(t,n);return a}function ka(t,e={}){let{hideCategory:r=!0,itemGrid:n="45px 1fr",includeIncompatible:o=!0,disableIncompatible:a=!0,categoryName:i="Presets",theme:s,onSelect:d,iconHandler:l}=e||{},u=ze(s??t?.theme),c=h=>{let g=b(h?.id)?.colors||{},f=g?.primary,y=g?.secondary,v=g?.accent;return f&&y&&v?`<span style="display:flex;gap:1px;flex-shrink:0;" aria-hidden="true">
      ...
      </span>`:h?.icon?`<pds-icon icon="${h.icon}" size="sm"></pds-icon>`:""},p=()=>{let h=t?.presets||{};return Object.values(h||{}).filter(S=>!!(S?.id||S?.name))},b=h=>h&&p().find(g=>String(g?.id||g?.name)===String(h))||null;return{hideCategory:r,itemGrid:n,iconHandler:typeof l=="function"?l:c,categories:{[i]:{trigger:()=>!0,getItems:(h={})=>{let S=String(h?.search||"").toLowerCase().trim();return p().filter(f=>{let y=String(f?.name||f?.id||"").toLowerCase(),v=String(f?.description||"").toLowerCase(),m=Array.isArray(f?.tags)?f.tags.map(A=>String(A).toLowerCase()):[];if(S&&!(y.includes(S)||v.includes(S)||m.some(C=>C.includes(S))))return!1;let w=fe(f,u);return!(!o&&!w)}).map(f=>{let y=f?.id||f?.name,v=fe(f,u),m=or(f),w=m.length===1?`${m[0]} only`:`Not available in ${u} mode`,A=String(f?.description||"").trim(),C=v?A:A?`${A} - ${w}`:w;return{id:y,text:f?.name||String(y),description:C,icon:"palette",class:!v&&a?"disabled":"",disabled:!v&&a,tooltip:v?"":w}}).sort((f,y)=>String(f.text||"").localeCompare(String(y.text||"")))},action:async h=>{if(!h?.id||h?.disabled)return h?.id;let S=b(h.id);return S?typeof d=="function"?await d({preset:S,selection:h,resolvedTheme:u}):(typeof t?.applyLivePreset=="function"&&await t.applyLivePreset(S.id||h.id),S.id||h.id):h?.id}}}}}async function Sa(t,{applyResolvedTheme:e,setupSystemListenerIfNeeded:r,emitConfigChanged:n}){if(on)return;let[o,a,i]=await Promise.all([Promise.resolve().then(()=>(Dt(),_r)),Promise.resolve().then(()=>(_e(),wr)),Promise.resolve().then(()=>(sr(),ut))]),s=o?.default||o?.ontology,d=o?.findComponentForElement,l=a?.enums;t.ontology=s,t.findComponentForElement=d,t.enums=l,t.common=i||{},t.presets=Q,t.configRelations=Cr,t.configSpec=Er,t.configEditorMetadata=Tr,t.configFormSchema=Rr,t.buildConfigFormSchema=be,t.getConfigEditorMetadata=je,t.enhancerMetadata=Kr,(!Array.isArray(t.defaultEnhancers)||t.defaultEnhancers.length===0)&&(t.defaultEnhancers=Array.isArray(ot)?ot:[]),t.applyStyles=function(u){let c=u||X.instance;Vr(c),typeof n=="function"&&n({mode:"live",source:"live:styles-applied"})},t.adoptLayers=function(u,c,p){return nt(u,c,p,X.instance)},t.adoptPrimitives=function(u,c){return rt(u,c,X.instance)},t.getGenerator=async function(){return X},t.buildPresetOmniboxSettings=function(u={}){return ka(t,u)},t.applyLivePreset=async function(u,c={}){if(!u)return!1;if(!t.registry?.isLive)return t.log("warn","PDS.applyLivePreset is only available in live mode."),!1;let p=t.currentConfig||{},{design:b,preset:h,...S}=p,g={...gt(S),preset:u},f=tr(g,{},{presets:Q,defaultLog:Bt,validateDesignConfig:jt,validateInitConfig:Ot}),y=ze(t.theme);if(!fe(f.generatorConfig.design,y)){let A=f.presetInfo?.name||f.generatorConfig?.design?.name||u;t.log("warn",`PDS theme "${y}" not supported by preset "${A}".`)}p.theme&&!f.generatorConfig.theme&&(f.generatorConfig.theme=p.theme);let v=new X(f.generatorConfig);if(f.generatorConfig.design?.typography)try{await Yt(f.generatorConfig.design.typography)}catch(A){f.generatorConfig?.log?.("warn","Failed to load some fonts from Google Fonts:",A)}t.applyStyles?.(v);let m=f.presetInfo||{id:u,name:u};if(t.currentPreset=m,t.compiled=sn({...p,preset:f.generatorConfig.preset,design:f.generatorConfig.design,theme:f.generatorConfig.theme||p.theme}),t.configEditorMetadata=je(f.generatorConfig.design),t.configFormSchema=be(f.generatorConfig.design),c?.persist!==!1&&typeof window<"u"){let A="pure-ds-config";try{let C=localStorage.getItem(A),R=C?JSON.parse(C):null,z={...R&&typeof R=="object"?R:{},preset:m.id||u,design:gt(f.generatorConfig.design||{})};localStorage.setItem(A,JSON.stringify(z))}catch(C){f.generatorConfig?.log?.("warn","Failed to store preset:",C)}}return!0},t.preloadCritical=function(u,c={}){if(typeof window>"u"||!document.head||!u)return;let{theme:p,layers:b=["tokens"]}=c;try{let h=p||"light";(p==="system"||!p)&&(h=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),document.documentElement.setAttribute("data-theme",h);let S=u.design?{...u,theme:h}:{design:u,theme:h},g=new X(S),f=b.map(y=>{try{return g.css?.[y]||""}catch{return""}}).filter(y=>y.trim()).join(`
`);if(f){let y=document.head.querySelector("style[data-pds-preload]");y&&y.remove();let v=document.createElement("style");v.setAttribute("data-pds-preload",""),v.textContent=f,document.head.insertBefore(v,document.head.firstChild)}}catch(h){t.log("warn","PDS preload failed:",h)}},on=!0}async function $a(t,e,{emitReady:r,emitConfigChanged:n,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}){if(!e||typeof e!="object")throw new Error("PDS.start({ mode: 'live', ... }) requires a valid configuration object");let i=e?.design?.icons?.externalPath||e?.icons?.externalPath||null;if(e=wa(e),typeof i=="string"&&i.trim()){let b=e?.design&&typeof e.design=="object"?e.design:{},h=b?.icons&&typeof b.icons=="object"?b.icons:{};e={...e,design:{...b,icons:{...h,externalPath:i}}}}if(await Sa(t,{applyResolvedTheme:o,setupSystemListenerIfNeeded:a,emitConfigChanged:n}),it(t),typeof document<"u"&&document.adoptedStyleSheets){let b=`
          html { opacity: 0; }
          html.pds-ready { opacity: 1; transition: opacity 0.3s ease-in; }
        `;try{if(!document.adoptedStyleSheets.some(S=>S._pdsFouc)){let S=new CSSStyleSheet;S.replaceSync(b),S._pdsFouc=!0,document.adoptedStyleSheets=[S,...document.adoptedStyleSheets]}}catch(h){if(t.log("warn","Constructable stylesheets not supported, using <style> tag fallback:",h),!document.head.querySelector("style[data-pds-fouc]")){let g=document.createElement("style");g.setAttribute("data-pds-fouc",""),g.textContent=b,document.head.insertBefore(g,document.head.firstChild)}}}let s=e.applyGlobalStyles??!0,d=e.manageTheme??!0,l=e.themeStorageKey??"pure-ds-theme",u=e.preloadStyles??!1,c=e.criticalLayers??["tokens","primitives"],p=e&&e.autoDefine||null;try{let{resolvedTheme:b}=st({manageTheme:d,themeStorageKey:l,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}),h=tr(e,{},{presets:Q,defaultLog:Bt,validateDesignConfig:jt,validateInitConfig:Ot});if(d&&!fe(h.generatorConfig.design,b)){let z=h.presetInfo?.name||h.generatorConfig?.design?.name||h.generatorConfig?.preset||"current preset";t.log("warn",`PDS theme "${b}" not supported by preset "${z}".`)}let S=h.enhancers,{log:g,...f}=h.generatorConfig,y=gt(f);y.log=g,d&&(y.theme=b);let v=new X(y);if(y.design?.typography)try{await Yt(y.design.typography)}catch(z){y?.log?.("warn","Failed to load some fonts from Google Fonts:",z)}if(u&&typeof window<"u"&&document.head)try{let z=c.map(M=>{try{return v.css?.[M]||""}catch(P){return y?.log?.("warn",`Failed to generate critical CSS for layer "${M}":`,P),""}}).filter(M=>M.trim()).join(`
`);if(z){let M=document.head.querySelector("style[data-pds-critical]");M&&M.remove();let P=document.createElement("style");P.setAttribute("data-pds-critical",""),P.textContent=z;let E=document.head.querySelector('meta[charset], meta[name="viewport"]');E?E.parentNode.insertBefore(P,E.nextSibling):document.head.insertBefore(P,document.head.firstChild)}}catch(z){y?.log?.("warn","Failed to preload critical styles:",z)}t.registry.setLiveMode(),h.presetInfo?.name?y?.log?.("log",`PDS live with preset "${h.presetInfo.name}"`):y?.log?.("log","PDS live with custom config"),s&&(t.applyStyles?.(X.instance),typeof window<"u"&&setTimeout(()=>{let z=document.head.querySelector("style[data-pds-critical]");z&&z.remove();let M=document.head.querySelector("style[data-pds-preload]");M&&M.remove();let P=document.getElementById("pds-runtime-stylesheet");P&&P.remove()},100));let m=Le(e,{resolvePublicAssetURL:ke}),w;p&&p.baseURL?w=Se($e(p.baseURL,{preferModule:!1})):w=`${m}components/`;let A=null,C=[];try{let z=await lt({autoDefineBaseURL:w,autoDefinePreload:p&&Array.isArray(p.predefine)&&p.predefine||[],autoDefineMapper:p&&typeof p.mapper=="function"&&p.mapper||null,enhancers:S,autoDefineOverrides:p||null,autoDefinePreferModule:!(p&&p.baseURL)},{baseEnhancers:ot});A=z.autoDefiner,C=z.mergedEnhancers||[]}catch(z){y?.log?.("error","\u274C Failed to initialize AutoDefiner/Enhancers:",z)}let R=v?.options||y;if(t.compiled=sn({mode:"live",...R,theme:b,enhancers:C}),t.configEditorMetadata=je(h.generatorConfig.design),t.configFormSchema=be(h.generatorConfig.design),typeof n=="function"&&n({mode:"live",source:"live:config-applied",preset:h.generatorConfig.preset}),typeof document<"u")try{e?.liveEdit?setTimeout(()=>{va()},0):ya()}catch(z){y?.log?.("warn","Live editor toggle failed to start:",z)}return r({mode:"live",generator:v,config:R,theme:b,autoDefiner:A}),{generator:v,config:R,theme:b,autoDefiner:A}}catch(b){throw t.dispatchEvent(new CustomEvent("pds:error",{detail:{error:b}})),b}}function La(t){let e=Number(t);return Number.isFinite(e)?Math.max(0,Math.min(1,e)):.5}function za(t){return Array.isArray(t)?t.map(e=>e?{severity:String(e.severity||"info").toLowerCase(),message:String(e.message||""),path:e.path?String(e.path):""}:null).filter(e=>e&&e.message):[]}function H(t={}){let e=String(t.source||"unknown"),r=String(t.type||"generic"),n=La(t.confidence),o=za(t.issues),a=t.designPatch&&typeof t.designPatch=="object"?t.designPatch:{},i=t.template&&typeof t.template=="object"?t.template:null;return{source:e,type:r,confidence:n,issues:o,designPatch:a,template:i,meta:t.meta&&typeof t.meta=="object"?t.meta:{}}}function Ca(t){return!!(t&&typeof t=="object"&&"source"in t&&"type"in t&&"confidence"in t&&"issues"in t&&"designPatch"in t)}var Ea="../templates/templates.json",dn="/assets/pds/templates/templates.json",Ma=["public","assets","pds","templates","templates.json"],Aa=["..","..","..","public","assets","pds","templates","templates.json"],mt=null;function un(){return!!(typeof process<"u"&&process?.versions?.node)}function Ta(t={}){return{id:String(t.id||"").trim(),name:String(t.name||t.id||"Template").trim(),description:String(t.description||"").trim(),icon:String(t.icon||"layout").trim(),file:String(t.file||"").trim(),tags:Array.isArray(t.tags)?t.tags.map(e=>String(e)):[]}}function ht(t={},e={}){let n=(Array.isArray(t)?t:Array.isArray(t?.templates)?t.templates:[]).map(Ta).filter(o=>o.id&&o.file);return{version:t?.version||"1",templates:n,__catalogURL:e.catalogURL||null,__catalogFilePath:e.catalogFilePath||null}}async function Ra(t={}){let r=[t.catalogURL||globalThis?.PDS?.currentConfig?.templateCatalogURL,Ea,dn].filter(Boolean);for(let n of r)try{let o=new URL(n,import.meta.url).href,a=await fetch(o,{credentials:"same-origin"});if(!a.ok)continue;let i=await a.json();return ht(i,{catalogURL:o})}catch{}return ht({templates:[]})}async function Ia(t={}){let e="node:fs/promises",r="node:path",n="node:url",[{readFile:o},a,{fileURLToPath:i}]=await Promise.all([import(e),import(r),import(n)]),s=[];t.catalogPath&&s.push(a.resolve(t.catalogPath)),s.push(a.resolve(process.cwd(),...Ma));let d=a.dirname(i(import.meta.url));s.push(a.resolve(d,...Aa));for(let l of s)try{let u=await o(l,"utf8"),c=JSON.parse(u);return ht(c,{catalogFilePath:l})}catch{}return ht({templates:[]})}async function _a(t,e){if(!t?.file)return"";if(!un()){let d=e?.__catalogURL||dn,l=new URL(t.file,d).href,u=await fetch(l,{credentials:"same-origin"});if(!u.ok)throw new Error(`Template file not found: ${t.file}`);return(await u.text()).trim()}let r="node:fs/promises",n="node:path",[{readFile:o},a]=await Promise.all([import(r),import(n)]),i=e?.__catalogFilePath?a.dirname(e.__catalogFilePath):a.resolve(process.cwd(),"public","assets","pds","templates"),s=a.resolve(i,t.file);return(await o(s,"utf8")).trim()}async function bt(t={}){return mt&&!t.forceReload||(mt=un()?await Ia(t):await Ra(t)),mt}async function pn(t={}){return(await bt(t)).templates.map(({id:r,name:n,description:o,icon:a,file:i,tags:s})=>({id:r,name:n,description:o,icon:a,file:i,tags:s}))}async function Fa(t,e={}){let r=await bt(e),n=r.templates.find(a=>a.id===t)||null;if(!n)return null;let o=await _a(n,r);return{...n,html:o}}async function fn(t,e={}){let r=await Fa(t,e);return r?H({source:"template",type:"template",confidence:1,template:{id:r.id,name:r.name,html:r.html,icon:r.icon,description:r.description}}):H({source:"template",type:"template",confidence:0,issues:[{severity:"error",message:`Unknown template: ${t}`}]})}var gn={version:"tw2pds-layout-v4",summary:"Deterministic Tailwind\u2192PDS conversion rules focused on layout intent, semantic primitive mapping, and richer import-* fallback coverage.",governance:[{id:"layout.utilities.grid",controls:["grid","grid-cols-*","grid-auto-*"],note:"When false, grid mappings are skipped."},{id:"layout.utilities.flex",controls:["flex","flex-*","items-*","justify-*","grow"],note:"When false, flex mappings are skipped."},{id:"layout.utilities.spacing",controls:["gap-*","stack-*"],note:"When false, spacing mappings are skipped."},{id:"layout.utilities.container",controls:["container","max-w-*"],note:"When false, container mappings are skipped."}],nonPdsClassPatterns:["^group(?:[/:].*)?$","^layout-container$"],neverFallbackTags:["table","thead","tbody","tfoot","tr","th","td","caption","colgroup","col"],directMappings:[{id:"layout.flex.base",tw:"flex",pds:["flex"],gate:"flex"},{id:"layout.flex.inline",tw:"inline-flex",pds:["flex"],gate:"flex"},{id:"layout.flex.row",tw:"flex-row",pds:["flex-row"],gate:"flex"},{id:"layout.flex.col",tw:"flex-col",pds:["flex-col"],gate:"flex"},{id:"layout.flex.wrap",tw:"flex-wrap",pds:["flex-wrap"],gate:"flex"},{id:"layout.flex.grow",tw:"grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow.tw",tw:"flex-grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow1",tw:"flex-1",pds:["grow"],gate:"flex"},{id:"layout.items.start",tw:"items-start",pds:["items-start"],gate:"flex"},{id:"layout.items.center",tw:"items-center",pds:["items-center"],gate:"flex"},{id:"layout.items.end",tw:"items-end",pds:["items-end"],gate:"flex"},{id:"layout.items.stretch",tw:"items-stretch",pds:["items-stretch"],gate:"flex"},{id:"layout.items.baseline",tw:"items-baseline",pds:["items-baseline"],gate:"flex"},{id:"layout.justify.start",tw:"justify-start",pds:["justify-start"],gate:"flex"},{id:"layout.justify.center",tw:"justify-center",pds:["justify-center"],gate:"flex"},{id:"layout.justify.end",tw:"justify-end",pds:["justify-end"],gate:"flex"},{id:"layout.justify.between",tw:"justify-between",pds:["justify-between"],gate:"flex"},{id:"layout.justify.around",tw:"justify-around",pds:["justify-around"],gate:"flex"},{id:"layout.justify.evenly",tw:"justify-evenly",pds:["justify-evenly"],gate:"flex"},{id:"layout.grid.base",tw:"grid",pds:["grid"],gate:"grid"},{id:"layout.grid.cols.1",tw:"grid-cols-1",pds:["grid-cols-1"],gate:"grid"},{id:"layout.grid.cols.2",tw:"grid-cols-2",pds:["grid-cols-2"],gate:"grid"},{id:"layout.grid.cols.3",tw:"grid-cols-3",pds:["grid-cols-3"],gate:"grid"},{id:"layout.grid.cols.4",tw:"grid-cols-4",pds:["grid-cols-4"],gate:"grid"},{id:"layout.grid.cols.6",tw:"grid-cols-6",pds:["grid-cols-6"],gate:"grid"},{id:"layout.container",tw:"container",pds:["container"],gate:"container"},{id:"intent.surface.shadow",tw:"shadow",pds:["surface-elevated"]},{id:"intent.surface.shadow-md",tw:"shadow-md",pds:["surface-elevated"]},{id:"intent.surface.shadow-lg",tw:"shadow-lg",pds:["surface-elevated"]},{id:"intent.surface.base",tw:"bg-white",pds:["surface-base"]},{id:"typography.align.center",tw:"text-center",pds:["text-center"]},{id:"typography.align.left",tw:"text-left",pds:["text-left"]},{id:"typography.align.right",tw:"text-right",pds:["text-right"]},{id:"typography.text.muted.gray500",tw:"text-gray-500",pds:["text-muted"]},{id:"typography.text.muted.slate500",tw:"text-slate-500",pds:["text-muted"]}],ignoredPatterns:[{id:"style.color",pattern:"^(?:text|from|to|via|decoration|accent|caret)-|^bg-(?!cover$|center$|no-repeat$)",reason:"Visual style token skipped in favor of semantic PDS styling."},{id:"style.radius-border-shadow",pattern:"^(?:rounded|ring|border|shadow|outline)-?",reason:"Surface/shape inferred at primitive level."},{id:"style.typography",pattern:"^(?:font|leading|tracking|uppercase|lowercase|capitalize)-?",reason:"Typography atomic utilities are skipped."},{id:"style.effects",pattern:"^(?:opacity|blur|backdrop|drop-shadow|mix-blend|filter)-",reason:"Visual effects skipped unless mapped to a PDS utility."},{id:"style.transitions",pattern:"^(?:transition|duration|ease|delay|animate)-",reason:"Motion is system-defined in PDS."},{id:"style.spacing.atomic",pattern:"^(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-",reason:"Atomic spacing skipped; structural spacing intent is mapped."},{id:"style.positioning.atomic",pattern:"^(?:absolute|relative|fixed|sticky|inset(?:-[xy])?|top|right|bottom|left|z|translate(?:-[xy])?|-translate-[xy])(?:-|$)",reason:"Atomic positioning/offset utilities are skipped so PDS primitives and layout utilities control placement."}],intentRules:[{id:"intent.layout.responsive-grid-to-auto",summary:"Collapse responsive grid-cols patterns (including base+md two-step patterns) to best-fit grid-auto-*"},{id:"intent.layout.mobile-stack",summary:"Map flex-col + md/lg:flex-row to mobile-stack"},{id:"intent.component.card",summary:"Infer card/surface classes from rounded+shadow+surface signals"},{id:"intent.component.card.normalize",summary:"Detect Tailwind card utility clusters and normalize them to PDS card and surface variants."},{id:"intent.component.button",summary:"Infer btn-primary / btn-outline / icon-only from CTA patterns"},{id:"intent.component.button.normalize",summary:"Prevents import-* style classes on button-like elements and applies PDS button variants/sizes."},{id:"intent.component.button.layout-grow",summary:"Preserve CTA row width intent on button-like elements by mapping w-full/flex-1 to grow."},{id:"intent.icon.color-preserve",summary:"Preserve icon color intent by mapping Tailwind text color utilities on icon-like elements to tokenized import-* classes."},{id:"intent.component.badge.normalize",summary:"Detects Tailwind badge/pill utility clusters and normalizes them to PDS badge primitives/variants."},{id:"intent.typography.heading-semantic",summary:"Removes Tailwind heading typography/color utilities so heading semantics and PDS defaults control typography."},{id:"intent.surface.footer-inverse",summary:"Use surface-inverse for footers with explicit background intent"},{id:"intent.typography.link-treatment",summary:"Apply minimal link treatment for hover/transition-tailwind anchors"},{id:"intent.typography.link-active-preserve",summary:"Preserve anchor text color intent (including active menu states) by mapping Tailwind text utilities to tokenized import-* classes."},{id:"intent.typography.metric-paragraph-to-div",summary:"Normalize metric display lines from paragraph tags to div tags to avoid default paragraph margins in compact stat layouts."},{id:"intent.typography.metric-pair-no-stack",summary:"When a compact metric container has two consecutive typography lines, remove stack-sm so spacing follows Tailwind preflight no-margin assumptions."},{id:"intent.typography.semantic-heading-from-scale",summary:"Map large bold typography scales (text-2xl/text-3xl/text-4xl) to semantic heading tags when possible."},{id:"intent.typography.bold-to-strong",summary:"Prefer semantic strong tags for bold inline text intent instead of utility-only font-weight classes."},{id:"intent.preflight.tailwind-runtime-detected",summary:"Detect Tailwind runtime CSS injection and translate key preflight intent"},{id:"intent.preflight.list-reset",summary:"Preserve Tailwind list-reset preflight behavior via scoped fallback class"},{id:"intent.preflight.anchor-reset",summary:"Preserve Tailwind anchor reset preflight behavior via scoped fallback class"},{id:"table.strict-tags.no-classes",summary:"Never emit classes for semantic table tags (table/thead/tbody/tfoot/tr/th/td/caption/colgroup/col)"},{id:"intent.form.nested-label",summary:"Convert sibling label+control pairs into nested labels"},{id:"fallback.import-style",summary:"Generate import-* classes + local style block for unmapped utility styles"}],gapScaleMap:{"gap-0":"gap-0","gap-1":"gap-xs","gap-2":"gap-sm","gap-3":"gap-sm","gap-4":"gap-md","gap-5":"gap-md","gap-6":"gap-lg","gap-7":"gap-lg","gap-8":"gap-xl","gap-10":"gap-xl","gap-12":"gap-xl"},maxWidthMap:{"max-w-xs":"max-w-sm","max-w-sm":"max-w-sm","max-w-md":"max-w-md","max-w-lg":"max-w-lg","max-w-xl":"max-w-xl","max-w-2xl":"max-w-xl","max-w-3xl":"max-w-xl","max-w-4xl":"max-w-xl","max-w-5xl":"max-w-xl","max-w-6xl":"max-w-xl","max-w-7xl":"max-w-xl"},tailwindSizeScale:{"0":"var(--spacing-0)","0.5":"0.125rem","1":"var(--spacing-1)","1.5":"0.375rem","2":"var(--spacing-2)","2.5":"0.625rem","3":"var(--spacing-3)","3.5":"0.875rem","4":"var(--spacing-4)","5":"var(--spacing-5)","6":"var(--spacing-6)","7":"var(--spacing-7)","8":"var(--spacing-8)","9":"var(--spacing-9)","10":"var(--spacing-10)","11":"var(--spacing-11)","12":"var(--spacing-12)","14":"3.5rem","16":"4rem","20":"5rem","24":"6rem","28":"7rem","32":"8rem","36":"9rem","40":"10rem","48":"12rem"},tailwindShadeScale:["50","100","200","300","400","500","600","700","800","900"],defaultTailwindShade:"500",importStyleRules:{"mx-auto":"margin-left:auto;margin-right:auto","ml-auto":"margin-left:auto","mr-auto":"margin-right:auto","w-full":"width:100%","w-auto":"width:auto","h-full":"height:100%","h-48":"height:12rem","h-2.5":"height:0.625rem","h-10":"height:var(--spacing-10)","h-2":"height:var(--spacing-2)","w-2":"width:var(--spacing-2)","size-8":"width:var(--spacing-8);height:var(--spacing-8)","size-10":"width:var(--spacing-10);height:var(--spacing-10)","size-full":"width:100%;height:100%","min-h-screen":"min-height:100vh","overflow-hidden":"overflow:hidden","overflow-x-hidden":"overflow-x:hidden","overflow-x-auto":"overflow-x:auto","whitespace-nowrap":"white-space:nowrap",hidden:"display:none",block:"display:block",truncate:"overflow:hidden;text-overflow:ellipsis;white-space:nowrap","justify-items-center":"justify-items:center","justify-items-start":"justify-items:start","justify-items-end":"justify-items:end","justify-items-stretch":"justify-items:stretch","grid-flow-col":"grid-auto-flow:column","aspect-square":"aspect-ratio:1 / 1","bg-center":"background-position:center","bg-cover":"background-size:cover","bg-no-repeat":"background-repeat:no-repeat","transition-colors":"transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-duration:150ms"},importStyleDynamicRules:[{id:"fallback.import-style.gap-scale",pattern:"^gap-(\\d+)$",summary:"Converts gap scale utilities (including responsive variants like md:gap-6) to generated import-* fallback classes."},{id:"fallback.import-style.min-width-arbitrary",pattern:"^min-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-width utilities (e.g. min-w-[600px]) to generated import-* fallback classes."},{id:"fallback.import-style.max-width-arbitrary",pattern:"^max-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary max-width utilities (e.g. max-w-[480px]) to generated import-* fallback classes."},{id:"fallback.import-style.min-height-arbitrary",pattern:"^min-h-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-height utilities (e.g. min-h-[180px]) to generated import-* fallback classes."},{id:"fallback.import-style.grid-rows-arbitrary",pattern:"^grid-rows-\\[[^\\]]+\\]$",summary:"Converts arbitrary grid template row utilities (e.g. grid-rows-[1fr_auto]) to generated import-* fallback classes."},{id:"fallback.import-style.size-scale",pattern:"^size-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts size scale/arbitrary utilities into width+height fallback declarations."},{id:"fallback.import-style.width-height-scale",pattern:"^[wh]-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts width/height scale and arbitrary utilities to import-* classes."},{id:"fallback.import-style.spacing",pattern:"^-?(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-(.+)$",summary:"Converts spacing utilities to directional padding/margin fallback declarations, including responsive variants."},{id:"fallback.import-style.text-size",pattern:"^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$",summary:"Converts common text size utilities to import-* font-size declarations."},{id:"fallback.import-style.font-weight",pattern:"^font-(normal|medium|semibold|bold|extrabold|black)$",summary:"Converts common font weight utilities to import-* font-weight declarations."},{id:"fallback.import-style.leading-tracking",pattern:"^(leading|tracking)-(none|tight|snug|normal|relaxed|loose|tighter|wide|wider|widest)$",summary:"Converts line-height and letter-spacing utilities to import-* declarations for typography fidelity."},{id:"fallback.import-style.bg-tokenized",pattern:"^bg-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind background color utilities by mapping families like blue/purple/green/red to PDS semantic tokens."},{id:"fallback.import-style.bg-semantic",pattern:"^bg-(primary|secondary|accent)$",summary:"Safeguards semantic background utilities by mapping bg-primary/bg-secondary/bg-accent to PDS color tokens."},{id:"fallback.import-style.text-tokenized",pattern:"^text-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind text color utilities by mapping common families to PDS semantic tokens."},{id:"fallback.import-style.rounded",pattern:"^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$",summary:"Safeguards rounded utilities (including rounded-t-sm) by mapping to PDS radius tokens."},{id:"fallback.import-style.overlay-alpha",pattern:"^bg-black\\/(\\d{1,3})$",summary:"Converts alpha black overlay classes (e.g. bg-black/50) to tokenized color-mix background overlays."},{id:"fallback.import-style.text-inverse",pattern:"^text-white$",summary:"Preserves white foreground intent for text-on-image use cases using inverse-compatible tokens."},{id:"fallback.import-style.bg-arbitrary",pattern:"^bg-\\[[^\\]]+\\]$",summary:"Converts arbitrary background colors to import-* fallback classes when values are CSS-safe."},{id:"fallback.import-style.text-arbitrary",pattern:"^text-\\[[^\\]]+\\]$",summary:"Converts arbitrary text colors to import-* fallback classes when values are CSS-safe."}]};_e();sr();var yt=class{constructor(e={},r=null){let n=e&&typeof e=="object"?e:{},o=r||(typeof document<"u"?document:new EventTarget),a=new WeakMap,i=b=>b.map(h=>String(h)).join("."),s,d=(b,h,S,g)=>{let f=i(b),y={property:h,path:f,value:S,oldValue:g};o.dispatchEvent(new CustomEvent(`change:${f}`,{detail:y,bubbles:!0,composed:!0})),o.dispatchEvent(new CustomEvent("change",{detail:{...y,state:s},bubbles:!0,composed:!0}))},l=(b,h)=>(typeof h=="function"&&o.addEventListener(b,h),s),u=(b,h)=>(typeof h=="function"&&o.removeEventListener(b,h),s),c=(b,h)=>{if(typeof h=="function"){let S=g=>{h(g),o.removeEventListener(b,S)};o.addEventListener(b,S)}return s},p=(b,h)=>{if(!b||typeof b!="object")return b;if(a.has(b))return a.get(b);let S=new Proxy(b,{get(g,f,y){if(f==="on")return l;if(f==="off")return u;if(f==="once")return c;let v=Reflect.get(g,f,y);return v&&typeof v=="object"?p(v,[...h,f]):v},set(g,f,y,v){let m=Reflect.get(g,f,v);return Object.is(m,y)?!0:Reflect.set(g,f,y,v)?(d([...h,f],f,y,m),!0):!1},deleteProperty(g,f){if(!Reflect.has(g,f))return!0;let y=g[f];return Reflect.deleteProperty(g,f)?(d([...h,f],f,void 0,y),!0):!1}});return a.set(b,S),S};return s=p(n,[]),s}};function mn(t,e,r){if(!t||!e||typeof r!="object")return()=>{};let n={};return Object.entries(r).forEach(([o,a])=>{n[o]=i=>{typeof a=="function"&&a(t,i.detail.value,i.detail.oldValue)},e.on(`change:${o}`,n[o])}),()=>{Object.entries(n).forEach(([o,a])=>{e.off(`change:${o}`,a)})}}typeof x.initializing!="boolean"&&(x.initializing=!1);"currentPreset"in x||(x.currentPreset=null);typeof x.debug!="boolean"&&(x.debug=!1);"currentConfig"in x||(x.currentConfig=null);"compiled"in x||(x.compiled=null);typeof x.logHandler!="function"&&(x.logHandler=null);"mode"in x||(x.mode=null);var vt=null,xt=null,wt=null,kt=null,St=null,$t=null,bn="__pdsLocalizationRuntime";function Ce(){if($t)return $t;let t=x?.[bn];return t&&typeof t=="object"?($t=t,t):null}function Na(t){let e=t&&typeof t=="object"?t:null;$t=e,x[bn]=e}jr({getLogger:()=>typeof x.logHandler=="function"?x.logHandler:null,getContext:()=>{let t=x?.mode||x?.compiled?.mode||(x?.registry?.isLive?"live":"static"),e=(x?.debug||x?.currentConfig?.debug||x?.currentConfig?.design?.debug||x?.compiled?.debug||x?.compiled?.design?.debug||!1)===!0;return{mode:t,debug:e,thisArg:x}}});x.log=(t="log",e,...r)=>{tt(t,e,...r)};var U={locale:"en",messages:{},hasProvider:!1},Lt=new Set;function yn(t){return!!t&&typeof t!="string"&&typeof t=="object"&&"strTag"in t}function vn(t=[]){let e="";for(let r=0;r<=t.length-1;r+=1)e+=t[r],r<t.length-1&&(e+=`{${r}}`);return e}function ja(t,e){return String(t).replace(/\{(\d+)\}/g,(r,n)=>e(Number(n)))}function Oa(t){if(!t||typeof t!="object")return{};let e={};for(let[r,n]of Object.entries(t)){if(typeof n=="string"){e[r]=n;continue}n&&typeof n=="object"&&typeof n.content=="string"&&(e[r]=n.content)}return e}function Ba(t,...e){return{strTag:!0,strings:Array.from(t||[]),values:e,raw:Array.from(t?.raw||[])}}function Da(t){if(!t)return"";if(yn(t)){let r=vn(t.strings||[]),n=U.messages[r]||r;return ja(n,o=>t.values?.[o])}let e=String(t);return U.messages[e]||e}function Ha(t){if(!t)return;let e=yn(t)?vn(t.strings||[]):String(t);typeof e=="string"&&e.length>0&&Lt.add(e)}function xn(t){if(!t||typeof t.msg!="function"||Lt.size===0)return;let e=Array.from(Lt);Lt.clear();for(let r of e)try{t.msg(r)}catch{}}async function qe(){let t=Ce();return t||(St||(St=import(Ve("pds-localization.js")).then(r=>{if(typeof r?.msg!="function"||typeof r?.str!="function"||typeof r?.configureLocalization!="function"||typeof r?.loadLocale!="function"||typeof r?.setLocale!="function"||typeof r?.getLocalizationState!="function")throw new Error("Failed to load localization runtime exports");return Na(r),xn(r),r}).catch(r=>{throw St=null,r})),St)}var wn=(t,e={})=>{let r=Ce();return typeof r?.msg=="function"?r.msg(t,e):(Ha(t),Da(t,e))},kn=(t,...e)=>{let r=Ce();return typeof r?.str=="function"?r.str(t,...e):Ba(t,...e)},zt=(t=null)=>{let e=Ce();if(typeof e?.configureLocalization=="function")return e.configureLocalization(t);if(!t||typeof t!="object")return U.locale="en",U.messages={},U.hasProvider=!1,{locale:U.locale,messages:{...U.messages},hasProvider:U.hasProvider};typeof t.locale=="string"&&t.locale.trim()&&(U.locale=t.locale.trim()),Object.prototype.hasOwnProperty.call(t,"messages")&&(U.messages=Oa(t.messages));let r=!!(t.provider||t.translate||t.loadLocale||t.setLocale);return U.hasProvider=r,r&&qe().then(n=>{n.configureLocalization(t),xn(n)}).catch(()=>{}),{locale:U.locale,messages:{...U.messages},hasProvider:U.hasProvider}},Sn=async t=>(await qe()).loadLocale(t),$n=async(t,e={})=>(await qe()).setLocale(t,e),Ln=()=>{let t=Ce();return typeof t?.getLocalizationState=="function"?t.getLocalizationState():{locale:U.locale,messages:{...U.messages},hasProvider:U.hasProvider}},zn=(t={})=>{let e=Ce();if(typeof e?.createJSONLocalization=="function")return e.createJSONLocalization(t);let r=typeof t?.locale=="string"&&t.locale.trim()?t.locale.trim().toLowerCase():"en",n=Array.isArray(t?.locales)?t.locales.map(d=>String(d||"").trim().toLowerCase()).filter(Boolean):[],o=Array.from(new Set([r,...n])),a=null,i=async()=>(a||(a=qe().then(d=>typeof d?.createJSONLocalization=="function"?d.createJSONLocalization(t):null).catch(()=>null)),a),s=async(d="loadLocale")=>{let l=await i();if(!l||typeof l!="object")return null;let u=l.provider;if(!u||typeof u!="object")return null;let c=u[d];return typeof c=="function"?c:d==="setLocale"&&typeof u.loadLocale=="function"?u.loadLocale:null};return{locale:r,locales:[...o],provider:{locales:[...o],async loadLocale(d={}){let l=await s("loadLocale");return typeof l!="function"?{}:l(d)},async setLocale(d={}){let l=await s("setLocale");return typeof l!="function"?{}:l(d)}}}};function Ve(t,e){return e&&typeof e=="string"?e:`${Le(x.currentConfig||{},{resolvePublicAssetURL:ke})}core/${t}`}async function Wa(){return Array.isArray(x.defaultEnhancers)&&x.defaultEnhancers.length>0?x.defaultEnhancers:(kt||(kt=import(Ve("pds-enhancers.js",x.currentConfig?.enhancersURL)).then(e=>{let r=Array.isArray(e?.defaultPDSEnhancers)?e.defaultPDSEnhancers:[];return x.defaultEnhancers=r,r}).catch(e=>{throw kt=null,e})),kt)}async function Ua(){return typeof x.ask=="function"&&x.ask!==Cn?x.ask:(xt||(xt=import(Ve("pds-ask.js",x.currentConfig?.askURL)).then(e=>{let r=e?.ask;if(typeof r!="function")throw new Error("Failed to load ask helper");return x.ask=r,r}).catch(e=>{throw xt=null,e})),xt)}async function Ge(){return typeof x.toast=="function"&&x.toast!==Ee?x.toast:(wt||(wt=import(Ve("pds-toast.js",x.currentConfig?.toastURL)).then(e=>{let r=e?.toast;if(typeof r!="function")throw new Error("Failed to load toast helper");return x.toast=r,r}).catch(e=>{throw wt=null,e})),wt)}async function Cn(...t){return(await Ua())(...t)}async function Ee(...t){return(await Ge())(...t)}Ee.success=async(...t)=>(await Ge()).success(...t);Ee.error=async(...t)=>(await Ge()).error(...t);Ee.warning=async(...t)=>(await Ge()).warning(...t);Ee.info=async(...t)=>(await Ge()).info(...t);var hn=function(t="log",e,...r){x.log(t,e,...r)};function pr(t){if(t==null)return t;if(typeof t=="function")return;if(typeof t!="object")return t;if(Array.isArray(t))return t.map(r=>pr(r)).filter(r=>r!==void 0);let e={};for(let[r,n]of Object.entries(t)){let o=pr(n);o!==void 0&&(e[r]=o)}return e}function En(t,e=new WeakSet){if(!t||typeof t!="object"||e.has(t))return t;e.add(t),Object.freeze(t);for(let r of Object.keys(t))En(t[r],e);return t}function fr(t){return t==null||typeof t!="object"?t:En(structuredClone(pr(t)))}async function qa(t,e={}){if(e?.runtimeConfig===!1||typeof fetch!="function")return null;let r=e?.runtimeConfigURL||`${t}pds-runtime-config.json`;try{let n=await fetch(r,{cache:"no-store"});return n.ok?await n.json():null}catch{return null}}x.registry=we;x.enums=$;x.adoptLayers=nt;x.adoptPrimitives=rt;var Va=ir;x.parse=Va;var Ga=dt;x.html=Ga;x.State=yt;x.bindState=mn;x.createStylesheet=Gr;x.isLiveMode=()=>we.isLive;x.ask=Cn;x.toast=Ee;x.common=ut;x.msg=wn;x.str=kn;x.configureLocalization=zt;x.loadLocale=Sn;x.setLocale=$n;x.getLocalizationState=Ln;x.createJSONLocalization=zn;x.i18n={msg:wn,str:kn,configure:zt,loadLocale:Sn,setLocale:$n,getState:Ln,createJSONLocalization:zn};x.AutoComplete=null;x.loadAutoComplete=async()=>{if(x.AutoComplete&&typeof x.AutoComplete.connect=="function")return x.AutoComplete;let t=Ve("pds-autocomplete.js",x.currentConfig?.autoCompleteURL);return vt||(vt=import(t).then(e=>{let r=e?.AutoComplete||e?.default?.AutoComplete||e?.default||null;if(!r)throw new Error("AutoComplete export not found in module");return x.AutoComplete=r,r}).catch(e=>{throw vt=null,e})),vt};function Mn(t){let e=typeof CustomEvent=="function";try{let r=e?new CustomEvent("pds:ready",{detail:t}):new Event("pds:ready");x.dispatchEvent(r)}catch{}if(typeof document<"u")if(e){let r={detail:t,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:ready",r))}catch{}try{document.dispatchEvent(new CustomEvent("pds-ready",r))}catch{}}else{try{document.dispatchEvent(new Event("pds:ready"))}catch{}try{document.dispatchEvent(new Event("pds-ready"))}catch{}}}function An(t={}){let e=typeof CustomEvent=="function",r={at:Date.now(),...t};try{let n=e?new CustomEvent("pds:config-changed",{detail:r}):new Event("pds:config-changed");x.dispatchEvent(n)}catch{}if(typeof document<"u")if(e){let n={detail:r,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:config-changed",n))}catch{}}else try{document.dispatchEvent(new Event("pds:config-changed"))}catch{}}var ur="pure-ds-theme",ge=null,Ue=null;function gr(t){try{if(typeof document>"u")return;let e="light";t?t==="system"?e=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e=t:e=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",document.documentElement.setAttribute("data-theme",e)}catch{}}function mr(t){try{if(ge&&Ue){try{typeof ge.removeEventListener=="function"?ge.removeEventListener("change",Ue):typeof ge.removeListener=="function"&&ge.removeListener(Ue)}catch{}ge=null,Ue=null}if(t==="system"&&typeof window<"u"&&window.matchMedia){let e=window.matchMedia("(prefers-color-scheme: dark)"),r=n=>{let o=n?.matches===void 0?e.matches:n.matches;try{let a=o?"dark":"light";document.documentElement.setAttribute("data-theme",a),x.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:a,source:"system"}}))}catch{}};ge=e,Ue=r,typeof e.addEventListener=="function"?e.addEventListener("change",r):typeof e.addListener=="function"&&e.addListener(r)}}catch{}}var Ka=Object.getOwnPropertyDescriptor(x,"theme");Ka||Object.defineProperty(x,"theme",{get(){try{return typeof window>"u"?null:localStorage.getItem(ur)||null}catch{return null}},set(t){try{if(typeof window>"u")return;let e=x.currentConfig?.design||null,r=ze(t);if(e&&!fe(e,r)){let n=e?.name||x.currentPreset?.name||x.currentConfig?.preset||"current preset";x.log("warn",`PDS theme "${r}" not supported by preset "${n}".`),x.dispatchEvent(new CustomEvent("pds:theme:blocked",{detail:{theme:t,resolvedTheme:r,preset:n}}));return}t==null?localStorage.removeItem(ur):localStorage.setItem(ur,t),gr(t),mr(t),x.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:t,source:"api"}}))}catch{}}});x.defaultEnhancers=[];async function Ja(t){x.initializing=!0;try{let e=t&&t.mode||"live",{mode:r,...n}=t||{};x.mode=e,x.logHandler=typeof n?.log=="function"?n.log:null,x.currentConfig=fr(n);let o=n&&typeof n.localization=="object"&&n.localization?n.localization:null;o?(await qe(),zt(o)):zt(null);let a;if(e==="static")a=await Ya(n);else{let{localization:s,...d}=n||{},l=Le(d,{resolvePublicAssetURL:ke}),u=d?.managerURL||d?.public?.managerURL||d?.manager?.url||new URL("core/pds-manager.js",l).href||new URL("./pds-manager.js",import.meta.url).href,{startLive:c}=await import(u);a=await c(x,d,{emitReady:Mn,emitConfigChanged:An,applyResolvedTheme:gr,setupSystemListenerIfNeeded:mr})}x.compiled=fr(a?.config||null);let i=x?.compiled?.design?.icons?.externalPath||"/assets/img/icons/";return x.log("info",`startup ready; external icon path: ${i}`),a}finally{x.initializing=!1}}x.start=Ja;async function Ya(t){if(!t||typeof t!="object")throw new Error("PDS.start({ mode: 'static', ... }) requires a valid configuration object");let e=t.applyGlobalStyles??!0,r=t.manageTheme??!0,n=t.themeStorageKey??"pure-ds-theme",o=t.staticPaths??{},a=Le(t,{resolvePublicAssetURL:ke}),i=t&&t.autoDefine||null,s;i&&i.baseURL?s=Se($e(i.baseURL,{preferModule:!1})):s=`${a}components/`;let d=i&&Array.isArray(i.predefine)&&i.predefine||[],l=i&&typeof i.mapper=="function"&&i.mapper||null;try{it(x);let{resolvedTheme:u}=st({manageTheme:r,themeStorageKey:n,applyResolvedTheme:gr,setupSystemListenerIfNeeded:mr}),c=await qa(a,t),p=Array.isArray(t?.enhancers)?t.enhancers:t?.enhancers&&typeof t.enhancers=="object"?Object.values(t.enhancers):[],b=c?.config?{...c.config,...t,design:t?.design||c.config.design,preset:t?.preset||c.config.preset}:{...t},h={tokens:`${a}styles/pds-tokens.css.js`,primitives:`${a}styles/pds-primitives.css.js`,components:`${a}styles/pds-components.css.js`,utilities:`${a}styles/pds-utilities.css.js`,styles:`${a}styles/pds-styles.css.js`},S=c?.paths||{};if(o={...h,...S,...o},x.registry.setStaticMode(o),e&&typeof document<"u")try{let y=await x.registry.getStylesheet("styles");if(y){y._pds=!0;let v=(document.adoptedStyleSheets||[]).filter(m=>m._pds!==!0);document.adoptedStyleSheets=[...v,y],An({mode:"static",source:"static:styles-applied"})}}catch(y){hn.call(x,"warn","Failed to apply static styles:",y)}let g=null,f=[];try{let y=await Wa(),v=await lt({autoDefineBaseURL:s,autoDefinePreload:d,autoDefineMapper:l,enhancers:p,autoDefineOverrides:i||null,autoDefinePreferModule:!(i&&i.baseURL)},{baseEnhancers:y});g=v.autoDefiner,f=v.mergedEnhancers||[]}catch(y){hn.call(x,"error","\u274C Failed to initialize AutoDefiner/Enhancers (static):",y)}return x.compiled=fr({mode:"static",...b,theme:u,enhancers:f}),Mn({mode:"static",config:b,theme:u,autoDefiner:g}),{config:b,theme:u,autoDefiner:g}}catch(u){throw x.dispatchEvent(new CustomEvent("pds:error",{detail:{error:u}})),u}}var Za="src/js/pds-live-manager/tailwind-conversion-rules.json",Mt=["base","sm","md","lg","xl","2xl"];function Xa(t={}){let e=Array.isArray(t.ignoredPatterns)?t.ignoredPatterns.map(n=>({...n,pattern:n?.pattern instanceof RegExp?n.pattern:new RegExp(String(n?.pattern||""))})):[],r=Array.isArray(t.nonPdsClassPatterns)?t.nonPdsClassPatterns.map(n=>n instanceof RegExp?n:new RegExp(String(n||""))):[];return{...t,ignoredPatterns:e,nonPdsClassPatterns:r}}var V=Xa(gn),Tn=V.version||"tw2pds-layout-v4",Qa=new Map(V.directMappings.map(t=>[t.tw,t])),hr=new Map(Object.entries(V.gapScaleMap||{})),Rn=new Map(Object.entries(V.maxWidthMap||{})),ei=V.nonPdsClassPatterns||[],ti=new Set(V.neverFallbackTags||[]),ri={...V.importStyleRules||{}},ni=V.tailwindSizeScale||{},br=Array.isArray(V.tailwindShadeScale)?V.tailwindShadeScale.map(t=>String(t)).filter(Boolean):["50","100","200","300","400","500","600","700","800","900"],In=br.includes(String(V.defaultTailwindShade||""))?String(V.defaultTailwindShade):"500",Et=1.2,oi=["container","grid","flex","gap","space","items","justify","content","place","self","col","row","w","h","min","max","p","m","rounded","border","ring","outline","shadow","bg","text","font","leading","tracking","uppercase","lowercase","capitalize","overflow","whitespace","truncate","object","aspect","opacity","blur","backdrop","transition","duration","ease","delay","animate","hidden","block","inline","absolute","relative","fixed","sticky","size"];function _n(t="",e=""){if(!t||!e)return t;let r=new RegExp(`\\s${e}\\s*=\\s*("[^"]*"|'[^']*'|[^\\s>]+)`,"gi");return String(t).replace(r,"")}function ai(t="",e=null){let r=String(t||""),n=0;return r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(input)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*?)>/gi,(o,a,i,s,d,l,u,c,p,b,h)=>{if(s!==b)return o;let S=_n(`${a||""}${d||""}`,"for"),g=`<${u}${c||""} id="${b}"${h||""}>`;return n+=1,`<label${S}>${l}${g}</label>`}),r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(select|textarea)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*)>([\s\S]*?)<\/\6>/gi,(o,a,i,s,d,l,u,c,p,b,h,S)=>{if(s!==b)return o;let g=_n(`${a||""}${d||""}`,"for"),f=`<${u}${c||""} id="${b}"${h||""}>${S}</${u}>`;return n+=1,`<label${g}>${l}${f}</label>`}),e&&n>0&&(e.labelNestingCount+=n,j(e,`Nested ${n} label/control pairs.`),_(e,"intent.form.nested-label")),r}function ii(t="",e="base"){let r=String(t||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rule";return`import-${e&&e!=="base"?`${e}-`:""}${r}`}function me(t,e,r,n="base",o=""){if(!t||!e||!r)return"";let a=ii(e,n);if(o){let i=`${n}|${o}`;t.importPseudoStyles.has(i)||t.importPseudoStyles.set(i,new Map),t.importPseudoStyles.get(i).set(a,r)}else n==="base"?t.importBaseStyles.set(a,r):(t.importResponsiveStyles.has(n)||t.importResponsiveStyles.set(n,new Map),t.importResponsiveStyles.get(n).set(a,r));return t.importedStyleCount+=1,a}function Ae(t=""){return String(t||"").trim().replace(/_/g," ")}function Te(t=""){return!t||/[;{}]/.test(t)?!1:/^[-#(),.%/\sa-zA-Z0-9]+$/.test(t)}function Ke(t=""){let e=String(t||"").trim();if(!e)return null;let r=e.match(/^\[([^\]]+)\]$/);if(r){let n=Ae(r[1]);return Te(n)?n:null}return ni[e]||null}function si(t=""){let e=Number(t);if(!Number.isFinite(e))return In;let r=String(e);return br.includes(r)?r:br.reduce((n,o)=>{let a=Math.abs(Number(n)-e);return Math.abs(Number(o)-e)<a?o:n},In)}function Ye(t="",e="500"){let r=String(t||"").toLowerCase(),n=si(e);return["blue","sky","indigo","cyan"].includes(r)?`var(--color-primary-${n})`:["purple","violet","fuchsia"].includes(r)?`var(--color-accent-${n})`:["green","emerald","lime","teal"].includes(r)?`var(--color-success-${n})`:["yellow","amber","warning"].includes(r)?`var(--color-warning-${n})`:["red","rose","pink","orange"].includes(r)?`var(--color-danger-${n})`:["slate","gray","zinc","neutral","stone"].includes(r)?`var(--color-gray-${n})`:""}function Fn(t=""){let e=Ae(t);return Te(e)&&(/^#(?:[0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(e)||/^(?:rgb|hsl)a?\([^)]*\)$/.test(e))?e:""}function ae(t=""){return String(t||"").split(/\s+/).map(e=>e.trim()).filter(Boolean)}function li(t="",e=""){if(!e)return t;let r=String(t||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return`${r} class="${e}"`;let o=n[1]||'"',a=ae(n[2]);a.includes(e)||a.push(e);let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function ci(t="",e=""){return e?new RegExp(`\\s${e}\\s*=`,"i").test(String(t||"")):!1}function di(t=""){let e=String(t||"").replace(/[-_]+/g," ").trim();return e?e.replace(/(^|\s)([a-z])/g,(r,n,o)=>`${n}${o.toUpperCase()}`):"Icon button"}function ui(t="",e=null){let r=String(t||"");return r&&r.replace(/<(button|a)([^>]*)>\s*(<pds-icon\b[^>]*><\/pds-icon>)\s*<\/\1>/gi,(n,o,a,i)=>{let s=li(a,"icon-only");if(!ci(s,"aria-label")){let d=String(i).match(/\sicon\s*=\s*(["'])(.*?)\1/i),l=d?String(d[2]||""):"",u=di(l);s+=` aria-label="${u}"`}return e&&(e.intentHits+=1,_(e,"intent.component.button.icon-only-markup")),`<${o}${s}>${i}</${o}>`})}function pi(t="",e=null){let r=String(t||"");if(!r)return r;let n=0,o=r.replace(/<p([^>]*?)>([\s\S]*?)<\/p>/gi,(a,i,s)=>{let d=String(i||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!d)return a;let l=ae(d[2]||""),u=l.some(p=>/^import-text-/.test(String(p||""))),c=l.includes("text-muted")||l.some(p=>/^import-font-/.test(String(p||"")));return!u||!c?a:(n+=1,`<div${i}>${s}</div>`)});return e&&n>0&&(e.intentHits+=1,_(e,"intent.typography.metric-paragraph-to-div"),j(e,`Normalized ${n} metric text paragraph tag(s) to div.`)),o}function Hn(t="",e=""){if(!e)return t;let r=String(t||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=ae(n[2]).filter(s=>s!==e);if(a.length===0)return r.replace(n[0],"");let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function fi(t="",e=r=>r){let r=String(t||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=ae(n[2]),i=e(Array.from(a)),s=Array.isArray(i)?i.filter(Boolean):a;if(s.length===0)return r.replace(n[0],"");let d=` class=${o}${s.join(" ")}${o}`;return r.replace(n[0],d)}function gi(t="",e=null){let r=String(t||"");if(!r)return r;let n=0,o=r.replace(/<(div|section|article|aside)([^>]*)>\s*<(p|div)([^>]*)>[\s\S]*?<\/\3>\s*<(p|div)([^>]*)>[\s\S]*?<\/\5>\s*<\/\1>/gi,(a,i,s,d,l,u,c)=>{let p=String(s||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!p||!ae(p[2]).includes("stack-sm"))return a;let h=String(l||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i),S=String(c||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!h||!S)return a;let g=ae(h[2]),f=ae(S[2]);if(!(g.some(m=>/^import-text-/.test(String(m||"")))&&f.some(m=>/^import-text-/.test(String(m||"")))))return a;let v=Hn(s,"stack-sm");return n+=1,a.replace(`<${i}${s}>`,`<${i}${v}>`)});return e&&n>0&&(e.intentHits+=1,_(e,"intent.typography.metric-pair-no-stack"),j(e,`Removed stack-sm from ${n} metric text pair container(s).`)),o}function mi(t={}){if(!t||typeof t!="object")return{};let e=t.typography;if(e&&typeof e=="object")return e;let r=t.design?.typography;return r&&typeof r=="object"?r:{}}function hi(t={}){let e=mi(t),r=Number(e.fontScale);return Number.isFinite(r)?Math.max(1,Math.min(2,r)):Et}function bi(t="",e=Et){let n={"4xl":1,"3xl":2,"2xl":3,xl:4}[t];if(!n)return"";let o=Number.isFinite(Number(e))?Math.max(1,Math.min(2,Number(e))):Et,a=Math.max(-1,Math.min(1,Math.round((o-Et)/.25))),i=n-a;return i<1?"h1":i>4?"":`h${i}`}function yi(t="",e=null,r={}){let n=String(t||"");if(!n)return n;let o=hi(r.config||{}),a=0,i=0,s=n.replace(/<(p|div|span)([^>]*)>([\s\S]*?)<\/\1>/gi,(d,l,u,c)=>{let p=String(u||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!p)return d;let b=ae(p[2]);if(!b.includes("import-font-bold"))return d;let S=b.find(m=>/^import-text-(?:4xl|3xl|2xl|xl)$/.test(String(m||"")))||"",g=S.match(/^import-text-(4xl|3xl|2xl|xl)$/);if(g){let m=bi(g[1],o);if(!m)return d;let w=fi(u,A=>A.filter(C=>C!=="import-font-bold"&&C!==S));return a+=1,`<${m}${w}>${c}</${m}>`}let f=/<\/?(?:div|p|section|article|aside|main|header|footer|ul|ol|li|table|tr|td|th|h[1-6])\b/i.test(c),y=/<\/?(?:strong|b)\b/i.test(c);if(f||y)return d;let v=Hn(u,"import-font-bold");return i+=1,`<${l}${v}><strong>${c}</strong></${l}>`});return e&&(a>0&&(e.intentHits+=1,_(e,"intent.typography.semantic-heading-from-scale"),j(e,`Converted ${a} bold display text node(s) to semantic heading tags (fontScale=${Number(o).toFixed(2)}).`)),i>0&&(e.intentHits+=1,_(e,"intent.typography.bold-to-strong"),j(e,`Wrapped ${i} bold text node(s) in strong tags.`))),s}function vi(t=[]){if(!Array.isArray(t)||t.length===0)return"";let e=t.filter(n=>!Mt.includes(n));if(e.length===0||e.length>1)return"";let r=e[0];return["hover","focus","active"].includes(r)?r:""}function Pn(t,e="base",r=[]){let n=vi(r),o=ri[t];if(o)return{declaration:o,breakpoint:e,pseudo:n,ruleId:"fallback.import-style"};let a=String(t).match(/^gap-(\d+)$/);if(a){let k={0:"var(--spacing-0)",1:"var(--spacing-1)",2:"var(--spacing-2)",3:"var(--spacing-3)",4:"var(--spacing-4)",5:"var(--spacing-5)",6:"var(--spacing-6)",7:"var(--spacing-7)",8:"var(--spacing-8)",10:"var(--spacing-10)",12:"var(--spacing-12)"},L=Number(a[1]);if(k[L])return{declaration:`gap:${k[L]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.gap-scale"}}let i=String(t).match(/^(mt|mb|my)-(.+)$/);if(i){let k=i[1],L=i[2],T=Ke(L);if(T){let I="";return k==="mt"?I=`margin-top:${T}`:k==="mb"?I=`margin-bottom:${T}`:I=`margin-top:${T};margin-bottom:${T}`,{declaration:I,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.margin-scale"}}}let s=String(t).match(/^min-w-\[([^\]]+)\]$/);if(s){let k=Ae(s[1]);if(Te(k))return{declaration:`min-width:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.min-width-arbitrary"}}let d=String(t).match(/^max-w-\[([^\]]+)\]$/);if(d){let k=Ae(d[1]);if(Te(k))return{declaration:`max-width:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.max-width-arbitrary"}}let l=String(t).match(/^min-h-\[([^\]]+)\]$/);if(l){let k=Ae(l[1]);if(Te(k))return{declaration:`min-height:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.min-height-arbitrary"}}let u=String(t).match(/^grid-rows-\[([^\]]+)\]$/);if(u){let k=Ae(u[1]);if(Te(k))return{declaration:`grid-template-rows:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.grid-rows-arbitrary"}}let c=String(t).match(/^size-(.+)$/);if(c){let k=Ke(c[1]);if(k)return{declaration:`width:${k};height:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.size-scale"}}let p=String(t).match(/^w-(.+)$/);if(p){let k=Ke(p[1]);if(k)return{declaration:`width:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.width-scale"}}let b=String(t).match(/^h-(.+)$/);if(b){let k=Ke(b[1]);if(k)return{declaration:`height:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.height-scale"}}let h={xs:"var(--font-size-xs)",sm:"var(--font-size-sm)",base:"var(--font-size-md)",lg:"var(--font-size-lg)",xl:"var(--font-size-xl)","2xl":"var(--font-size-2xl)","3xl":"var(--font-size-3xl)","4xl":"var(--font-size-4xl)"},S=String(t).match(/^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$/);if(S)return{declaration:`font-size:${h[S[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-size"};let g={normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},f=String(t).match(/^font-(normal|medium|semibold|bold|extrabold|black)$/);if(f)return{declaration:`font-weight:${g[f[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.font-weight"};let y={none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"},v=String(t).match(/^leading-(none|tight|snug|normal|relaxed|loose)$/);if(v)return{declaration:`line-height:${y[v[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.line-height"};let m={tighter:"-0.05em",tight:"-0.025em",normal:"0em",wide:"0.025em",wider:"0.05em",widest:"0.1em"},w=String(t).match(/^tracking-(tighter|tight|normal|wide|wider|widest)$/);if(w)return{declaration:`letter-spacing:${m[w[1]]}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.tracking"};let A=String(t).match(/^bg-black\/(\d{1,3})$/);if(A)return{declaration:`background-color:color-mix(in srgb, var(--color-gray-900) ${Math.max(0,Math.min(100,Number(A[1])))}%, transparent)`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.overlay-alpha"};if(t==="text-white")return{declaration:"color:var(--color-gray-50)",breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-inverse"};let C=String(t).match(/^bg-(primary|secondary|accent)$/);if(C){let L={primary:"var(--color-primary-fill)",secondary:"var(--color-gray-500)",accent:"var(--color-accent-500)"}[C[1]];if(L)return{declaration:`background-color:${L}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.bg-semantic"}}let R=String(t).match(/^bg-([a-z]+)-(\d{2,3})$/);if(R){let k=Ye(R[1],R[2]);if(k)return{declaration:`background-color:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.bg-tokenized"}}let z=String(t).match(/^bg-\[([^\]]+)\]$/);if(z){let k=Fn(z[1]);if(k)return{declaration:`background-color:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.bg-arbitrary"}}let M=String(t).match(/^text-([a-z]+)-(\d{2,3})$/);if(M){let k=Ye(M[1],M[2]);if(k)return{declaration:`color:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-tokenized"}}let P=String(t).match(/^text-\[([^\]]+)\]$/);if(P){let k=Fn(P[1]);if(k)return{declaration:`color:${k}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.text-arbitrary"}}let E=String(t).match(/^rounded(?:-([trbl]{1,2}))?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(E){let k=E[1]||"",L=E[2]||"sm",T=L==="none"?"0":`var(--radius-${L})`,I={t:["top-left","top-right"],b:["bottom-left","bottom-right"],l:["top-left","bottom-left"],r:["top-right","bottom-right"],tl:["top-left"],tr:["top-right"],bl:["bottom-left"],br:["bottom-right"]};if(!k)return{declaration:`border-radius:${T}`,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.rounded"};let B=(I[k]||[]).map(K=>`border-${K}-radius:${T}`).join(";");if(B)return{declaration:B,breakpoint:e,pseudo:n,ruleId:"fallback.import-style.rounded"}}return null}function Ct(t,e){return typeof t=="number"&&Number.isFinite(t)?`${t}px`:typeof t=="string"&&t.trim()?t.trim():`${e}px`}function xi(t={}){let r=(t?.design&&typeof t.design=="object"?t.design:t)?.layout?.breakpoints||{};return{sm:Ct(r.sm,640),md:Ct(r.md,768),lg:Ct(r.lg,1024),xl:Ct(r.xl,1280)}}function wi(t,e){let r=Array.from(t.importBaseStyles.entries()).map(([a,i])=>`.${a}{${i};}`),n=[];for(let[a,i]of t.importResponsiveStyles.entries()){let s=e?.[a];if(!s||!i?.size)continue;let d=Array.from(i.entries()).map(([l,u])=>`.${l}{${u};}`).join(`
`);n.push(`@media (min-width: ${s}) {
${d}
}`)}for(let[a,i]of t.importPseudoStyles.entries()){let[s,d]=String(a).split("|");if(!d||!i?.size)continue;let l=Array.from(i.entries()).map(([c,p])=>`.${c}:${d}{${p};}`).join(`
`);if(!l)continue;if(s==="base"){n.push(l);continue}let u=e?.[s];u&&n.push(`@media (min-width: ${u}) {
${l}
}`)}let o=[...r,...n].filter(Boolean).join(`
`);return o.trim()?["/* pds-import: generated fallback styles for unmapped Tailwind utilities */",o].join(`
`):""}function ki(t="",e=""){if(!e||!e.trim())return t;let r=`<style data-pds-import="tailwind-fallback">
${e}
</style>`;return/<head[^>]*>/i.test(t)?t.replace(/<head([^>]*)>/i,`<head$1>
${r}`):`${r}
${t}`}function Nn(t=""){if(!t)return!1;if(t.includes(":")||t.includes("["))return!0;let e=t.split("-")[0];return oi.includes(e)}function ie(t=""){let e=String(t).split(":");if(e.length===1)return{breakpoint:"base",base:e[0],variants:[]};let r=e[e.length-1],n=e.slice(0,-1);return{breakpoint:n.find(a=>Mt.includes(a))||"base",base:r,variants:n}}function Si(){return{totalTailwind:0,mapped:0,ignored:0,policySkipped:0,unknown:0,intentHits:0,unknownTokens:new Map,notes:[],appliedRules:new Set,importBaseStyles:new Map,importResponsiveStyles:new Map,importPseudoStyles:new Map,importedStyleCount:0,labelNestingCount:0,removedAtomicSpacingCount:0,removedAtomicPositioningCount:0}}function $i(t=""){let e=String(t||"").toLowerCase().replace(/\s+/g,""),r=e.includes("menu,ol,ul{list-style:none")||e.includes("ol,ul,menu{list-style:none")||e.includes("ul,ol,menu{list-style:none"),n=e.includes("a{color:inherit;text-decoration:inherit");return{listReset:r,anchorReset:n}}function Li(t=""){return String(t||"").toLowerCase().includes("cdn.tailwindcss.com")?{listReset:!0,anchorReset:!0}:{listReset:!1,anchorReset:!1}}function zi(t="",e=null){let r=String(t||""),n={listReset:!1,anchorReset:!1,strippedRuntimeCssBlocks:0,strippedRuntimeScripts:0};return r=r.replace(/<style([^>]*)>([\s\S]*?)<\/style>/gi,(o,a,i)=>{let s=String(i||"");if(!(/tailwindcss\s+v\d/i.test(s)||/\*\s*!\s*tailwindcss/i.test(s)))return o;let l=$i(s);return n.listReset=n.listReset||l.listReset,n.anchorReset=n.anchorReset||l.anchorReset,n.strippedRuntimeCssBlocks+=1,""}),r=r.replace(/<script([^>]*?)src\s*=\s*(?:(['"])([^"']*cdn\.tailwindcss\.com[^"']*)\2|([^\s>]*cdn\.tailwindcss\.com[^\s>]*))([^>]*)><\/script>/gi,(o,a,i,s,d)=>{let u=Li(s||d||"");return n.listReset=n.listReset||u.listReset,n.anchorReset=n.anchorReset||u.anchorReset,n.strippedRuntimeScripts+=1,""}),e&&(n.strippedRuntimeCssBlocks>0||n.strippedRuntimeScripts>0)&&(_(e,"intent.preflight.tailwind-runtime-detected"),n.strippedRuntimeCssBlocks>0&&j(e,`Detected and stripped ${n.strippedRuntimeCssBlocks} Tailwind runtime style block(s).`)),e&&n.strippedRuntimeScripts>0&&j(e,`Removed ${n.strippedRuntimeScripts} Tailwind CDN script reference(s).`),{html:r,hints:n}}function j(t,e){!t||!e||t.notes.includes(e)||t.notes.push(e)}function Ci(t,e){let r=t.unknownTokens.get(e)||0;t.unknownTokens.set(e,r+1)}function Ei(t={}){let r=(t?.design&&typeof t.design=="object"?t.design:t)?.layout?.utilities||{};return{grid:r.grid!==!1,flex:r.flex!==!1,spacing:r.spacing!==!1,container:r.container!==!1}}function J(t,e){return e?t?.[e]!==!1:!0}function jn(t){let e=String(t).match(/^grid-cols-(\d+)$/);return e?Number(e[1]):null}function On(t={}){let e=Mt.map(o=>({bp:o,cols:t[o]})).filter(o=>Number.isFinite(o.cols));if(e.length<2)return null;if(e.length===2){let[o,a]=e;if(o.bp==="base"&&o.cols===1&&a.cols===2)return"grid-auto-lg";if(o.bp==="base"&&o.cols===1&&a.cols>=3)return null;if(o.cols<a.cols){if(a.cols>=4)return"grid-auto-md";if(a.cols>=2)return"grid-auto-lg"}return null}let r=!0;for(let o=1;o<e.length;o+=1)if(e[o].cols<=e[o-1].cols){r=!1;break}if(!r)return null;let n=e[e.length-1]?.cols||0;return n>=4?"grid-auto-md":n>=3?"grid-auto-sm":null}function Mi(t=""){let e=String(t).match(/^text-(gray|slate|zinc|neutral|stone)-(\d{2,3})$/);if(!e)return"";let r=Number(e[2]);return Number.isFinite(r)&&r>=400&&r<=600?"text-muted":""}function Ai(t="",e=0){return!t||!Number.isFinite(e)?"":{sm:{2:"sm:grid-cols-2"},md:{3:"md:grid-cols-3"},lg:{4:"lg:grid-cols-4"}}?.[t]?.[e]||""}function Ti(t=""){let e=ie(t),n=String(e?.base||"").match(/^space-y-(\d+)$/);if(!n)return"stack-md";let o=Number(n[1]);return Number.isFinite(o)?o<=1?"stack-xs":o<=2?"stack-sm":o<=4?"stack-md":"stack-lg":"stack-md"}function Ri(t=new Set){return Array.from(t).some(e=>{let r=String(e||"");return/^gap-(?:xs|sm|md|lg|xl)$/.test(r)||/^gap-[0-9]+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?gap-/.test(r)})}function Ii(t=new Set){return Array.from(t).some(e=>/^stack-(?:xs|sm|md|lg|xl)$/.test(String(e||"")))}function _i(t=new Set){return Array.from(t).some(e=>{let r=String(e||"");return/^grid-cols-\d+$/.test(r)||/^grid-auto-(?:sm|md|lg|xl)$/.test(r)||/^(?:sm|md|lg|xl):grid-cols-\d+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?grid-cols-\d+$/.test(r)})}function Fi(t,e=12){return Array.from(t.unknownTokens.entries()).sort((r,n)=>n[1]-r[1]).slice(0,e).map(([r])=>r)}function _(t,e){!t||!e||t.appliedRules.add(e)}function le(t=[],e){return!Array.isArray(t)||!e?!1:t.some(r=>e.test(String(r)))}function Pi(t=[]){for(let e of t){let r=ie(e);if(r.breakpoint!=="base")continue;let n=String(r.base).match(/^h-(.+)$/);if(!n)continue;let o=Ke(n[1]);if(!o||o==="auto")continue;let a=String(o).match(/^(-?\d+(?:\.\d+)?)rem$/);if(a){let i=Number(a[1]);if(Number.isFinite(i))return i*16}}return null}function Ni(t=[],e=""){let r=e==="button",n=le(t,/^bg-/),o=le(t,/^hover:bg-/),a=le(t,/^border/),i=le(t,/^shadow/),s=t.includes("cursor-pointer"),d=le(t,/^rounded/),l=le(t,/^(?:min-w|max-w|w)-/),u=le(t,/^text-(?:white|black|\[[^\]]+\]|[a-z]+-\d{2,3})$/),c=n||o||i;if(!(r||e==="a"&&(c||a||s||d&&l)))return{shouldNormalize:!1,variant:"none",size:"base",iconOnly:!1};let h="none";a&&!n&&!o?h="outline":(c||n&&u)&&(h="primary");let S=t.includes("rounded-full")&&(t.includes("p-2")||t.includes("p-1")||t.includes("p-2.5")),g=le(t,/^size-(?:6|7|8|9|10|11|12)$/),f=S||g,y=Pi(t),v=t.includes("text-sm")||t.includes("text-xs"),m=t.includes("text-lg")||t.includes("text-xl"),w="base";return y&&y<=40||v?w="sm":(y&&y>=48||m)&&(w="lg"),{shouldNormalize:!0,variant:h,size:w,iconOnly:f}}function ji(t=""){let e=String(t||"").toLowerCase();return["green","emerald","lime","teal"].includes(e)?"badge-success":["blue","sky","cyan","indigo"].includes(e)?"badge-info":["yellow","amber","orange"].includes(e)?"badge-warning":["red","rose","pink"].includes(e)?"badge-danger":["gray","slate","zinc","neutral","stone"].includes(e)?"badge-secondary":["purple","violet","fuchsia","primary","accent"].includes(e)?"badge-primary":"badge-secondary"}function Oi(t=[],e="",r={shouldNormalize:!1}){if(r?.shouldNormalize)return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(["button","a","input","select","textarea"].includes(e))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(t.some(M=>/^badge(?:-|$)/.test(String(M))))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let n=t.map(M=>ie(M)).filter(M=>M.breakpoint==="base").map(M=>String(M.base)),o=n.some(M=>/^rounded(?:-|$)/.test(M)),a=n.some(M=>/^px-/.test(M)),i=n.some(M=>/^py-/.test(M)),s=a&&i,d=n.includes("text-xs")||n.includes("text-sm"),l=n.includes("text-lg")||n.includes("text-xl"),u=n.map(M=>M.match(/^bg-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),c=n.map(M=>M.match(/^text-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),p=n.map(M=>M.match(/^border-([a-z]+)-(\d{2,3})$/)).find(Boolean),b=Number(u?.[2]),h=Number(c?.[2]),S=!!(u&&Number.isFinite(b)&&b<=300),g=n.some(M=>/^border(?:-|$)/.test(M)),f=!!(u||c||p),y=[o,s,d,S||g].filter(Boolean).length;if(!(f&&y>=3))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let m=u&&u[1]||c&&c[1]||p&&p[1]||"",w=ji(m),A=g&&!S,C=d?"badge-sm":l?"badge-lg":"",R=S?{family:m,bgShade:Number.isFinite(b)?b:200,textShade:Number.isFinite(h)?h:700}:null;return{shouldNormalize:!0,variantClass:R?"":w,outline:A,sizeClass:C,pastel:R}}function Bi(t="",e=0){let r=String(t||"").toLowerCase(),n=Number(e);return r==="white"?"surface-base":["gray","slate","zinc","neutral","stone"].includes(r)?Number.isFinite(n)&&n<=100?"surface-base":"surface-subtle":["blue","sky","cyan","indigo","primary","info"].includes(r)?"surface-info":["purple","violet","fuchsia","accent"].includes(r)?"surface-primary":["green","emerald","lime","teal","success"].includes(r)?"surface-success":["yellow","amber","orange","warning"].includes(r)?"surface-warning":["red","rose","pink","danger"].includes(r)?"surface-danger":"surface-base"}function Di(t=[],e="",r={shouldNormalize:!1},n={shouldNormalize:!1}){if(r?.shouldNormalize||n?.shouldNormalize)return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(!new Set(["div","section","article","aside","li"]).has(e))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(t.some(g=>/^card(?:-|$)/.test(String(g))))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let a=t.map(g=>ie(g)).filter(g=>g.breakpoint==="base").map(g=>String(g.base)),i=a.some(g=>/^rounded(?:-|$)/.test(g)),s=a.some(g=>/^border(?:$|-)/.test(g)),d=a.some(g=>/^shadow(?:$|-)/.test(g)),l=a.some(g=>/^(?:p|px|py|pt|pb|pl|pr)-/.test(g)),u=a.map(g=>g.match(/^bg-([a-z]+)-?(\d{2,3})?$/)).find(Boolean),c=a.includes("bg-white")||!!u;if(!([i,s||d,c,l].filter(Boolean).length>=3))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let h="card-basic";d?h="card-elevated":s&&(h="card-outlined");let S="";return d?S="surface-elevated":u?S=Bi(u[1],u[2]):c&&(S="surface-base"),{shouldNormalize:!0,cardVariantClass:h,surfaceClass:S}}function Hi({tagName:t,originalClassValue:e,policy:r,summary:n,preflightHints:o={}}){if(ti.has(t))return _(n,"table.strict-tags.no-classes"),"";let a=String(e).split(/\s+/).filter(Boolean),i=Ni(a,t),s=Oi(a,t,i),d=Di(a,t,i,s),l=/^h[1-6]$/.test(t),u=["i","svg"].includes(t)||a.some(E=>/^fa(?:[a-z-]+)?$/i.test(String(E||""))||/^fa-/.test(String(E||""))),c=new Set,p={},b={},h=!1,S="",g="",f=!1,y="";a.forEach(E=>{let k=ie(E),L=k.base;if(ei.some(N=>N.test(L))){n.ignored+=1,_(n,"cleanup.non-pds-class");return}let T=Nn(E)||Nn(L);if(T&&(n.totalTailwind+=1),/^space-y-/.test(L)){h=!0,S=S||E,g=g||Ti(E),n.ignored+=1,_(n,"layout.spacing.space-y-to-stack");return}if(/^space-x-/.test(L)){let N=String(L).match(/^space-x-(\d+)$/);if(N){let D=`gap-${N[1]}`,Y=hr.get(D);if(Y&&J(r,"spacing")){c.add(Y),f=!0,y=y||E,n.mapped+=1,n.intentHits+=1,_(n,"layout.spacing.space-x-to-gap");return}}n.ignored+=1,_(n,"style.spacing.atomic");return}if(/^grid-cols-\d+$/.test(L)&&k.breakpoint!=="base"){let N=jn(L);if(Number.isFinite(N)&&J(r,"grid")){p[k.breakpoint]=N,n.mapped+=1,_(n,"intent.layout.responsive-grid-to-auto");return}if(!J(r,"grid")){n.policySkipped+=1,j(n,"Skipped responsive grid mapping because layout.utilities.grid=false.");return}}if(/^flex-(?:row|col)$/.test(L)&&k.breakpoint!=="base"){if(J(r,"flex")){b[k.breakpoint]=L,n.mapped+=1,_(n,"intent.layout.mobile-stack");return}n.policySkipped+=1,j(n,"Skipped responsive flex mapping because layout.utilities.flex=false.");return}if(/^grid-cols-\d+$/.test(L)&&k.breakpoint==="base"){let N=jn(L);Number.isFinite(N)&&J(r,"grid")&&(p.base=N)}let I=Qa.get(L);if(I&&k.breakpoint==="base"){if(!J(r,I.gate)){n.policySkipped+=1,j(n,`Skipped ${L} because layout.utilities.${I.gate}=false.`);return}I.pds.forEach(N=>{N&&c.add(N)}),n.mapped+=1,_(n,I.id);return}if(hr.has(L)&&k.breakpoint==="base"){if(!J(r,"spacing")){n.policySkipped+=1,j(n,"Skipped gap utility because layout.utilities.spacing=false.");return}c.add(hr.get(L)),n.mapped+=1,_(n,"layout.spacing.gap-scale");return}if(Rn.has(L)&&k.breakpoint==="base"){if(!J(r,"container")){n.policySkipped+=1,j(n,"Skipped max-width utility because layout.utilities.container=false.");return}c.add(Rn.get(L)),n.mapped+=1,_(n,"layout.container.max-width");return}if(i.shouldNormalize&&T){let N=String(L||"");if(k.breakpoint==="base"&&["flex-1","grow","flex-grow"].includes(N)){c.add("grow"),n.mapped+=1,n.intentHits+=1,_(n,"intent.component.button.layout-grow");return}if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,_(n,"intent.component.button.normalize");return}}if(l&&/^(?:text-(?:xs|sm|base|lg|xl|\dxl|white|black|\[[^\]]+\]|[a-z]+-\d{2,3})|font-|leading-|tracking-|uppercase|lowercase|capitalize)/.test(L)){n.ignored+=1,n.intentHits+=1,_(n,"intent.typography.heading-semantic");return}if(s.shouldNormalize&&T){let N=String(L||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,_(n,"intent.component.badge.normalize");return}}if(d.shouldNormalize&&T){let N=String(L||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)/.test(N)||N.startsWith("hover:")){n.ignored+=1,_(n,"intent.component.card.normalize");return}}let O=Mi(L);if(O&&k.breakpoint==="base"){c.add(O),n.mapped+=1,n.intentHits+=1,_(n,"intent.typography.text-neutral-to-muted");return}if(/^text-(?:white|black|[a-z]+-\d{2,3}|\[[^\]]+\])$/.test(L)){if(u||t==="a"&&!i.shouldNormalize){let D=Pn(L,k.breakpoint,k.variants);if(D){let Y=me(n,`${t}-color-${L}`,D.declaration,D.breakpoint,D.pseudo);if(Y){c.add(Y),n.mapped+=1,n.intentHits+=1,_(n,u?"intent.icon.color-preserve":"intent.typography.link-active-preserve");return}}}n.ignored+=1,_(n,"style.color");return}let K=Pn(L,k.breakpoint,k.variants);if(K){let N=me(n,L,K.declaration,K.breakpoint,K.pseudo);if(N){c.add(N),n.mapped+=1,n.intentHits+=1,_(n,K.ruleId),k.breakpoint!=="base"&&j(n,`Generated responsive import fallback for ${E}.`);return}}for(let N of V.ignoredPatterns)if(N.pattern.test(L)){n.ignored+=1,_(n,N.id),N.id==="style.spacing.atomic"&&(n.removedAtomicSpacingCount+=1),N.id==="style.positioning.atomic"&&(n.removedAtomicPositioningCount+=1);return}if(T){n.unknown+=1,Ci(n,E);return}c.add(E)}),h&&J(r,"spacing")&&(c.add(g||"stack-md"),n.mapped+=1,n.intentHits+=1,j(n,`Mapped ${S} to ${g||"stack-md"}.`)),f&&J(r,"spacing")&&j(n,`Mapped ${y} to gap utility.`);let v=On(p);if(v&&J(r,"grid")?(c.delete("grid-cols-1"),c.delete("grid-cols-2"),c.delete("grid-cols-3"),c.delete("grid-cols-4"),c.delete("grid-cols-6"),c.add("grid"),c.add(v),n.intentHits+=1,_(n,"intent.layout.responsive-grid-to-auto"),j(n,`Collapsed responsive grid columns to ${v}.`)):J(r,"grid")&&Mt.filter(k=>k!=="base"&&Number.isFinite(p[k])).forEach(k=>{let L=p[k],T=Ai(k,L);if(T){c.add("grid"),c.add(T),n.intentHits+=1,_(n,"intent.layout.responsive-grid-to-auto"),j(n,`Mapped ${k}:grid-cols-${L} to ${T}.`);return}let I=me(n,`grid-cols-${L}`,`grid-template-columns:repeat(${L}, minmax(0, 1fr))`,k);I&&(c.add("grid"),c.add(I),n.intentHits+=1,_(n,"fallback.import-style.grid-cols-responsive"),j(n,`Mapped ${k}:grid-cols-${L} to responsive import fallback for exact columns.`))}),J(r,"flex")&&a.includes("flex-col")&&(b.md==="flex-row"||b.lg==="flex-row")&&(c.delete("flex-col"),c.delete("flex-row"),c.add("mobile-stack"),n.intentHits+=1,_(n,"intent.layout.mobile-stack"),j(n,"Mapped flex-col + breakpoint flex-row to mobile-stack.")),(c.has("flex")||c.has("inline-flex"))&&J(r,"spacing")&&(Ri(c)||Ii(c)||f||h||(c.add("gap-sm"),n.intentHits+=1,_(n,"layout.spacing.flex-min-gap"),j(n,"Added gap-sm fallback for flex container without explicit spacing."))),a.some(E=>/^grid-cols-\d+$/.test(ie(E).base))&&c.has("grid")&&!_i(c)){let E=On(p);E?(c.add(E),n.intentHits+=1,_(n,"intent.layout.responsive-grid-to-auto"),j(n,`Applied grid safety fallback ${E} to avoid bare grid output.`)):Number.isFinite(p.base)&&p.base>1?(c.add(`grid-cols-${p.base}`),n.intentHits+=1,_(n,"intent.layout.grid-safety-fallback"),j(n,`Applied grid safety fallback grid-cols-${p.base} to preserve explicit grid intent.`)):(c.add("mobile-stack"),n.intentHits+=1,_(n,"intent.layout.grid-safety-fallback.mobile-stack"),j(n,"Applied mobile-stack safety fallback to avoid bare grid output when explicit grid intent was present."))}let A=a.some(E=>/^(?:bg-white|shadow|shadow-md|shadow-lg)$/.test(E)),C=a.some(E=>/^rounded/.test(E));if(["div","section","article","li","aside"].includes(t)&&A&&C&&(c.add("card"),!c.has("surface-elevated")&&a.some(E=>/^shadow/.test(E))&&c.add("surface-elevated"),!c.has("surface-base")&&a.includes("bg-white")&&c.add("surface-base"),n.intentHits+=1,_(n,"intent.component.card")),t==="button"||t==="a"){let E=a.some(T=>/^bg-(?:[a-z]+-)?[4567]00$/.test(T))&&a.includes("text-white"),k=a.some(T=>/^border/.test(T))&&!E,L=a.includes("p-2")&&a.includes("rounded-full");E?(c.delete("surface-base"),c.delete("surface-elevated"),c.add("btn-primary"),n.intentHits+=1,_(n,"intent.component.button.primary")):k&&(c.add("btn-outline"),n.intentHits+=1,_(n,"intent.component.button.outline")),L&&(c.add("icon-only"),_(n,"intent.component.button.icon-only"))}if(i.shouldNormalize){for(let k of Array.from(c))String(k).startsWith("import-")&&c.delete(k);["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","surface-base","surface-elevated","surface-subtle","card"].forEach(k=>c.delete(k)),i.variant==="primary"?(c.add("btn-primary"),_(n,"intent.component.button.primary")):i.variant==="outline"&&(c.add("btn-outline"),_(n,"intent.component.button.outline")),i.size==="sm"?(c.add("btn-sm"),_(n,"intent.component.button.size-sm")):i.size==="lg"&&(c.add("btn-lg"),_(n,"intent.component.button.size-lg")),i.iconOnly&&(c.add("icon-only"),_(n,"intent.component.button.icon-only")),n.intentHits+=1,_(n,"intent.component.button.normalize")}if(s.shouldNormalize){for(let k of Array.from(c))String(k).startsWith("import-")&&c.delete(k);if(["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","grow","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","text-muted","surface-base","surface-elevated","surface-subtle","card"].forEach(k=>c.delete(k)),c.add("badge"),s.variantClass&&c.add(s.variantClass),s.outline&&c.add("badge-outline"),s.sizeClass&&c.add(s.sizeClass),s.pastel&&s.pastel.family){let k=Ye(s.pastel.family,String(s.pastel.bgShade||200)),L=Ye(s.pastel.family,String(s.pastel.textShade||700));if(k&&L){let T=`badge-pastel-${s.pastel.family}-${s.pastel.bgShade}-${s.pastel.textShade}`,I=me(n,T,`background-color:${k};color:${L}`,"base");I&&(c.add(I),_(n,"intent.component.badge.pastel-preserve"),j(n,`Preserved pastel badge tone using ${I}.`))}}n.intentHits+=1,_(n,"intent.component.badge.normalize"),j(n,"Normalized badge/pill utility cluster to PDS badge classes.")}if(d.shouldNormalize){for(let k of Array.from(c))String(k).startsWith("import-")&&c.delete(k);["surface-base","surface-subtle","surface-elevated","surface-sunken","surface-overlay","surface-inverse","surface-primary","surface-secondary","surface-success","surface-warning","surface-danger","surface-info","card-basic","card-elevated","card-outlined","card-interactive"].forEach(k=>c.delete(k)),c.add("card"),d.cardVariantClass&&c.add(d.cardVariantClass),d.surfaceClass&&c.add(d.surfaceClass),n.intentHits+=1,_(n,"intent.component.card.normalize"),j(n,"Normalized card utility cluster to PDS card/surface classes.")}if(t==="a"&&!i.shouldNormalize&&a.some(k=>k.includes("hover:text")||k==="transition-colors")){let k=me(n,"link-reset","text-decoration:none");k&&c.add(k),n.intentHits+=1,_(n,"intent.typography.link-treatment")}if(t==="footer"&&(c.has("surface-base")||a.some(k=>/^bg-/.test(k)))&&(c.delete("surface-base"),c.delete("surface-subtle"),c.add("surface-inverse"),n.intentHits+=1,_(n,"intent.surface.footer-inverse")),o?.listReset&&["ul","ol","menu"].includes(t)){let E=me(n,"list-reset","list-style:none;margin:0;padding:0");E&&(c.add(E),n.intentHits+=1,_(n,"intent.preflight.list-reset"))}if(o?.anchorReset&&t==="a"&&!i.shouldNormalize){let E=me(n,"anchor-reset","color:inherit;text-decoration:inherit");E&&(c.add(E),n.intentHits+=1,_(n,"intent.preflight.anchor-reset"))}let M=new Set(["div","section","article","aside","nav","main","header","footer","form","fieldset","ul","ol","li"]),P=a.some(E=>{let k=ie(E).base;return/^(?:flex|grid|container|gap-|space-[xy]-|items-|justify-|content-|place-|self-|w-|h-|min-|max-)/.test(k)});return c.size===0&&M.has(t)&&P&&(c.add("stack-sm"),j(n,`Added stack-sm fallback for <${t}> with unmapped classes.`)),Array.from(c).join(" ")}function Wi(t="",e={}){let r=String(t||""),n=Ei(e.config||{}),o=xi(e.config||{}),a=Si(),i=zi(r,a),d=ai(i.html,a).replace(/<([a-zA-Z][\w:-]*)([^>]*?)\sclass\s*=\s*(["'])(.*?)\3([^>]*)>/gs,(w,A,C,R,z,M)=>{let P=Hi({tagName:String(A||"").toLowerCase(),originalClassValue:z,policy:n,summary:a,preflightHints:i.hints}),E=String(P||"").trim();return E?`<${A}${C} class=${R}${E}${R}${M}>`:`<${A}${C}${M}>`}),l=yi(gi(pi(ui(d,a),a),a),a,{config:e.config||{}}),u=wi(a,o),c=ki(l,u);u&&j(a,`Generated ${a.importedStyleCount} import-* fallback style mappings.`),(a.removedAtomicSpacingCount>0||a.removedAtomicPositioningCount>0)&&j(a,`Removed atomic utilities by policy: spacing=${a.removedAtomicSpacingCount}, positioning=${a.removedAtomicPositioningCount}.`);let p=Fi(a,16),b=a.mapped+a.ignored+a.policySkipped,h=a.totalTailwind>0?b/a.totalTailwind:1,S=a.totalTailwind>0?a.unknown/a.totalTailwind:0,g=.42+h*.45+Math.min(a.intentHits,4)*.025-S*.18,f=Math.max(.15,Math.min(.96,Number(g.toFixed(2)))),y=[`pds-import: rulebook=${Tn} confidence=${Math.round(f*100)}%`,`pds-import: tailwind=${a.totalTailwind} mapped=${a.mapped} ignored=${a.ignored} policySkipped=${a.policySkipped} unknown=${a.unknown}`];p.length&&y.push(`pds-import: unknown-tailwind=${p.join(", ")}`),a.notes.length&&y.push(`pds-import: notes=${a.notes.join(" | ")}`);let v=`<!-- ${y.join(` -->
<!-- `)} -->
${c}`,m=[];return a.unknown>0&&m.push({severity:"warning",message:`Converted with ${a.unknown} unknown Tailwind utilities requiring manual review.`}),a.policySkipped>0&&m.push({severity:"info",message:`Skipped ${a.policySkipped} utility mappings due to PDS config policy.`}),p.length&&m.push({severity:"info",message:`Top unknown utilities: ${p.slice(0,8).join(", ")}`}),{html:v,confidence:f,issues:m,meta:{rulebookVersion:Tn,coverage:{tailwind:a.totalTailwind,mapped:a.mapped,ignored:a.ignored,policySkipped:a.policySkipped,unknown:a.unknown,importedStyles:a.importedStyleCount,nestedLabelPairs:a.labelNestingCount},unknownTailwindTokens:p,notes:a.notes,appliedRules:Array.from(a.appliedRules),policy:n,importStyleSheetInjected:!!u,breakpoints:o}}}function Ui(){return{rulesJsonPath:Za,...V,directMappings:V.directMappings.map(t=>({id:t.id,tw:t.tw,pds:t.pds,gate:t.gate||null})),ignoredPatterns:V.ignoredPatterns.map(t=>({id:t.id,pattern:String(t.pattern),reason:t.reason}))}}function qi(t){let e=String(t||"").match(/#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})\b/);return e?e[0]:null}function Vi(t){return String(t||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Wn(t){return/<\s*[a-z][^>]*>/i.test(String(t||""))}function Gi(t){let e=String(t||"").trim().toLowerCase();if(!e)return null;let r=Number.parseFloat(e);return Number.isFinite(r)?e.endsWith("rem")||e.endsWith("em")?r*16:e.endsWith("px")||/^[0-9.\-]+$/.test(e)?r:null:null}function ee(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/#(?:[0-9a-f]{3,8})\b/i);if(r)return r[0].toLowerCase();let n=e.match(/rgba?\([^)]*\)/i);if(n)return n[0];let o=e.match(/hsla?\([^)]*\)/i);return o?o[0]:""}function Ki(t=""){let e=String(t||"").trim();if(!e||typeof window>"u"||typeof document>"u")return"";let r=document.documentElement;if(!r)return"";let n=window.getComputedStyle(r);return String(n.getPropertyValue(e)||"").trim()}function Ji(t=""){let e=String(t||"").trim(),r=ee(e);if(r)return r;let n=e.match(/var\(\s*(--[^\s,)]+)\s*(?:,[^)]+)?\)/i);if(!n)return"";let o=Ki(n[1]);return ee(o)}function Yi(t=""){let e=String(t||"").trim();if(!e)return"";let r=e.split(":").pop()||e;if(r==="bg-white")return"#ffffff";if(r==="bg-black")return"#000000";let n=r.match(/^bg-black\/(\d{1,3})$/i);if(n)return`rgba(0,0,0,${Math.max(0,Math.min(100,Number(n[1])))/100})`;let o=r.match(/^bg-\[([^\]]+)\]$/i);if(o)return ee(o[1]);let a=r.match(/^bg-([a-z]+)-(\d{2,3})$/i);if(!a)return"";let i=Ye(a[1],a[2]);return i?Ji(i):""}function Bn(t=""){return String(t||"").split(/\s+/).map(r=>r.trim()).filter(Boolean).map(r=>Yi(r)).filter(Boolean)}function Zi(t=""){let e=[],r=String(t||""),n=/([^{}]+)\{([^{}]*)\}/g,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim(),i=String(o[2]||"").trim();a&&i&&e.push({selector:a,body:i}),o=n.exec(r)}return e}function Xi(t=""){let e=String(t||"").toLowerCase();return e?/(^|\s|,)(html|body|:root|main)(\s|,|$)|#app\b|#root\b|\.app\b|\.page\b/.test(e):!1}function Qi(t=""){let e=String(t||"").trim().match(/rgba?\(\s*([0-9.]+)\s*,\s*([0-9.]+)\s*,\s*([0-9.]+)(?:\s*,\s*([0-9.]+))?\s*\)/i);if(!e)return null;let r=Number.parseFloat(e[1]),n=Number.parseFloat(e[2]),o=Number.parseFloat(e[3]),a=e[4]==null?1:Number.parseFloat(e[4]);return[r,n,o,a].every(i=>Number.isFinite(i))?{r:Math.max(0,Math.min(255,r)),g:Math.max(0,Math.min(255,n)),b:Math.max(0,Math.min(255,o)),a:Math.max(0,Math.min(1,a))}:null}function es(t=""){let e=String(t||"").trim().match(/^#([0-9a-f]{3,8})$/i);if(!e)return null;let r=e[1].toLowerCase();if(r.length===3){let[n,o,a]=r.split("");return{r:Number.parseInt(`${n}${n}`,16),g:Number.parseInt(`${o}${o}`,16),b:Number.parseInt(`${a}${a}`,16),a:1}}return r.length===6||r.length===8?{r:Number.parseInt(r.slice(0,2),16),g:Number.parseInt(r.slice(2,4),16),b:Number.parseInt(r.slice(4,6),16),a:r.length===8?Number.parseInt(r.slice(6,8),16)/255:1}:null}function Un(t=""){let e=ee(t);return e?e.startsWith("#")?es(e):e.startsWith("rgb")?Qi(e):null:null}function ts(t){if(!t)return null;let e=a=>{let i=Number(a)/255;return i<=.03928?i/12.92:((i+.055)/1.055)**2.4},r=e(t.r),n=e(t.g),o=e(t.b);return .2126*r+.7152*n+.0722*o}function Dn(t=""){let e=String(t||"").trim().toLowerCase();if(!e||e==="transparent")return!0;let r=Un(e);return r&&Number.isFinite(r.a)?r.a<=.04:!1}function rs(t=[],e=[]){let r=t.map(d=>ee(d)).filter(d=>d&&!Dn(d)),n=Je(r);if(n)return{color:n,source:"root"};let o=e.map(d=>ee(d)).filter(d=>d&&!Dn(d)),a=o.filter(d=>{let l=Un(d),u=ts(l);return Number.isFinite(u)?u>=.72:!1}),i=Je(a);if(i)return{color:i,source:"fallback-bright"};let s=Je(o);return s?{color:s,source:"fallback"}:{color:"",source:"none"}}function Me(t,e=new Map){let r=String(t||""),n=/([a-z-]+)\s*:\s*([^;{}]+)/gi,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim().toLowerCase(),i=String(o[2]||"").trim();a&&i&&(e.has(a)||e.set(a,[]),e.get(a).push(i)),o=n.exec(r)}return e}function ns(t=""){let e=String(t||""),r=new Map,n=[],o=[],a=[],i=[],s=[],d=[],l=[],u=/#(?:[0-9a-f]{3,8})\b|rgba?\([^)]*\)|hsla?\([^)]*\)/gi,c=p=>{(String(p||"").match(u)||[]).forEach(h=>{let S=ee(h);S&&n.push(S)})};if(typeof DOMParser<"u"&&Wn(e))try{let b=new DOMParser().parseFromString(e,"text/html");Array.from(b.querySelectorAll("style")).map(v=>v.textContent||"").forEach(v=>{Me(v,r),c(v),Zi(v).forEach(m=>{if(!Xi(m.selector))return;let w=Me(m.body,new Map),A=Z(w,["background","background-color"]).map(C=>ee(C)).filter(Boolean);o.push(...A)})}),Array.from(b.querySelectorAll("[style]")).forEach(v=>{let m=v.getAttribute("style")||"";Me(m,r),c(m)}),["html","body","main","#app","#root",".app",".page"].forEach(v=>{let m=b.querySelector(v);if(!m)return;let w=m.getAttribute("style")||"";if(!w)return;let A=Me(w,new Map),C=Z(A,["background","background-color"]).map(z=>ee(z)).filter(Boolean);o.push(...C);let R=Bn(m.getAttribute("class")||"");a.push(...R)}),Array.from(b.querySelectorAll("[class]")).forEach(v=>{let m=ae(v.getAttribute("class")||"");d.push(...m);let w=Bn(v.getAttribute("class")||"");i.push(...w);let A=String(v.tagName||"").toLowerCase(),C=A==="button"||A==="a",R=m.some(z=>/^bg-/.test(String(ie(z).base||"")));C&&R&&w.length&&s.push(...w)});let y=b.body?.textContent||"";y.trim()&&l.push(y),c(b.documentElement?.outerHTML||e)}catch{Me(e,r),c(e),l.push(e)}else Me(e,r),c(e),l.push(e);return{declarations:r,colorValues:n,rootBackgroundColors:o,rootClassBackgroundColors:a,classBackgroundColors:i,buttonBackgroundColors:s,classTokens:d,textCorpus:l.join(`
`)}}function Je(t=[]){let e=new Map;t.forEach(o=>{let a=String(o||"").trim();a&&e.set(a,(e.get(a)||0)+1)});let r="",n=-1;return e.forEach((o,a)=>{o>n&&(r=a,n=o)}),r}function Z(t,e=[]){return e.flatMap(r=>t.get(r)||[])}function os(t,e){if(!t||!e)return null;let r=String(e).split(".").filter(Boolean),n=t;for(let o of r){if(!n||n.type!=="object"||!n.properties||typeof n.properties!="object")return null;n=n.properties[o]}return n||null}function as(t={}){let e=t&&typeof t=="object"?t:{},r=x?.configRelations&&typeof x.configRelations=="object"?x.configRelations:{},n=new Set(Object.keys(r)),o=null;if(typeof x?.buildConfigFormSchema=="function")try{o=x.buildConfigFormSchema(e)?.schema||null}catch{o=null}return!o&&x?.configFormSchema?.schema&&(o=x.configFormSchema.schema),{design:e,schema:o,allowedPaths:n}}function is(t,e){if(!t)return e;if(Array.isArray(t.oneOf)&&t.oneOf.length){let r=t.oneOf.map(n=>n?.const).filter(n=>n!=null);if(r.length){if(typeof e=="string"){let n=r.find(o=>String(o).toLowerCase()===e.toLowerCase());if(n!==void 0)return n}if(typeof e=="number"){let n=r.map(o=>Number(o)).filter(o=>Number.isFinite(o));if(n.length)return n.reduce((o,a)=>Math.abs(a-e)<Math.abs(o-e)?a:o,n[0])}return r[0]}}if(t.type==="number"||t.type==="integer"){let r=Number(e);return Number.isFinite(r)?t.type==="integer"?Math.round(r):r:void 0}return t.type==="boolean"?!!e:t.type==="string"?String(e||"").trim():e}function ss(t,e,r){let n=String(e||"").split(".").filter(Boolean);if(!n.length)return;let o=t;for(let a=0;a<n.length;a+=1){let i=n[a];if(a===n.length-1){o[i]=r;return}(!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))&&(o[i]={}),o=o[i]}}function W(t,e,r){if(r==null||r===""||t.allowedPaths.size&&!t.allowedPaths.has(e))return;let n=os(t.schema,e),o=is(n,r);o==null||o===""||(ss(t.patch,e,o),t.inferredPaths.add(e))}function he(t=[]){let e=t.map(n=>Gi(n)).filter(n=>Number.isFinite(n));if(!e.length)return null;e.sort((n,o)=>n-o);let r=Math.floor(e.length/2);return e.length%2?e[r]:(e[r-1]+e[r])/2}function ls(t=[]){let e=t.map(r=>String(r||"").split(",")[0]||"").map(r=>r.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean);return Je(e)}function cs(t){let e=Number(t);return Number.isFinite(e)?e<=.75?"hairline":e<=1.5?"thin":e<=2.5?"medium":"thick":"thin"}function ds(t=""){let r=String(ie(t).base||"").toLowerCase().match(/^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(!r)return null;let n=r[1]||"DEFAULT",o={none:0,xs:2,sm:4,DEFAULT:6,md:8,lg:12,xl:16,"2xl":24,"3xl":32};return n==="full"?null:Number.isFinite(o[n])?o[n]:null}function us(t=[]){let e=t.map(n=>ds(n)).filter(n=>Number.isFinite(n));if(!e.length)return null;e.sort((n,o)=>n-o);let r=Math.floor(e.length/2);return e.length%2?e[r]:(e[r-1]+e[r])/2}function yr(t={}){let e=String(t.html||"");if(!e.trim())return H({source:"html-inference",type:String(t.sourceType||"design-inference"),confidence:0,issues:[{severity:"warning",message:"No HTML or guideline text provided for design extraction."}],designPatch:{},meta:{extractedPathCount:0,extractedPaths:[]}});let r=as(t.config||{}),n=ns(e),o={patch:{},inferredPaths:new Set,allowedPaths:r.allowedPaths,schema:r.schema},a=Z(n.declarations,["color"]).map(G=>ee(G)).filter(Boolean),i=Z(n.declarations,["background","background-color"]).map(G=>ee(G)).filter(Boolean),s=[...i,...a,...n.colorValues].filter(Boolean),d=Array.from(new Set(s)),l=[...n.rootBackgroundColors||[]],u=[...n.rootClassBackgroundColors||[]],c=l.length?l:u,p=[...i,...n.classBackgroundColors||[]],b=rs(c,p),h=b.color;W(o,"colors.background",h||i[0]||d[0]);let S=d.filter(G=>G&&G!==h),f=Je(n.buttonBackgroundColors||[])||S[0]||d[0],y=S.filter(G=>G&&G!==f);W(o,"colors.primary",f),W(o,"colors.secondary",y[0]||f||d[0]),W(o,"colors.accent",y[1]||y[0]||f||d[0]);let v=Z(n.declarations,["font-family"]),m=ls(v);W(o,"typography.fontFamilyBody",m),W(o,"typography.fontFamilyHeadings",m),W(o,"typography.fontFamilyMono",/mono|code/i.test(n.textCorpus)?"JetBrains Mono":"");let w=Z(n.declarations,["font-size"]),A=he(w);W(o,"typography.baseSize",A);let C=Z(n.declarations,["padding","padding-top","padding-right","padding-bottom","padding-left","margin","margin-top","margin-right","margin-bottom","margin-left","gap","row-gap","column-gap"]),R=he(C);W(o,"spatialRhythm.baseUnit",R),W(o,"spatialRhythm.inputPadding",R),W(o,"spatialRhythm.buttonPadding",R);let z=Z(n.declarations,["border-radius"]),M=he(z)||us(n.classTokens||[]);W(o,"shape.radiusSize",M);let P=Z(n.declarations,["border-width","border-top-width","border-right-width","border-bottom-width","border-left-width"]),E=he(P);W(o,"shape.borderWidth",cs(E));let k=Z(n.declarations,["max-width"]),L=he(k);W(o,"layout.containerMaxWidth",L),W(o,"layout.maxWidth",L);let T=Z(n.declarations,["min-height","height"]),I=he(T);W(o,"layout.buttonMinHeight",I),W(o,"layout.inputMinHeight",I);let O=Z(n.declarations,["transition-duration"]),B=he(O.map(G=>{let Ie=String(G||"").trim().toLowerCase(),ce=Number.parseFloat(Ie);return Number.isFinite(ce)?Ie.endsWith("ms")?ce:Ie.endsWith("s")?ce*1e3:ce:null}));W(o,"behavior.transitionSpeed",B);let N=Z(n.declarations,["box-shadow"]).length>0;W(o,"layers.baseShadowOpacity",N?.2:.08);let D=Array.from(o.inferredPaths),Y=D.reduce((G,Ie)=>{let ce=Ie.split(".")[0];return G[ce]=(G[ce]||0)+1,G},{}),Re=D.length?Math.min(.92,.35+D.length*.02):.25;return H({source:"html-inference",type:String(t.sourceType||"design-inference"),confidence:Re,issues:D.length?[]:[{severity:"warning",message:"Could not infer enough design signals from input."}],designPatch:o.patch,meta:{extractedPathCount:D.length,extractedPaths:D,categoryCoverage:Y,colorSampleSize:d.length,backgroundInference:{source:b.source,candidates:{root:c.length,declaration:i.length,classBased:(n.classBackgroundColors||[]).length}}}})}function qn(t={}){let e=String(t.input||"").trim(),r=String(t.sourceType||"unknown");if(!e)return H({source:r,type:r,confidence:0,issues:[{severity:"error",message:"No input provided."}],meta:{conversionMode:"none"}});if(Wn(e)){let n=At({html:e,config:t.config||{}});return H({source:r,type:r,confidence:n.confidence,issues:n.issues,template:n.template,meta:{...n.meta||{},conversionMode:"html-to-pds"}})}return H({source:r,type:r,confidence:.48,issues:[{severity:"info",message:"Input is not HTML; generated text-based preview template."}],template:{id:`${r}-text-import`,name:"Imported Guideline Text",html:`<article class="card surface-base stack-sm"><h3>Imported Guidelines</h3><pre>${Vi(e)}</pre></article>`},meta:{conversionMode:"text-preview"}})}function At(t={}){let e=String(t.html||"").trim();if(!e)return H({source:"tailwind",type:"tailwind-html",confidence:0,issues:[{severity:"error",message:"No HTML provided."}]});let r=Wi(e,{config:t.config||{}});return H({source:"tailwind",type:"tailwind-html",confidence:r.confidence,issues:r.issues,template:{id:"tailwind-import",name:"Converted Tailwind Markup",html:r.html},meta:r.meta})}function vr(t={}){let e=String(t.text||"").trim();if(!e)return H({source:"brand",type:"brand-guidelines",confidence:0,issues:[{severity:"error",message:"No brand guideline text provided."}]});let r=qi(e),n={colors:{},typography:{}},o=[];return r?n.colors.primary=r:o.push({severity:"warning",message:"No HEX color found; primary color was not inferred."}),/serif/i.test(e)&&(n.typography.fontFamilyBody="Georgia, serif"),/sans[-\s]?serif/i.test(e)&&(n.typography.fontFamilyBody="Inter, Arial, sans-serif"),/mono|monospace/i.test(e)&&(n.typography.fontFamilyMono="JetBrains Mono, monospace"),H({source:"brand",type:"brand-guidelines",confidence:r?.68:.52,issues:o,designPatch:n,meta:{inferred:{primaryColor:r}}})}var xr="convert-only",Vn="adopt-design-and-convert";function ps(t){return String(t||"").trim().toLowerCase()===Vn?Vn:xr}function Gn(...t){let e=t.flat().filter(Boolean);if(!e.length)return[];let r=new Set;return e.filter(n=>{let o=`${String(n?.severity||"info")}::${String(n?.path||"")}::${String(n?.message||"")}`;return r.has(o)?!1:(r.add(o),!0)})}function Kn(t=[]){let e=t.map(r=>Number(r)).filter(r=>Number.isFinite(r));return e.length?Math.max(0,Math.min(1,e.reduce((r,n)=>r+n,0)/e.length)):0}function Ze(t={},e={}){return{...t&&typeof t=="object"?t:{},...e&&typeof e=="object"?e:{}}}function Zn(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};return Object.entries(e).forEach(([n,o])=>{o&&typeof o=="object"&&!Array.isArray(o)?r[n]=Zn(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o}),r}function Jn(t){if(typeof structuredClone=="function")try{return structuredClone(t)}catch{}return JSON.parse(JSON.stringify(t||{}))}function fs(t={}){let e=Number(t?.ratio),r=Number(t?.min),n=Number.isFinite(e)?e.toFixed(2):"n/a",o=Number.isFinite(r)?r.toFixed(2):"n/a";return{severity:"error",path:String(t?.path||"/colors"),message:`${String(t?.message||"Color contrast validation failed.")} (ratio=${n}, required=${o})`}}function Yn(t={},e={},r={}){if(!(e&&typeof e=="object"?Object.keys(e):[]).length)return{ok:!0,blocked:!1,issues:[],report:{ok:!0,issues:[]}};let o=Number(r.minContrast),a=Number.isFinite(o)?o:4.5,i=Zn(Jn(t||{}),Jn(e||{})),s=Fr(i,{minContrast:a,minMutedContrast:3,extendedChecks:!0}),d=Array.isArray(s?.issues)?s.issues.map(l=>fs(l)):[];return{ok:!!s?.ok,blocked:!s?.ok,issues:d,report:{ok:!!s?.ok,minContrast:a,issues:Array.isArray(s?.issues)?s.issues:[]}}}function gs(){return[{id:"template",name:"Templates"},{id:"tailwind-html",name:"Tailwind HTML"},{id:"brand-guidelines",name:"Brand Guidelines"},{id:"figma-json",name:"Figma Tokens JSON (planned)"},{id:"ux-pilot",name:"UX Pilot (planned)"},{id:"google-stitch",name:"Google Stitch (planned)"}]}async function ms(t={}){let e=String(t.sourceType||""),r=ps(t.importMode),n=String(t.input||""),o=t.config||null;if(e==="template"){let a=fn(t.templateId,t);return a.meta=Ze(a.meta,{importMode:r}),a}if(e==="tailwind-html"){let a=At({html:n,config:o});if(r===xr)return a.meta=Ze(a.meta,{importMode:r}),a;let i=yr({html:n,config:o,sourceType:e}),s=Yn(o||{},i.designPatch||{}),d=s.blocked?{}:i.designPatch,l=s.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...s.issues]:[];return H({source:a.source||"tailwind",type:e,confidence:Kn([a.confidence,i.confidence]),issues:Gn(a.issues,i.issues,l),template:a.template,designPatch:d,meta:Ze(a.meta,{importMode:r,inference:i.meta,validation:s.report,validationBlocked:s.blocked})})}if(e==="brand-guidelines"){let a=qn({input:n,sourceType:e,config:o});if(r===xr)return a.meta=Ze(a.meta,{importMode:r}),a;let i=vr({text:n}),s=yr({html:n,config:o,sourceType:e}),d={...i.designPatch&&typeof i.designPatch=="object"?i.designPatch:{},...s.designPatch&&typeof s.designPatch=="object"?s.designPatch:{}},l=Yn(o||{},d||{}),u=l.blocked?{}:d,c=l.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...l.issues]:[];return H({source:"brand",type:e,confidence:Kn([a.confidence,i.confidence,s.confidence]),issues:Gn(a.issues,i.issues,s.issues,c),template:a.template,designPatch:u,meta:Ze(a.meta,{importMode:r,inference:s.meta,brandHeuristics:i.meta,validation:l.report,validationBlocked:l.blocked})})}return e==="figma-json"||e==="ux-pilot"||e==="google-stitch"?H({source:e,type:e,confidence:0,issues:[{severity:"info",message:`${e} adapter is not implemented yet in this phase.`}],meta:{importMode:r}}):H({source:e||"unknown",type:"unknown",confidence:0,issues:[{severity:"error",message:"Unsupported import source type."}],meta:{importMode:r}})}var hs="pds-live-import-history";var ne="imports",Tt=null;function bs(){return typeof globalThis<"u"&&typeof globalThis.indexedDB<"u"}function te(t){return typeof t=="string"?t:""}function Rt(t){return Array.isArray(t)?t:[]}function It(t){return t&&typeof t=="object"?t:{}}function _t(){return bs()?Tt||(Tt=new Promise((t,e)=>{let r=globalThis.indexedDB.open(hs,1);r.onupgradeneeded=()=>{let n=r.result;if(!n.objectStoreNames.contains(ne)){let o=n.createObjectStore(ne,{keyPath:"id",autoIncrement:!0});o.createIndex("createdAt","createdAt",{unique:!1}),o.createIndex("sourceType","sourceType",{unique:!1}),o.createIndex("fileName","fileName",{unique:!1})}},r.onsuccess=()=>t(r.result),r.onerror=()=>e(r.error||new Error("Failed to open import history database."))}),Tt):Promise.resolve(null)}function Ft(t){return new Promise((e,r)=>{t.onsuccess=()=>e(t.result),t.onerror=()=>r(t.error||new Error("IndexedDB operation failed."))})}function ys(t={}){let e=Date.now(),r=Number.isFinite(Number(t.createdAt))?Number(t.createdAt):e,n=new Date(r).toISOString(),o=Rt(t.issues).map(d=>({severity:te(d?.severity||"info"),message:te(d?.message||"")})),a=Rt(t.notes).filter(d=>typeof d=="string"),i=Rt(t.unknownTailwindTokens).filter(d=>typeof d=="string"),s=Rt(t.appliedRules).filter(d=>typeof d=="string");return{createdAt:r,createdAtIso:n,sourceType:te(t.sourceType||"unknown"),importMode:te(t.importMode||"convert-only"),source:te(t.source||"unknown"),type:te(t.type||"unknown"),fileName:te(t.fileName||""),fileSize:Number.isFinite(Number(t.fileSize))?Number(t.fileSize):0,mimeType:te(t.mimeType||""),fileContents:te(t.fileContents||""),convertedHtml:te(t.convertedHtml||""),confidence:Number.isFinite(Number(t.confidence))?Number(t.confidence):0,notes:a,issues:o,coverage:It(t.coverage),unknownTailwindTokens:i,appliedRules:s,importStyleSheetInjected:!!t.importStyleSheetInjected,templateName:te(t.templateName||""),designPatch:It(t.designPatch),meta:It(t.meta),resultSnapshot:It(t.resultSnapshot)}}async function vs(t={}){let e=await _t();if(!e)return null;let r=ys(t),o=e.transaction(ne,"readwrite").objectStore(ne);return{id:await Ft(o.add(r)),...r}}async function xs(t={}){let e=await _t();if(!e)return[];let r=Number.isFinite(Number(t.limit))?Math.max(1,Number(t.limit)):30,o=e.transaction(ne,"readonly").objectStore(ne);return(await Ft(o.getAll())||[]).sort((i,s)=>Number(s?.createdAt||0)-Number(i?.createdAt||0)).slice(0,r)}async function ws(t){let e=await _t();if(!e)return null;let r=Number(t);if(!Number.isFinite(r))return null;let o=e.transaction(ne,"readonly").objectStore(ne);return await Ft(o.get(r))||null}async function ks(){let t=await _t();if(!t)return;let r=t.transaction(ne,"readwrite").objectStore(ne);await Ft(r.clear())}export{ks as clearLiveImportHistory,vr as convertBrandGuidelinesToPatch,At as convertTailwindHtmlToPds,H as createImportResult,Ui as describeTailwindConversionRules,ws as getLiveImportHistoryEntry,gs as getLiveImportSources,Ca as isImportResult,xs as listLiveImportHistory,pn as listLiveTemplates,Xr as loadGoogleFont,bt as loadLiveTemplateCatalog,ms as runLiveImport,vs as saveLiveImportHistory,$a as startLive};
