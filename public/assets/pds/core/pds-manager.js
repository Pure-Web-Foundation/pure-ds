...
`}#xe(){let{layout:t={}}=this.options.design,r=t.breakpoints||{sm:640,md:768,lg:1024,xl:1280},n=t.gridSystem||{},o=n.columns||[1,2,3,4,6],a=n.autoFitBreakpoints||{sm:"150px",md:"250px",lg:"350px",xl:"450px"},i=this.#C(t),s=[`
/* ============================================================================
   Layout Utilities
...
`}};function Er(e={},t={}){let r=Number(t.minContrast||4.5),n=Number(t.minMutedContrast||3),o=!!t.extendedChecks,a=c=>{let d=String(c||"").replace("#",""),l=d.length===3?d.split("").map(g=>g+g).join(""):d,u=parseInt(l||"0",16);return{r:u>>16&255,g:u>>8&255,b:u&255}},i=c=>{let{r:d,g:l,b:u}=a(c),g=[d/255,l/255,u/255].map(m=>m<=.03928?m/12.92:Math.pow((m+.055)/1.055,2.4));return .2126*g[0]+.7152*g[1]+.0722*g[2]},s=(c,d)=>{if(!c||!d)return 0;let l=i(c),u=i(d),g=Math.max(l,u),m=Math.min(l,u);return(g+.05)/(m+.05)},p=[];try{let d=new Z({design:structuredClone(e)}).tokens.colors,l={surfaceBg:d.surface?.base,surfaceText:d.gray?.[900]||"#000000",surfaceTextSecondary:d.gray?.[700]||d.gray?.[800]||d.gray?.[900],surfaceTextMuted:d.gray?.[500]||d.gray?.[600]||d.gray?.[700],surfaceElevated:d.surface?.elevated||d.surface?.base,primaryFill:d.interactive?.light?.fill||d.primary?.[600],primaryText:d.interactive?.light?.text||d.primary?.[600],accentFill:d.accent?.[600]||d.accent?.[500],successFill:d.success?.[600]||d.success?.[500],warningFill:d.warning?.[600]||d.warning?.[500],dangerFill:d.danger?.[600]||d.danger?.[500],infoFill:d.info?.[600]||d.info?.[500]},u=b=>Math.max(s(b,"#ffffff"),s(b,"#000000")),g=s(l.primaryFill,"#ffffff");g<r&&p.push({path:"/colors/primary",message:`Primary button contrast too low in light theme (${g.toFixed(2)} < ${r}). Choose a darker primary.`,ratio:g,min:r,context:"light/btn-primary"});let m=s(l.surfaceBg,l.surfaceText);if(m<r&&p.push({path:"/colors/background",message:`Base text contrast on surface (light) is too low (${m.toFixed(2)} < ${r}). Adjust background or secondary (gray).`,ratio:m,min:r,context:"light/surface-text"}),o){let b=s(l.surfaceBg,l.surfaceTextSecondary);b<r&&p.push({path:"/colors/secondary",message:`Secondary text contrast on base surface (light) is too low (${b.toFixed(2)} < ${r}).`,ratio:b,min:r,context:"light/surface-text-secondary"});let k=s(l.surfaceBg,l.surfaceTextMuted);k<n&&p.push({path:"/colors/secondary",message:`Muted text contrast on base surface (light) is too low (${k.toFixed(2)} < ${n}).`,ratio:k,min:n,context:"light/surface-text-muted"});let w=s(l.surfaceElevated,l.surfaceText);w<r&&p.push({path:"/colors/background",message:`Elevated surface text contrast (light) is too low (${w.toFixed(2)} < ${r}).`,ratio:w,min:r,context:"light/surface-elevated-text"})}let v=s(l.primaryText,l.surfaceBg);v<r&&p.push({path:"/colors/primary",message:`Primary text on surface is too low for outline/link styles (light) (${v.toFixed(2)} < ${r}). Choose a darker primary or lighter surface.`,ratio:v,min:r,context:"light/outline"}),o&&[{path:"/colors/accent",key:"accent",value:l.accentFill},{path:"/colors/success",key:"success",value:l.successFill},{path:"/colors/warning",key:"warning",value:l.warningFill},{path:"/colors/danger",key:"danger",value:l.dangerFill},{path:"/colors/info",key:"info",value:l.infoFill}].forEach(k=>{if(!k?.value)return;let w=u(k.value);w<r&&p.push({path:k.path,message:`${k.key} fill color cannot achieve accessible text contrast (${w.toFixed(2)} < ${r}) with either white or black text.`,ratio:w,min:r,context:`light/${k.key}-fill`})});let h=d.dark;if(h){let b={surfaceBg:h.surface?.base||d.surface?.inverse,surfaceText:h.gray?.[50]||h.gray?.[100]||"#ffffff",surfaceTextMuted:h.gray?.[300]||h.gray?.[400]||h.gray?.[500],primaryFill:d.interactive?.dark?.fill||h.primary?.[600],primaryText:d.interactive?.dark?.text||h.primary?.[600]},k=s(b.primaryFill,"#ffffff");k<r&&p.push({path:"/colors/darkMode/primary",message:`Primary button contrast too low in dark theme (${k.toFixed(2)} < ${r}). Override darkMode.primary or pick a brighter hue.`,ratio:k,min:r,context:"dark/btn-primary"});let w=s(b.primaryText,b.surfaceBg);if(w<r&&p.push({path:"/colors/darkMode/primary",message:`Primary text on surface is too low for outline/link styles (dark) (${w.toFixed(2)} < ${r}). Override darkMode.primary/background.`,ratio:w,min:r,context:"dark/outline"}),o){let $=s(b.surfaceBg,b.surfaceText);$<r&&p.push({path:"/colors/darkMode/background",message:`Base text contrast on surface (dark) is too low (${$.toFixed(2)} < ${r}).`,ratio:$,min:r,context:"dark/surface-text"});let T=s(b.surfaceBg,b.surfaceTextMuted);T<n&&p.push({path:"/colors/darkMode/secondary",message:`Muted text contrast on surface (dark) is too low (${T.toFixed(2)} < ${n}).`,ratio:T,min:n,context:"dark/surface-text-muted"})}}}catch(c){p.push({path:"/",message:`Validation failed: ${String(c?.message||c)}`,ratio:0,min:0})}return{ok:p.length===0,issues:p}}var Dt=class{constructor(){this._mode="static",this._staticPaths={tokens:"/assets/pds/styles/pds-tokens.css.js",primitives:"/assets/pds/styles/pds-primitives.css.js",components:"/assets/pds/styles/pds-components.css.js",utilities:"/assets/pds/styles/pds-utilities.css.js",styles:"/assets/pds/styles/pds-styles.css.js"}}setLiveMode(){this._mode="live"}setStaticMode(t={}){this._mode="static",this._staticPaths={...this._staticPaths,...t}}async getStylesheet(t){if(this._mode==="live")return null;try{return(await import(this._staticPaths[t]))[t]}catch(r){f.log("error",`Registry: failed to load static ${t}:`,r),f.log("error",`Registry: looking for ${this._staticPaths[t]}`),f.log("error","Registry: make sure you've run 'npm run pds:build' and configured PDS.start() with the correct static.root path");let n=new CSSStyleSheet;return n.replaceSync("/* Failed to load "+t+" */"),n}}get mode(){return this._mode}get isLive(){return this._mode==="live"}},be=new Dt;function eo(e){try{if(typeof document>"u")return;if(typeof CSSStyleSheet<"u"&&"adoptedStyleSheets"in Document.prototype){let n=new CSSStyleSheet;n.replaceSync(e),n._pds=!0;let o=(document.adoptedStyleSheets||[]).filter(a=>a._pds!==!0);document.adoptedStyleSheets=[...o,n];return}let t="pds-runtime-stylesheet",r=document.getElementById(t);if(!r){r=document.createElement("style"),r.id=t,r.type="text/css";let n=document.head||document.getElementsByTagName("head")[0];n?n.appendChild(r):document.documentElement.appendChild(r)}r.textContent=e}catch(t){f.log("warn","installRuntimeStyles failed:",t)}}function Tr(e){let t=e;if(!t||typeof t!="object"){f.log("error","Runtime applyStyles requires an explicit generator instance in live mode");return}let r=t.layeredCSS||t.css||"";if(!r){t.options?.log?.("warn","Runtime: no CSS available on generator to apply");return}eo(r)}async function Ke(e,t=[],r=null){try{let n=r?.primitivesStylesheet?r.primitivesStylesheet:await be.getStylesheet("primitives");e.adoptedStyleSheets=[n,...t]}catch(n){let o=e.host?.tagName?.toLowerCase()||"unknown";f.log("error",`Adopter: <${o}> failed to adopt primitives:`,n),e.adoptedStyleSheets=t}}async function Je(e,t=["primitives"],r=[],n=null){let o=Array.isArray(r)?r.filter(Boolean):[];if(o.length){let i=(Array.isArray(e.adoptedStyleSheets)?e.adoptedStyleSheets:[]).filter(s=>!o.includes(s));e.adoptedStyleSheets=[...i,...o]}try{let i=(await Promise.all(t.map(async s=>{if(n)switch(s){case"tokens":return n.tokensStylesheet;case"primitives":return n.primitivesStylesheet;case"components":return n.componentsStylesheet;case"utilities":return n.utilitiesStylesheet;default:break}return be.getStylesheet(s)}))).filter(s=>s!==null);e.adoptedStyleSheets=[...i,...o]}catch(a){let i=e.host?.tagName?.toLowerCase()||"unknown";f.log("error",`Adopter: <${i}> failed to adopt layers:`,a),e.adoptedStyleSheets=o}}function Ar(e){let t=new CSSStyleSheet;return t.replaceSync(e),t}var to=new Set(["log","warn","error","debug","info"]),ro="__PURE_DS_PDS_SINGLETON__",Wt=null,Ht=null;function _r(){try{let t=(typeof globalThis<"u"?globalThis:window)?.[ro];if(t&&typeof t=="object")return t}catch{return null}return null}function no(e){return!e||typeof e!="object"?null:{mode:e.mode==="live"||e.mode==="static"?e.mode:null,debug:e.debug===!0,thisArg:e.thisArg}}function oo(e){if(typeof e!="string")return"log";let t=e.toLowerCase();return to.has(t)?t:"log"}function ao(){if(typeof Ht=="function")try{let t=no(Ht());if(t)return t}catch{}let e=_r();if(e){let t=e?.mode||e?.compiled?.mode||(e?.registry?.isLive?"live":"static"),r=(e?.debug||e?.currentConfig?.debug||e?.currentConfig?.design?.debug||e?.compiled?.debug||e?.compiled?.design?.debug||!1)===!0;return{mode:t,debug:r,thisArg:e}}return{mode:null,debug:!1}}function io(){if(typeof Wt=="function")try{let t=Wt();if(typeof t=="function")return t}catch{}let e=_r();return typeof e?.logHandler=="function"?e.logHandler:null}function Rr(e,t,...r){if(typeof console>"u")return;let n=typeof console[e]=="function"?console[e].bind(console):typeof console.log=="function"?console.log.bind(console):null;n&&(r.length>0?n(t,...r):n(t))}function so(e,t){let r=t?.debug===!0;return!(t?.mode==="static"&&!r||!r&&e!=="error"&&e!=="warn")}function Fr({getLogger:e,getContext:t}={}){Wt=typeof e=="function"?e:null,Ht=typeof t=="function"?t:null}function Ye(e="log",t,...r){let n=oo(e),o=ao(),a=io();if(a)try{a.call(o?.thisArg,n,t,...r);return}catch(i){Rr("error","Custom log handler failed:",i)}so(n,o)&&Rr(n,t,...r)}var lo="en",F={defaultLocale:lo,provider:null,messagesByLocale:new Map,loadingByLocale:new Map,observer:null,reconcileTimer:null,requestedKeys:new Set,textNodeKeyMap:new WeakMap,valueToKeys:new Map,missingWarnings:new Set},co=e=>!!e&&typeof e!="string"&&typeof e=="object"&&"strTag"in e;function ie(e){return String(e||"").trim().toLowerCase()}function po(e){let t=ie(e);return t?t.split("-")[0]||t:""}function de(e){let t=ie(e);return t||F.defaultLocale}function uo(e){let t="";for(let r=0;r<=e.length-1;r+=1)t+=e[r],r<e.length-1&&(t+=`{${r}}`);return t}function Xe(e,t){return String(e).replace(/\{(\d+)\}/g,(r,n)=>t(Number(n)))}function Ut(e){if(!e||typeof e!="object")return{};let t={};for(let[r,n]of Object.entries(e)){if(typeof n=="string"){t[r]=n;continue}n&&typeof n=="object"&&typeof n.content=="string"&&(t[r]=n.content)}return t}function go(e){let t=ie(e);if(!t)return[F.defaultLocale];let r=po(t);return!r||r===t?[t]:[t,r]}function Pr(e,t){let r=de(e);F.messagesByLocale.set(r,Ut(t))}function jr(e){typeof e=="string"&&e.length>0&&F.requestedKeys.add(e)}function Nr(e,t){if(typeof e!="string"||!e.length)return;let r=typeof t=="string"?t:String(t||"");r.length&&(F.valueToKeys.has(r)||F.valueToKeys.set(r,new Set),F.valueToKeys.get(r).add(e))}function Pe(e){let t=go(e);for(let r of t)if(F.messagesByLocale.has(r))return{locale:r,messages:F.messagesByLocale.get(r)};return null}async function Ze(e,t="explicit"){let r=de(e),n=Pe(r);if(n)return n.messages;let o=r;if(F.loadingByLocale.has(o))return F.loadingByLocale.get(o);if(!F.provider)return{};let a=F.provider.loadLocale||F.provider.setLocale||null;if(typeof a!="function")return{};let i={locale:r,defaultLocale:F.defaultLocale,reason:t,loadedLocales:Array.from(F.messagesByLocale.keys()),messages:{...Pe(r)?.messages||{}},load:t==="set-default"||t==="explicit-load"},s;try{s=a(i)}catch{return{}}if(s&&typeof s.then=="function"){let c=s.then(d=>{let l=Ut(d);return Pr(r,l),l}).catch(()=>({})).finally(()=>{F.loadingByLocale.delete(o)});return F.loadingByLocale.set(o,c),c}let p=Ut(s);return Pr(r,p),p}function mo(e){if(!e||typeof e!="object")return"";let r=typeof Element<"u"&&e instanceof Element||e?.nodeType===1?e:null;if(!r)return"";if(r.hasAttribute?.("lang"))return ie(r.getAttribute("lang"));let n=r.closest?.("[lang]");return n&&n.getAttribute?ie(n.getAttribute("lang")):""}function qt(e={}){if(typeof e?.lang=="string"&&e.lang.trim())return de(e.lang);let t=e?.element||e?.scope||e?.host||e?.contextElement||null,r=mo(t);if(r)return de(r);if(typeof document<"u"&&document.documentElement){let n=ie(document.documentElement.getAttribute("lang"));if(n)return de(n)}return F.defaultLocale}function fo(){let e=new Set([F.defaultLocale]);if(typeof document>"u")return e;let t=ie(document.documentElement?.getAttribute?.("lang"));t&&e.add(de(t));let r=document.querySelectorAll?.("[lang]")||[];for(let n of r){let o=ie(n.getAttribute("lang"));o&&e.add(de(o))}return e}async function ho(e){for(let t of e)await Ze(t,"lang-detected")}function bo(e){for(let t of Array.from(F.messagesByLocale.keys()))e.has(t)||F.messagesByLocale.delete(t)}function yo(e){let t=String(e||""),r=(t.match(/^\s*/)||[""])[0],n=(t.match(/\s*$/)||[""])[0],o=r.length,a=t.length-n.length,i=a>=o?t.slice(o,a):"";return{leading:r,core:i,trailing:n}}function Ir(e){return String(e||"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function vo(e,t){let r=typeof e=="string"?e:String(e||""),n=typeof t=="string"?t:String(t||""),o=/\{(\d+)\}/g,a=Array.from(r.matchAll(o));if(!a.length)return r===n?[]:null;let i=[],s="^",p=0;for(let l of a){let u=l.index??0;s+=Ir(r.slice(p,u)),s+="([\\s\\S]*?)",i.push(Number(l[1])),p=u+l[0].length}s+=Ir(r.slice(p)),s+="$";let c=new RegExp(s).exec(n);if(!c)return null;let d=[];for(let l=1;l<c.length;l+=1){let u=i[l-1],g=c[l];if(Object.prototype.hasOwnProperty.call(d,u)&&d[u]!==g)return null;d[u]=g}return d}function Br(e,t){if(typeof e!="string"||!e.length)return[];let r=[e];for(let[,n]of F.messagesByLocale.entries()){let o=n?.[e];typeof o=="string"&&o.length&&r.push(o)}for(let n of r){let o=vo(n,t);if(o)return o}return[]}function xo(e){if(!e)return null;let t=F.valueToKeys.get(e);if(t&&t.size>0){for(let n of t)if(F.requestedKeys.has(n))return n}if(F.requestedKeys.has(e))return e;let r=Array.from(F.messagesByLocale.entries());for(let n of F.requestedKeys)for(let[,o]of r)if(o&&o[n]===e)return n;return null}function wo(e){if(!e)return null;let t=null;for(let[r,n]of F.valueToKeys.entries()){if(typeof r!="string"||!r.length||r===e)continue;let o=e.indexOf(r);if(o!==-1)for(let a of n){if(!F.requestedKeys.has(a))continue;let i=Br(a,r),s={key:a,matchedText:r,start:o,end:o+r.length,values:i};(!t||s.matchedText.length>t.matchedText.length)&&(t=s);break}}return t}async function ko(e){if(!e||e.nodeType!==3)return;let t=e.parentElement||null;if(!t)return;let{leading:r,core:n,trailing:o}=yo(e.nodeValue);if(!n)return;let a=F.textNodeKeyMap.get(e)||null;if((!a||!F.requestedKeys.has(a))&&(a=xo(n)),!a){let l=wo(n);if(!l)return;let u=qt({element:t});await Ze(u,"text-node");let g=Qe(l.key,l.values,{element:t},null),m=l.values.length?Xe(g,b=>l.values[b]):g,v=n.slice(0,l.start)+m+n.slice(l.end),h=`${r}${v}${o}`;h!==e.nodeValue&&(e.nodeValue=h);return}F.textNodeKeyMap.set(e,a);let i=qt({element:t});await Ze(i,"text-node");let s=Br(a,n),p=Qe(a,s,{element:t},null),c=s.length?Xe(p,l=>s[l]):p,d=`${r}${c}${o}`;d!==e.nodeValue&&(e.nodeValue=d)}async function So(){if(typeof document>"u"||F.requestedKeys.size===0)return;let e=document.body||document.documentElement;if(!e||typeof document.createTreeWalker!="function")return;let t=[],r=new Set,n=a=>{!a||r.has(a)||(r.add(a),t.push(a))};n(e);for(let a=0;a<t.length;a+=1){let i=t[a];if(!i||typeof i.querySelectorAll!="function")continue;let s=i.querySelectorAll("*");for(let p of s){let c=p?.shadowRoot;c&&n(c)}}let o=[];for(let a of t){let i=document.createTreeWalker(a,NodeFilter.SHOW_TEXT);for(;i.nextNode();)o.push(i.currentNode)}for(let a of o)await ko(a)}async function $o(){let e=fo();await ho(e),await So(),bo(e)}function zo(){typeof window>"u"||(F.reconcileTimer&&clearTimeout(F.reconcileTimer),F.reconcileTimer=setTimeout(()=>{F.reconcileTimer=null,$o()},16))}function Qe(e,t=[],r={},n=null){let o=qt(r),a=Pe(o);a||Ze(o,"msg");let i=Pe(o)?.messages||{},s=Pe(F.defaultLocale)?.messages||{},p={key:e,values:t,options:r,locale:o,defaultLocale:F.defaultLocale,messages:i,messagesByLocale:Object.fromEntries(Array.from(F.messagesByLocale.entries())),template:n},c,d=!!a,l=o===F.defaultLocale;typeof F.provider?.translate=="function"&&(c=F.provider.translate(p));let u=null;if(c==null&&(c=i[e]),c==null&&(c=s[e],u=c==null?null:"default"),c==null&&(c=e,u="key"),d&&!l&&u){let m=`${o}::${e}`;F.missingWarnings.has(m)||(F.missingWarnings.add(m),Ye("warn",`[i18n] Missing translation for locale "${o}" and key "${e}"; using ${u} fallback.`))}let g=typeof c=="string"?c:String(c);if(Nr(e,g),Array.isArray(t)&&t.length>0){let m=Xe(g,v=>t[v]);m!==g&&Nr(e,m)}return g}var Co=(e,t,r={})=>{let n=uo(e);jr(n);let o=Qe(n,t,r,{strings:e,values:t});return Xe(o,a=>t[a])};var et=(e,t={})=>{if(!e)return"";if(co(e))return Co(e.strings,e.values,t);let r=String(e);jr(r);let n=Qe(r,[],t,null);return!t?.element&&!t?.scope&&!t?.host&&!t?.contextElement&&!t?.lang&&zo(),n};var Lo=[{selector:".accordion"},{selector:"nav[data-dropdown]"},{selector:"label[data-toggle]"},{selector:"label[data-color]"},{selector:'input[type="range"]'},{selector:"form[data-required]"},{selector:"fieldset[role=group][data-open]"},{selector:"[data-clip]"},{selector:"button, a[class*='btn-']"}];function Mo(e){e.dataset.enhancedAccordion||(e.dataset.enhancedAccordion="true",e.addEventListener("toggle",t=>{t.target.open&&t.target.parentElement===e&&e.querySelectorAll(":scope > details[open]").forEach(r=>{r!==t.target&&(r.open=!1)})},!0))}function Eo(e){if(e.dataset.enhancedDropdown)return;e.dataset.enhancedDropdown="true";let t=e.lastElementChild;if(!t)return;let r=e.querySelector("[data-dropdown-toggle]")||e.querySelector("button");r&&!r.hasAttribute("type")&&r.setAttribute("type","button"),t.id||(t.id=`dropdown-${Math.random().toString(36).slice(2,9)}`);let n=t.tagName?.toLowerCase()==="menu",o=8;n&&!t.hasAttribute("role")&&t.setAttribute("role","menu"),t.hasAttribute("aria-hidden")||t.setAttribute("aria-hidden","true"),r&&(r.setAttribute("aria-haspopup","true"),r.setAttribute("aria-controls",t.id),r.setAttribute("aria-expanded","false"));let a=()=>{let z=t.getAttribute("style");t.style.visibility="hidden",t.style.display="inline-block",t.style.pointerEvents="none";let L=t.getBoundingClientRect(),P=Math.max(t.offsetWidth||0,t.scrollWidth||0,L.width||0,1),C=Math.max(t.offsetHeight||0,t.scrollHeight||0,L.height||0,1);return z===null?t.removeAttribute("style"):t.setAttribute("style",z),{width:P,height:C}},i=()=>{let z=(e.getAttribute("data-direction")||e.getAttribute("data-dropdown-direction")||e.getAttribute("data-mode")||"auto").toLowerCase();if(z==="up"||z==="down")return z;let L=(r||e).getBoundingClientRect(),{height:P}=a(),C=Math.max(0,window.innerHeight-L.bottom),y=Math.max(0,L.top),S=C>=P,M=y>=P;return S&&!M?"down":M&&!S?"up":S&&M?"down":y>C?"up":"down"},s=()=>{let z=(e.getAttribute("data-align")||e.getAttribute("data-dropdown-align")||"auto").toLowerCase();if(z==="left"||z==="right"||z==="start"||z==="end")return z==="start"?"left":z==="end"?"right":z;let L=(r||e).getBoundingClientRect(),{width:P}=a(),C=Math.max(0,window.innerWidth-L.left),y=Math.max(0,L.right),S=C>=P,M=y>=P;return S&&!M?"left":M&&!S?"right":S&&M?"left":y>C?"right":"left"},p=(z,L=8)=>{let P=getComputedStyle(e).getPropertyValue(z).trim();if(!P)return L;let C=document.createElement("span");C.style.position="fixed",C.style.visibility="hidden",C.style.pointerEvents="none",C.style.height=P,document.body.appendChild(C);let y=Number.parseFloat(getComputedStyle(C).height);return C.remove(),Number.isFinite(y)?y:L},c=()=>{t.style.removeProperty("position"),t.style.removeProperty("left"),t.style.removeProperty("top"),t.style.removeProperty("right"),t.style.removeProperty("bottom"),t.style.removeProperty("margin-top"),t.style.removeProperty("margin-bottom"),t.style.removeProperty("max-width"),t.style.removeProperty("max-inline-size"),t.style.removeProperty("max-height"),t.style.removeProperty("overflow")},d=z=>{if(!z)return null;if(z.parentElement)return z.parentElement;let L=z.getRootNode?.();return L instanceof ShadowRoot?L.host:null},l=()=>{let z=d(t);for(;z&&z!==document.documentElement;){let L=getComputedStyle(z),P=L.contain||"",C=L.willChange||"";if(L.transform!=="none"||L.perspective!=="none"||L.filter!=="none"||L.backdropFilter!=="none"||P.includes("paint")||P.includes("layout")||P.includes("strict")||P.includes("content")||C.includes("transform")||C.includes("perspective")||C.includes("filter"))return!0;z=d(z)}return!1},u=()=>{t.getAttribute("aria-hidden")==="false"&&(c(),requestAnimationFrame(()=>{requestAnimationFrame(()=>{g()})}))},g=()=>{if(t.getAttribute("aria-hidden")!=="false")return;if(l()){c();return}let z=(r||e).getBoundingClientRect(),L=window.visualViewport,P=L?.width||document.documentElement?.clientWidth||window.innerWidth,C=L?.height||document.documentElement?.clientHeight||window.innerHeight,y=L?.offsetLeft||0,S=L?.offsetTop||0,M=Math.max(1,P-o*2),E=Math.max(1,C-o*2);t.style.maxWidth=`${Math.round(M)}px`,t.style.maxInlineSize=`${Math.round(M)}px`,t.style.maxHeight=`${Math.round(E)}px`,t.style.overflow="auto";let{width:B,height:O}=a(),K=p("--spacing-2",8),N=i(),D=s();e.dataset.dropdownDirection=N,e.dataset.dropdownAlign=D;let Y=D==="right"?z.right-B:z.left;B>=M-1?Y=y+o:Y=Math.max(y+o,Math.min(Y,y+P-B-o));let Me=N==="up"?z.top-K-O:z.bottom+K;Me=Math.max(S+o,Math.min(Me,S+C-O-o)),t.style.position="fixed",t.style.left=`${Math.round(Y)}px`,t.style.top=`${Math.round(Me)}px`,t.style.right="auto",t.style.bottom="auto",t.style.marginTop="0",t.style.marginBottom="0"},m=null,v=()=>{m||(m=()=>g(),window.addEventListener("resize",m),window.addEventListener("scroll",m,!0))},h=()=>{m&&(window.removeEventListener("resize",m),window.removeEventListener("scroll",m,!0),m=null)},b=null,k=null,w=()=>{b||typeof document>"u"||(b=()=>{t.getAttribute("aria-hidden")==="false"&&(e.dataset.dropdownDirection=i(),e.dataset.dropdownAlign=s(),k!==null&&cancelAnimationFrame(k),k=requestAnimationFrame(()=>{k=null,t.getAttribute("aria-hidden")==="false"&&g()}))},document.addEventListener("pds:config-changed",b))},$=()=>{!b||typeof document>"u"||(document.removeEventListener("pds:config-changed",b),b=null,k!==null&&(cancelAnimationFrame(k),k=null))},T=null,A=()=>{e.dataset.dropdownDirection=i(),e.dataset.dropdownAlign=s(),t.setAttribute("aria-hidden","false"),r?.setAttribute("aria-expanded","true"),v(),w(),u(),T||(T=z=>{(z.composedPath?z.composedPath():[z.target]).some(C=>C===e)||_()},setTimeout(()=>{document.addEventListener("click",T)},0))},_=()=>{t.setAttribute("aria-hidden","true"),r?.setAttribute("aria-expanded","false"),h(),$(),c(),T&&(document.removeEventListener("click",T),T=null)},I=()=>{t.getAttribute("aria-hidden")==="false"?_():A()};r?.addEventListener("click",z=>{z.preventDefault(),z.stopPropagation(),I()}),e.addEventListener("keydown",z=>{z.key==="Escape"&&(_(),r?.focus())}),e.addEventListener("focusout",z=>{z.relatedTarget&&((z.composedPath?z.composedPath():[z.relatedTarget]).some(C=>C===e)||_())})}function To(e){if(e.dataset.enhancedToggle)return;e.dataset.enhancedToggle="true";let t=e.querySelector('input[type="checkbox"]');if(!t)return;e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("role","switch"),e.setAttribute("aria-checked",t.checked?"true":"false");let r=document.createElement("span");r.className="toggle-switch",r.setAttribute("role","presentation"),r.setAttribute("aria-hidden","true");let n=document.createElement("span");n.className="toggle-knob",r.appendChild(n),e.insertBefore(r,t.nextSibling);let o=()=>{e.setAttribute("aria-checked",t.checked?"true":"false")},a=()=>{t.disabled||(t.checked=!t.checked,o(),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})))};e.addEventListener("click",i=>{i.preventDefault(),a()}),e.addEventListener("keydown",i=>{(i.key===" "||i.key==="Enter")&&(i.preventDefault(),a())}),t.addEventListener("change",o)}function Ao(e){if(e.dataset.enhancedColorInput)return;let t=e.querySelector('input[type="color"]');if(!t)return;e.dataset.enhancedColorInput="true";let r=e.querySelector(":scope > .color-control"),n=e.querySelector(":scope > .color-control > .color-swatch"),o=e.querySelector(":scope > .color-control > output");r||(r=document.createElement("span"),r.className="color-control",t.before(r)),n||(n=document.createElement("span"),n.className="color-swatch",r.appendChild(n)),t.parentElement!==n&&n.appendChild(t),o||(o=document.createElement("output"),r.appendChild(o));let a=()=>{if(t.dataset.colorUnset==="1"){o.value="",o.textContent=et("not set"),r.dataset.value="",r.dataset.unset="1",n.dataset.unset="1";return}o.value=t.value,o.textContent=t.value,r.dataset.value=t.value,delete r.dataset.unset,delete n.dataset.unset};a();let i=()=>{t.dataset.colorUnset==="1"&&(t.dataset.colorUnset="0"),a()};t.addEventListener("input",i,{passive:!0}),t.addEventListener("change",i,{passive:!0})}function Ro(e){if(e.dataset.enhancedRange)return;let t=i=>{if(e.dataset.enhancedRangeProgrammatic)return;e.dataset.enhancedRangeProgrammatic="1";let s=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(e),"value")||Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value");s?.get&&s?.set&&Object.defineProperty(e,"value",{configurable:!0,enumerable:s.enumerable,get(){return s.get.call(this)},set(c){s.set.call(this,c),i()}}),new MutationObserver(c=>{c.some(l=>{let u=l.attributeName;return u==="value"||u==="min"||u==="max"})&&i()}).observe(e,{attributes:!0,attributeFilter:["value","min","max"]})},r=e.closest("label"),n=r?.classList.contains("range-output"),o=e.id||`range-${Math.random().toString(36).substring(2,11)}`,a=`${o}-output`;if(e.id=o,n){let i=r.querySelector("span");if(i&&!i.classList.contains("range-output-wrapper")){let s=document.createElement("span");s.className="range-output-wrapper",s.style.display="flex",s.style.justifyContent="space-between",s.style.alignItems="center";let p=document.createElement("span");p.textContent=i.textContent,s.appendChild(p);let c=document.createElement("output");c.id=a,c.setAttribute("for",o),c.style.color="var(--surface-text-secondary, var(--color-text-secondary))",c.style.fontSize="0.875rem",c.textContent=e.value,s.appendChild(c),i.textContent="",i.appendChild(s);let d=()=>{c.textContent=e.value};e.addEventListener("input",d),e.addEventListener("change",d),t(d),d()}}else{let i=e.closest(".range-container");i||(i=document.createElement("div"),i.className="range-container",e.parentNode?.insertBefore(i,e),i.appendChild(e)),i.style.position="relative";let s=document.createElement("output");s.id=a,s.setAttribute("for",o),s.className="range-bubble",s.setAttribute("aria-live","polite"),i.appendChild(s);let p=()=>{let l=parseFloat(e.min)||0,u=parseFloat(e.max)||100,g=parseFloat(e.value),m=(g-l)/(u-l);s.style.left=`calc(${m*100}% )`,s.textContent=String(g)},c=()=>s.classList.add("visible"),d=()=>s.classList.remove("visible");e.addEventListener("input",p),e.addEventListener("pointerdown",c),e.addEventListener("pointerup",d),e.addEventListener("pointerleave",d),e.addEventListener("focus",c),e.addEventListener("blur",d),e.addEventListener("change",p),t(p),p()}e.dataset.enhancedRange="1"}function _o(e){if(e.dataset.enhancedRequired)return;e.dataset.enhancedRequired="true";let t=r=>{let n;if(r.closest("[role$=group]")?n=r.closest("[role$=group]").querySelector("legend"):n=r.closest("label"),!n||n.querySelector(".required-asterisk"))return;let o=document.createElement("span");o.classList.add("required-asterisk"),o.textContent="*",o.style.marginLeft="4px";let a=n.querySelector("span, [data-label]");if(a)a.appendChild(o);else{let s=n.querySelector("input, select, textarea");s?n.insertBefore(o,s):n.appendChild(o)}let i=r.closest("form");if(i&&!i.querySelector(".required-legend")){let s=document.createElement("small");s.classList.add("required-legend"),s.textContent=et("* Required fields"),i.insertBefore(s,i.querySelector(".form-actions")||i.lastElementChild)}};e.querySelectorAll("[required]").forEach(r=>{t(r)})}function Fo(e){if(e.dataset.enhancedOpenGroup)return;e.dataset.enhancedOpenGroup="true",e.classList.add("flex","flex-wrap","buttons");let t=document.createElement("input");t.type="text",t.placeholder=et("Add item..."),t.classList.add("input-text","input-sm"),t.style.width="auto";let r=()=>e.querySelector('input[type="radio"], input[type="checkbox"]');e.appendChild(t),t.addEventListener("keydown",n=>{if(n.key==="Enter"||n.key==="Tab"){let o=t.value.trim();if(o){n.preventDefault();let a=r(),i=a?.type==="radio"?"radio":"checkbox",s=`open-group-${Math.random().toString(36).substring(2,11)}`,p=document.createElement("label"),c=document.createElement("span");c.setAttribute("data-label",""),c.textContent=o;let d=document.createElement("input");d.type=i,d.name=a?.name||e.getAttribute("data-name")||"open-group",d.value=o,d.id=s,p.appendChild(c),p.appendChild(d),e.insertBefore(p,t),t.value=""}}else if(n.key==="Backspace"&&t.value===""){n.preventDefault();let o=e.querySelectorAll("label");o.length>0&&o[o.length-1].remove()}})}function Po(e){if(e.dataset.enhancedClip)return;e.dataset.enhancedClip="true",e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.hasAttribute("role")||e.setAttribute("role","button");let t=()=>{let n=e.getAttribute("data-clip-open")==="true";e.setAttribute("aria-expanded",n?"true":"false")},r=()=>{let n=e.getAttribute("data-clip-open")==="true";e.setAttribute("data-clip-open",n?"false":"true"),t()};e.addEventListener("click",n=>{n.defaultPrevented||r()}),e.addEventListener("keydown",n=>{(n.key===" "||n.key==="Enter")&&(n.preventDefault(),r())}),t()}function No(e){if(e.dataset.enhancedBtnWorking)return;e.dataset.enhancedBtnWorking="true";let t=null,r=!1;new MutationObserver(o=>{o.forEach(a=>{if(a.attributeName==="class"){let i=e.classList.contains("btn-working"),s=e.querySelector("pds-icon");if(i)if(s)t||(t=s.getAttribute("icon")),s.setAttribute("icon","circle-notch");else{let p=document.createElement("pds-icon");p.setAttribute("icon","circle-notch"),p.setAttribute("size","sm"),e.insertBefore(p,e.firstChild),r=!0}else a.oldValue?.includes("btn-working")&&s&&(r?(s.remove(),r=!1):t&&(s.setAttribute("icon",t),t=null))}})}).observe(e,{attributes:!0,attributeFilter:["class"],attributeOldValue:!0})}var Io=new Map([[".accordion",Mo],["nav[data-dropdown]",Eo],["label[data-toggle]",To],["label[data-color]",Ao],['input[type="range"]',Ro],["form[data-required]",_o],["fieldset[role=group][data-open]",Fo],["[data-clip]",Po],["button, a[class*='btn-']",No]]),tt=Lo.map(e=>({...e,run:Io.get(e.selector)||(()=>{})}));var Or=[{selector:".accordion",description:"Ensures only one <details> element can be open at a time within the accordion.",demoHtml:`
      <div class="accordion">
        <details>
    ...
    `.trim()}];var Wr="pds",jo=/^([a-z][a-z0-9+\-.]*:)?\/\//i,Dr=/^[a-z]:/i;function Ne(e=""){return e.endsWith("/")?e:`${e}/`}function Bo(e="",t=Wr){let r=e.replace(/\/+$/,"");return new RegExp(`(?:^|/)${t}$`,"i").test(r)?r:`${r}/${t}`}function Oo(e){return e.replace(/^\.\/+/,"")}function Do(e){return Dr.test(e)?e.replace(Dr,"").replace(/^\/+/,""):e}function Wo(e){return e.startsWith("public/")?e.substring(7):e}function ye(e,t={}){let r=t.segment||Wr,n=t.defaultRoot||`/assets/${r}/`,o=e?.public&&e.public?.root||e?.static&&e.static?.root||null;if(!o||typeof o!="string")return Ne(n);let a=o.trim();return a?(a=a.replace(/\\/g,"/"),a=Bo(a,r),a=Ne(a),jo.test(a)?a:(a=Oo(a),a=Do(a),a.startsWith("/")||(a=Wo(a),a.startsWith("/")||(a=`/${a}`),a=a.replace(/\/+/g,(i,s)=>s===0?i:"/")),Ne(a))):Ne(n)}function Hr(e){let t=e.replace(/['"]/g,"").trim();if(["system-ui","-apple-system","sans-serif","serif","monospace","cursive","fantasy","ui-sans-serif","ui-serif","ui-monospace","ui-rounded"].includes(t.toLowerCase()))return!0;let o=document.createElement("canvas").getContext("2d");if(!o)return!1;let a="mmmmmmmmmmlli",i="72px",s="monospace";o.font=`${i} ${s}`;let p=o.measureText(a).width;o.font=`${i} "${t}", ${s}`;let c=o.measureText(a).width;return p!==c}function Ho(e){return e?e.split(",").map(n=>n.trim())[0].replace(/['"]/g,"").trim():null}async function Ur(e,t={}){if(!e)return Promise.resolve();let{weights:r=[400,500,600,700],italic:n=!1}=t,o=Ho(e);if(!o||Hr(o))return Promise.resolve();let a=encodeURIComponent(o);return document.querySelector(`link[href*="fonts.googleapis.com"][href*="${a}"]`)?(f.log("log",`Font "${o}" is already loading or loaded`),Promise.resolve()):(f.log("log",`Loading font "${o}" from Google Fonts...`),new Promise((s,p)=>{let c=document.createElement("link");c.rel="stylesheet";let d=n?`ital,wght@0,${r.join(";0,")};1,${r.join(";1,")}`:`wght@${r.join(";")}`;c.href=`https://fonts.googleapis.com/css2?family=${a}:${d}&display=swap`,c.setAttribute("data-font-loader",o),c.onload=()=>{f.log("log",`Successfully loaded font "${o}"`),s()},c.onerror=()=>{f.log("warn",`Failed to load font "${o}" from Google Fonts`),p(new Error(`Failed to load font: ${o}`))},document.head.appendChild(c),setTimeout(()=>{Hr(o)||f.log("warn",`Font "${o}" did not load within timeout`),s()},5e3)}))}async function Gt(e){if(!e)return Promise.resolve();let t=new Set;e.fontFamilyHeadings&&t.add(e.fontFamilyHeadings),e.fontFamilyBody&&t.add(e.fontFamilyBody),e.fontFamilyMono&&t.add(e.fontFamilyMono);let r=Array.from(t).map(n=>Ur(n).catch(o=>{f.log("warn",`Could not load font: ${n}`,o)}));await Promise.all(r)}async function Uo(...e){let t={};e.length&&typeof e[e.length-1]=="object"&&(t=e.pop()||{});let r=e,{baseURL:n,mapper:o=c=>`${c}.js`,onError:a=(c,d)=>console.error(`[defineWebComponents] ${c}:`,d)}=t,i=n?new URL(n,typeof location<"u"?location.href:import.meta.url):new URL("./",import.meta.url),s=c=>c.toLowerCase().replace(/(^|-)([a-z])/g,(d,l,u)=>u.toUpperCase()),p=async c=>{try{if(customElements.get(c))return{tag:c,status:"already-defined"};let d=o(c),u=await import(d instanceof URL?d.href:new URL(d,i).href),g=u?.default??u?.[s(c)];if(!g){if(customElements.get(c))return{tag:c,status:"self-defined"};throw new Error(`No export found for ${c}. Expected default export or named export "${s(c)}".`)}return customElements.get(c)?{tag:c,status:"race-already-defined"}:(customElements.define(c,g),{tag:c,status:"defined"})}catch(d){throw a(c,d),d}};return Promise.all(r.map(p))}var rt=class{constructor(t={}){let{baseURL:r,mapper:n,onError:o,predicate:a=()=>!0,attributeModule:i="data-module",root:s=document,scanExisting:p=!0,debounceMs:c=16,observeShadows:d=!0,enhancers:l=[],patchAttachShadow:u=!0}=t,g=new Set,m=new Set,v=new Set,h=new Map,b=new WeakMap,k=new WeakMap,w=0,$=!1,T=null,A=S=>{if(!S||!l.length)return;let M=k.get(S);M||(M=new Set,k.set(S,M));for(let E of l)if(!(!E.selector||!E.run)&&!M.has(E.selector))try{S.matches&&S.matches(E.selector)&&(E.run(S),M.add(E.selector))}catch(B){console.warn(`[AutoDefiner] Error applying enhancer for selector "${E.selector}":`,B)}},_=(S,M)=>{if(!$&&!(!S||!S.includes("-"))&&!customElements.get(S)&&!m.has(S)&&!v.has(S)){if(M&&M.getAttribute){let E=M.getAttribute(i);E&&!h.has(S)&&h.set(S,E)}g.add(S),I()}},I=()=>{w||(w=setTimeout(P,c))},z=S=>{if(S){if(S.nodeType===1){let M=S,E=M.tagName?.toLowerCase();E&&E.includes("-")&&!customElements.get(E)&&a(E,M)&&_(E,M),A(M),d&&M.shadowRoot&&L(M.shadowRoot)}S.querySelectorAll&&S.querySelectorAll("*").forEach(M=>{let E=M.tagName?.toLowerCase();E&&E.includes("-")&&!customElements.get(E)&&a(E,M)&&_(E,M),A(M),d&&M.shadowRoot&&L(M.shadowRoot)})}},L=S=>{if(!S||b.has(S))return;z(S);let M=new MutationObserver(E=>{for(let B of E)B.addedNodes?.forEach(O=>{z(O)}),B.type==="attributes"&&B.target&&z(B.target)});M.observe(S,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[i,...l.map(E=>E.selector).filter(E=>E.startsWith("data-"))]}),b.set(S,M)};async function P(){if(clearTimeout(w),w=0,!g.size)return;let S=Array.from(g);g.clear(),S.forEach(M=>m.add(M));try{let M=E=>h.get(E)??(n?n(E):`${E}.js`);await Uo(...S,{baseURL:r,mapper:M,onError:(E,B)=>{v.add(E),o?.(E,B)}})}catch{}finally{S.forEach(M=>m.delete(M))}}let C=s===document?document.documentElement:s,y=new MutationObserver(S=>{for(let M of S)M.addedNodes?.forEach(E=>{z(E)}),M.type==="attributes"&&M.target&&z(M.target)});if(y.observe(C,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[i,...l.map(S=>S.selector).filter(S=>S.startsWith("data-"))]}),d&&u&&Element.prototype.attachShadow){let S=Element.prototype.attachShadow;Element.prototype.attachShadow=function(E){let B=S.call(this,E);if(E&&E.mode==="open"){L(B);let O=this.tagName?.toLowerCase();O&&O.includes("-")&&!customElements.get(O)&&_(O,this)}return B},T=()=>Element.prototype.attachShadow=S}return p&&z(C),{stop(){$=!0,y.disconnect(),T&&T(),w&&(clearTimeout(w),w=0),b.forEach(S=>S.disconnect())},flush:P}}static async define(...t){let r={};t.length&&typeof t[t.length-1]=="object"&&(r=t.pop()||{});let n=t,{baseURL:o,mapper:a=d=>`${d}.js`,onError:i=(d,l)=>console.error(`[defineWebComponents] ${d}:`,l)}=r,s=o?new URL(o,typeof location<"u"?location.href:import.meta.url):new URL("./",import.meta.url),p=d=>d.toLowerCase().replace(/(^|-)([a-z])/g,(l,u,g)=>g.toUpperCase()),c=async d=>{try{if(customElements.get(d))return{tag:d,status:"already-defined"};let l=a(d),g=await import(l instanceof URL?l.href:new URL(l,s).href),m=g?.default??g?.[p(d)];if(!m){if(customElements.get(d))return{tag:d,status:"self-defined"};throw new Error(`No export found for ${d}. Expected default export or named export "${p(d)}".`)}return customElements.get(d)?{tag:d,status:"race-already-defined"}:(customElements.define(d,m),{tag:d,status:"defined"})}catch(l){throw i(d,l),l}};return Promise.all(n.map(c))}};var qo=/^[a-z][a-z0-9+\-.]*:\/\//i,Ie=(()=>{try{return import.meta.url}catch{return}})(),ve=e=>typeof e=="string"&&e.length&&!e.endsWith("/")?`${e}/`:e;function xe(e,t={}){if(!e||qo.test(e))return e;let{preferModule:r=!0}=t,n=()=>{if(!Ie)return null;try{return new URL(e,Ie).href}catch{return null}},o=()=>{if(typeof window>"u"||!window.location?.origin)return null;try{return new URL(e,window.location.origin).href}catch{return null}};return(r?n()||o():o()||n())||e}var qr=(()=>{if(Ie)try{let e=new URL(Ie);if(/\/public\/assets\/js\//.test(e.pathname))return new URL("../pds/",Ie).href}catch{return}})(),Gr=!1;function nt(e){Gr||typeof document>"u"||(Gr=!0,e.addEventListener("pds:ready",t=>{let r=t.detail?.mode;r&&document.documentElement.classList.add(`pds-${r}`,"pds-ready")}))}function Kt(e={},t={}){if(!t||typeof t!="object")return e;let r=Array.isArray(e)?[...e]:{...e};for(let[n,o]of Object.entries(t))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=Kt(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function Vt(e=""){return String(e).toLowerCase().replace(/&/g," and ").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function pe(e){if(e==null)return e;if(typeof e=="function")return;if(typeof e!="object")return e;if(Array.isArray(e))return e.map(r=>pe(r)).filter(r=>r!==void 0);let t={};for(let r in e)if(e.hasOwnProperty(r)){let n=e[r];if(typeof n!="function"){let o=pe(n);o!==void 0&&(t[r]=o)}}return t}function Jt(e={},t={},{presets:r,defaultLog:n,validateDesignConfig:o,validateInitConfig:a}={}){let i=e&&typeof e.log=="function"?e.log:n,s=typeof e=="object"&&("colors"in e||"typography"in e||"spatialRhythm"in e||"shape"in e||"behavior"in e||"layout"in e||"advanced"in e||"a11y"in e||"components"in e||"icons"in e),p=e&&e.enhancers;p&&!Array.isArray(p)&&(p=Object.values(p));let c=p??t.enhancers??[],d=e&&e.preset,l=e&&e.design,u=e&&e.icons&&typeof e.icons=="object"?e.icons:null,g="preset"in(e||{})||"design"in(e||{})||"enhancers"in(e||{});e&&typeof e=="object"&&typeof a=="function"&&a(e,{log:i,context:"PDS.start"});let m,v=null;if(g){l&&typeof l=="object"&&typeof o=="function"&&o(l,{log:i,context:"PDS.start"});let h=String(d||"default").toLowerCase(),b=r?.[h]||Object.values(r||{}).find(O=>Vt(O.name)===h||String(O.name||"").toLowerCase()===h);if(!b)throw new Error(`PDS preset not found: "${d||"default"}"`);v={id:b.id||Vt(b.name),name:b.name||b.id||String(h)};let k=structuredClone(b);if(l&&typeof l=="object"||u){let O=l?pe(l):{},K=u?pe(u):null,N=K?Kt(O,{icons:K}):O;k=Kt(k,structuredClone(N))}let{mode:w,autoDefine:$,applyGlobalStyles:T,manageTheme:A,themeStorageKey:_,preloadStyles:I,criticalLayers:z,managerURL:L,manager:P,localization:C,preset:y,design:S,enhancers:M,log:E,...B}=e;m={...B,design:k,preset:v.name,log:E||n}}else if(s){typeof o=="function"&&o(e,{log:i,context:"PDS.start"});let{log:h,...b}=e;m={design:structuredClone(b),log:h||n}}else{let h=r?.default||Object.values(r||{}).find(b=>Vt(b.name)==="default");if(!h)throw new Error("PDS default preset not available");v={id:h.id||"default",name:h.name||"Default"},m={design:structuredClone(h),preset:v.name,log:n}}return{generatorConfig:m,enhancers:c,presetInfo:v}}function ot({manageTheme:e,themeStorageKey:t,applyResolvedTheme:r,setupSystemListenerIfNeeded:n}){let o="light",a=null;if(e&&typeof window<"u"){try{a=localStorage.getItem(t)||null}catch{a=null}try{r?.(a),n?.(a)}catch{}a?a==="system"?o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":o=a:o=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}return{resolvedTheme:o,storedTheme:a}}function we(e,{resolvePublicAssetURL:t}){let r=!!(e?.public?.root||e?.static?.root),n=t(e);return!r&&qr&&(n=qr),ve(xe(n))}async function at(e,{baseEnhancers:t=[]}={}){let{autoDefineBaseURL:r="/auto-define/",autoDefinePreload:n=[],autoDefineMapper:o=null,enhancers:a=[],autoDefineOverrides:i=null,autoDefinePreferModule:s=!0}=e,p=(()=>{let d=new Map;return(t||[]).forEach(l=>d.set(l.selector,l)),(a||[]).forEach(l=>d.set(l.selector,l)),Array.from(d.values())})(),c=null;if(typeof window<"u"&&typeof document<"u"){let d=rt,l=w=>{switch(w){case"pds-tabpanel":return"pds-tabstrip.js";default:return`${w}.js`}},{mapper:u,enhancers:g,...m}=i&&typeof i=="object"?i:{},v=g?Array.isArray(g)?g:typeof g=="object"?Object.values(g):[]:[],h=(()=>{let w=new Map;return(p||[]).forEach($=>{$?.selector&&w.set($.selector,$)}),(v||[]).forEach($=>{if(!$?.selector)return;let T=w.get($.selector)||null;w.set($.selector,{...T||{},...$,run:typeof $?.run=="function"?$.run:T?.run})}),Array.from(w.values())})(),k={baseURL:r&&ve(xe(r,{preferModule:s})),predefine:n,scanExisting:!0,observeShadows:!0,patchAttachShadow:!0,debounceMs:16,enhancers:h,onError:(w,$)=>{if(typeof w=="string"&&w.startsWith("pds-")){let A=["pds-form","pds-drawer"].includes(w),_=$?.message?.includes("#pds/lit")||$?.message?.includes("Failed to resolve module specifier");A&&_?f.log("error",`\u274C PDS component <${w}> requires Lit but #pds/lit is not in import map.
              See: https://github.com/Pure-Web-Foundation/pure-ds/blob/main/readme.md#lit-components-not-working`):f.log("warn",`\u26A0\uFE0F PDS component <${w}> not found. Assets may not be installed.`)}else f.log("error",`\u274C Auto-define error for <${w}>:`,$)},...m,mapper:w=>{if(customElements.get(w))return null;if(typeof o=="function")try{let $=o(w);return $===void 0?l(w):$}catch($){return f.log("warn","Custom autoDefine.mapper error; falling back to default:",$?.message||$),l(w)}return l(w)}};c=new d(k),n.length>0&&typeof d.define=="function"&&await d.define(...n,{baseURL:r,mapper:k.mapper,onError:k.onError})}return{autoDefiner:c,mergedEnhancers:p}}var Yt=["light","dark"],Xt=new Set(Yt);function Zt(e){let r=(Array.isArray(e?.themes)?e.themes.map(n=>String(n).toLowerCase()):Yt).filter(n=>Xt.has(n));return r.length?r:Yt}function ke(e,{preferDocument:t=!0}={}){let r=String(e||"").toLowerCase();if(Xt.has(r))return r;if(t&&typeof document<"u"){let n=document.documentElement?.getAttribute("data-theme");if(Xt.has(n))return n}return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function ue(e,t){let r=ke(t);return Zt(e).includes(r)}var Kr=!1,ct="pds-live-edit-toggle",rr="pds-live-edit-toggle-style";function Jr(e,t=new WeakSet){if(!e||typeof e!="object"||t.has(e))return e;t.add(e),Object.freeze(e);for(let r of Object.keys(e))Jr(e[r],t);return e}function Yr(e){return e==null||typeof e!="object"?e:Jr(structuredClone(pe(e)))}function Xr(e){if(typeof document>"u"||typeof e!="function")return;if(document.body){e();return}let t=()=>{document.body&&(document.removeEventListener("DOMContentLoaded",t),e())};document.addEventListener("DOMContentLoaded",t,{once:!0})}function Vo(e={}){let t=e?.interactive!==!1;typeof document>"u"||Xr(()=>{if(document.querySelector("pds-live-edit")){if(!t){let r=document.querySelector("pds-live-edit");r&&r.setAttribute("data-pds-live-settings-only","true")}}else{let r=document.createElement("pds-live-edit");t||r.setAttribute("data-pds-live-settings-only","true"),document.body.appendChild(r)}})}function lt(e=0){return new Promise(t=>{setTimeout(t,Math.max(0,Number(e)||0))})}async function je(e={}){let t=e?.mountIfMissing!==!1,r=e?.interactive!==!1,n=typeof e?.requiredMethod=="string"&&e.requiredMethod.trim()?e.requiredMethod.trim():"openDesignSettings",o=Number.isFinite(Number(e?.timeoutMs))?Number(e.timeoutMs):2400;if(typeof document>"u"||!t&&!document.querySelector("pds-live-edit"))return null;t&&Vo({interactive:r});let a=Date.now();for(;Date.now()-a<o;){let s=document.querySelector("pds-live-edit");if(!s){await lt(40);continue}if(typeof s?.[n]=="function")return s;if(typeof customElements<"u"&&typeof customElements.whenDefined=="function"){try{await Promise.race([customElements.whenDefined("pds-live-edit"),lt(80)])}catch{await lt(40)}continue}await lt(40)}let i=document.querySelector("pds-live-edit");return i&&typeof i?.[n]=="function"?i:null}function Zr(){if(typeof document>"u")return;document.querySelectorAll("pds-live-edit").forEach(t=>{typeof t?.setInteractiveEditingEnabled=="function"&&t.setInteractiveEditingEnabled(!1),t.remove()})}function Ko(e){return e?typeof e.isInteractiveEditingEnabled=="function"?!!e.isInteractiveEditingEnabled():!0:!1}function Jo(){if(typeof document>"u"||document.getElementById(rr))return;let e=document.createElement("style");e.id=rr,e.textContent=`
  ...
  `,document.head.appendChild(e)}function tr(e,t){if(!e)return;e.classList.toggle("btn-primary",t),e.classList.toggle("btn-secondary",!t),e.setAttribute("aria-pressed",t?"true":"false");let r="PDS Manager";e.setAttribute("aria-label",r),e.setAttribute("title",r)}async function Yo(){if(typeof document>"u")return null;Jo();let e=document.getElementById(ct);if(!e){let t=document.createElement("nav");t.className="pds-live-edit-toggle-nav",t.setAttribute("data-dropdown",""),t.setAttribute("data-mode","auto"),t.setAttribute("data-pds-live-edit-ignore","true"),e=document.createElement("button"),e.id=ct,e.type="button",e.className="icon-only btn-secondary",e.setAttribute("data-pds-live-edit-ignore","true"),e.innerHTML='<pds-icon icon="cursor-click" size="sm"></pds-icon>';let r=document.createElement("menu");r.setAttribute("data-pds-live-edit-ignore","true");let n=(a,i,s)=>{let p=document.createElement("li"),c=document.createElement("a");c.href="#",c.dataset.pdsLiveAction=a,c.setAttribute("data-pds-live-edit-ignore","true");let d=document.createElement("pds-icon");return d.setAttribute("icon",s),d.setAttribute("size","sm"),c.append(d,document.createTextNode(` ${i}`)),p.appendChild(c),p},o=()=>{let a=document.createElement("li");a.setAttribute("data-pds-live-edit-ignore","true");let i=document.createElement("hr");return i.setAttribute("aria-hidden","true"),a.appendChild(i),a};r.appendChild(n("toggle","Toggle live editing","pencil")),r.appendChild(n("open-settings","Open Settings","gear")),r.appendChild(o()),r.appendChild(n("reset-config","Reset Config","arrow-counter-clockwise")),await Xo(r),t.append(e,r),Xr(()=>{document.getElementById(ct)||document.body.appendChild(t)})}return e}async function Xo(e){if(e instanceof Element){if(e.__pdsLiveSharedMenuItemInFlight)return e.__pdsLiveSharedMenuItemInFlight;e.__pdsLiveSharedMenuItemInFlight=(async()=>{e.querySelectorAll("li.pds-live-shared-quick-mode-item").forEach(s=>s.remove());let t=await je({mountIfMissing:!0,interactive:!1,requiredMethod:"createSharedQuickModeMenuItem",timeoutMs:7e3});if(!t||typeof t.createSharedQuickModeMenuItem!="function")return;let r=await t.createSharedQuickModeMenuItem();if(!(r instanceof Element))return;r.classList.add("pds-live-shared-quick-mode-item");let o=e.querySelector('a[data-pds-live-action="reset-config"]')?.closest("li")||null,a=o?.previousElementSibling||null,i=a&&a.querySelector?.(":scope > hr")?a:null;if(i){e.insertBefore(r,i);return}if(o){e.insertBefore(r,o);return}e.appendChild(r)})();try{await e.__pdsLiveSharedMenuItemInFlight}finally{e.__pdsLiveSharedMenuItemInFlight=null}}}function Zo(){if(typeof document>"u")return;let e=document.getElementById(ct);if(e){let r=e.closest(".pds-live-edit-toggle-nav");r?r.remove():e.remove()}let t=document.getElementById(rr);t&&t.remove(),Zr()}async function Qo(){if(typeof document>"u")return;let e=await Yo();if(!e)return;let t=async i=>{if(i){let s=await je({mountIfMissing:!0});s&&typeof s.setInteractiveEditingEnabled=="function"&&s.setInteractiveEditingEnabled(!0)}else Zr();tr(e,i)};t(!1);let r=e.closest(".pds-live-edit-toggle-nav")||e;e.__pdsLiveEditActionHandler&&r.removeEventListener("click",e.__pdsLiveEditActionHandler);let n=async i=>{let s=i.target?.closest?.("[data-pds-live-action]");if(!s)return;i.preventDefault();let p=String(s.dataset.pdsLiveAction||"");if(p==="toggle"){let c=await je({mountIfMissing:!1}),d=Ko(c);await t(!d);return}if(p==="open-settings"){let c=await je({mountIfMissing:!0,requiredMethod:"openDesignSettings",interactive:!1});c&&typeof c.setInteractiveEditingEnabled=="function"&&c.setInteractiveEditingEnabled(!1),c&&typeof c.openDesignSettings=="function"&&(tr(e,!1),await c.openDesignSettings());return}if(p==="reset-config"){let c=await je({mountIfMissing:!0,requiredMethod:"resetConfig",interactive:!1});tr(e,!1),c&&typeof c.resetConfig=="function"&&await c.resetConfig();return}};e.__pdsLiveEditActionHandler=n,r.addEventListener("click",n),e.__pdsLiveEditDisableHandler&&document.removeEventListener("pds:live-edit:disable",e.__pdsLiveEditDisableHandler),e.__pdsLiveEditEnableHandler&&document.removeEventListener("pds:live-edit:enable",e.__pdsLiveEditEnableHandler);let o=()=>{t(!1)},a=()=>{t(!0)};e.__pdsLiveEditDisableHandler=o,document.addEventListener("pds:live-edit:disable",o),e.__pdsLiveEditEnableHandler=a,document.addEventListener("pds:live-edit:enable",a)}function ea(){if(typeof window>"u"||!window.localStorage)return null;try{let e=window.localStorage.getItem("pure-ds-config");if(!e)return null;let t=JSON.parse(e);if(t&&("preset"in t||"design"in t))return t}catch{return null}return null}function nr(e={},t={}){if(!t||typeof t!="object")return e;let r=Array.isArray(e)?[...e]:{...e};for(let[n,o]of Object.entries(t))o&&typeof o=="object"&&!Array.isArray(o)?r[n]=nr(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o;return r}function ta(e){let t=ea();if(!t||!e||typeof e!="object")return e;let r=t.preset,n=t.design&&typeof t.design=="object"?t.design:null;if(!r&&!n)return e;let o="preset"in e||"design"in e||"enhancers"in e,a={...e};if(r&&(a.preset=r),n)if(o){let i=e.design&&typeof e.design=="object"?e.design:{};a.design=nr(i,n)}else a=nr(e,n);return a}function ra(e,t={}){let{hideCategory:r=!0,itemGrid:n="45px 1fr",includeIncompatible:o=!0,disableIncompatible:a=!0,categoryName:i="Presets",theme:s,onSelect:p,iconHandler:c}=t||{},d=ke(s??e?.theme),l=m=>{let h=g(m?.id)?.colors||{},b=h?.primary,k=h?.secondary,w=h?.accent;return b&&k&&w?`<span style="display:flex;gap:1px;flex-shrink:0;" aria-hidden="true">
      ...
      </span>`:m?.icon?`<pds-icon icon="${m.icon}" size="sm"></pds-icon>`:""},u=()=>{let m=e?.presets||{};return Object.values(m||{}).filter(v=>!!(v?.id||v?.name))},g=m=>m&&u().find(h=>String(h?.id||h?.name)===String(m))||null;return{hideCategory:r,itemGrid:n,iconHandler:typeof c=="function"?c:l,categories:{[i]:{trigger:()=>!0,getItems:(m={})=>{let v=String(m?.search||"").toLowerCase().trim();return u().filter(b=>{let k=String(b?.name||b?.id||"").toLowerCase(),w=String(b?.description||"").toLowerCase(),$=Array.isArray(b?.tags)?b.tags.map(A=>String(A).toLowerCase()):[];if(v&&!(k.includes(v)||w.includes(v)||$.some(_=>_.includes(v))))return!1;let T=ue(b,d);return!(!o&&!T)}).map(b=>{let k=b?.id||b?.name,w=ue(b,d),$=Zt(b),T=$.length===1?`${$[0]} only`:`Not available in ${d} mode`,A=String(b?.description||"").trim(),_=w?A:A?`${A} - ${T}`:T;return{id:k,text:b?.name||String(k),description:_,icon:"palette",class:!w&&a?"disabled":"",disabled:!w&&a,tooltip:w?"":T}}).sort((b,k)=>String(b.text||"").localeCompare(String(k.text||"")))},action:async m=>{if(!m?.id||m?.disabled)return m?.id;let v=g(m.id);return v?typeof p=="function"?await p({preset:v,selection:m,resolvedTheme:d}):(typeof e?.applyLivePreset=="function"&&await e.applyLivePreset(v.id||m.id),v.id||m.id):m?.id}}}}}async function na(e,{applyResolvedTheme:t,setupSystemListenerIfNeeded:r,emitConfigChanged:n}){if(Kr)return;let[o,a,i]=await Promise.all([Promise.resolve().then(()=>(Ot(),Mr)),Promise.resolve().then(()=>(Te(),mr)),Promise.resolve().then(()=>(er(),st))]),s=o?.default||o?.ontology,p=o?.findComponentForElement,c=a?.enums;e.ontology=s,e.findComponentForElement=p,e.enums=c,e.common=i||{},e.presets=Q,e.configRelations=wr,e.configSpec=kr,e.configEditorMetadata=zr,e.configFormSchema=Cr,e.buildConfigFormSchema=he,e.getConfigEditorMetadata=Fe,e.enhancerMetadata=Or,(!Array.isArray(e.defaultEnhancers)||e.defaultEnhancers.length===0)&&(e.defaultEnhancers=Array.isArray(tt)?tt:[]),e.applyStyles=function(d){let l=d||Z.instance;Tr(l),typeof n=="function"&&n({mode:"live",source:"live:styles-applied"})},e.adoptLayers=function(d,l,u){return Je(d,l,u,Z.instance)},e.adoptPrimitives=function(d,l){return Ke(d,l,Z.instance)},e.getGenerator=async function(){return Z},e.buildPresetOmniboxSettings=function(d={}){return ra(e,d)},e.applyLivePreset=async function(d,l={}){if(!d)return!1;if(!e.registry?.isLive)return e.log("warn","PDS.applyLivePreset is only available in live mode."),!1;let u=e.currentConfig||{},{design:g,preset:m,...v}=u,h={...structuredClone(pe(v)),preset:d},b=Jt(h,{},{presets:Q,defaultLog:Bt,validateDesignConfig:It,validateInitConfig:jt}),k=ke(e.theme);if(!ue(b.generatorConfig.design,k)){let A=b.presetInfo?.name||b.generatorConfig?.design?.name||d;e.log("warn",`PDS theme "${k}" not supported by preset "${A}".`)}u.theme&&!b.generatorConfig.theme&&(b.generatorConfig.theme=u.theme);let w=new Z(b.generatorConfig);if(b.generatorConfig.design?.typography)try{await Gt(b.generatorConfig.design.typography)}catch(A){b.generatorConfig?.log?.("warn","Failed to load some fonts from Google Fonts:",A)}e.applyStyles?.(w);let $=b.presetInfo||{id:d,name:d};if(e.currentPreset=$,e.compiled=Yr({...u,preset:b.generatorConfig.preset,design:b.generatorConfig.design,theme:b.generatorConfig.theme||u.theme}),e.configEditorMetadata=Fe(b.generatorConfig.design),e.configFormSchema=he(b.generatorConfig.design),l?.persist!==!1&&typeof window<"u"){let A="pure-ds-config";try{let _=localStorage.getItem(A),I=_?JSON.parse(_):null,z={...I&&typeof I=="object"?I:{},preset:$.id||d,design:structuredClone(b.generatorConfig.design||{})};localStorage.setItem(A,JSON.stringify(z))}catch(_){b.generatorConfig?.log?.("warn","Failed to store preset:",_)}}return!0},e.preloadCritical=function(d,l={}){if(typeof window>"u"||!document.head||!d)return;let{theme:u,layers:g=["tokens"]}=l;try{let m=u||"light";(u==="system"||!u)&&(m=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),document.documentElement.setAttribute("data-theme",m);let v=d.design?{...d,theme:m}:{design:d,theme:m},h=new Z(v),b=g.map(k=>{try{return h.css?.[k]||""}catch{return""}}).filter(k=>k.trim()).join(`
`);if(b){let k=document.head.querySelector("style[data-pds-preload]");k&&k.remove();let w=document.createElement("style");w.setAttribute("data-pds-preload",""),w.textContent=b,document.head.insertBefore(w,document.head.firstChild)}}catch(m){e.log("warn","PDS preload failed:",m)}},Kr=!0}async function oa(e,t,{emitReady:r,emitConfigChanged:n,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}){if(!t||typeof t!="object")throw new Error("PDS.start({ mode: 'live', ... }) requires a valid configuration object");let i=t?.design?.icons?.externalPath||t?.icons?.externalPath||null;if(t=ta(t),typeof i=="string"&&i.trim()){let g=t?.design&&typeof t.design=="object"?t.design:{},m=g?.icons&&typeof g.icons=="object"?g.icons:{};t={...t,design:{...g,icons:{...m,externalPath:i}}}}if(await na(e,{applyResolvedTheme:o,setupSystemListenerIfNeeded:a,emitConfigChanged:n}),nt(e),typeof document<"u"&&document.adoptedStyleSheets){let g=`
          html { opacity: 0; }
          html.pds-ready { opacity: 1; transition: opacity 0.3s ease-in; }
        `;try{if(!document.adoptedStyleSheets.some(v=>v._pdsFouc)){let v=new CSSStyleSheet;v.replaceSync(g),v._pdsFouc=!0,document.adoptedStyleSheets=[v,...document.adoptedStyleSheets]}}catch(m){if(e.log("warn","Constructable stylesheets not supported, using <style> tag fallback:",m),!document.head.querySelector("style[data-pds-fouc]")){let h=document.createElement("style");h.setAttribute("data-pds-fouc",""),h.textContent=g,document.head.insertBefore(h,document.head.firstChild)}}}let s=t.applyGlobalStyles??!0,p=t.manageTheme??!0,c=t.themeStorageKey??"pure-ds-theme",d=t.preloadStyles??!1,l=t.criticalLayers??["tokens","primitives"],u=t&&t.autoDefine||null;try{let{resolvedTheme:g}=ot({manageTheme:p,themeStorageKey:c,applyResolvedTheme:o,setupSystemListenerIfNeeded:a}),m=Jt(t,{},{presets:Q,defaultLog:Bt,validateDesignConfig:It,validateInitConfig:jt});if(p&&!ue(m.generatorConfig.design,g)){let z=m.presetInfo?.name||m.generatorConfig?.design?.name||m.generatorConfig?.preset||"current preset";e.log("warn",`PDS theme "${g}" not supported by preset "${z}".`)}let v=m.enhancers,{log:h,...b}=m.generatorConfig,k=structuredClone(b);k.log=h,p&&(k.theme=g);let w=new Z(k);if(k.design?.typography)try{await Gt(k.design.typography)}catch(z){k?.log?.("warn","Failed to load some fonts from Google Fonts:",z)}if(d&&typeof window<"u"&&document.head)try{let z=l.map(L=>{try{return w.css?.[L]||""}catch(P){return k?.log?.("warn",`Failed to generate critical CSS for layer "${L}":`,P),""}}).filter(L=>L.trim()).join(`
`);if(z){let L=document.head.querySelector("style[data-pds-critical]");L&&L.remove();let P=document.createElement("style");P.setAttribute("data-pds-critical",""),P.textContent=z;let C=document.head.querySelector('meta[charset], meta[name="viewport"]');C?C.parentNode.insertBefore(P,C.nextSibling):document.head.insertBefore(P,document.head.firstChild)}}catch(z){k?.log?.("warn","Failed to preload critical styles:",z)}e.registry.setLiveMode(),m.presetInfo?.name?k?.log?.("log",`PDS live with preset "${m.presetInfo.name}"`):k?.log?.("log","PDS live with custom config"),s&&(e.applyStyles?.(Z.instance),typeof window<"u"&&setTimeout(()=>{let z=document.head.querySelector("style[data-pds-critical]");z&&z.remove();let L=document.head.querySelector("style[data-pds-preload]");L&&L.remove();let P=document.getElementById("pds-runtime-stylesheet");P&&P.remove()},100));let $=we(t,{resolvePublicAssetURL:ye}),T;u&&u.baseURL?T=ve(xe(u.baseURL,{preferModule:!1})):T=`${$}components/`;let A=null,_=[];try{let z=await at({autoDefineBaseURL:T,autoDefinePreload:u&&Array.isArray(u.predefine)&&u.predefine||[],autoDefineMapper:u&&typeof u.mapper=="function"&&u.mapper||null,enhancers:v,autoDefineOverrides:u||null,autoDefinePreferModule:!(u&&u.baseURL)},{baseEnhancers:tt});A=z.autoDefiner,_=z.mergedEnhancers||[]}catch(z){k?.log?.("error","\u274C Failed to initialize AutoDefiner/Enhancers:",z)}let I=w?.options||k;if(e.compiled=Yr({mode:"live",...I,theme:g,enhancers:_}),e.configEditorMetadata=Fe(m.generatorConfig.design),e.configFormSchema=he(m.generatorConfig.design),typeof n=="function"&&n({mode:"live",source:"live:config-applied",preset:m.generatorConfig.preset}),typeof document<"u")try{t?.liveEdit?setTimeout(()=>{Qo()},0):Zo()}catch(z){k?.log?.("warn","Live editor toggle failed to start:",z)}return r({mode:"live",generator:w,config:I,theme:g,autoDefiner:A}),{generator:w,config:I,theme:g,autoDefiner:A}}catch(g){throw e.dispatchEvent(new CustomEvent("pds:error",{detail:{error:g}})),g}}function aa(e){let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):.5}function ia(e){return Array.isArray(e)?e.map(t=>t?{severity:String(t.severity||"info").toLowerCase(),message:String(t.message||""),path:t.path?String(t.path):""}:null).filter(t=>t&&t.message):[]}function W(e={}){let t=String(e.source||"unknown"),r=String(e.type||"generic"),n=aa(e.confidence),o=ia(e.issues),a=e.designPatch&&typeof e.designPatch=="object"?e.designPatch:{},i=e.template&&typeof e.template=="object"?e.template:null;return{source:t,type:r,confidence:n,issues:o,designPatch:a,template:i,meta:e.meta&&typeof e.meta=="object"?e.meta:{}}}function sa(e){return!!(e&&typeof e=="object"&&"source"in e&&"type"in e&&"confidence"in e&&"issues"in e&&"designPatch"in e)}var la="../templates/templates.json",Qr="/assets/pds/templates/templates.json",ca=["public","assets","pds","templates","templates.json"],da=["..","..","..","public","assets","pds","templates","templates.json"],dt=null;function en(){return!!(typeof process<"u"&&process?.versions?.node)}function pa(e={}){return{id:String(e.id||"").trim(),name:String(e.name||e.id||"Template").trim(),description:String(e.description||"").trim(),icon:String(e.icon||"layout").trim(),file:String(e.file||"").trim(),tags:Array.isArray(e.tags)?e.tags.map(t=>String(t)):[]}}function pt(e={},t={}){let n=(Array.isArray(e)?e:Array.isArray(e?.templates)?e.templates:[]).map(pa).filter(o=>o.id&&o.file);return{version:e?.version||"1",templates:n,__catalogURL:t.catalogURL||null,__catalogFilePath:t.catalogFilePath||null}}async function ua(e={}){let r=[e.catalogURL||globalThis?.PDS?.currentConfig?.templateCatalogURL,la,Qr].filter(Boolean);for(let n of r)try{let o=new URL(n,import.meta.url).href,a=await fetch(o,{credentials:"same-origin"});if(!a.ok)continue;let i=await a.json();return pt(i,{catalogURL:o})}catch{}return pt({templates:[]})}async function ga(e={}){let t="node:fs/promises",r="node:path",n="node:url",[{readFile:o},a,{fileURLToPath:i}]=await Promise.all([import(t),import(r),import(n)]),s=[];e.catalogPath&&s.push(a.resolve(e.catalogPath)),s.push(a.resolve(process.cwd(),...ca));let p=a.dirname(i(import.meta.url));s.push(a.resolve(p,...da));for(let c of s)try{let d=await o(c,"utf8"),l=JSON.parse(d);return pt(l,{catalogFilePath:c})}catch{}return pt({templates:[]})}async function ma(e,t){if(!e?.file)return"";if(!en()){let p=t?.__catalogURL||Qr,c=new URL(e.file,p).href,d=await fetch(c,{credentials:"same-origin"});if(!d.ok)throw new Error(`Template file not found: ${e.file}`);return(await d.text()).trim()}let r="node:fs/promises",n="node:path",[{readFile:o},a]=await Promise.all([import(r),import(n)]),i=t?.__catalogFilePath?a.dirname(t.__catalogFilePath):a.resolve(process.cwd(),"public","assets","pds","templates"),s=a.resolve(i,e.file);return(await o(s,"utf8")).trim()}async function ut(e={}){return dt&&!e.forceReload||(dt=en()?await ga(e):await ua(e)),dt}async function tn(e={}){return(await ut(e)).templates.map(({id:r,name:n,description:o,icon:a,file:i,tags:s})=>({id:r,name:n,description:o,icon:a,file:i,tags:s}))}async function fa(e,t={}){let r=await ut(t),n=r.templates.find(a=>a.id===e)||null;if(!n)return null;let o=await ma(n,r);return{...n,html:o}}async function rn(e,t={}){let r=await fa(e,t);return r?W({source:"template",type:"template",confidence:1,template:{id:r.id,name:r.name,html:r.html,icon:r.icon,description:r.description}}):W({source:"template",type:"template",confidence:0,issues:[{severity:"error",message:`Unknown template: ${e}`}]})}var nn={version:"tw2pds-layout-v4",summary:"Deterministic Tailwind\u2192PDS conversion rules focused on layout intent, semantic primitive mapping, and richer import-* fallback coverage.",governance:[{id:"layout.utilities.grid",controls:["grid","grid-cols-*","grid-auto-*"],note:"When false, grid mappings are skipped."},{id:"layout.utilities.flex",controls:["flex","flex-*","items-*","justify-*","grow"],note:"When false, flex mappings are skipped."},{id:"layout.utilities.spacing",controls:["gap-*","stack-*"],note:"When false, spacing mappings are skipped."},{id:"layout.utilities.container",controls:["container","max-w-*"],note:"When false, container mappings are skipped."}],nonPdsClassPatterns:["^group(?:[/:].*)?$","^layout-container$"],neverFallbackTags:["table","thead","tbody","tfoot","tr","th","td","caption","colgroup","col"],directMappings:[{id:"layout.flex.base",tw:"flex",pds:["flex"],gate:"flex"},{id:"layout.flex.inline",tw:"inline-flex",pds:["flex"],gate:"flex"},{id:"layout.flex.row",tw:"flex-row",pds:["flex-row"],gate:"flex"},{id:"layout.flex.col",tw:"flex-col",pds:["flex-col"],gate:"flex"},{id:"layout.flex.wrap",tw:"flex-wrap",pds:["flex-wrap"],gate:"flex"},{id:"layout.flex.grow",tw:"grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow.tw",tw:"flex-grow",pds:["grow"],gate:"flex"},{id:"layout.flex.grow1",tw:"flex-1",pds:["grow"],gate:"flex"},{id:"layout.items.start",tw:"items-start",pds:["items-start"],gate:"flex"},{id:"layout.items.center",tw:"items-center",pds:["items-center"],gate:"flex"},{id:"layout.items.end",tw:"items-end",pds:["items-end"],gate:"flex"},{id:"layout.items.stretch",tw:"items-stretch",pds:["items-stretch"],gate:"flex"},{id:"layout.items.baseline",tw:"items-baseline",pds:["items-baseline"],gate:"flex"},{id:"layout.justify.start",tw:"justify-start",pds:["justify-start"],gate:"flex"},{id:"layout.justify.center",tw:"justify-center",pds:["justify-center"],gate:"flex"},{id:"layout.justify.end",tw:"justify-end",pds:["justify-end"],gate:"flex"},{id:"layout.justify.between",tw:"justify-between",pds:["justify-between"],gate:"flex"},{id:"layout.justify.around",tw:"justify-around",pds:["justify-around"],gate:"flex"},{id:"layout.justify.evenly",tw:"justify-evenly",pds:["justify-evenly"],gate:"flex"},{id:"layout.grid.base",tw:"grid",pds:["grid"],gate:"grid"},{id:"layout.grid.cols.1",tw:"grid-cols-1",pds:["grid-cols-1"],gate:"grid"},{id:"layout.grid.cols.2",tw:"grid-cols-2",pds:["grid-cols-2"],gate:"grid"},{id:"layout.grid.cols.3",tw:"grid-cols-3",pds:["grid-cols-3"],gate:"grid"},{id:"layout.grid.cols.4",tw:"grid-cols-4",pds:["grid-cols-4"],gate:"grid"},{id:"layout.grid.cols.6",tw:"grid-cols-6",pds:["grid-cols-6"],gate:"grid"},{id:"layout.container",tw:"container",pds:["container"],gate:"container"},{id:"intent.surface.shadow",tw:"shadow",pds:["surface-elevated"]},{id:"intent.surface.shadow-md",tw:"shadow-md",pds:["surface-elevated"]},{id:"intent.surface.shadow-lg",tw:"shadow-lg",pds:["surface-elevated"]},{id:"intent.surface.base",tw:"bg-white",pds:["surface-base"]},{id:"typography.align.center",tw:"text-center",pds:["text-center"]},{id:"typography.align.left",tw:"text-left",pds:["text-left"]},{id:"typography.align.right",tw:"text-right",pds:["text-right"]},{id:"typography.text.muted.gray500",tw:"text-gray-500",pds:["text-muted"]},{id:"typography.text.muted.slate500",tw:"text-slate-500",pds:["text-muted"]}],ignoredPatterns:[{id:"style.color",pattern:"^(?:text|from|to|via|decoration|accent|caret)-|^bg-(?!cover$|center$|no-repeat$)",reason:"Visual style token skipped in favor of semantic PDS styling."},{id:"style.radius-border-shadow",pattern:"^(?:rounded|ring|border|shadow|outline)-?",reason:"Surface/shape inferred at primitive level."},{id:"style.typography",pattern:"^(?:font|leading|tracking|uppercase|lowercase|capitalize)-?",reason:"Typography atomic utilities are skipped."},{id:"style.effects",pattern:"^(?:opacity|blur|backdrop|drop-shadow|mix-blend|filter)-",reason:"Visual effects skipped unless mapped to a PDS utility."},{id:"style.transitions",pattern:"^(?:transition|duration|ease|delay|animate)-",reason:"Motion is system-defined in PDS."},{id:"style.spacing.atomic",pattern:"^(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-",reason:"Atomic spacing skipped; structural spacing intent is mapped."},{id:"style.positioning.atomic",pattern:"^(?:absolute|relative|fixed|sticky|inset(?:-[xy])?|top|right|bottom|left|z|translate(?:-[xy])?|-translate-[xy])(?:-|$)",reason:"Atomic positioning/offset utilities are skipped so PDS primitives and layout utilities control placement."}],intentRules:[{id:"intent.layout.responsive-grid-to-auto",summary:"Collapse responsive grid-cols patterns (including base+md two-step patterns) to best-fit grid-auto-*"},{id:"intent.layout.mobile-stack",summary:"Map flex-col + md/lg:flex-row to mobile-stack"},{id:"intent.component.card",summary:"Infer card/surface classes from rounded+shadow+surface signals"},{id:"intent.component.card.normalize",summary:"Detect Tailwind card utility clusters and normalize them to PDS card and surface variants."},{id:"intent.component.button",summary:"Infer btn-primary / btn-outline / icon-only from CTA patterns"},{id:"intent.component.button.normalize",summary:"Prevents import-* style classes on button-like elements and applies PDS button variants/sizes."},{id:"intent.component.button.layout-grow",summary:"Preserve CTA row width intent on button-like elements by mapping w-full/flex-1 to grow."},{id:"intent.icon.color-preserve",summary:"Preserve icon color intent by mapping Tailwind text color utilities on icon-like elements to tokenized import-* classes."},{id:"intent.component.badge.normalize",summary:"Detects Tailwind badge/pill utility clusters and normalizes them to PDS badge primitives/variants."},{id:"intent.typography.heading-semantic",summary:"Removes Tailwind heading typography/color utilities so heading semantics and PDS defaults control typography."},{id:"intent.surface.footer-inverse",summary:"Use surface-inverse for footers with explicit background intent"},{id:"intent.typography.link-treatment",summary:"Apply minimal link treatment for hover/transition-tailwind anchors"},{id:"intent.typography.link-active-preserve",summary:"Preserve anchor text color intent (including active menu states) by mapping Tailwind text utilities to tokenized import-* classes."},{id:"intent.typography.metric-paragraph-to-div",summary:"Normalize metric display lines from paragraph tags to div tags to avoid default paragraph margins in compact stat layouts."},{id:"intent.typography.metric-pair-no-stack",summary:"When a compact metric container has two consecutive typography lines, remove stack-sm so spacing follows Tailwind preflight no-margin assumptions."},{id:"intent.typography.semantic-heading-from-scale",summary:"Map large bold typography scales (text-2xl/text-3xl/text-4xl) to semantic heading tags when possible."},{id:"intent.typography.bold-to-strong",summary:"Prefer semantic strong tags for bold inline text intent instead of utility-only font-weight classes."},{id:"intent.preflight.tailwind-runtime-detected",summary:"Detect Tailwind runtime CSS injection and translate key preflight intent"},{id:"intent.preflight.list-reset",summary:"Preserve Tailwind list-reset preflight behavior via scoped fallback class"},{id:"intent.preflight.anchor-reset",summary:"Preserve Tailwind anchor reset preflight behavior via scoped fallback class"},{id:"table.strict-tags.no-classes",summary:"Never emit classes for semantic table tags (table/thead/tbody/tfoot/tr/th/td/caption/colgroup/col)"},{id:"intent.form.nested-label",summary:"Convert sibling label+control pairs into nested labels"},{id:"fallback.import-style",summary:"Generate import-* classes + local style block for unmapped utility styles"}],gapScaleMap:{"gap-0":"gap-0","gap-1":"gap-xs","gap-2":"gap-sm","gap-3":"gap-sm","gap-4":"gap-md","gap-5":"gap-md","gap-6":"gap-lg","gap-7":"gap-lg","gap-8":"gap-xl","gap-10":"gap-xl","gap-12":"gap-xl"},maxWidthMap:{"max-w-xs":"max-w-sm","max-w-sm":"max-w-sm","max-w-md":"max-w-md","max-w-lg":"max-w-lg","max-w-xl":"max-w-xl","max-w-2xl":"max-w-xl","max-w-3xl":"max-w-xl","max-w-4xl":"max-w-xl","max-w-5xl":"max-w-xl","max-w-6xl":"max-w-xl","max-w-7xl":"max-w-xl"},tailwindSizeScale:{"0":"var(--spacing-0)","0.5":"0.125rem","1":"var(--spacing-1)","1.5":"0.375rem","2":"var(--spacing-2)","2.5":"0.625rem","3":"var(--spacing-3)","3.5":"0.875rem","4":"var(--spacing-4)","5":"var(--spacing-5)","6":"var(--spacing-6)","7":"var(--spacing-7)","8":"var(--spacing-8)","9":"var(--spacing-9)","10":"var(--spacing-10)","11":"var(--spacing-11)","12":"var(--spacing-12)","14":"3.5rem","16":"4rem","20":"5rem","24":"6rem","28":"7rem","32":"8rem","36":"9rem","40":"10rem","48":"12rem"},tailwindShadeScale:["50","100","200","300","400","500","600","700","800","900"],defaultTailwindShade:"500",importStyleRules:{"mx-auto":"margin-left:auto;margin-right:auto","ml-auto":"margin-left:auto","mr-auto":"margin-right:auto","w-full":"width:100%","w-auto":"width:auto","h-full":"height:100%","h-48":"height:12rem","h-2.5":"height:0.625rem","h-10":"height:var(--spacing-10)","h-2":"height:var(--spacing-2)","w-2":"width:var(--spacing-2)","size-8":"width:var(--spacing-8);height:var(--spacing-8)","size-10":"width:var(--spacing-10);height:var(--spacing-10)","size-full":"width:100%;height:100%","min-h-screen":"min-height:100vh","overflow-hidden":"overflow:hidden","overflow-x-hidden":"overflow-x:hidden","overflow-x-auto":"overflow-x:auto","whitespace-nowrap":"white-space:nowrap",hidden:"display:none",block:"display:block",truncate:"overflow:hidden;text-overflow:ellipsis;white-space:nowrap","justify-items-center":"justify-items:center","justify-items-start":"justify-items:start","justify-items-end":"justify-items:end","justify-items-stretch":"justify-items:stretch","grid-flow-col":"grid-auto-flow:column","aspect-square":"aspect-ratio:1 / 1","bg-center":"background-position:center","bg-cover":"background-size:cover","bg-no-repeat":"background-repeat:no-repeat","transition-colors":"transition-property:color,background-color,border-color,text-decoration-color,fill,stroke;transition-duration:150ms"},importStyleDynamicRules:[{id:"fallback.import-style.gap-scale",pattern:"^gap-(\\d+)$",summary:"Converts gap scale utilities (including responsive variants like md:gap-6) to generated import-* fallback classes."},{id:"fallback.import-style.min-width-arbitrary",pattern:"^min-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-width utilities (e.g. min-w-[600px]) to generated import-* fallback classes."},{id:"fallback.import-style.max-width-arbitrary",pattern:"^max-w-\\[[^\\]]+\\]$",summary:"Converts arbitrary max-width utilities (e.g. max-w-[480px]) to generated import-* fallback classes."},{id:"fallback.import-style.min-height-arbitrary",pattern:"^min-h-\\[[^\\]]+\\]$",summary:"Converts arbitrary min-height utilities (e.g. min-h-[180px]) to generated import-* fallback classes."},{id:"fallback.import-style.grid-rows-arbitrary",pattern:"^grid-rows-\\[[^\\]]+\\]$",summary:"Converts arbitrary grid template row utilities (e.g. grid-rows-[1fr_auto]) to generated import-* fallback classes."},{id:"fallback.import-style.size-scale",pattern:"^size-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts size scale/arbitrary utilities into width+height fallback declarations."},{id:"fallback.import-style.width-height-scale",pattern:"^[wh]-(\\[[^\\]]+\\]|[0-9.]+)$",summary:"Converts width/height scale and arbitrary utilities to import-* classes."},{id:"fallback.import-style.spacing",pattern:"^-?(?:p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)-(.+)$",summary:"Converts spacing utilities to directional padding/margin fallback declarations, including responsive variants."},{id:"fallback.import-style.text-size",pattern:"^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$",summary:"Converts common text size utilities to import-* font-size declarations."},{id:"fallback.import-style.font-weight",pattern:"^font-(normal|medium|semibold|bold|extrabold|black)$",summary:"Converts common font weight utilities to import-* font-weight declarations."},{id:"fallback.import-style.leading-tracking",pattern:"^(leading|tracking)-(none|tight|snug|normal|relaxed|loose|tighter|wide|wider|widest)$",summary:"Converts line-height and letter-spacing utilities to import-* declarations for typography fidelity."},{id:"fallback.import-style.bg-tokenized",pattern:"^bg-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind background color utilities by mapping families like blue/purple/green/red to PDS semantic tokens."},{id:"fallback.import-style.bg-semantic",pattern:"^bg-(primary|secondary|accent)$",summary:"Safeguards semantic background utilities by mapping bg-primary/bg-secondary/bg-accent to PDS color tokens."},{id:"fallback.import-style.text-tokenized",pattern:"^text-([a-z]+)-(\\d{2,3})$",summary:"Safeguards Tailwind text color utilities by mapping common families to PDS semantic tokens."},{id:"fallback.import-style.rounded",pattern:"^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$",summary:"Safeguards rounded utilities (including rounded-t-sm) by mapping to PDS radius tokens."},{id:"fallback.import-style.overlay-alpha",pattern:"^bg-black\\/(\\d{1,3})$",summary:"Converts alpha black overlay classes (e.g. bg-black/50) to tokenized color-mix background overlays."},{id:"fallback.import-style.text-inverse",pattern:"^text-white$",summary:"Preserves white foreground intent for text-on-image use cases using inverse-compatible tokens."},{id:"fallback.import-style.bg-arbitrary",pattern:"^bg-\\[[^\\]]+\\]$",summary:"Converts arbitrary background colors to import-* fallback classes when values are CSS-safe."},{id:"fallback.import-style.text-arbitrary",pattern:"^text-\\[[^\\]]+\\]$",summary:"Converts arbitrary text colors to import-* fallback classes when values are CSS-safe."}]};Te();er();typeof f.initializing!="boolean"&&(f.initializing=!1);"currentPreset"in f||(f.currentPreset=null);typeof f.debug!="boolean"&&(f.debug=!1);"currentConfig"in f||(f.currentConfig=null);"compiled"in f||(f.compiled=null);typeof f.logHandler!="function"&&(f.logHandler=null);"mode"in f||(f.mode=null);var gt=null,mt=null,ft=null,ht=null,bt=null,yt=null,an="__pdsLocalizationRuntime";function Se(){if(yt)return yt;let e=f?.[an];return e&&typeof e=="object"?(yt=e,e):null}function ba(e){let t=e&&typeof e=="object"?e:null;yt=t,f[an]=t}Fr({getLogger:()=>typeof f.logHandler=="function"?f.logHandler:null,getContext:()=>{let e=f?.mode||f?.compiled?.mode||(f?.registry?.isLive?"live":"static"),t=(f?.debug||f?.currentConfig?.debug||f?.currentConfig?.design?.debug||f?.compiled?.debug||f?.compiled?.design?.debug||!1)===!0;return{mode:e,debug:t,thisArg:f}}});f.log=(e="log",t,...r)=>{Ye(e,t,...r)};var U={locale:"en",messages:{},hasProvider:!1},vt=new Set;function sn(e){return!!e&&typeof e!="string"&&typeof e=="object"&&"strTag"in e}function ln(e=[]){let t="";for(let r=0;r<=e.length-1;r+=1)t+=e[r],r<e.length-1&&(t+=`{${r}}`);return t}function ya(e,t){return String(e).replace(/\{(\d+)\}/g,(r,n)=>t(Number(n)))}function va(e){if(!e||typeof e!="object")return{};let t={};for(let[r,n]of Object.entries(e)){if(typeof n=="string"){t[r]=n;continue}n&&typeof n=="object"&&typeof n.content=="string"&&(t[r]=n.content)}return t}function xa(e,...t){return{strTag:!0,strings:Array.from(e||[]),values:t,raw:Array.from(e?.raw||[])}}function wa(e){if(!e)return"";if(sn(e)){let r=ln(e.strings||[]),n=U.messages[r]||r;return ya(n,o=>e.values?.[o])}let t=String(e);return U.messages[t]||t}function ka(e){if(!e)return;let t=sn(e)?ln(e.strings||[]):String(e);typeof t=="string"&&t.length>0&&vt.add(t)}function cn(e){if(!e||typeof e.msg!="function"||vt.size===0)return;let t=Array.from(vt);vt.clear();for(let r of t)try{e.msg(r)}catch{}}async function Oe(){let e=Se();return e||(bt||(bt=import(De("pds-localization.js")).then(r=>{if(typeof r?.msg!="function"||typeof r?.str!="function"||typeof r?.configureLocalization!="function"||typeof r?.loadLocale!="function"||typeof r?.setLocale!="function"||typeof r?.getLocalizationState!="function")throw new Error("Failed to load localization runtime exports");return ba(r),cn(r),r}).catch(r=>{throw bt=null,r})),bt)}var dn=(e,t={})=>{let r=Se();return typeof r?.msg=="function"?r.msg(e,t):(ka(e),wa(e,t))},pn=(e,...t)=>{let r=Se();return typeof r?.str=="function"?r.str(e,...t):xa(e,...t)},xt=(e=null)=>{let t=Se();if(typeof t?.configureLocalization=="function")return t.configureLocalization(e);if(!e||typeof e!="object")return U.locale="en",U.messages={},U.hasProvider=!1,{locale:U.locale,messages:{...U.messages},hasProvider:U.hasProvider};typeof e.locale=="string"&&e.locale.trim()&&(U.locale=e.locale.trim()),Object.prototype.hasOwnProperty.call(e,"messages")&&(U.messages=va(e.messages));let r=!!(e.provider||e.translate||e.loadLocale||e.setLocale);return U.hasProvider=r,r&&Oe().then(n=>{n.configureLocalization(e),cn(n)}).catch(()=>{}),{locale:U.locale,messages:{...U.messages},hasProvider:U.hasProvider}},un=async e=>(await Oe()).loadLocale(e),gn=async(e,t={})=>(await Oe()).setLocale(e,t),mn=()=>{let e=Se();return typeof e?.getLocalizationState=="function"?e.getLocalizationState():{locale:U.locale,messages:{...U.messages},hasProvider:U.hasProvider}},fn=(e={})=>{let t=Se();if(typeof t?.createJSONLocalization=="function")return t.createJSONLocalization(e);let r=typeof e?.locale=="string"&&e.locale.trim()?e.locale.trim().toLowerCase():"en",n=Array.isArray(e?.locales)?e.locales.map(p=>String(p||"").trim().toLowerCase()).filter(Boolean):[],o=Array.from(new Set([r,...n])),a=null,i=async()=>(a||(a=Oe().then(p=>typeof p?.createJSONLocalization=="function"?p.createJSONLocalization(e):null).catch(()=>null)),a),s=async(p="loadLocale")=>{let c=await i();if(!c||typeof c!="object")return null;let d=c.provider;if(!d||typeof d!="object")return null;let l=d[p];return typeof l=="function"?l:p==="setLocale"&&typeof d.loadLocale=="function"?d.loadLocale:null};return{locale:r,locales:[...o],provider:{locales:[...o],async loadLocale(p={}){let c=await s("loadLocale");return typeof c!="function"?{}:c(p)},async setLocale(p={}){let c=await s("setLocale");return typeof c!="function"?{}:c(p)}}}};function De(e,t){return t&&typeof t=="string"?t:`${we(f.currentConfig||{},{resolvePublicAssetURL:ye})}core/${e}`}async function Sa(){return Array.isArray(f.defaultEnhancers)&&f.defaultEnhancers.length>0?f.defaultEnhancers:(ht||(ht=import(De("pds-enhancers.js",f.currentConfig?.enhancersURL)).then(t=>{let r=Array.isArray(t?.defaultPDSEnhancers)?t.defaultPDSEnhancers:[];return f.defaultEnhancers=r,r}).catch(t=>{throw ht=null,t})),ht)}async function $a(){return typeof f.ask=="function"&&f.ask!==hn?f.ask:(mt||(mt=import(De("pds-ask.js",f.currentConfig?.askURL)).then(t=>{let r=t?.ask;if(typeof r!="function")throw new Error("Failed to load ask helper");return f.ask=r,r}).catch(t=>{throw mt=null,t})),mt)}async function We(){return typeof f.toast=="function"&&f.toast!==$e?f.toast:(ft||(ft=import(De("pds-toast.js",f.currentConfig?.toastURL)).then(t=>{let r=t?.toast;if(typeof r!="function")throw new Error("Failed to load toast helper");return f.toast=r,r}).catch(t=>{throw ft=null,t})),ft)}async function hn(...e){return(await $a())(...e)}async function $e(...e){return(await We())(...e)}$e.success=async(...e)=>(await We()).success(...e);$e.error=async(...e)=>(await We()).error(...e);$e.warning=async(...e)=>(await We()).warning(...e);$e.info=async(...e)=>(await We()).info(...e);var on=function(e="log",t,...r){f.log(e,t,...r)};function ar(e){if(e==null)return e;if(typeof e=="function")return;if(typeof e!="object")return e;if(Array.isArray(e))return e.map(r=>ar(r)).filter(r=>r!==void 0);let t={};for(let[r,n]of Object.entries(e)){let o=ar(n);o!==void 0&&(t[r]=o)}return t}function bn(e,t=new WeakSet){if(!e||typeof e!="object"||t.has(e))return e;t.add(e),Object.freeze(e);for(let r of Object.keys(e))bn(e[r],t);return e}function ir(e){return e==null||typeof e!="object"?e:bn(structuredClone(ar(e)))}async function za(e,t={}){if(t?.runtimeConfig===!1||typeof fetch!="function")return null;let r=t?.runtimeConfigURL||`${e}pds-runtime-config.json`;try{let n=await fetch(r,{cache:"no-store"});return n.ok?await n.json():null}catch{return null}}f.registry=be;f.enums=x;f.adoptLayers=Je;f.adoptPrimitives=Ke;f.parse=Qt;f.createStylesheet=Ar;f.isLiveMode=()=>be.isLive;f.ask=hn;f.toast=$e;f.common=st;f.msg=dn;f.str=pn;f.configureLocalization=xt;f.loadLocale=un;f.setLocale=gn;f.getLocalizationState=mn;f.createJSONLocalization=fn;f.i18n={msg:dn,str:pn,configure:xt,loadLocale:un,setLocale:gn,getState:mn,createJSONLocalization:fn};f.AutoComplete=null;f.loadAutoComplete=async()=>{if(f.AutoComplete&&typeof f.AutoComplete.connect=="function")return f.AutoComplete;let e=De("pds-autocomplete.js",f.currentConfig?.autoCompleteURL);return gt||(gt=import(e).then(t=>{let r=t?.AutoComplete||t?.default?.AutoComplete||t?.default||null;if(!r)throw new Error("AutoComplete export not found in module");return f.AutoComplete=r,r}).catch(t=>{throw gt=null,t})),gt};function yn(e){let t=typeof CustomEvent=="function";try{let r=t?new CustomEvent("pds:ready",{detail:e}):new Event("pds:ready");f.dispatchEvent(r)}catch{}if(typeof document<"u")if(t){let r={detail:e,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:ready",r))}catch{}try{document.dispatchEvent(new CustomEvent("pds-ready",r))}catch{}}else{try{document.dispatchEvent(new Event("pds:ready"))}catch{}try{document.dispatchEvent(new Event("pds-ready"))}catch{}}}function vn(e={}){let t=typeof CustomEvent=="function",r={at:Date.now(),...e};try{let n=t?new CustomEvent("pds:config-changed",{detail:r}):new Event("pds:config-changed");f.dispatchEvent(n)}catch{}if(typeof document<"u")if(t){let n={detail:r,bubbles:!0,composed:!0};try{document.dispatchEvent(new CustomEvent("pds:config-changed",n))}catch{}}else try{document.dispatchEvent(new Event("pds:config-changed"))}catch{}}var or="pure-ds-theme",ge=null,Be=null;function sr(e){try{if(typeof document>"u")return;let t="light";e?e==="system"?t=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":t=e:t=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",document.documentElement.setAttribute("data-theme",t)}catch{}}function lr(e){try{if(ge&&Be){try{typeof ge.removeEventListener=="function"?ge.removeEventListener("change",Be):typeof ge.removeListener=="function"&&ge.removeListener(Be)}catch{}ge=null,Be=null}if(e==="system"&&typeof window<"u"&&window.matchMedia){let t=window.matchMedia("(prefers-color-scheme: dark)"),r=n=>{let o=n?.matches===void 0?t.matches:n.matches;try{let a=o?"dark":"light";document.documentElement.setAttribute("data-theme",a),f.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:a,source:"system"}}))}catch{}};ge=t,Be=r,typeof t.addEventListener=="function"?t.addEventListener("change",r):typeof t.addListener=="function"&&t.addListener(r)}}catch{}}var Ca=Object.getOwnPropertyDescriptor(f,"theme");Ca||Object.defineProperty(f,"theme",{get(){try{return typeof window>"u"?null:localStorage.getItem(or)||null}catch{return null}},set(e){try{if(typeof window>"u")return;let t=f.currentConfig?.design||null,r=ke(e);if(t&&!ue(t,r)){let n=t?.name||f.currentPreset?.name||f.currentConfig?.preset||"current preset";f.log("warn",`PDS theme "${r}" not supported by preset "${n}".`),f.dispatchEvent(new CustomEvent("pds:theme:blocked",{detail:{theme:e,resolvedTheme:r,preset:n}}));return}e==null?localStorage.removeItem(or):localStorage.setItem(or,e),sr(e),lr(e),f.dispatchEvent(new CustomEvent("pds:theme:changed",{detail:{theme:e,source:"api"}}))}catch{}}});f.defaultEnhancers=[];async function La(e){f.initializing=!0;try{let t=e&&e.mode||"live",{mode:r,...n}=e||{};f.mode=t,f.logHandler=typeof n?.log=="function"?n.log:null,f.currentConfig=ir(n);let o=n&&typeof n.localization=="object"&&n.localization?n.localization:null;o?(await Oe(),xt(o)):xt(null);let a;if(t==="static")a=await Ma(n);else{let s=we(n,{resolvePublicAssetURL:ye}),p=n?.managerURL||n?.public?.managerURL||n?.manager?.url||new URL("core/pds-manager.js",s).href||new URL("./pds-manager.js",import.meta.url).href,{startLive:c}=await import(p);a=await c(f,n,{emitReady:yn,emitConfigChanged:vn,applyResolvedTheme:sr,setupSystemListenerIfNeeded:lr})}f.compiled=ir(a?.config||null);let i=f?.compiled?.design?.icons?.externalPath||"/assets/img/icons/";return f.log("info",`startup ready; external icon path: ${i}`),a}finally{f.initializing=!1}}f.start=La;async function Ma(e){if(!e||typeof e!="object")throw new Error("PDS.start({ mode: 'static', ... }) requires a valid configuration object");let t=e.applyGlobalStyles??!0,r=e.manageTheme??!0,n=e.themeStorageKey??"pure-ds-theme",o=e.staticPaths??{},a=we(e,{resolvePublicAssetURL:ye}),i=e&&e.autoDefine||null,s;i&&i.baseURL?s=ve(xe(i.baseURL,{preferModule:!1})):s=`${a}components/`;let p=i&&Array.isArray(i.predefine)&&i.predefine||[],c=i&&typeof i.mapper=="function"&&i.mapper||null;try{nt(f);let{resolvedTheme:d}=ot({manageTheme:r,themeStorageKey:n,applyResolvedTheme:sr,setupSystemListenerIfNeeded:lr}),l=await za(a,e),u=Array.isArray(e?.enhancers)?e.enhancers:e?.enhancers&&typeof e.enhancers=="object"?Object.values(e.enhancers):[],g=l?.config?{...l.config,...e,design:e?.design||l.config.design,preset:e?.preset||l.config.preset}:{...e},m={tokens:`${a}styles/pds-tokens.css.js`,primitives:`${a}styles/pds-primitives.css.js`,components:`${a}styles/pds-components.css.js`,utilities:`${a}styles/pds-utilities.css.js`,styles:`${a}styles/pds-styles.css.js`},v=l?.paths||{};if(o={...m,...v,...o},f.registry.setStaticMode(o),t&&typeof document<"u")try{let k=await f.registry.getStylesheet("styles");if(k){k._pds=!0;let w=(document.adoptedStyleSheets||[]).filter($=>$._pds!==!0);document.adoptedStyleSheets=[...w,k],vn({mode:"static",source:"static:styles-applied"})}}catch(k){on.call(f,"warn","Failed to apply static styles:",k)}let h=null,b=[];try{let k=await Sa(),w=await at({autoDefineBaseURL:s,autoDefinePreload:p,autoDefineMapper:c,enhancers:u,autoDefineOverrides:i||null,autoDefinePreferModule:!(i&&i.baseURL)},{baseEnhancers:k});h=w.autoDefiner,b=w.mergedEnhancers||[]}catch(k){on.call(f,"error","\u274C Failed to initialize AutoDefiner/Enhancers (static):",k)}return f.compiled=ir({mode:"static",...g,theme:d,enhancers:b}),yn({mode:"static",config:g,theme:d,autoDefiner:h}),{config:g,theme:d,autoDefiner:h}}catch(d){throw f.dispatchEvent(new CustomEvent("pds:error",{detail:{error:d}})),d}}var Ea="src/js/pds-live-manager/tailwind-conversion-rules.json",St=["base","sm","md","lg","xl","2xl"];function Ta(e={}){let t=Array.isArray(e.ignoredPatterns)?e.ignoredPatterns.map(n=>({...n,pattern:n?.pattern instanceof RegExp?n.pattern:new RegExp(String(n?.pattern||""))})):[],r=Array.isArray(e.nonPdsClassPatterns)?e.nonPdsClassPatterns.map(n=>n instanceof RegExp?n:new RegExp(String(n||""))):[];return{...e,ignoredPatterns:t,nonPdsClassPatterns:r}}var G=Ta(nn),xn=G.version||"tw2pds-layout-v4",Aa=new Map(G.directMappings.map(e=>[e.tw,e])),cr=new Map(Object.entries(G.gapScaleMap||{})),wn=new Map(Object.entries(G.maxWidthMap||{})),Ra=G.nonPdsClassPatterns||[],_a=new Set(G.neverFallbackTags||[]),Fa={...G.importStyleRules||{}},Pa=G.tailwindSizeScale||{},dr=Array.isArray(G.tailwindShadeScale)?G.tailwindShadeScale.map(e=>String(e)).filter(Boolean):["50","100","200","300","400","500","600","700","800","900"],kn=dr.includes(String(G.defaultTailwindShade||""))?String(G.defaultTailwindShade):"500",kt=1.2,Na=["container","grid","flex","gap","space","items","justify","content","place","self","col","row","w","h","min","max","p","m","rounded","border","ring","outline","shadow","bg","text","font","leading","tracking","uppercase","lowercase","capitalize","overflow","whitespace","truncate","object","aspect","opacity","blur","backdrop","transition","duration","ease","delay","animate","hidden","block","inline","absolute","relative","fixed","sticky","size"];function Sn(e="",t=""){if(!e||!t)return e;let r=new RegExp(`\\s${t}\\s*=\\s*("[^"]*"|'[^']*'|[^\\s>]+)`,"gi");return String(e).replace(r,"")}function Ia(e="",t=null){let r=String(e||""),n=0;return r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(input)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*?)>/gi,(o,a,i,s,p,c,d,l,u,g,m)=>{if(s!==g)return o;let v=Sn(`${a||""}${p||""}`,"for"),h=`<${d}${l||""} id="${g}"${m||""}>`;return n+=1,`<label${v}>${c}${h}</label>`}),r=r.replace(/<label([^>]*?)\sfor\s*=\s*(["'])([^"']+)\2([^>]*)>([\s\S]*?)<\/label>\s*<(select|textarea)([^>]*?)\sid\s*=\s*(["'])([^"']+)\8([^>]*)>([\s\S]*?)<\/\6>/gi,(o,a,i,s,p,c,d,l,u,g,m,v)=>{if(s!==g)return o;let h=Sn(`${a||""}${p||""}`,"for"),b=`<${d}${l||""} id="${g}"${m||""}>${v}</${d}>`;return n+=1,`<label${h}>${c}${b}</label>`}),t&&n>0&&(t.labelNestingCount+=n,j(t,`Nested ${n} label/control pairs.`),R(t,"intent.form.nested-label")),r}function ja(e="",t="base"){let r=String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rule";return`import-${t&&t!=="base"?`${t}-`:""}${r}`}function me(e,t,r,n="base",o=""){if(!e||!t||!r)return"";let a=ja(t,n);if(o){let i=`${n}|${o}`;e.importPseudoStyles.has(i)||e.importPseudoStyles.set(i,new Map),e.importPseudoStyles.get(i).set(a,r)}else n==="base"?e.importBaseStyles.set(a,r):(e.importResponsiveStyles.has(n)||e.importResponsiveStyles.set(n,new Map),e.importResponsiveStyles.get(n).set(a,r));return e.importedStyleCount+=1,a}function Ce(e=""){return String(e||"").trim().replace(/_/g," ")}function Le(e=""){return!e||/[;{}]/.test(e)?!1:/^[-#(),.%/\sa-zA-Z0-9]+$/.test(e)}function He(e=""){let t=String(e||"").trim();if(!t)return null;let r=t.match(/^\[([^\]]+)\]$/);if(r){let n=Ce(r[1]);return Le(n)?n:null}return Pa[t]||null}function Ba(e=""){let t=Number(e);if(!Number.isFinite(t))return kn;let r=String(t);return dr.includes(r)?r:dr.reduce((n,o)=>{let a=Math.abs(Number(n)-t);return Math.abs(Number(o)-t)<a?o:n},kn)}function qe(e="",t="500"){let r=String(e||"").toLowerCase(),n=Ba(t);return["blue","sky","indigo","cyan"].includes(r)?`var(--color-primary-${n})`:["purple","violet","fuchsia"].includes(r)?`var(--color-accent-${n})`:["green","emerald","lime","teal"].includes(r)?`var(--color-success-${n})`:["yellow","amber","warning"].includes(r)?`var(--color-warning-${n})`:["red","rose","pink","orange"].includes(r)?`var(--color-danger-${n})`:["slate","gray","zinc","neutral","stone"].includes(r)?`var(--color-gray-${n})`:""}function $n(e=""){let t=Ce(e);return Le(t)&&(/^#(?:[0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(t)||/^(?:rgb|hsl)a?\([^)]*\)$/.test(t))?t:""}function oe(e=""){return String(e||"").split(/\s+/).map(t=>t.trim()).filter(Boolean)}function Oa(e="",t=""){if(!t)return e;let r=String(e||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return`${r} class="${t}"`;let o=n[1]||'"',a=oe(n[2]);a.includes(t)||a.push(t);let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function Da(e="",t=""){return t?new RegExp(`\\s${t}\\s*=`,"i").test(String(e||"")):!1}function Wa(e=""){let t=String(e||"").replace(/[-_]+/g," ").trim();return t?t.replace(/(^|\s)([a-z])/g,(r,n,o)=>`${n}${o.toUpperCase()}`):"Icon button"}function Ha(e="",t=null){let r=String(e||"");return r&&r.replace(/<(button|a)([^>]*)>\s*(<pds-icon\b[^>]*><\/pds-icon>)\s*<\/\1>/gi,(n,o,a,i)=>{let s=Oa(a,"icon-only");if(!Da(s,"aria-label")){let p=String(i).match(/\sicon\s*=\s*(["'])(.*?)\1/i),c=p?String(p[2]||""):"",d=Wa(c);s+=` aria-label="${d}"`}return t&&(t.intentHits+=1,R(t,"intent.component.button.icon-only-markup")),`<${o}${s}>${i}</${o}>`})}function Ua(e="",t=null){let r=String(e||"");if(!r)return r;let n=0,o=r.replace(/<p([^>]*?)>([\s\S]*?)<\/p>/gi,(a,i,s)=>{let p=String(i||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!p)return a;let c=oe(p[2]||""),d=c.some(u=>/^import-text-/.test(String(u||""))),l=c.includes("text-muted")||c.some(u=>/^import-font-/.test(String(u||"")));return!d||!l?a:(n+=1,`<div${i}>${s}</div>`)});return t&&n>0&&(t.intentHits+=1,R(t,"intent.typography.metric-paragraph-to-div"),j(t,`Normalized ${n} metric text paragraph tag(s) to div.`)),o}function An(e="",t=""){if(!t)return e;let r=String(e||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=oe(n[2]).filter(s=>s!==t);if(a.length===0)return r.replace(n[0],"");let i=` class=${o}${a.join(" ")}${o}`;return r.replace(n[0],i)}function qa(e="",t=r=>r){let r=String(e||""),n=r.match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!n)return r;let o=n[1]||'"',a=oe(n[2]),i=t(Array.from(a)),s=Array.isArray(i)?i.filter(Boolean):a;if(s.length===0)return r.replace(n[0],"");let p=` class=${o}${s.join(" ")}${o}`;return r.replace(n[0],p)}function Ga(e="",t=null){let r=String(e||"");if(!r)return r;let n=0,o=r.replace(/<(div|section|article|aside)([^>]*)>\s*<(p|div)([^>]*)>[\s\S]*?<\/\3>\s*<(p|div)([^>]*)>[\s\S]*?<\/\5>\s*<\/\1>/gi,(a,i,s,p,c,d,l)=>{let u=String(s||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!u||!oe(u[2]).includes("stack-sm"))return a;let m=String(c||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i),v=String(l||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!m||!v)return a;let h=oe(m[2]),b=oe(v[2]);if(!(h.some($=>/^import-text-/.test(String($||"")))&&b.some($=>/^import-text-/.test(String($||"")))))return a;let w=An(s,"stack-sm");return n+=1,a.replace(`<${i}${s}>`,`<${i}${w}>`)});return t&&n>0&&(t.intentHits+=1,R(t,"intent.typography.metric-pair-no-stack"),j(t,`Removed stack-sm from ${n} metric text pair container(s).`)),o}function Va(e={}){if(!e||typeof e!="object")return{};let t=e.typography;if(t&&typeof t=="object")return t;let r=e.design?.typography;return r&&typeof r=="object"?r:{}}function Ka(e={}){let t=Va(e),r=Number(t.fontScale);return Number.isFinite(r)?Math.max(1,Math.min(2,r)):kt}function Ja(e="",t=kt){let n={"4xl":1,"3xl":2,"2xl":3,xl:4}[e];if(!n)return"";let o=Number.isFinite(Number(t))?Math.max(1,Math.min(2,Number(t))):kt,a=Math.max(-1,Math.min(1,Math.round((o-kt)/.25))),i=n-a;return i<1?"h1":i>4?"":`h${i}`}function Ya(e="",t=null,r={}){let n=String(e||"");if(!n)return n;let o=Ka(r.config||{}),a=0,i=0,s=n.replace(/<(p|div|span)([^>]*)>([\s\S]*?)<\/\1>/gi,(p,c,d,l)=>{let u=String(d||"").match(/\sclass\s*=\s*(["'])(.*?)\1/i);if(!u)return p;let g=oe(u[2]);if(!g.includes("import-font-bold"))return p;let v=g.find($=>/^import-text-(?:4xl|3xl|2xl|xl)$/.test(String($||"")))||"",h=v.match(/^import-text-(4xl|3xl|2xl|xl)$/);if(h){let $=Ja(h[1],o);if(!$)return p;let T=qa(d,A=>A.filter(_=>_!=="import-font-bold"&&_!==v));return a+=1,`<${$}${T}>${l}</${$}>`}let b=/<\/?(?:div|p|section|article|aside|main|header|footer|ul|ol|li|table|tr|td|th|h[1-6])\b/i.test(l),k=/<\/?(?:strong|b)\b/i.test(l);if(b||k)return p;let w=An(d,"import-font-bold");return i+=1,`<${c}${w}><strong>${l}</strong></${c}>`});return t&&(a>0&&(t.intentHits+=1,R(t,"intent.typography.semantic-heading-from-scale"),j(t,`Converted ${a} bold display text node(s) to semantic heading tags (fontScale=${Number(o).toFixed(2)}).`)),i>0&&(t.intentHits+=1,R(t,"intent.typography.bold-to-strong"),j(t,`Wrapped ${i} bold text node(s) in strong tags.`))),s}function Xa(e=[]){if(!Array.isArray(e)||e.length===0)return"";let t=e.filter(n=>!St.includes(n));if(t.length===0||t.length>1)return"";let r=t[0];return["hover","focus","active"].includes(r)?r:""}function zn(e,t="base",r=[]){let n=Xa(r),o=Fa[e];if(o)return{declaration:o,breakpoint:t,pseudo:n,ruleId:"fallback.import-style"};let a=String(e).match(/^gap-(\d+)$/);if(a){let y={0:"var(--spacing-0)",1:"var(--spacing-1)",2:"var(--spacing-2)",3:"var(--spacing-3)",4:"var(--spacing-4)",5:"var(--spacing-5)",6:"var(--spacing-6)",7:"var(--spacing-7)",8:"var(--spacing-8)",10:"var(--spacing-10)",12:"var(--spacing-12)"},S=Number(a[1]);if(y[S])return{declaration:`gap:${y[S]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.gap-scale"}}let i=String(e).match(/^(mt|mb|my)-(.+)$/);if(i){let y=i[1],S=i[2],M=He(S);if(M){let E="";return y==="mt"?E=`margin-top:${M}`:y==="mb"?E=`margin-bottom:${M}`:E=`margin-top:${M};margin-bottom:${M}`,{declaration:E,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.margin-scale"}}}let s=String(e).match(/^min-w-\[([^\]]+)\]$/);if(s){let y=Ce(s[1]);if(Le(y))return{declaration:`min-width:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.min-width-arbitrary"}}let p=String(e).match(/^max-w-\[([^\]]+)\]$/);if(p){let y=Ce(p[1]);if(Le(y))return{declaration:`max-width:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.max-width-arbitrary"}}let c=String(e).match(/^min-h-\[([^\]]+)\]$/);if(c){let y=Ce(c[1]);if(Le(y))return{declaration:`min-height:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.min-height-arbitrary"}}let d=String(e).match(/^grid-rows-\[([^\]]+)\]$/);if(d){let y=Ce(d[1]);if(Le(y))return{declaration:`grid-template-rows:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.grid-rows-arbitrary"}}let l=String(e).match(/^size-(.+)$/);if(l){let y=He(l[1]);if(y)return{declaration:`width:${y};height:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.size-scale"}}let u=String(e).match(/^w-(.+)$/);if(u){let y=He(u[1]);if(y)return{declaration:`width:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.width-scale"}}let g=String(e).match(/^h-(.+)$/);if(g){let y=He(g[1]);if(y)return{declaration:`height:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.height-scale"}}let m={xs:"var(--font-size-xs)",sm:"var(--font-size-sm)",base:"var(--font-size-md)",lg:"var(--font-size-lg)",xl:"var(--font-size-xl)","2xl":"var(--font-size-2xl)","3xl":"var(--font-size-3xl)","4xl":"var(--font-size-4xl)"},v=String(e).match(/^text-(xs|sm|base|lg|xl|2xl|3xl|4xl)$/);if(v)return{declaration:`font-size:${m[v[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-size"};let h={normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},b=String(e).match(/^font-(normal|medium|semibold|bold|extrabold|black)$/);if(b)return{declaration:`font-weight:${h[b[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.font-weight"};let k={none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"},w=String(e).match(/^leading-(none|tight|snug|normal|relaxed|loose)$/);if(w)return{declaration:`line-height:${k[w[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.line-height"};let $={tighter:"-0.05em",tight:"-0.025em",normal:"0em",wide:"0.025em",wider:"0.05em",widest:"0.1em"},T=String(e).match(/^tracking-(tighter|tight|normal|wide|wider|widest)$/);if(T)return{declaration:`letter-spacing:${$[T[1]]}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.tracking"};let A=String(e).match(/^bg-black\/(\d{1,3})$/);if(A)return{declaration:`background-color:color-mix(in srgb, var(--color-gray-900) ${Math.max(0,Math.min(100,Number(A[1])))}%, transparent)`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.overlay-alpha"};if(e==="text-white")return{declaration:"color:var(--color-gray-50)",breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-inverse"};let _=String(e).match(/^bg-(primary|secondary|accent)$/);if(_){let S={primary:"var(--color-primary-fill)",secondary:"var(--color-gray-500)",accent:"var(--color-accent-500)"}[_[1]];if(S)return{declaration:`background-color:${S}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.bg-semantic"}}let I=String(e).match(/^bg-([a-z]+)-(\d{2,3})$/);if(I){let y=qe(I[1],I[2]);if(y)return{declaration:`background-color:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.bg-tokenized"}}let z=String(e).match(/^bg-\[([^\]]+)\]$/);if(z){let y=$n(z[1]);if(y)return{declaration:`background-color:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.bg-arbitrary"}}let L=String(e).match(/^text-([a-z]+)-(\d{2,3})$/);if(L){let y=qe(L[1],L[2]);if(y)return{declaration:`color:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-tokenized"}}let P=String(e).match(/^text-\[([^\]]+)\]$/);if(P){let y=$n(P[1]);if(y)return{declaration:`color:${y}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.text-arbitrary"}}let C=String(e).match(/^rounded(?:-([trbl]{1,2}))?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(C){let y=C[1]||"",S=C[2]||"sm",M=S==="none"?"0":`var(--radius-${S})`,E={t:["top-left","top-right"],b:["bottom-left","bottom-right"],l:["top-left","bottom-left"],r:["top-right","bottom-right"],tl:["top-left"],tr:["top-right"],bl:["bottom-left"],br:["bottom-right"]};if(!y)return{declaration:`border-radius:${M}`,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.rounded"};let O=(E[y]||[]).map(K=>`border-${K}-radius:${M}`).join(";");if(O)return{declaration:O,breakpoint:t,pseudo:n,ruleId:"fallback.import-style.rounded"}}return null}function wt(e,t){return typeof e=="number"&&Number.isFinite(e)?`${e}px`:typeof e=="string"&&e.trim()?e.trim():`${t}px`}function Za(e={}){let r=(e?.design&&typeof e.design=="object"?e.design:e)?.layout?.breakpoints||{};return{sm:wt(r.sm,640),md:wt(r.md,768),lg:wt(r.lg,1024),xl:wt(r.xl,1280)}}function Qa(e,t){let r=Array.from(e.importBaseStyles.entries()).map(([a,i])=>`.${a}{${i};}`),n=[];for(let[a,i]of e.importResponsiveStyles.entries()){let s=t?.[a];if(!s||!i?.size)continue;let p=Array.from(i.entries()).map(([c,d])=>`.${c}{${d};}`).join(`
...
`):""}function ei(e="",t=""){if(!t||!t.trim())return e;let r=`<style data-pds-import="tailwind-fallback">
${t}
</style>`;return/<head[^>]*>/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>
${r}`):`${r}
${e}`}function Cn(e=""){if(!e)return!1;if(e.includes(":")||e.includes("["))return!0;let t=e.split("-")[0];return Na.includes(t)}function ae(e=""){let t=String(e).split(":");if(t.length===1)return{breakpoint:"base",base:t[0],variants:[]};let r=t[t.length-1],n=t.slice(0,-1);return{breakpoint:n.find(a=>St.includes(a))||"base",base:r,variants:n}}function ti(){return{totalTailwind:0,mapped:0,ignored:0,policySkipped:0,unknown:0,intentHits:0,unknownTokens:new Map,notes:[],appliedRules:new Set,importBaseStyles:new Map,importResponsiveStyles:new Map,importPseudoStyles:new Map,importedStyleCount:0,labelNestingCount:0,removedAtomicSpacingCount:0,removedAtomicPositioningCount:0}}function ri(e=""){let t=String(e||"").toLowerCase().replace(/\s+/g,""),r=t.includes("menu,ol,ul{list-style:none")||t.includes("ol,ul,menu{list-style:none")||t.includes("ul,ol,menu{list-style:none"),n=t.includes("a{color:inherit;text-decoration:inherit");return{listReset:r,anchorReset:n}}function ni(e=""){return String(e||"").toLowerCase().includes("cdn.tailwindcss.com")?{listReset:!0,anchorReset:!0}:{listReset:!1,anchorReset:!1}}function oi(e="",t=null){let r=String(e||""),n={listReset:!1,anchorReset:!1,strippedRuntimeCssBlocks:0,strippedRuntimeScripts:0};return r=r.replace(/<style([^>]*)>([\s\S]*?)<\/style>/gi,(o,a,i)=>{let s=String(i||"");if(!(/tailwindcss\s+v\d/i.test(s)||/\*\s*!\s*tailwindcss/i.test(s)))return o;let c=ri(s);return n.listReset=n.listReset||c.listReset,n.anchorReset=n.anchorReset||c.anchorReset,n.strippedRuntimeCssBlocks+=1,""}),r=r.replace(/<script([^>]*?)src\s*=\s*(?:(['"])([^"']*cdn\.tailwindcss\.com[^"']*)\2|([^\s>]*cdn\.tailwindcss\.com[^\s>]*))([^>]*)><\/script>/gi,(o,a,i,s,p)=>{let d=ni(s||p||"");return n.listReset=n.listReset||d.listReset,n.anchorReset=n.anchorReset||d.anchorReset,n.strippedRuntimeScripts+=1,""}),t&&(n.strippedRuntimeCssBlocks>0||n.strippedRuntimeScripts>0)&&(R(t,"intent.preflight.tailwind-runtime-detected"),n.strippedRuntimeCssBlocks>0&&j(t,`Detected and stripped ${n.strippedRuntimeCssBlocks} Tailwind runtime style block(s).`)),t&&n.strippedRuntimeScripts>0&&j(t,`Removed ${n.strippedRuntimeScripts} Tailwind CDN script reference(s).`),{html:r,hints:n}}function j(e,t){!e||!t||e.notes.includes(t)||e.notes.push(t)}function ai(e,t){let r=e.unknownTokens.get(t)||0;e.unknownTokens.set(t,r+1)}function ii(e={}){let r=(e?.design&&typeof e.design=="object"?e.design:e)?.layout?.utilities||{};return{grid:r.grid!==!1,flex:r.flex!==!1,spacing:r.spacing!==!1,container:r.container!==!1}}function J(e,t){return t?e?.[t]!==!1:!0}function Ln(e){let t=String(e).match(/^grid-cols-(\d+)$/);return t?Number(t[1]):null}function Mn(e={}){let t=St.map(o=>({bp:o,cols:e[o]})).filter(o=>Number.isFinite(o.cols));if(t.length<2)return null;if(t.length===2){let[o,a]=t;if(o.bp==="base"&&o.cols===1&&a.cols===2)return"grid-auto-lg";if(o.bp==="base"&&o.cols===1&&a.cols>=3)return null;if(o.cols<a.cols){if(a.cols>=4)return"grid-auto-md";if(a.cols>=2)return"grid-auto-lg"}return null}let r=!0;for(let o=1;o<t.length;o+=1)if(t[o].cols<=t[o-1].cols){r=!1;break}if(!r)return null;let n=t[t.length-1]?.cols||0;return n>=4?"grid-auto-md":n>=3?"grid-auto-sm":null}function si(e=""){let t=String(e).match(/^text-(gray|slate|zinc|neutral|stone)-(\d{2,3})$/);if(!t)return"";let r=Number(t[2]);return Number.isFinite(r)&&r>=400&&r<=600?"text-muted":""}function li(e="",t=0){return!e||!Number.isFinite(t)?"":{sm:{2:"sm:grid-cols-2"},md:{3:"md:grid-cols-3"},lg:{4:"lg:grid-cols-4"}}?.[e]?.[t]||""}function ci(e=""){let t=ae(e),n=String(t?.base||"").match(/^space-y-(\d+)$/);if(!n)return"stack-md";let o=Number(n[1]);return Number.isFinite(o)?o<=1?"stack-xs":o<=2?"stack-sm":o<=4?"stack-md":"stack-lg":"stack-md"}function di(e=new Set){return Array.from(e).some(t=>{let r=String(t||"");return/^gap-(?:xs|sm|md|lg|xl)$/.test(r)||/^gap-[0-9]+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?gap-/.test(r)})}function pi(e=new Set){return Array.from(e).some(t=>/^stack-(?:xs|sm|md|lg|xl)$/.test(String(t||"")))}function ui(e=new Set){return Array.from(e).some(t=>{let r=String(t||"");return/^grid-cols-\d+$/.test(r)||/^grid-auto-(?:sm|md|lg|xl)$/.test(r)||/^(?:sm|md|lg|xl):grid-cols-\d+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?grid-cols-\d+$/.test(r)})}function gi(e,t=12){return Array.from(e.unknownTokens.entries()).sort((r,n)=>n[1]-r[1]).slice(0,t).map(([r])=>r)}function R(e,t){!e||!t||e.appliedRules.add(t)}function se(e=[],t){return!Array.isArray(e)||!t?!1:e.some(r=>t.test(String(r)))}function mi(e=[]){for(let t of e){let r=ae(t);if(r.breakpoint!=="base")continue;let n=String(r.base).match(/^h-(.+)$/);if(!n)continue;let o=He(n[1]);if(!o||o==="auto")continue;let a=String(o).match(/^(-?\d+(?:\.\d+)?)rem$/);if(a){let i=Number(a[1]);if(Number.isFinite(i))return i*16}}return null}function fi(e=[],t=""){let r=t==="button",n=se(e,/^bg-/),o=se(e,/^hover:bg-/),a=se(e,/^border/),i=se(e,/^shadow/),s=e.includes("cursor-pointer"),p=se(e,/^rounded/),c=se(e,/^(?:min-w|max-w|w)-/),d=se(e,/^text-(?:white|black|\[[^\]]+\]|[a-z]+-\d{2,3})$/),l=n||o||i;if(!(r||t==="a"&&(l||a||s||p&&c)))return{shouldNormalize:!1,variant:"none",size:"base",iconOnly:!1};let m="none";a&&!n&&!o?m="outline":(l||n&&d)&&(m="primary");let v=e.includes("rounded-full")&&(e.includes("p-2")||e.includes("p-1")||e.includes("p-2.5")),h=se(e,/^size-(?:6|7|8|9|10|11|12)$/),b=v||h,k=mi(e),w=e.includes("text-sm")||e.includes("text-xs"),$=e.includes("text-lg")||e.includes("text-xl"),T="base";return k&&k<=40||w?T="sm":(k&&k>=48||$)&&(T="lg"),{shouldNormalize:!0,variant:m,size:T,iconOnly:b}}function hi(e=""){let t=String(e||"").toLowerCase();return["green","emerald","lime","teal"].includes(t)?"badge-success":["blue","sky","cyan","indigo"].includes(t)?"badge-info":["yellow","amber","orange"].includes(t)?"badge-warning":["red","rose","pink"].includes(t)?"badge-danger":["gray","slate","zinc","neutral","stone"].includes(t)?"badge-secondary":["purple","violet","fuchsia","primary","accent"].includes(t)?"badge-primary":"badge-secondary"}function bi(e=[],t="",r={shouldNormalize:!1}){if(r?.shouldNormalize)return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(["button","a","input","select","textarea"].includes(t))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(e.some(L=>/^badge(?:-|$)/.test(String(L))))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let n=e.map(L=>ae(L)).filter(L=>L.breakpoint==="base").map(L=>String(L.base)),o=n.some(L=>/^rounded(?:-|$)/.test(L)),a=n.some(L=>/^px-/.test(L)),i=n.some(L=>/^py-/.test(L)),s=a&&i,p=n.includes("text-xs")||n.includes("text-sm"),c=n.includes("text-lg")||n.includes("text-xl"),d=n.map(L=>L.match(/^bg-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),l=n.map(L=>L.match(/^text-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),u=n.map(L=>L.match(/^border-([a-z]+)-(\d{2,3})$/)).find(Boolean),g=Number(d?.[2]),m=Number(l?.[2]),v=!!(d&&Number.isFinite(g)&&g<=300),h=n.some(L=>/^border(?:-|$)/.test(L)),b=!!(d||l||u),k=[o,s,p,v||h].filter(Boolean).length;if(!(b&&k>=3))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let $=d&&d[1]||l&&l[1]||u&&u[1]||"",T=hi($),A=h&&!v,_=p?"badge-sm":c?"badge-lg":"",I=v?{family:$,bgShade:Number.isFinite(g)?g:200,textShade:Number.isFinite(m)?m:700}:null;return{shouldNormalize:!0,variantClass:I?"":T,outline:A,sizeClass:_,pastel:I}}function yi(e="",t=0){let r=String(e||"").toLowerCase(),n=Number(t);return r==="white"?"surface-base":["gray","slate","zinc","neutral","stone"].includes(r)?Number.isFinite(n)&&n<=100?"surface-base":"surface-subtle":["blue","sky","cyan","indigo","primary","info"].includes(r)?"surface-info":["purple","violet","fuchsia","accent"].includes(r)?"surface-primary":["green","emerald","lime","teal","success"].includes(r)?"surface-success":["yellow","amber","orange","warning"].includes(r)?"surface-warning":["red","rose","pink","danger"].includes(r)?"surface-danger":"surface-base"}function vi(e=[],t="",r={shouldNormalize:!1},n={shouldNormalize:!1}){if(r?.shouldNormalize||n?.shouldNormalize)return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(!new Set(["div","section","article","aside","li"]).has(t))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(e.some(h=>/^card(?:-|$)/.test(String(h))))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let a=e.map(h=>ae(h)).filter(h=>h.breakpoint==="base").map(h=>String(h.base)),i=a.some(h=>/^rounded(?:-|$)/.test(h)),s=a.some(h=>/^border(?:$|-)/.test(h)),p=a.some(h=>/^shadow(?:$|-)/.test(h)),c=a.some(h=>/^(?:p|px|py|pt|pb|pl|pr)-/.test(h)),d=a.map(h=>h.match(/^bg-([a-z]+)-?(\d{2,3})?$/)).find(Boolean),l=a.includes("bg-white")||!!d;if(!([i,s||p,l,c].filter(Boolean).length>=3))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let m="card-basic";p?m="card-elevated":s&&(m="card-outlined");let v="";return p?v="surface-elevated":d?v=yi(d[1],d[2]):l&&(v="surface-base"),{shouldNormalize:!0,cardVariantClass:m,surfaceClass:v}}function xi({tagName:e,originalClassValue:t,policy:r,summary:n,preflightHints:o={}}){if(_a.has(e))return R(n,"table.strict-tags.no-classes"),"";let a=String(t).split(/\s+/).filter(Boolean),i=fi(a,e),s=bi(a,e,i),p=vi(a,e,i,s),c=/^h[1-6]$/.test(e),d=["i","svg"].includes(e)||a.some(C=>/^fa(?:[a-z-]+)?$/i.test(String(C||""))||/^fa-/.test(String(C||""))),l=new Set,u={},g={},m=!1,v="",h="",b=!1,k="";a.forEach(C=>{let y=ae(C),S=y.base;if(Ra.some(N=>N.test(S))){n.ignored+=1,R(n,"cleanup.non-pds-class");return}let M=Cn(C)||Cn(S);if(M&&(n.totalTailwind+=1),/^space-y-/.test(S)){m=!0,v=v||C,h=h||ci(C),n.ignored+=1,R(n,"layout.spacing.space-y-to-stack");return}if(/^space-x-/.test(S)){let N=String(S).match(/^space-x-(\d+)$/);if(N){let D=`gap-${N[1]}`,Y=cr.get(D);if(Y&&J(r,"spacing")){l.add(Y),b=!0,k=k||C,n.mapped+=1,n.intentHits+=1,R(n,"layout.spacing.space-x-to-gap");return}}n.ignored+=1,R(n,"style.spacing.atomic");return}if(/^grid-cols-\d+$/.test(S)&&y.breakpoint!=="base"){let N=Ln(S);if(Number.isFinite(N)&&J(r,"grid")){u[y.breakpoint]=N,n.mapped+=1,R(n,"intent.layout.responsive-grid-to-auto");return}if(!J(r,"grid")){n.policySkipped+=1,j(n,"Skipped responsive grid mapping because layout.utilities.grid=false.");return}}if(/^flex-(?:row|col)$/.test(S)&&y.breakpoint!=="base"){if(J(r,"flex")){g[y.breakpoint]=S,n.mapped+=1,R(n,"intent.layout.mobile-stack");return}n.policySkipped+=1,j(n,"Skipped responsive flex mapping because layout.utilities.flex=false.");return}if(/^grid-cols-\d+$/.test(S)&&y.breakpoint==="base"){let N=Ln(S);Number.isFinite(N)&&J(r,"grid")&&(u.base=N)}let E=Aa.get(S);if(E&&y.breakpoint==="base"){if(!J(r,E.gate)){n.policySkipped+=1,j(n,`Skipped ${S} because layout.utilities.${E.gate}=false.`);return}E.pds.forEach(N=>{N&&l.add(N)}),n.mapped+=1,R(n,E.id);return}if(cr.has(S)&&y.breakpoint==="base"){if(!J(r,"spacing")){n.policySkipped+=1,j(n,"Skipped gap utility because layout.utilities.spacing=false.");return}l.add(cr.get(S)),n.mapped+=1,R(n,"layout.spacing.gap-scale");return}if(wn.has(S)&&y.breakpoint==="base"){if(!J(r,"container")){n.policySkipped+=1,j(n,"Skipped max-width utility because layout.utilities.container=false.");return}l.add(wn.get(S)),n.mapped+=1,R(n,"layout.container.max-width");return}if(i.shouldNormalize&&M){let N=String(S||"");if(y.breakpoint==="base"&&["flex-1","grow","flex-grow"].includes(N)){l.add("grow"),n.mapped+=1,n.intentHits+=1,R(n,"intent.component.button.layout-grow");return}if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.button.normalize");return}}if(c&&/^(?:text-(?:xs|sm|base|lg|xl|\dxl|white|black|\[[^\]]+\]|[a-z]+-\d{2,3})|font-|leading-|tracking-|uppercase|lowercase|capitalize)/.test(S)){n.ignored+=1,n.intentHits+=1,R(n,"intent.typography.heading-semantic");return}if(s.shouldNormalize&&M){let N=String(S||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.badge.normalize");return}}if(p.shouldNormalize&&M){let N=String(S||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.card.normalize");return}}let B=si(S);if(B&&y.breakpoint==="base"){l.add(B),n.mapped+=1,n.intentHits+=1,R(n,"intent.typography.text-neutral-to-muted");return}if(/^text-(?:white|black|[a-z]+-\d{2,3}|\[[^\]]+\])$/.test(S)){if(d||e==="a"&&!i.shouldNormalize){let D=zn(S,y.breakpoint,y.variants);if(D){let Y=me(n,`${e}-color-${S}`,D.declaration,D.breakpoint,D.pseudo);if(Y){l.add(Y),n.mapped+=1,n.intentHits+=1,R(n,d?"intent.icon.color-preserve":"intent.typography.link-active-preserve");return}}}n.ignored+=1,R(n,"style.color");return}let K=zn(S,y.breakpoint,y.variants);if(K){let N=me(n,S,K.declaration,K.breakpoint,K.pseudo);if(N){l.add(N),n.mapped+=1,n.intentHits+=1,R(n,K.ruleId),y.breakpoint!=="base"&&j(n,`Generated responsive import fallback for ${C}.`);return}}for(let N of G.ignoredPatterns)if(N.pattern.test(S)){n.ignored+=1,R(n,N.id),N.id==="style.spacing.atomic"&&(n.removedAtomicSpacingCount+=1),N.id==="style.positioning.atomic"&&(n.removedAtomicPositioningCount+=1);return}if(M){n.unknown+=1,ai(n,C);return}l.add(C)}),m&&J(r,"spacing")&&(l.add(h||"stack-md"),n.mapped+=1,n.intentHits+=1,j(n,`Mapped ${v} to ${h||"stack-md"}.`)),b&&J(r,"spacing")&&j(n,`Mapped ${k} to gap utility.`);let w=Mn(u);if(w&&J(r,"grid")?(l.delete("grid-cols-1"),l.delete("grid-cols-2"),l.delete("grid-cols-3"),l.delete("grid-cols-4"),l.delete("grid-cols-6"),l.add("grid"),l.add(w),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Collapsed responsive grid columns to ${w}.`)):J(r,"grid")&&St.filter(y=>y!=="base"&&Number.isFinite(u[y])).forEach(y=>{let S=u[y],M=li(y,S);if(M){l.add("grid"),l.add(M),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Mapped ${y}:grid-cols-${S} to ${M}.`);return}let E=me(n,`grid-cols-${S}`,`grid-template-columns:repeat(${S}, minmax(0, 1fr))`,y);E&&(l.add("grid"),l.add(E),n.intentHits+=1,R(n,"fallback.import-style.grid-cols-responsive"),j(n,`Mapped ${y}:grid-cols-${S} to responsive import fallback for exact columns.`))}),J(r,"flex")&&a.includes("flex-col")&&(g.md==="flex-row"||g.lg==="flex-row")&&(l.delete("flex-col"),l.delete("flex-row"),l.add("mobile-stack"),n.intentHits+=1,R(n,"intent.layout.mobile-stack"),j(n,"Mapped flex-col + breakpoint flex-row to mobile-stack.")),(l.has("flex")||l.has("inline-flex"))&&J(r,"spacing")&&(di(l)||pi(l)||b||m||(l.add("gap-sm"),n.intentHits+=1,R(n,"layout.spacing.flex-min-gap"),j(n,"Added gap-sm fallback for flex container without explicit spacing."))),a.some(C=>/^grid-cols-\d+$/.test(ae(C).base))&&l.has("grid")&&!ui(l)){let C=Mn(u);C?(l.add(C),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Applied grid safety fallback ${C} to avoid bare grid output.`)):Number.isFinite(u.base)&&u.base>1?(l.add(`grid-cols-${u.base}`),n.intentHits+=1,R(n,"intent.layout.grid-safety-fallback"),j(n,`Applied grid safety fallback grid-cols-${u.base} to preserve explicit grid intent.`)):(l.add("mobile-stack"),n.intentHits+=1,R(n,"intent.layout.grid-safety-fallback.mobile-stack"),j(n,"Applied mobile-stack safety fallback to avoid bare grid output when explicit grid intent was present."))}let A=a.some(C=>/^(?:bg-white|shadow|shadow-md|shadow-lg)$/.test(C)),_=a.some(C=>/^rounded/.test(C));if(["div","section","article","li","aside"].includes(e)&&A&&_&&(l.add("card"),!l.has("surface-elevated")&&a.some(C=>/^shadow/.test(C))&&l.add("surface-elevated"),!l.has("surface-base")&&a.includes("bg-white")&&l.add("surface-base"),n.intentHits+=1,R(n,"intent.component.card")),e==="button"||e==="a"){let C=a.some(M=>/^bg-(?:[a-z]+-)?[4567]00$/.test(M))&&a.includes("text-white"),y=a.some(M=>/^border/.test(M))&&!C,S=a.includes("p-2")&&a.includes("rounded-full");C?(l.delete("surface-base"),l.delete("surface-elevated"),l.add("btn-primary"),n.intentHits+=1,R(n,"intent.component.button.primary")):y&&(l.add("btn-outline"),n.intentHits+=1,R(n,"intent.component.button.outline")),S&&(l.add("icon-only"),R(n,"intent.component.button.icon-only"))}if(i.shouldNormalize){for(let y of Array.from(l))String(y).startsWith("import-")&&l.delete(y);["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","surface-base","surface-elevated","surface-subtle","card"].forEach(y=>l.delete(y)),i.variant==="primary"?(l.add("btn-primary"),R(n,"intent.component.button.primary")):i.variant==="outline"&&(l.add("btn-outline"),R(n,"intent.component.button.outline")),i.size==="sm"?(l.add("btn-sm"),R(n,"intent.component.button.size-sm")):i.size==="lg"&&(l.add("btn-lg"),R(n,"intent.component.button.size-lg")),i.iconOnly&&(l.add("icon-only"),R(n,"intent.component.button.icon-only")),n.intentHits+=1,R(n,"intent.component.button.normalize")}if(s.shouldNormalize){for(let y of Array.from(l))String(y).startsWith("import-")&&l.delete(y);if(["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","grow","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","text-muted","surface-base","surface-elevated","surface-subtle","card"].forEach(y=>l.delete(y)),l.add("badge"),s.variantClass&&l.add(s.variantClass),s.outline&&l.add("badge-outline"),s.sizeClass&&l.add(s.sizeClass),s.pastel&&s.pastel.family){let y=qe(s.pastel.family,String(s.pastel.bgShade||200)),S=qe(s.pastel.family,String(s.pastel.textShade||700));if(y&&S){let M=`badge-pastel-${s.pastel.family}-${s.pastel.bgShade}-${s.pastel.textShade}`,E=me(n,M,`background-color:${y};color:${S}`,"base");E&&(l.add(E),R(n,"intent.component.badge.pastel-preserve"),j(n,`Preserved pastel badge tone using ${E}.`))}}n.intentHits+=1,R(n,"intent.component.badge.normalize"),j(n,"Normalized badge/pill utility cluster to PDS badge classes.")}if(p.shouldNormalize){for(let y of Array.from(l))String(y).startsWith("import-")&&l.delete(y);["surface-base","surface-subtle","surface-elevated","surface-sunken","surface-overlay","surface-inverse","surface-primary","surface-secondary","surface-success","surface-warning","surface-danger","surface-info","card-basic","card-elevated","card-outlined","card-interactive"].forEach(y=>l.delete(y)),l.add("card"),p.cardVariantClass&&l.add(p.cardVariantClass),p.surfaceClass&&l.add(p.surfaceClass),n.intentHits+=1,R(n,"intent.component.card.normalize"),j(n,"Normalized card utility cluster to PDS card/surface classes.")}if(e==="a"&&!i.shouldNormalize&&a.some(y=>y.includes("hover:text")||y==="transition-colors")){let y=me(n,"link-reset","text-decoration:none");y&&l.add(y),n.intentHits+=1,R(n,"intent.typography.link-treatment")}if(e==="footer"&&(l.has("surface-base")||a.some(y=>/^bg-/.test(y)))&&(l.delete("surface-base"),l.delete("surface-subtle"),l.add("surface-inverse"),n.intentHits+=1,R(n,"intent.surface.footer-inverse")),o?.listReset&&["ul","ol","menu"].includes(e)){let C=me(n,"list-reset","list-style:none;margin:0;padding:0");C&&(l.add(C),n.intentHits+=1,R(n,"intent.preflight.list-reset"))}if(o?.anchorReset&&e==="a"&&!i.shouldNormalize){let C=me(n,"anchor-reset","color:inherit;text-decoration:inherit");C&&(l.add(C),n.intentHits+=1,R(n,"intent.preflight.anchor-reset"))}let L=new Set(["div","section","article","aside","nav","main","header","footer","form","fieldset","ul","ol","li"]),P=a.some(C=>{let y=ae(C).base;return/^(?:flex|grid|container|gap-|space-[xy]-|items-|justify-|content-|place-|self-|w-|h-|min-|max-)/.test(y)});return l.size===0&&L.has(e)&&P&&(l.add("stack-sm"),j(n,`Added stack-sm fallback for <${e}> with unmapped classes.`)),Array.from(l).join(" ")}function wi(e="",t={}){let r=String(e||""),n=ii(t.config||{}),o=Za(t.config||{}),a=ti(),i=oi(r,a),p=Ia(i.html,a).replace(/<([a-zA-Z][\w:-]*)([^>]*?)\sclass\s*=\s*(["'])(.*?)\3([^>]*)>/gs,(T,A,_,I,z,L)=>{let P=xi({tagName:String(A||"").toLowerCase(),originalClassValue:z,policy:n,summary:a,preflightHints:i.hints}),C=String(P||"").trim();return C?`<${A}${_} class=${I}${C}${I}${L}>`:`<${A}${_}${L}>`}),c=Ya(Ga(Ua(Ha(p,a),a),a),a,{config:t.config||{}}),d=Qa(a,o),l=ei(c,d);d&&j(a,`Generated ${a.importedStyleCount} import-* fallback style mappings.`),(a.removedAtomicSpacingCount>0||a.removedAtomicPositioningCount>0)&&j(a,`Removed atomic utilities by policy: spacing=${a.removedAtomicSpacingCount}, positioning=${a.removedAtomicPositioningCount}.`);let u=gi(a,16),g=a.mapped+a.ignored+a.policySkipped,m=a.totalTailwind>0?g/a.totalTailwind:1,v=a.totalTailwind>0?a.unknown/a.totalTailwind:0,h=.42+m*.45+Math.min(a.intentHits,4)*.025-v*.18,b=Math.max(.15,Math.min(.96,Number(h.toFixed(2)))),k=[`pds-import: rulebook=${xn} confidence=${Math.round(b*100)}%`,`pds-import: tailwind=${a.totalTailwind} mapped=${a.mapped} ignored=${a.ignored} policySkipped=${a.policySkipped} unknown=${a.unknown}`];u.length&&k.push(`pds-import: unknown-tailwind=${u.join(", ")}`),a.notes.length&&k.push(`pds-import: notes=${a.notes.join(" | ")}`);let w=`<!-- ${k.join(` -->
<!-- `)} -->
${l}`,$=[];return a.unknown>0&&$.push({severity:"warning",message:`Converted with ${a.unknown} unknown Tailwind utilities requiring manual review.`}),a.policySkipped>0&&$.push({severity:"info",message:`Skipped ${a.policySkipped} utility mappings due to PDS config policy.`}),u.length&&$.push({severity:"info",message:`Top unknown utilities: ${u.slice(0,8).join(", ")}`}),{html:w,confidence:b,issues:$,meta:{rulebookVersion:xn,coverage:{tailwind:a.totalTailwind,mapped:a.mapped,ignored:a.ignored,policySkipped:a.policySkipped,unknown:a.unknown,importedStyles:a.importedStyleCount,nestedLabelPairs:a.labelNestingCount},unknownTailwindTokens:u,notes:a.notes,appliedRules:Array.from(a.appliedRules),policy:n,importStyleSheetInjected:!!d,breakpoints:o}}}function ki(){return{rulesJsonPath:Ea,...G,directMappings:G.directMappings.map(e=>({id:e.id,tw:e.tw,pds:e.pds,gate:e.gate||null})),ignoredPatterns:G.ignoredPatterns.map(e=>({id:e.id,pattern:String(e.pattern),reason:e.reason}))}}function Si(e){let t=String(e||"").match(/#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})\b/);return t?t[0]:null}function $i(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Rn(e){return/<\s*[a-z][^>]*>/i.test(String(e||""))}function zi(e){let t=String(e||"").trim().toLowerCase();if(!t)return null;let r=Number.parseFloat(t);return Number.isFinite(r)?t.endsWith("rem")||t.endsWith("em")?r*16:t.endsWith("px")||/^[0-9.\-]+$/.test(t)?r:null:null}function ee(e){let t=String(e||"").trim();if(!t)return"";let r=t.match(/#(?:[0-9a-f]{3,8})\b/i);if(r)return r[0].toLowerCase();let n=t.match(/rgba?\([^)]*\)/i);if(n)return n[0];let o=t.match(/hsla?\([^)]*\)/i);return o?o[0]:""}function Ci(e=""){let t=String(e||"").trim();if(!t||typeof window>"u"||typeof document>"u")return"";let r=document.documentElement;if(!r)return"";let n=window.getComputedStyle(r);return String(n.getPropertyValue(t)||"").trim()}function Li(e=""){let t=String(e||"").trim(),r=ee(t);if(r)return r;let n=t.match(/var\(\s*(--[^\s,)]+)\s*(?:,[^)]+)?\)/i);if(!n)return"";let o=Ci(n[1]);return ee(o)}function Mi(e=""){let t=String(e||"").trim();if(!t)return"";let r=t.split(":").pop()||t;if(r==="bg-white")return"#ffffff";if(r==="bg-black")return"#000000";let n=r.match(/^bg-black\/(\d{1,3})$/i);if(n)return`rgba(0,0,0,${Math.max(0,Math.min(100,Number(n[1])))/100})`;let o=r.match(/^bg-\[([^\]]+)\]$/i);if(o)return ee(o[1]);let a=r.match(/^bg-([a-z]+)-(\d{2,3})$/i);if(!a)return"";let i=qe(a[1],a[2]);return i?Li(i):""}function En(e=""){return String(e||"").split(/\s+/).map(r=>r.trim()).filter(Boolean).map(r=>Mi(r)).filter(Boolean)}function Ei(e=""){let t=[],r=String(e||""),n=/([^{}]+)\{([^{}]*)\}/g,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim(),i=String(o[2]||"").trim();a&&i&&t.push({selector:a,body:i}),o=n.exec(r)}return t}function Ti(e=""){let t=String(e||"").toLowerCase();return t?/(^|\s|,)(html|body|:root|main)(\s|,|$)|#app\b|#root\b|\.app\b|\.page\b/.test(t):!1}function Ai(e=""){let t=String(e||"").trim().match(/rgba?\(\s*([0-9.]+)\s*,\s*([0-9.]+)\s*,\s*([0-9.]+)(?:\s*,\s*([0-9.]+))?\s*\)/i);if(!t)return null;let r=Number.parseFloat(t[1]),n=Number.parseFloat(t[2]),o=Number.parseFloat(t[3]),a=t[4]==null?1:Number.parseFloat(t[4]);return[r,n,o,a].every(i=>Number.isFinite(i))?{r:Math.max(0,Math.min(255,r)),g:Math.max(0,Math.min(255,n)),b:Math.max(0,Math.min(255,o)),a:Math.max(0,Math.min(1,a))}:null}function Ri(e=""){let t=String(e||"").trim().match(/^#([0-9a-f]{3,8})$/i);if(!t)return null;let r=t[1].toLowerCase();if(r.length===3){let[n,o,a]=r.split("");return{r:Number.parseInt(`${n}${n}`,16),g:Number.parseInt(`${o}${o}`,16),b:Number.parseInt(`${a}${a}`,16),a:1}}return r.length===6||r.length===8?{r:Number.parseInt(r.slice(0,2),16),g:Number.parseInt(r.slice(2,4),16),b:Number.parseInt(r.slice(4,6),16),a:r.length===8?Number.parseInt(r.slice(6,8),16)/255:1}:null}function _n(e=""){let t=ee(e);return t?t.startsWith("#")?Ri(t):t.startsWith("rgb")?Ai(t):null:null}function _i(e){if(!e)return null;let t=a=>{let i=Number(a)/255;return i<=.03928?i/12.92:((i+.055)/1.055)**2.4},r=t(e.r),n=t(e.g),o=t(e.b);return .2126*r+.7152*n+.0722*o}function Tn(e=""){let t=String(e||"").trim().toLowerCase();if(!t||t==="transparent")return!0;let r=_n(t);return r&&Number.isFinite(r.a)?r.a<=.04:!1}function Fi(e=[],t=[]){let r=e.map(p=>ee(p)).filter(p=>p&&!Tn(p)),n=Ue(r);if(n)return{color:n,source:"root"};let o=t.map(p=>ee(p)).filter(p=>p&&!Tn(p)),a=o.filter(p=>{let c=_n(p),d=_i(c);return Number.isFinite(d)?d>=.72:!1}),i=Ue(a);if(i)return{color:i,source:"fallback-bright"};let s=Ue(o);return s?{color:s,source:"fallback"}:{color:"",source:"none"}}function ze(e,t=new Map){let r=String(e||""),n=/([a-z-]+)\s*:\s*([^;{}]+)/gi,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim().toLowerCase(),i=String(o[2]||"").trim();a&&i&&(t.has(a)||t.set(a,[]),t.get(a).push(i)),o=n.exec(r)}return t}function Pi(e=""){let t=String(e||""),r=new Map,n=[],o=[],a=[],i=[],s=[],p=[],c=[],d=/#(?:[0-9a-f]{3,8})\b|rgba?\([^)]*\)|hsla?\([^)]*\)/gi,l=u=>{(String(u||"").match(d)||[]).forEach(m=>{let v=ee(m);v&&n.push(v)})};if(typeof DOMParser<"u"&&Rn(t))try{let g=new DOMParser().parseFromString(t,"text/html");Array.from(g.querySelectorAll("style")).map(w=>w.textContent||"").forEach(w=>{ze(w,r),l(w),Ei(w).forEach($=>{if(!Ti($.selector))return;let T=ze($.body,new Map),A=X(T,["background","background-color"]).map(_=>ee(_)).filter(Boolean);o.push(...A)})}),Array.from(g.querySelectorAll("[style]")).forEach(w=>{let $=w.getAttribute("style")||"";ze($,r),l($)}),["html","body","main","#app","#root",".app",".page"].forEach(w=>{let $=g.querySelector(w);if(!$)return;let T=$.getAttribute("style")||"";if(!T)return;let A=ze(T,new Map),_=X(A,["background","background-color"]).map(z=>ee(z)).filter(Boolean);o.push(..._);let I=En($.getAttribute("class")||"");a.push(...I)}),Array.from(g.querySelectorAll("[class]")).forEach(w=>{let $=oe(w.getAttribute("class")||"");p.push(...$);let T=En(w.getAttribute("class")||"");i.push(...T);let A=String(w.tagName||"").toLowerCase(),_=A==="button"||A==="a",I=$.some(z=>/^bg-/.test(String(ae(z).base||"")));_&&I&&T.length&&s.push(...T)});let k=g.body?.textContent||"";k.trim()&&c.push(k),l(g.documentElement?.outerHTML||t)}catch{ze(t,r),l(t),c.push(t)}else ze(t,r),l(t),c.push(t);return{declarations:r,colorValues:n,rootBackgroundColors:o,rootClassBackgroundColors:a,classBackgroundColors:i,buttonBackgroundColors:s,classTokens:p,textCorpus:c.join(`
`)}}function Ue(e=[]){let t=new Map;e.forEach(o=>{let a=String(o||"").trim();a&&t.set(a,(t.get(a)||0)+1)});let r="",n=-1;return t.forEach((o,a)=>{o>n&&(r=a,n=o)}),r}function X(e,t=[]){return t.flatMap(r=>e.get(r)||[])}function Ni(e,t){if(!e||!t)return null;let r=String(t).split(".").filter(Boolean),n=e;for(let o of r){if(!n||n.type!=="object"||!n.properties||typeof n.properties!="object")return null;n=n.properties[o]}return n||null}function Ii(e={}){let t=e&&typeof e=="object"?e:{},r=f?.configRelations&&typeof f.configRelations=="object"?f.configRelations:{},n=new Set(Object.keys(r)),o=null;if(typeof f?.buildConfigFormSchema=="function")try{o=f.buildConfigFormSchema(t)?.schema||null}catch{o=null}return!o&&f?.configFormSchema?.schema&&(o=f.configFormSchema.schema),{design:t,schema:o,allowedPaths:n}}function ji(e,t){if(!e)return t;if(Array.isArray(e.oneOf)&&e.oneOf.length){let r=e.oneOf.map(n=>n?.const).filter(n=>n!=null);if(r.length){if(typeof t=="string"){let n=r.find(o=>String(o).toLowerCase()===t.toLowerCase());if(n!==void 0)return n}if(typeof t=="number"){let n=r.map(o=>Number(o)).filter(o=>Number.isFinite(o));if(n.length)return n.reduce((o,a)=>Math.abs(a-t)<Math.abs(o-t)?a:o,n[0])}return r[0]}}if(e.type==="number"||e.type==="integer"){let r=Number(t);return Number.isFinite(r)?e.type==="integer"?Math.round(r):r:void 0}return e.type==="boolean"?!!t:e.type==="string"?String(t||"").trim():t}function Bi(e,t,r){let n=String(t||"").split(".").filter(Boolean);if(!n.length)return;let o=e;for(let a=0;a<n.length;a+=1){let i=n[a];if(a===n.length-1){o[i]=r;return}(!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))&&(o[i]={}),o=o[i]}}function H(e,t,r){if(r==null||r===""||e.allowedPaths.size&&!e.allowedPaths.has(t))return;let n=Ni(e.schema,t),o=ji(n,r);o==null||o===""||(Bi(e.patch,t,o),e.inferredPaths.add(t))}function fe(e=[]){let t=e.map(n=>zi(n)).filter(n=>Number.isFinite(n));if(!t.length)return null;t.sort((n,o)=>n-o);let r=Math.floor(t.length/2);return t.length%2?t[r]:(t[r-1]+t[r])/2}function Oi(e=[]){let t=e.map(r=>String(r||"").split(",")[0]||"").map(r=>r.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean);return Ue(t)}function Di(e){let t=Number(e);return Number.isFinite(t)?t<=.75?"hairline":t<=1.5?"thin":t<=2.5?"medium":"thick":"thin"}function Wi(e=""){let r=String(ae(e).base||"").toLowerCase().match(/^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(!r)return null;let n=r[1]||"DEFAULT",o={none:0,xs:2,sm:4,DEFAULT:6,md:8,lg:12,xl:16,"2xl":24,"3xl":32};return n==="full"?null:Number.isFinite(o[n])?o[n]:null}function Hi(e=[]){let t=e.map(n=>Wi(n)).filter(n=>Number.isFinite(n));if(!t.length)return null;t.sort((n,o)=>n-o);let r=Math.floor(t.length/2);return t.length%2?t[r]:(t[r-1]+t[r])/2}function pr(e={}){let t=String(e.html||"");if(!t.trim())return W({source:"html-inference",type:String(e.sourceType||"design-inference"),confidence:0,issues:[{severity:"warning",message:"No HTML or guideline text provided for design extraction."}],designPatch:{},meta:{extractedPathCount:0,extractedPaths:[]}});let r=Ii(e.config||{}),n=Pi(t),o={patch:{},inferredPaths:new Set,allowedPaths:r.allowedPaths,schema:r.schema},a=X(n.declarations,["color"]).map(V=>ee(V)).filter(Boolean),i=X(n.declarations,["background","background-color"]).map(V=>ee(V)).filter(Boolean),s=[...i,...a,...n.colorValues].filter(Boolean),p=Array.from(new Set(s)),c=[...n.rootBackgroundColors||[]],d=[...n.rootClassBackgroundColors||[]],l=c.length?c:d,u=[...i,...n.classBackgroundColors||[]],g=Fi(l,u),m=g.color;H(o,"colors.background",m||i[0]||p[0]);let v=p.filter(V=>V&&V!==m),b=Ue(n.buttonBackgroundColors||[])||v[0]||p[0],k=v.filter(V=>V&&V!==b);H(o,"colors.primary",b),H(o,"colors.secondary",k[0]||b||p[0]),H(o,"colors.accent",k[1]||k[0]||b||p[0]);let w=X(n.declarations,["font-family"]),$=Oi(w);H(o,"typography.fontFamilyBody",$),H(o,"typography.fontFamilyHeadings",$),H(o,"typography.fontFamilyMono",/mono|code/i.test(n.textCorpus)?"JetBrains Mono":"");let T=X(n.declarations,["font-size"]),A=fe(T);H(o,"typography.baseSize",A);let _=X(n.declarations,["padding","padding-top","padding-right","padding-bottom","padding-left","margin","margin-top","margin-right","margin-bottom","margin-left","gap","row-gap","column-gap"]),I=fe(_);H(o,"spatialRhythm.baseUnit",I),H(o,"spatialRhythm.inputPadding",I),H(o,"spatialRhythm.buttonPadding",I);let z=X(n.declarations,["border-radius"]),L=fe(z)||Hi(n.classTokens||[]);H(o,"shape.radiusSize",L);let P=X(n.declarations,["border-width","border-top-width","border-right-width","border-bottom-width","border-left-width"]),C=fe(P);H(o,"shape.borderWidth",Di(C));let y=X(n.declarations,["max-width"]),S=fe(y);H(o,"layout.containerMaxWidth",S),H(o,"layout.maxWidth",S);let M=X(n.declarations,["min-height","height"]),E=fe(M);H(o,"layout.buttonMinHeight",E),H(o,"layout.inputMinHeight",E);let B=X(n.declarations,["transition-duration"]),O=fe(B.map(V=>{let Ee=String(V||"").trim().toLowerCase(),le=Number.parseFloat(Ee);return Number.isFinite(le)?Ee.endsWith("ms")?le:Ee.endsWith("s")?le*1e3:le:null}));H(o,"behavior.transitionSpeed",O);let N=X(n.declarations,["box-shadow"]).length>0;H(o,"layers.baseShadowOpacity",N?.2:.08);let D=Array.from(o.inferredPaths),Y=D.reduce((V,Ee)=>{let le=Ee.split(".")[0];return V[le]=(V[le]||0)+1,V},{}),Me=D.length?Math.min(.92,.35+D.length*.02):.25;return W({source:"html-inference",type:String(e.sourceType||"design-inference"),confidence:Me,issues:D.length?[]:[{severity:"warning",message:"Could not infer enough design signals from input."}],designPatch:o.patch,meta:{extractedPathCount:D.length,extractedPaths:D,categoryCoverage:Y,colorSampleSize:p.length,backgroundInference:{source:g.source,candidates:{root:l.length,declaration:i.length,classBased:(n.classBackgroundColors||[]).length}}}})}function Fn(e={}){let t=String(e.input||"").trim(),r=String(e.sourceType||"unknown");if(!t)return W({source:r,type:r,confidence:0,issues:[{severity:"error",message:"No input provided."}],meta:{conversionMode:"none"}});if(Rn(t)){let n=$t({html:t,config:e.config||{}});return W({source:r,type:r,confidence:n.confidence,issues:n.issues,template:n.template,meta:{...n.meta||{},conversionMode:"html-to-pds"}})}return W({source:r,type:r,confidence:.48,issues:[{severity:"info",message:"Input is not HTML; generated text-based preview template."}],template:{id:`${r}-text-import`,name:"Imported Guideline Text",html:`<article class="card surface-base stack-sm"><h3>Imported Guidelines</h3><pre>${$i(t)}</pre></article>`},meta:{conversionMode:"text-preview"}})}function $t(e={}){let t=String(e.html||"").trim();if(!t)return W({source:"tailwind",type:"tailwind-html",confidence:0,issues:[{severity:"error",message:"No HTML provided."}]});let r=wi(t,{config:e.config||{}});return W({source:"tailwind",type:"tailwind-html",confidence:r.confidence,issues:r.issues,template:{id:"tailwind-import",name:"Converted Tailwind Markup",html:r.html},meta:r.meta})}function ur(e={}){let t=String(e.text||"").trim();if(!t)return W({source:"brand",type:"brand-guidelines",confidence:0,issues:[{severity:"error",message:"No brand guideline text provided."}]});let r=Si(t),n={colors:{},typography:{}},o=[];return r?n.colors.primary=r:o.push({severity:"warning",message:"No HEX color found; primary color was not inferred."}),/serif/i.test(t)&&(n.typography.fontFamilyBody="Georgia, serif"),/sans[-\s]?serif/i.test(t)&&(n.typography.fontFamilyBody="Inter, Arial, sans-serif"),/mono|monospace/i.test(t)&&(n.typography.fontFamilyMono="JetBrains Mono, monospace"),W({source:"brand",type:"brand-guidelines",confidence:r?.68:.52,issues:o,designPatch:n,meta:{inferred:{primaryColor:r}}})}var gr="convert-only",Pn="adopt-design-and-convert";function Ui(e){return String(e||"").trim().toLowerCase()===Pn?Pn:gr}function Nn(...e){let t=e.flat().filter(Boolean);if(!t.length)return[];let r=new Set;return t.filter(n=>{let o=`${String(n?.severity||"info")}::${String(n?.path||"")}::${String(n?.message||"")}`;return r.has(o)?!1:(r.add(o),!0)})}function In(e=[]){let t=e.map(r=>Number(r)).filter(r=>Number.isFinite(r));return t.length?Math.max(0,Math.min(1,t.reduce((r,n)=>r+n,0)/t.length)):0}function Ge(e={},t={}){return{...e&&typeof e=="object"?e:{},...t&&typeof t=="object"?t:{}}}function On(e={},t={}){if(!t||typeof t!="object")return e;let r=Array.isArray(e)?[...e]:{...e};return Object.entries(t).forEach(([n,o])=>{o&&typeof o=="object"&&!Array.isArray(o)?r[n]=On(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o}),r}function jn(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e||{}))}function qi(e={}){let t=Number(e?.ratio),r=Number(e?.min),n=Number.isFinite(t)?t.toFixed(2):"n/a",o=Number.isFinite(r)?r.toFixed(2):"n/a";return{severity:"error",path:String(e?.path||"/colors"),message:`${String(e?.message||"Color contrast validation failed.")} (ratio=${n}, required=${o})`}}function Bn(e={},t={},r={}){if(!(t&&typeof t=="object"?Object.keys(t):[]).length)return{ok:!0,blocked:!1,issues:[],report:{ok:!0,issues:[]}};let o=Number(r.minContrast),a=Number.isFinite(o)?o:4.5,i=On(jn(e||{}),jn(t||{})),s=Er(i,{minContrast:a,minMutedContrast:3,extendedChecks:!0}),p=Array.isArray(s?.issues)?s.issues.map(c=>qi(c)):[];return{ok:!!s?.ok,blocked:!s?.ok,issues:p,report:{ok:!!s?.ok,minContrast:a,issues:Array.isArray(s?.issues)?s.issues:[]}}}function Gi(){return[{id:"template",name:"Templates"},{id:"tailwind-html",name:"Tailwind HTML"},{id:"brand-guidelines",name:"Brand Guidelines"},{id:"figma-json",name:"Figma Tokens JSON (planned)"},{id:"ux-pilot",name:"UX Pilot (planned)"},{id:"google-stitch",name:"Google Stitch (planned)"}]}async function Vi(e={}){let t=String(e.sourceType||""),r=Ui(e.importMode),n=String(e.input||""),o=e.config||null;if(t==="template"){let a=rn(e.templateId,e);return a.meta=Ge(a.meta,{importMode:r}),a}if(t==="tailwind-html"){let a=$t({html:n,config:o});if(r===gr)return a.meta=Ge(a.meta,{importMode:r}),a;let i=pr({html:n,config:o,sourceType:t}),s=Bn(o||{},i.designPatch||{}),p=s.blocked?{}:i.designPatch,c=s.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...s.issues]:[];return W({source:a.source||"tailwind",type:t,confidence:In([a.confidence,i.confidence]),issues:Nn(a.issues,i.issues,c),template:a.template,designPatch:p,meta:Ge(a.meta,{importMode:r,inference:i.meta,validation:s.report,validationBlocked:s.blocked})})}if(t==="brand-guidelines"){let a=Fn({input:n,sourceType:t,config:o});if(r===gr)return a.meta=Ge(a.meta,{importMode:r}),a;let i=ur({text:n}),s=pr({html:n,config:o,sourceType:t}),p={...i.designPatch&&typeof i.designPatch=="object"?i.designPatch:{},...s.designPatch&&typeof s.designPatch=="object"?s.designPatch:{}},c=Bn(o||{},p||{}),d=c.blocked?{}:p,l=c.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...c.issues]:[];return W({source:"brand",type:t,confidence:In([a.confidence,i.confidence,s.confidence]),issues:Nn(a.issues,i.issues,s.issues,l),template:a.template,designPatch:d,meta:Ge(a.meta,{importMode:r,inference:s.meta,brandHeuristics:i.meta,validation:c.report,validationBlocked:c.blocked})})}return t==="figma-json"||t==="ux-pilot"||t==="google-stitch"?W({source:t,type:t,confidence:0,issues:[{severity:"info",message:`${t} adapter is not implemented yet in this phase.`}],meta:{importMode:r}}):W({source:t||"unknown",type:"unknown",confidence:0,issues:[{severity:"error",message:"Unsupported import source type."}],meta:{importMode:r}})}var Ki="pds-live-import-history";var ne="imports",zt=null;function Ji(){return typeof globalThis<"u"&&typeof globalThis.indexedDB<"u"}function te(e){return typeof e=="string"?e:""}function Ct(e){return Array.isArray(e)?e:[]}function Lt(e){return e&&typeof e=="object"?e:{}}function Mt(){return Ji()?zt||(zt=new Promise((e,t)=>{let r=globalThis.indexedDB.open(Ki,1);r.onupgradeneeded=()=>{let n=r.result;if(!n.objectStoreNames.contains(ne)){let o=n.createObjectStore(ne,{keyPath:"id",autoIncrement:!0});o.createIndex("createdAt","createdAt",{unique:!1}),o.createIndex("sourceType","sourceType",{unique:!1}),o.createIndex("fileName","fileName",{unique:!1})}},r.onsuccess=()=>e(r.result),r.onerror=()=>t(r.error||new Error("Failed to open import history database."))}),zt):Promise.resolve(null)}function Et(e){return new Promise((t,r)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>r(e.error||new Error("IndexedDB operation failed."))})}function Yi(e={}){let t=Date.now(),r=Number.isFinite(Number(e.createdAt))?Number(e.createdAt):t,n=new Date(r).toISOString(),o=Ct(e.issues).map(p=>({severity:te(p?.severity||"info"),message:te(p?.message||"")})),a=Ct(e.notes).filter(p=>typeof p=="string"),i=Ct(e.unknownTailwindTokens).filter(p=>typeof p=="string"),s=Ct(e.appliedRules).filter(p=>typeof p=="string");return{createdAt:r,createdAtIso:n,sourceType:te(e.sourceType||"unknown"),importMode:te(e.importMode||"convert-only"),source:te(e.source||"unknown"),type:te(e.type||"unknown"),fileName:te(e.fileName||""),fileSize:Number.isFinite(Number(e.fileSize))?Number(e.fileSize):0,mimeType:te(e.mimeType||""),fileContents:te(e.fileContents||""),convertedHtml:te(e.convertedHtml||""),confidence:Number.isFinite(Number(e.confidence))?Number(e.confidence):0,notes:a,issues:o,coverage:Lt(e.coverage),unknownTailwindTokens:i,appliedRules:s,importStyleSheetInjected:!!e.importStyleSheetInjected,templateName:te(e.templateName||""),designPatch:Lt(e.designPatch),meta:Lt(e.meta),resultSnapshot:Lt(e.resultSnapshot)}}async function Xi(e={}){let t=await Mt();if(!t)return null;let r=Yi(e),o=t.transaction(ne,"readwrite").objectStore(ne);return{id:await Et(o.add(r)),...r}}async function Zi(e={}){let t=await Mt();if(!t)return[];let r=Number.isFinite(Number(e.limit))?Math.max(1,Number(e.limit)):30,o=t.transaction(ne,"readonly").objectStore(ne);return(await Et(o.getAll())||[]).sort((i,s)=>Number(s?.createdAt||0)-Number(i?.createdAt||0)).slice(0,r)}async function Qi(e){let t=await Mt();if(!t)return null;let r=Number(e);if(!Number.isFinite(r))return null;let o=t.transaction(ne,"readonly").objectStore(ne);return await Et(o.get(r))||null}async function es(){let e=await Mt();if(!e)return;let r=e.transaction(ne,"readwrite").objectStore(ne);await Et(r.clear())}export{es as clearLiveImportHistory,ur as convertBrandGuidelinesToPatch,$t as convertTailwindHtmlToPds,W as createImportResult,ki as describeTailwindConversionRules,Qi as getLiveImportHistoryEntry,Gi as getLiveImportSources,sa as isImportResult,Zi as listLiveImportHistory,tn as listLiveTemplates,Ur as loadGoogleFont,ut as loadLiveTemplateCatalog,Vi as runLiveImport,Xi as saveLiveImportHistory,oa as startLive};
