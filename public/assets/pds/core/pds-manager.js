...
${[...n,...a,...d,i,s,p].join("")}}
`}#re(e,r){if(!e?.dark)return"";let n=[],o=(u,g="")=>{Object.entries(u).forEach(([m,v])=>{typeof v=="object"&&v!==null?o(v,`${g}${m}-`):typeof v=="string"&&n.push(`    --color-${g}${m}: ${v};
...
`}#de(){let{shape:e={},spatialRhythm:r={},inputPadding:n,buttonPadding:o,focusRingWidth:a,focusRingOpacity:i,borderWidthThin:s,sectionSpacing:p,buttonMinHeight:d,inputMinHeight:c}=this.options.design,l=typeof e.borderWidth=="number"?e.borderWidth:typeof e.borderWidth=="string"?y.BorderWidths[e.borderWidth]??null:null,u=r.inputPadding??n??.75,g=r.buttonPadding??o??1,m=a||3,v=s||l||y.BorderWidths.thin,f=r.sectionSpacing??p??2,b=d||30;return`/* Mobile-First Form Styles - Generated from Design Config */
form {
  margin: 0;
  width: 100%;
}
...
${r}`):`${r}
${t}`}function Dr(t=""){if(!t)return!1;if(t.includes(":")||t.includes("["))return!0;let e=t.split("-")[0];return wo.includes(e)}function re(t=""){let e=String(t).split(":");if(e.length===1)return{breakpoint:"base",base:e[0],variants:[]};let r=e[e.length-1],n=e.slice(0,-1);return{breakpoint:n.find(a=>st.includes(a))||"base",base:r,variants:n}}function Oo(){return{totalTailwind:0,mapped:0,ignored:0,policySkipped:0,unknown:0,intentHits:0,unknownTokens:new Map,notes:[],appliedRules:new Set,importBaseStyles:new Map,importResponsiveStyles:new Map,importPseudoStyles:new Map,importedStyleCount:0,labelNestingCount:0,removedAtomicSpacingCount:0,removedAtomicPositioningCount:0}}function Do(t=""){let e=String(t||"").toLowerCase().replace(/\s+/g,""),r=e.includes("menu,ol,ul{list-style:none")||e.includes("ol,ul,menu{list-style:none")||e.includes("ul,ol,menu{list-style:none"),n=e.includes("a{color:inherit;text-decoration:inherit");return{listReset:r,anchorReset:n}}function Wo(t=""){return String(t||"").toLowerCase().includes("cdn.tailwindcss.com")?{listReset:!0,anchorReset:!0}:{listReset:!1,anchorReset:!1}}function Ho(t="",e=null){let r=String(t||""),n={listReset:!1,anchorReset:!1,strippedRuntimeCssBlocks:0,strippedRuntimeScripts:0};return r=r.replace(/<style([^>]*)>([\s\S]*?)<\/style>/gi,(o,a,i)=>{let s=String(i||"");if(!(/tailwindcss\s+v\d/i.test(s)||/\*\s*!\s*tailwindcss/i.test(s)))return o;let d=Do(s);return n.listReset=n.listReset||d.listReset,n.anchorReset=n.anchorReset||d.anchorReset,n.strippedRuntimeCssBlocks+=1,""}),r=r.replace(/<script([^>]*?)src\s*=\s*(?:(['"])([^"']*cdn\.tailwindcss\.com[^"']*)\2|([^\s>]*cdn\.tailwindcss\.com[^\s>]*))([^>]*)><\/script>/gi,(o,a,i,s,p)=>{let c=Wo(s||p||"");return n.listReset=n.listReset||c.listReset,n.anchorReset=n.anchorReset||c.anchorReset,n.strippedRuntimeScripts+=1,""}),e&&(n.strippedRuntimeCssBlocks>0||n.strippedRuntimeScripts>0)&&(R(e,"intent.preflight.tailwind-runtime-detected"),n.strippedRuntimeCssBlocks>0&&j(e,`Detected and stripped ${n.strippedRuntimeCssBlocks} Tailwind runtime style block(s).`)),e&&n.strippedRuntimeScripts>0&&j(e,`Removed ${n.strippedRuntimeScripts} Tailwind CDN script reference(s).`),{html:r,hints:n}}function j(t,e){!t||!e||t.notes.includes(e)||t.notes.push(e)}function Uo(t,e){let r=t.unknownTokens.get(e)||0;t.unknownTokens.set(e,r+1)}function qo(t={}){let r=(t?.design&&typeof t.design=="object"?t.design:t)?.layout?.utilities||{};return{grid:r.grid!==!1,flex:r.flex!==!1,spacing:r.spacing!==!1,container:r.container!==!1}}function G(t,e){return e?t?.[e]!==!1:!0}function Wr(t){let e=String(t).match(/^grid-cols-(\d+)$/);return e?Number(e[1]):null}function Hr(t={}){let e=st.map(o=>({bp:o,cols:t[o]})).filter(o=>Number.isFinite(o.cols));if(e.length<2)return null;if(e.length===2){let[o,a]=e;if(o.bp==="base"&&o.cols===1&&a.cols===2)return"grid-auto-lg";if(o.bp==="base"&&o.cols===1&&a.cols>=3)return null;if(o.cols<a.cols){if(a.cols>=4)return"grid-auto-md";if(a.cols>=2)return"grid-auto-lg"}return null}let r=!0;for(let o=1;o<e.length;o+=1)if(e[o].cols<=e[o-1].cols){r=!1;break}if(!r)return null;let n=e[e.length-1]?.cols||0;return n>=4?"grid-auto-md":n>=3?"grid-auto-sm":null}function Go(t=""){let e=String(t).match(/^text-(gray|slate|zinc|neutral|stone)-(\d{2,3})$/);if(!e)return"";let r=Number(e[2]);return Number.isFinite(r)&&r>=400&&r<=600?"text-muted":""}function Vo(t="",e=0){return!t||!Number.isFinite(e)?"":{sm:{2:"sm:grid-cols-2"},md:{3:"md:grid-cols-3"},lg:{4:"lg:grid-cols-4"}}?.[t]?.[e]||""}function Yo(t=""){let e=re(t),n=String(e?.base||"").match(/^space-y-(\d+)$/);if(!n)return"stack-md";let o=Number(n[1]);return Number.isFinite(o)?o<=1?"stack-xs":o<=2?"stack-sm":o<=4?"stack-md":"stack-lg":"stack-md"}function Jo(t=new Set){return Array.from(t).some(e=>{let r=String(e||"");return/^gap-(?:xs|sm|md|lg|xl)$/.test(r)||/^gap-[0-9]+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?gap-/.test(r)})}function Ko(t=new Set){return Array.from(t).some(e=>/^stack-(?:xs|sm|md|lg|xl)$/.test(String(e||"")))}function Zo(t=new Set){return Array.from(t).some(e=>{let r=String(e||"");return/^grid-cols-\d+$/.test(r)||/^grid-auto-(?:sm|md|lg|xl)$/.test(r)||/^(?:sm|md|lg|xl):grid-cols-\d+$/.test(r)||/^import-(?:sm-|md-|lg-|xl-)?grid-cols-\d+$/.test(r)})}function Qo(t,e=12){return Array.from(t.unknownTokens.entries()).sort((r,n)=>n[1]-r[1]).slice(0,e).map(([r])=>r)}function R(t,e){!t||!e||t.appliedRules.add(e)}function ne(t=[],e){return!Array.isArray(t)||!e?!1:t.some(r=>e.test(String(r)))}function Xo(t=[]){for(let e of t){let r=re(e);if(r.breakpoint!=="base")continue;let n=String(r.base).match(/^h-(.+)$/);if(!n)continue;let o=Ne(n[1]);if(!o||o==="auto")continue;let a=String(o).match(/^(-?\d+(?:\.\d+)?)rem$/);if(a){let i=Number(a[1]);if(Number.isFinite(i))return i*16}}return null}function ea(t=[],e=""){let r=e==="button",n=ne(t,/^bg-/),o=ne(t,/^hover:bg-/),a=ne(t,/^border/),i=ne(t,/^shadow/),s=t.includes("cursor-pointer"),p=ne(t,/^rounded/),d=ne(t,/^(?:min-w|max-w|w)-/),c=ne(t,/^text-(?:white|black|\[[^\]]+\]|[a-z]+-\d{2,3})$/),l=n||o||i;if(!(r||e==="a"&&(l||a||s||p&&d)))return{shouldNormalize:!1,variant:"none",size:"base",iconOnly:!1};let m="none";a&&!n&&!o?m="outline":(l||n&&c)&&(m="primary");let v=t.includes("rounded-full")&&(t.includes("p-2")||t.includes("p-1")||t.includes("p-2.5")),f=ne(t,/^size-(?:6|7|8|9|10|11|12)$/),b=v||f,w=Xo(t),x=t.includes("text-sm")||t.includes("text-xs"),C=t.includes("text-lg")||t.includes("text-xl"),A="base";return w&&w<=40||x?A="sm":(w&&w>=48||C)&&(A="lg"),{shouldNormalize:!0,variant:m,size:A,iconOnly:b}}function ta(t=""){let e=String(t||"").toLowerCase();return["green","emerald","lime","teal"].includes(e)?"badge-success":["blue","sky","cyan","indigo"].includes(e)?"badge-info":["yellow","amber","orange"].includes(e)?"badge-warning":["red","rose","pink"].includes(e)?"badge-danger":["gray","slate","zinc","neutral","stone"].includes(e)?"badge-secondary":["purple","violet","fuchsia","primary","accent"].includes(e)?"badge-primary":"badge-secondary"}function ra(t=[],e="",r={shouldNormalize:!1}){if(r?.shouldNormalize)return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(["button","a","input","select","textarea"].includes(e))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};if(t.some(M=>/^badge(?:-|$)/.test(String(M))))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let n=t.map(M=>re(M)).filter(M=>M.breakpoint==="base").map(M=>String(M.base)),o=n.some(M=>/^rounded(?:-|$)/.test(M)),a=n.some(M=>/^px-/.test(M)),i=n.some(M=>/^py-/.test(M)),s=a&&i,p=n.includes("text-xs")||n.includes("text-sm"),d=n.includes("text-lg")||n.includes("text-xl"),c=n.map(M=>M.match(/^bg-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),l=n.map(M=>M.match(/^text-([a-z]+)-(\d{2,3})(?:\/\d{1,3})?$/)).find(Boolean),u=n.map(M=>M.match(/^border-([a-z]+)-(\d{2,3})$/)).find(Boolean),g=Number(c?.[2]),m=Number(l?.[2]),v=!!(c&&Number.isFinite(g)&&g<=300),f=n.some(M=>/^border(?:-|$)/.test(M)),b=!!(c||l||u),w=[o,s,p,v||f].filter(Boolean).length;if(!(b&&w>=3))return{shouldNormalize:!1,variantClass:"",outline:!1,sizeClass:"",pastel:null};let C=c&&c[1]||l&&l[1]||u&&u[1]||"",A=ta(C),L=f&&!v,F=p?"badge-sm":d?"badge-lg":"",I=v?{family:C,bgShade:Number.isFinite(g)?g:200,textShade:Number.isFinite(m)?m:700}:null;return{shouldNormalize:!0,variantClass:I?"":A,outline:L,sizeClass:F,pastel:I}}function na(t="",e=0){let r=String(t||"").toLowerCase(),n=Number(e);return r==="white"?"surface-base":["gray","slate","zinc","neutral","stone"].includes(r)?Number.isFinite(n)&&n<=100?"surface-base":"surface-subtle":["blue","sky","cyan","indigo","primary","info"].includes(r)?"surface-info":["purple","violet","fuchsia","accent"].includes(r)?"surface-primary":["green","emerald","lime","teal","success"].includes(r)?"surface-success":["yellow","amber","orange","warning"].includes(r)?"surface-warning":["red","rose","pink","danger"].includes(r)?"surface-danger":"surface-base"}function oa(t=[],e="",r={shouldNormalize:!1},n={shouldNormalize:!1}){if(r?.shouldNormalize||n?.shouldNormalize)return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(!new Set(["div","section","article","aside","li"]).has(e))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};if(t.some(f=>/^card(?:-|$)/.test(String(f))))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let a=t.map(f=>re(f)).filter(f=>f.breakpoint==="base").map(f=>String(f.base)),i=a.some(f=>/^rounded(?:-|$)/.test(f)),s=a.some(f=>/^border(?:$|-)/.test(f)),p=a.some(f=>/^shadow(?:$|-)/.test(f)),d=a.some(f=>/^(?:p|px|py|pt|pb|pl|pr)-/.test(f)),c=a.map(f=>f.match(/^bg-([a-z]+)-?(\d{2,3})?$/)).find(Boolean),l=a.includes("bg-white")||!!c;if(!([i,s||p,l,d].filter(Boolean).length>=3))return{shouldNormalize:!1,cardVariantClass:"",surfaceClass:""};let m="card-basic";p?m="card-elevated":s&&(m="card-outlined");let v="";return p?v="surface-elevated":c?v=na(c[1],c[2]):l&&(v="surface-base"),{shouldNormalize:!0,cardVariantClass:m,surfaceClass:v}}function aa({tagName:t,originalClassValue:e,policy:r,summary:n,preflightHints:o={}}){if(yo.has(t))return R(n,"table.strict-tags.no-classes"),"";let a=String(e).split(/\s+/).filter(Boolean),i=ea(a,t),s=ra(a,t,i),p=oa(a,t,i,s),d=/^h[1-6]$/.test(t),c=["i","svg"].includes(t)||a.some($=>/^fa(?:[a-z-]+)?$/i.test(String($||""))||/^fa-/.test(String($||""))),l=new Set,u={},g={},m=!1,v="",f="",b=!1,w="";a.forEach($=>{let h=re($),k=h.base;if(bo.some(N=>N.test(k))){n.ignored+=1,R(n,"cleanup.non-pds-class");return}let E=Dr($)||Dr(k);if(E&&(n.totalTailwind+=1),/^space-y-/.test(k)){m=!0,v=v||$,f=f||Yo($),n.ignored+=1,R(n,"layout.spacing.space-y-to-stack");return}if(/^space-x-/.test(k)){let N=String(k).match(/^space-x-(\d+)$/);if(N){let _=`gap-${N[1]}`,Y=Ht.get(_);if(Y&&G(r,"spacing")){l.add(Y),b=!0,w=w||$,n.mapped+=1,n.intentHits+=1,R(n,"layout.spacing.space-x-to-gap");return}}n.ignored+=1,R(n,"style.spacing.atomic");return}if(/^grid-cols-\d+$/.test(k)&&h.breakpoint!=="base"){let N=Wr(k);if(Number.isFinite(N)&&G(r,"grid")){u[h.breakpoint]=N,n.mapped+=1,R(n,"intent.layout.responsive-grid-to-auto");return}if(!G(r,"grid")){n.policySkipped+=1,j(n,"Skipped responsive grid mapping because layout.utilities.grid=false.");return}}if(/^flex-(?:row|col)$/.test(k)&&h.breakpoint!=="base"){if(G(r,"flex")){g[h.breakpoint]=k,n.mapped+=1,R(n,"intent.layout.mobile-stack");return}n.policySkipped+=1,j(n,"Skipped responsive flex mapping because layout.utilities.flex=false.");return}if(/^grid-cols-\d+$/.test(k)&&h.breakpoint==="base"){let N=Wr(k);Number.isFinite(N)&&G(r,"grid")&&(u.base=N)}let T=ho.get(k);if(T&&h.breakpoint==="base"){if(!G(r,T.gate)){n.policySkipped+=1,j(n,`Skipped ${k} because layout.utilities.${T.gate}=false.`);return}T.pds.forEach(N=>{N&&l.add(N)}),n.mapped+=1,R(n,T.id);return}if(Ht.has(k)&&h.breakpoint==="base"){if(!G(r,"spacing")){n.policySkipped+=1,j(n,"Skipped gap utility because layout.utilities.spacing=false.");return}l.add(Ht.get(k)),n.mapped+=1,R(n,"layout.spacing.gap-scale");return}if(Ir.has(k)&&h.breakpoint==="base"){if(!G(r,"container")){n.policySkipped+=1,j(n,"Skipped max-width utility because layout.utilities.container=false.");return}l.add(Ir.get(k)),n.mapped+=1,R(n,"layout.container.max-width");return}if(i.shouldNormalize&&E){let N=String(k||"");if(h.breakpoint==="base"&&["flex-1","grow","flex-grow"].includes(N)){l.add("grow"),n.mapped+=1,n.intentHits+=1,R(n,"intent.component.button.layout-grow");return}if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.button.normalize");return}}if(d&&/^(?:text-(?:xs|sm|base|lg|xl|\dxl|white|black|\[[^\]]+\]|[a-z]+-\d{2,3})|font-|leading-|tracking-|uppercase|lowercase|capitalize)/.test(k)){n.ignored+=1,n.intentHits+=1,R(n,"intent.typography.heading-semantic");return}if(s.shouldNormalize&&E){let N=String(k||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr|w-|h-|min-|max-|size-|overflow)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.badge.normalize");return}}if(p.shouldNormalize&&E){let N=String(k||"");if(/^(?:bg-|text-(?!center$|left$|right$)|font-|leading-|tracking-|rounded|ring|border|shadow|outline|transition|duration|ease|delay|animate|p|px|py|pt|pb|pl|pr|m|mx|my|mt|mb|ml|mr)/.test(N)||N.startsWith("hover:")){n.ignored+=1,R(n,"intent.component.card.normalize");return}}let B=Go(k);if(B&&h.breakpoint==="base"){l.add(B),n.mapped+=1,n.intentHits+=1,R(n,"intent.typography.text-neutral-to-muted");return}if(/^text-(?:white|black|[a-z]+-\d{2,3}|\[[^\]]+\])$/.test(k)){if(c||t==="a"&&!i.shouldNormalize){let _=Or(k,h.breakpoint,h.variants);if(_){let Y=ce(n,`${t}-color-${k}`,_.declaration,_.breakpoint,_.pseudo);if(Y){l.add(Y),n.mapped+=1,n.intentHits+=1,R(n,c?"intent.icon.color-preserve":"intent.typography.link-active-preserve");return}}}n.ignored+=1,R(n,"style.color");return}let V=Or(k,h.breakpoint,h.variants);if(V){let N=ce(n,k,V.declaration,V.breakpoint,V.pseudo);if(N){l.add(N),n.mapped+=1,n.intentHits+=1,R(n,V.ruleId),h.breakpoint!=="base"&&j(n,`Generated responsive import fallback for ${$}.`);return}}for(let N of U.ignoredPatterns)if(N.pattern.test(k)){n.ignored+=1,R(n,N.id),N.id==="style.spacing.atomic"&&(n.removedAtomicSpacingCount+=1),N.id==="style.positioning.atomic"&&(n.removedAtomicPositioningCount+=1);return}if(E){n.unknown+=1,Uo(n,$);return}l.add($)}),m&&G(r,"spacing")&&(l.add(f||"stack-md"),n.mapped+=1,n.intentHits+=1,j(n,`Mapped ${v} to ${f||"stack-md"}.`)),b&&G(r,"spacing")&&j(n,`Mapped ${w} to gap utility.`);let x=Hr(u);if(x&&G(r,"grid")?(l.delete("grid-cols-1"),l.delete("grid-cols-2"),l.delete("grid-cols-3"),l.delete("grid-cols-4"),l.delete("grid-cols-6"),l.add("grid"),l.add(x),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Collapsed responsive grid columns to ${x}.`)):G(r,"grid")&&st.filter(h=>h!=="base"&&Number.isFinite(u[h])).forEach(h=>{let k=u[h],E=Vo(h,k);if(E){l.add("grid"),l.add(E),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Mapped ${h}:grid-cols-${k} to ${E}.`);return}let T=ce(n,`grid-cols-${k}`,`grid-template-columns:repeat(${k}, minmax(0, 1fr))`,h);T&&(l.add("grid"),l.add(T),n.intentHits+=1,R(n,"fallback.import-style.grid-cols-responsive"),j(n,`Mapped ${h}:grid-cols-${k} to responsive import fallback for exact columns.`))}),G(r,"flex")&&a.includes("flex-col")&&(g.md==="flex-row"||g.lg==="flex-row")&&(l.delete("flex-col"),l.delete("flex-row"),l.add("mobile-stack"),n.intentHits+=1,R(n,"intent.layout.mobile-stack"),j(n,"Mapped flex-col + breakpoint flex-row to mobile-stack.")),(l.has("flex")||l.has("inline-flex"))&&G(r,"spacing")&&(Jo(l)||Ko(l)||b||m||(l.add("gap-sm"),n.intentHits+=1,R(n,"layout.spacing.flex-min-gap"),j(n,"Added gap-sm fallback for flex container without explicit spacing."))),a.some($=>/^grid-cols-\d+$/.test(re($).base))&&l.has("grid")&&!Zo(l)){let $=Hr(u);$?(l.add($),n.intentHits+=1,R(n,"intent.layout.responsive-grid-to-auto"),j(n,`Applied grid safety fallback ${$} to avoid bare grid output.`)):Number.isFinite(u.base)&&u.base>1?(l.add(`grid-cols-${u.base}`),n.intentHits+=1,R(n,"intent.layout.grid-safety-fallback"),j(n,`Applied grid safety fallback grid-cols-${u.base} to preserve explicit grid intent.`)):(l.add("mobile-stack"),n.intentHits+=1,R(n,"intent.layout.grid-safety-fallback.mobile-stack"),j(n,"Applied mobile-stack safety fallback to avoid bare grid output when explicit grid intent was present."))}let L=a.some($=>/^(?:bg-white|shadow|shadow-md|shadow-lg)$/.test($)),F=a.some($=>/^rounded/.test($));if(["div","section","article","li","aside"].includes(t)&&L&&F&&(l.add("card"),!l.has("surface-elevated")&&a.some($=>/^shadow/.test($))&&l.add("surface-elevated"),!l.has("surface-base")&&a.includes("bg-white")&&l.add("surface-base"),n.intentHits+=1,R(n,"intent.component.card")),t==="button"||t==="a"){let $=a.some(E=>/^bg-(?:[a-z]+-)?[4567]00$/.test(E))&&a.includes("text-white"),h=a.some(E=>/^border/.test(E))&&!$,k=a.includes("p-2")&&a.includes("rounded-full");$?(l.delete("surface-base"),l.delete("surface-elevated"),l.add("btn-primary"),n.intentHits+=1,R(n,"intent.component.button.primary")):h&&(l.add("btn-outline"),n.intentHits+=1,R(n,"intent.component.button.outline")),k&&(l.add("icon-only"),R(n,"intent.component.button.icon-only"))}if(i.shouldNormalize){for(let h of Array.from(l))String(h).startsWith("import-")&&l.delete(h);["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","surface-base","surface-elevated","surface-subtle","card"].forEach(h=>l.delete(h)),i.variant==="primary"?(l.add("btn-primary"),R(n,"intent.component.button.primary")):i.variant==="outline"&&(l.add("btn-outline"),R(n,"intent.component.button.outline")),i.size==="sm"?(l.add("btn-sm"),R(n,"intent.component.button.size-sm")):i.size==="lg"&&(l.add("btn-lg"),R(n,"intent.component.button.size-lg")),i.iconOnly&&(l.add("icon-only"),R(n,"intent.component.button.icon-only")),n.intentHits+=1,R(n,"intent.component.button.normalize")}if(s.shouldNormalize){for(let h of Array.from(l))String(h).startsWith("import-")&&l.delete(h);if(["flex","inline-flex","items-start","items-center","items-end","justify-start","justify-center","justify-end","justify-between","grow","shrink","self-start","self-center","self-end","cursor-pointer","truncate","overflow-hidden","whitespace-nowrap","text-muted","surface-base","surface-elevated","surface-subtle","card"].forEach(h=>l.delete(h)),l.add("badge"),s.variantClass&&l.add(s.variantClass),s.outline&&l.add("badge-outline"),s.sizeClass&&l.add(s.sizeClass),s.pastel&&s.pastel.family){let h=je(s.pastel.family,String(s.pastel.bgShade||200)),k=je(s.pastel.family,String(s.pastel.textShade||700));if(h&&k){let E=`badge-pastel-${s.pastel.family}-${s.pastel.bgShade}-${s.pastel.textShade}`,T=ce(n,E,`background-color:${h};color:${k}`,"base");T&&(l.add(T),R(n,"intent.component.badge.pastel-preserve"),j(n,`Preserved pastel badge tone using ${T}.`))}}n.intentHits+=1,R(n,"intent.component.badge.normalize"),j(n,"Normalized badge/pill utility cluster to PDS badge classes.")}if(p.shouldNormalize){for(let h of Array.from(l))String(h).startsWith("import-")&&l.delete(h);["surface-base","surface-subtle","surface-elevated","surface-sunken","surface-overlay","surface-inverse","surface-primary","surface-secondary","surface-success","surface-warning","surface-danger","surface-info","card-basic","card-elevated","card-outlined","card-interactive"].forEach(h=>l.delete(h)),l.add("card"),p.cardVariantClass&&l.add(p.cardVariantClass),p.surfaceClass&&l.add(p.surfaceClass),n.intentHits+=1,R(n,"intent.component.card.normalize"),j(n,"Normalized card utility cluster to PDS card/surface classes.")}if(t==="a"&&!i.shouldNormalize&&a.some(h=>h.includes("hover:text")||h==="transition-colors")){let h=ce(n,"link-reset","text-decoration:none");h&&l.add(h),n.intentHits+=1,R(n,"intent.typography.link-treatment")}if(t==="footer"&&(l.has("surface-base")||a.some(h=>/^bg-/.test(h)))&&(l.delete("surface-base"),l.delete("surface-subtle"),l.add("surface-inverse"),n.intentHits+=1,R(n,"intent.surface.footer-inverse")),o?.listReset&&["ul","ol","menu"].includes(t)){let $=ce(n,"list-reset","list-style:none;margin:0;padding:0");$&&(l.add($),n.intentHits+=1,R(n,"intent.preflight.list-reset"))}if(o?.anchorReset&&t==="a"&&!i.shouldNormalize){let $=ce(n,"anchor-reset","color:inherit;text-decoration:inherit");$&&(l.add($),n.intentHits+=1,R(n,"intent.preflight.anchor-reset"))}let M=new Set(["div","section","article","aside","nav","main","header","footer","form","fieldset","ul","ol","li"]),P=a.some($=>{let h=re($).base;return/^(?:flex|grid|container|gap-|space-[xy]-|items-|justify-|content-|place-|self-|w-|h-|min-|max-)/.test(h)});return l.size===0&&M.has(t)&&P&&(l.add("stack-sm"),j(n,`Added stack-sm fallback for <${t}> with unmapped classes.`)),Array.from(l).join(" ")}function ia(t="",e={}){let r=String(t||""),n=qo(e.config||{}),o=jo(e.config||{}),a=Oo(),i=Ho(r,a),p=ko(i.html,a).replace(/<([a-zA-Z][\w:-]*)([^>]*?)\sclass\s*=\s*(["'])(.*?)\3([^>]*)>/gs,(A,L,F,I,S,M)=>{let P=aa({tagName:String(L||"").toLowerCase(),originalClassValue:S,policy:n,summary:a,preflightHints:i.hints}),$=String(P||"").trim();return $?`<${L}${F} class=${I}${$}${I}${M}>`:`<${L}${F}${M}>`}),d=No(Lo(To(Eo(p,a),a),a),a,{config:e.config||{}}),c=Bo(a,o),l=_o(d,c);c&&j(a,`Generated ${a.importedStyleCount} import-* fallback style mappings.`),(a.removedAtomicSpacingCount>0||a.removedAtomicPositioningCount>0)&&j(a,`Removed atomic utilities by policy: spacing=${a.removedAtomicSpacingCount}, positioning=${a.removedAtomicPositioningCount}.`);let u=Qo(a,16),g=a.mapped+a.ignored+a.policySkipped,m=a.totalTailwind>0?g/a.totalTailwind:1,v=a.totalTailwind>0?a.unknown/a.totalTailwind:0,f=.42+m*.45+Math.min(a.intentHits,4)*.025-v*.18,b=Math.max(.15,Math.min(.96,Number(f.toFixed(2)))),w=[`pds-import: rulebook=${Nr} confidence=${Math.round(b*100)}%`,`pds-import: tailwind=${a.totalTailwind} mapped=${a.mapped} ignored=${a.ignored} policySkipped=${a.policySkipped} unknown=${a.unknown}`];u.length&&w.push(`pds-import: unknown-tailwind=${u.join(", ")}`),a.notes.length&&w.push(`pds-import: notes=${a.notes.join(" | ")}`);let x=`<!-- ${w.join(` -->
<!-- `)} -->
${l}`,C=[];return a.unknown>0&&C.push({severity:"warning",message:`Converted with ${a.unknown} unknown Tailwind utilities requiring manual review.`}),a.policySkipped>0&&C.push({severity:"info",message:`Skipped ${a.policySkipped} utility mappings due to PDS config policy.`}),u.length&&C.push({severity:"info",message:`Top unknown utilities: ${u.slice(0,8).join(", ")}`}),{html:x,confidence:b,issues:C,meta:{rulebookVersion:Nr,coverage:{tailwind:a.totalTailwind,mapped:a.mapped,ignored:a.ignored,policySkipped:a.policySkipped,unknown:a.unknown,importedStyles:a.importedStyleCount,nestedLabelPairs:a.labelNestingCount},unknownTailwindTokens:u,notes:a.notes,appliedRules:Array.from(a.appliedRules),policy:n,importStyleSheetInjected:!!c,breakpoints:o}}}function sa(){return{rulesJsonPath:mo,...U,directMappings:U.directMappings.map(t=>({id:t.id,tw:t.tw,pds:t.pds,gate:t.gate||null})),ignoredPatterns:U.ignoredPatterns.map(t=>({id:t.id,pattern:String(t.pattern),reason:t.reason}))}}function la(t){let e=String(t||"").match(/#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})\b/);return e?e[0]:null}function ca(t){return String(t||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Vr(t){return/<\s*[a-z][^>]*>/i.test(String(t||""))}function da(t){let e=String(t||"").trim().toLowerCase();if(!e)return null;let r=Number.parseFloat(e);return Number.isFinite(r)?e.endsWith("rem")||e.endsWith("em")?r*16:e.endsWith("px")||/^[0-9.\-]+$/.test(e)?r:null:null}function Q(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/#(?:[0-9a-f]{3,8})\b/i);if(r)return r[0].toLowerCase();let n=e.match(/rgba?\([^)]*\)/i);if(n)return n[0];let o=e.match(/hsla?\([^)]*\)/i);return o?o[0]:""}function pa(t=""){let e=String(t||"").trim();if(!e||typeof window>"u"||typeof document>"u")return"";let r=document.documentElement;if(!r)return"";let n=window.getComputedStyle(r);return String(n.getPropertyValue(e)||"").trim()}function ua(t=""){let e=String(t||"").trim(),r=Q(e);if(r)return r;let n=e.match(/var\(\s*(--[^\s,)]+)\s*(?:,[^)]+)?\)/i);if(!n)return"";let o=pa(n[1]);return Q(o)}function ga(t=""){let e=String(t||"").trim();if(!e)return"";let r=e.split(":").pop()||e;if(r==="bg-white")return"#ffffff";if(r==="bg-black")return"#000000";let n=r.match(/^bg-black\/(\d{1,3})$/i);if(n)return`rgba(0,0,0,${Math.max(0,Math.min(100,Number(n[1])))/100})`;let o=r.match(/^bg-\[([^\]]+)\]$/i);if(o)return Q(o[1]);let a=r.match(/^bg-([a-z]+)-(\d{2,3})$/i);if(!a)return"";let i=je(a[1],a[2]);return i?ua(i):""}function Ur(t=""){return String(t||"").split(/\s+/).map(r=>r.trim()).filter(Boolean).map(r=>ga(r)).filter(Boolean)}function ma(t=""){let e=[],r=String(t||""),n=/([^{}]+)\{([^{}]*)\}/g,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim(),i=String(o[2]||"").trim();a&&i&&e.push({selector:a,body:i}),o=n.exec(r)}return e}function fa(t=""){let e=String(t||"").toLowerCase();return e?/(^|\s|,)(html|body|:root|main)(\s|,|$)|#app\b|#root\b|\.app\b|\.page\b/.test(e):!1}function ha(t=""){let e=String(t||"").trim().match(/rgba?\(\s*([0-9.]+)\s*,\s*([0-9.]+)\s*,\s*([0-9.]+)(?:\s*,\s*([0-9.]+))?\s*\)/i);if(!e)return null;let r=Number.parseFloat(e[1]),n=Number.parseFloat(e[2]),o=Number.parseFloat(e[3]),a=e[4]==null?1:Number.parseFloat(e[4]);return[r,n,o,a].every(i=>Number.isFinite(i))?{r:Math.max(0,Math.min(255,r)),g:Math.max(0,Math.min(255,n)),b:Math.max(0,Math.min(255,o)),a:Math.max(0,Math.min(1,a))}:null}function ba(t=""){let e=String(t||"").trim().match(/^#([0-9a-f]{3,8})$/i);if(!e)return null;let r=e[1].toLowerCase();if(r.length===3){let[n,o,a]=r.split("");return{r:Number.parseInt(`${n}${n}`,16),g:Number.parseInt(`${o}${o}`,16),b:Number.parseInt(`${a}${a}`,16),a:1}}return r.length===6||r.length===8?{r:Number.parseInt(r.slice(0,2),16),g:Number.parseInt(r.slice(2,4),16),b:Number.parseInt(r.slice(4,6),16),a:r.length===8?Number.parseInt(r.slice(6,8),16)/255:1}:null}function Yr(t=""){let e=Q(t);return e?e.startsWith("#")?ba(e):e.startsWith("rgb")?ha(e):null:null}function ya(t){if(!t)return null;let e=a=>{let i=Number(a)/255;return i<=.03928?i/12.92:((i+.055)/1.055)**2.4},r=e(t.r),n=e(t.g),o=e(t.b);return .2126*r+.7152*n+.0722*o}function qr(t=""){let e=String(t||"").trim().toLowerCase();if(!e||e==="transparent")return!0;let r=Yr(e);return r&&Number.isFinite(r.a)?r.a<=.04:!1}function va(t=[],e=[]){let r=t.map(p=>Q(p)).filter(p=>p&&!qr(p)),n=Ie(r);if(n)return{color:n,source:"root"};let o=e.map(p=>Q(p)).filter(p=>p&&!qr(p)),a=o.filter(p=>{let d=Yr(p),c=ya(d);return Number.isFinite(c)?c>=.72:!1}),i=Ie(a);if(i)return{color:i,source:"fallback-bright"};let s=Ie(o);return s?{color:s,source:"fallback"}:{color:"",source:"none"}}function xe(t,e=new Map){let r=String(t||""),n=/([a-z-]+)\s*:\s*([^;{}]+)/gi,o=n.exec(r);for(;o;){let a=String(o[1]||"").trim().toLowerCase(),i=String(o[2]||"").trim();a&&i&&(e.has(a)||e.set(a,[]),e.get(a).push(i)),o=n.exec(r)}return e}function xa(t=""){let e=String(t||""),r=new Map,n=[],o=[],a=[],i=[],s=[],p=[],d=[],c=/#(?:[0-9a-f]{3,8})\b|rgba?\([^)]*\)|hsla?\([^)]*\)/gi,l=u=>{(String(u||"").match(c)||[]).forEach(m=>{let v=Q(m);v&&n.push(v)})};if(typeof DOMParser<"u"&&Vr(e))try{let g=new DOMParser().parseFromString(e,"text/html");Array.from(g.querySelectorAll("style")).map(x=>x.textContent||"").forEach(x=>{xe(x,r),l(x),ma(x).forEach(C=>{if(!fa(C.selector))return;let A=xe(C.body,new Map),L=J(A,["background","background-color"]).map(F=>Q(F)).filter(Boolean);o.push(...L)})}),Array.from(g.querySelectorAll("[style]")).forEach(x=>{let C=x.getAttribute("style")||"";xe(C,r),l(C)}),["html","body","main","#app","#root",".app",".page"].forEach(x=>{let C=g.querySelector(x);if(!C)return;let A=C.getAttribute("style")||"";if(!A)return;let L=xe(A,new Map),F=J(L,["background","background-color"]).map(S=>Q(S)).filter(Boolean);o.push(...F);let I=Ur(C.getAttribute("class")||"");a.push(...I)}),Array.from(g.querySelectorAll("[class]")).forEach(x=>{let C=te(x.getAttribute("class")||"");p.push(...C);let A=Ur(x.getAttribute("class")||"");i.push(...A);let L=String(x.tagName||"").toLowerCase(),F=L==="button"||L==="a",I=C.some(S=>/^bg-/.test(String(re(S).base||"")));F&&I&&A.length&&s.push(...A)});let w=g.body?.textContent||"";w.trim()&&d.push(w),l(g.documentElement?.outerHTML||e)}catch{xe(e,r),l(e),d.push(e)}else xe(e,r),l(e),d.push(e);return{declarations:r,colorValues:n,rootBackgroundColors:o,rootClassBackgroundColors:a,classBackgroundColors:i,buttonBackgroundColors:s,classTokens:p,textCorpus:d.join(`
`)}}function Ie(t=[]){let e=new Map;t.forEach(o=>{let a=String(o||"").trim();a&&e.set(a,(e.get(a)||0)+1)});let r="",n=-1;return e.forEach((o,a)=>{o>n&&(r=a,n=o)}),r}function J(t,e=[]){return e.flatMap(r=>t.get(r)||[])}function wa(t,e){if(!t||!e)return null;let r=String(e).split(".").filter(Boolean),n=t;for(let o of r){if(!n||n.type!=="object"||!n.properties||typeof n.properties!="object")return null;n=n.properties[o]}return n||null}function ka(t={}){let e=t&&typeof t=="object"?t:{},r=z?.configRelations&&typeof z.configRelations=="object"?z.configRelations:{},n=new Set(Object.keys(r)),o=null;if(typeof z?.buildConfigFormSchema=="function")try{o=z.buildConfigFormSchema(e)?.schema||null}catch{o=null}return!o&&z?.configFormSchema?.schema&&(o=z.configFormSchema.schema),{design:e,schema:o,allowedPaths:n}}function Sa(t,e){if(!t)return e;if(Array.isArray(t.oneOf)&&t.oneOf.length){let r=t.oneOf.map(n=>n?.const).filter(n=>n!=null);if(r.length){if(typeof e=="string"){let n=r.find(o=>String(o).toLowerCase()===e.toLowerCase());if(n!==void 0)return n}if(typeof e=="number"){let n=r.map(o=>Number(o)).filter(o=>Number.isFinite(o));if(n.length)return n.reduce((o,a)=>Math.abs(a-e)<Math.abs(o-e)?a:o,n[0])}return r[0]}}if(t.type==="number"||t.type==="integer"){let r=Number(e);return Number.isFinite(r)?t.type==="integer"?Math.round(r):r:void 0}return t.type==="boolean"?!!e:t.type==="string"?String(e||"").trim():e}function $a(t,e,r){let n=String(e||"").split(".").filter(Boolean);if(!n.length)return;let o=t;for(let a=0;a<n.length;a+=1){let i=n[a];if(a===n.length-1){o[i]=r;return}(!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))&&(o[i]={}),o=o[i]}}function D(t,e,r){if(r==null||r===""||t.allowedPaths.size&&!t.allowedPaths.has(e))return;let n=wa(t.schema,e),o=Sa(n,r);o==null||o===""||($a(t.patch,e,o),t.inferredPaths.add(e))}function de(t=[]){let e=t.map(n=>da(n)).filter(n=>Number.isFinite(n));if(!e.length)return null;e.sort((n,o)=>n-o);let r=Math.floor(e.length/2);return e.length%2?e[r]:(e[r-1]+e[r])/2}function Ca(t=[]){let e=t.map(r=>String(r||"").split(",")[0]||"").map(r=>r.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean);return Ie(e)}function Ma(t){let e=Number(t);return Number.isFinite(e)?e<=.75?"hairline":e<=1.5?"thin":e<=2.5?"medium":"thick":"thin"}function za(t=""){let r=String(re(t).base||"").toLowerCase().match(/^rounded(?:-[trbl]{1,2})?(?:-(none|xs|sm|md|lg|xl|2xl|3xl|full))?$/);if(!r)return null;let n=r[1]||"DEFAULT",o={none:0,xs:2,sm:4,DEFAULT:6,md:8,lg:12,xl:16,"2xl":24,"3xl":32};return n==="full"?null:Number.isFinite(o[n])?o[n]:null}function Ea(t=[]){let e=t.map(n=>za(n)).filter(n=>Number.isFinite(n));if(!e.length)return null;e.sort((n,o)=>n-o);let r=Math.floor(e.length/2);return e.length%2?e[r]:(e[r-1]+e[r])/2}function qt(t={}){let e=String(t.html||"");if(!e.trim())return O({source:"html-inference",type:String(t.sourceType||"design-inference"),confidence:0,issues:[{severity:"warning",message:"No HTML or guideline text provided for design extraction."}],designPatch:{},meta:{extractedPathCount:0,extractedPaths:[]}});let r=ka(t.config||{}),n=xa(e),o={patch:{},inferredPaths:new Set,allowedPaths:r.allowedPaths,schema:r.schema},a=J(n.declarations,["color"]).map(q=>Q(q)).filter(Boolean),i=J(n.declarations,["background","background-color"]).map(q=>Q(q)).filter(Boolean),s=[...i,...a,...n.colorValues].filter(Boolean),p=Array.from(new Set(s)),d=[...n.rootBackgroundColors||[]],c=[...n.rootClassBackgroundColors||[]],l=d.length?d:c,u=[...i,...n.classBackgroundColors||[]],g=va(l,u),m=g.color;D(o,"colors.background",m||i[0]||p[0]);let v=p.filter(q=>q&&q!==m),b=Ie(n.buttonBackgroundColors||[])||v[0]||p[0],w=v.filter(q=>q&&q!==b);D(o,"colors.primary",b),D(o,"colors.secondary",w[0]||b||p[0]),D(o,"colors.accent",w[1]||w[0]||b||p[0]);let x=J(n.declarations,["font-family"]),C=Ca(x);D(o,"typography.fontFamilyBody",C),D(o,"typography.fontFamilyHeadings",C),D(o,"typography.fontFamilyMono",/mono|code/i.test(n.textCorpus)?"JetBrains Mono":"");let A=J(n.declarations,["font-size"]),L=de(A);D(o,"typography.baseSize",L);let F=J(n.declarations,["padding","padding-top","padding-right","padding-bottom","padding-left","margin","margin-top","margin-right","margin-bottom","margin-left","gap","row-gap","column-gap"]),I=de(F);D(o,"spatialRhythm.baseUnit",I),D(o,"spatialRhythm.inputPadding",I),D(o,"spatialRhythm.buttonPadding",I);let S=J(n.declarations,["border-radius"]),M=de(S)||Ea(n.classTokens||[]);D(o,"shape.radiusSize",M);let P=J(n.declarations,["border-width","border-top-width","border-right-width","border-bottom-width","border-left-width"]),$=de(P);D(o,"shape.borderWidth",Ma($));let h=J(n.declarations,["max-width"]),k=de(h);D(o,"layout.containerMaxWidth",k),D(o,"layout.maxWidth",k);let E=J(n.declarations,["min-height","height"]),T=de(E);D(o,"layout.buttonMinHeight",T),D(o,"layout.inputMinHeight",T);let B=J(n.declarations,["transition-duration"]),W=de(B.map(q=>{let $e=String(q||"").trim().toLowerCase(),oe=Number.parseFloat($e);return Number.isFinite(oe)?$e.endsWith("ms")?oe:$e.endsWith("s")?oe*1e3:oe:null}));D(o,"behavior.transitionSpeed",W);let N=J(n.declarations,["box-shadow"]).length>0;D(o,"layers.baseShadowOpacity",N?.2:.08);let _=Array.from(o.inferredPaths),Y=_.reduce((q,$e)=>{let oe=$e.split(".")[0];return q[oe]=(q[oe]||0)+1,q},{}),Se=_.length?Math.min(.92,.35+_.length*.02):.25;return O({source:"html-inference",type:String(t.sourceType||"design-inference"),confidence:Se,issues:_.length?[]:[{severity:"warning",message:"Could not infer enough design signals from input."}],designPatch:o.patch,meta:{extractedPathCount:_.length,extractedPaths:_,categoryCoverage:Y,colorSampleSize:p.length,backgroundInference:{source:g.source,candidates:{root:l.length,declaration:i.length,classBased:(n.classBackgroundColors||[]).length}}}})}function Jr(t={}){let e=String(t.input||"").trim(),r=String(t.sourceType||"unknown");if(!e)return O({source:r,type:r,confidence:0,issues:[{severity:"error",message:"No input provided."}],meta:{conversionMode:"none"}});if(Vr(e)){let n=lt({html:e,config:t.config||{}});return O({source:r,type:r,confidence:n.confidence,issues:n.issues,template:n.template,meta:{...n.meta||{},conversionMode:"html-to-pds"}})}return O({source:r,type:r,confidence:.48,issues:[{severity:"info",message:"Input is not HTML; generated text-based preview template."}],template:{id:`${r}-text-import`,name:"Imported Guideline Text",html:`<article class="card surface-base stack-sm"><h3>Imported Guidelines</h3><pre>${ca(e)}</pre></article>`},meta:{conversionMode:"text-preview"}})}function lt(t={}){let e=String(t.html||"").trim();if(!e)return O({source:"tailwind",type:"tailwind-html",confidence:0,issues:[{severity:"error",message:"No HTML provided."}]});let r=ia(e,{config:t.config||{}});return O({source:"tailwind",type:"tailwind-html",confidence:r.confidence,issues:r.issues,template:{id:"tailwind-import",name:"Converted Tailwind Markup",html:r.html},meta:r.meta})}function Gt(t={}){let e=String(t.text||"").trim();if(!e)return O({source:"brand",type:"brand-guidelines",confidence:0,issues:[{severity:"error",message:"No brand guideline text provided."}]});let r=la(e),n={colors:{},typography:{}},o=[];return r?n.colors.primary=r:o.push({severity:"warning",message:"No HEX color found; primary color was not inferred."}),/serif/i.test(e)&&(n.typography.fontFamilyBody="Georgia, serif"),/sans[-\s]?serif/i.test(e)&&(n.typography.fontFamilyBody="Inter, Arial, sans-serif"),/mono|monospace/i.test(e)&&(n.typography.fontFamilyMono="JetBrains Mono, monospace"),O({source:"brand",type:"brand-guidelines",confidence:r?.68:.52,issues:o,designPatch:n,meta:{inferred:{primaryColor:r}}})}var Vt="convert-only",Kr="adopt-design-and-convert";function Ta(t){return String(t||"").trim().toLowerCase()===Kr?Kr:Vt}function Zr(...t){let e=t.flat().filter(Boolean);if(!e.length)return[];let r=new Set;return e.filter(n=>{let o=`${String(n?.severity||"info")}::${String(n?.path||"")}::${String(n?.message||"")}`;return r.has(o)?!1:(r.add(o),!0)})}function Qr(t=[]){let e=t.map(r=>Number(r)).filter(r=>Number.isFinite(r));return e.length?Math.max(0,Math.min(1,e.reduce((r,n)=>r+n,0)/e.length)):0}function Be(t={},e={}){return{...t&&typeof t=="object"?t:{},...e&&typeof e=="object"?e:{}}}function tn(t={},e={}){if(!e||typeof e!="object")return t;let r=Array.isArray(t)?[...t]:{...t};return Object.entries(e).forEach(([n,o])=>{o&&typeof o=="object"&&!Array.isArray(o)?r[n]=tn(r[n]&&typeof r[n]=="object"?r[n]:{},o):r[n]=o}),r}function Xr(t){if(typeof structuredClone=="function")try{return structuredClone(t)}catch{}return JSON.parse(JSON.stringify(t||{}))}function Aa(t={}){let e=Number(t?.ratio),r=Number(t?.min),n=Number.isFinite(e)?e.toFixed(2):"n/a",o=Number.isFinite(r)?r.toFixed(2):"n/a";return{severity:"error",path:String(t?.path||"/colors"),message:`${String(t?.message||"Color contrast validation failed.")} (ratio=${n}, required=${o})`}}function en(t={},e={},r={}){if(!(e&&typeof e=="object"?Object.keys(e):[]).length)return{ok:!0,blocked:!1,issues:[],report:{ok:!0,issues:[]}};let o=Number(r.minContrast),a=Number.isFinite(o)?o:4.5,i=tn(Xr(t||{}),Xr(e||{})),s=lr(i,{minContrast:a,minMutedContrast:3,extendedChecks:!0}),p=Array.isArray(s?.issues)?s.issues.map(d=>Aa(d)):[];return{ok:!!s?.ok,blocked:!s?.ok,issues:p,report:{ok:!!s?.ok,minContrast:a,issues:Array.isArray(s?.issues)?s.issues:[]}}}function La(){return[{id:"template",name:"Templates"},{id:"tailwind-html",name:"Tailwind HTML"},{id:"brand-guidelines",name:"Brand Guidelines"},{id:"figma-json",name:"Figma Tokens JSON (planned)"},{id:"ux-pilot",name:"UX Pilot (planned)"},{id:"google-stitch",name:"Google Stitch (planned)"}]}async function Ra(t={}){let e=String(t.sourceType||""),r=Ta(t.importMode),n=String(t.input||""),o=t.config||null;if(e==="template"){let a=zr(t.templateId,t);return a.meta=Be(a.meta,{importMode:r}),a}if(e==="tailwind-html"){let a=lt({html:n,config:o});if(r===Vt)return a.meta=Be(a.meta,{importMode:r}),a;let i=qt({html:n,config:o,sourceType:e}),s=en(o||{},i.designPatch||{}),p=s.blocked?{}:i.designPatch,d=s.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...s.issues]:[];return O({source:a.source||"tailwind",type:e,confidence:Qr([a.confidence,i.confidence]),issues:Zr(a.issues,i.issues,d),template:a.template,designPatch:p,meta:Be(a.meta,{importMode:r,inference:i.meta,validation:s.report,validationBlocked:s.blocked})})}if(e==="brand-guidelines"){let a=Jr({input:n,sourceType:e,config:o});if(r===Vt)return a.meta=Be(a.meta,{importMode:r}),a;let i=Gt({text:n}),s=qt({html:n,config:o,sourceType:e}),p={...i.designPatch&&typeof i.designPatch=="object"?i.designPatch:{},...s.designPatch&&typeof s.designPatch=="object"?s.designPatch:{}},d=en(o||{},p||{}),c=d.blocked?{}:p,l=d.blocked?[{severity:"error",path:"/colors",message:"Import blocked: inferred design patch failed accessibility contrast validation."},...d.issues]:[];return O({source:"brand",type:e,confidence:Qr([a.confidence,i.confidence,s.confidence]),issues:Zr(a.issues,i.issues,s.issues,l),template:a.template,designPatch:c,meta:Be(a.meta,{importMode:r,inference:s.meta,brandHeuristics:i.meta,validation:d.report,validationBlocked:d.blocked})})}return e==="figma-json"||e==="ux-pilot"||e==="google-stitch"?O({source:e,type:e,confidence:0,issues:[{severity:"info",message:`${e} adapter is not implemented yet in this phase.`}],meta:{importMode:r}}):O({source:e||"unknown",type:"unknown",confidence:0,issues:[{severity:"error",message:"Unsupported import source type."}],meta:{importMode:r}})}var Fa="pds-live-import-history";var ee="imports",ct=null;function Pa(){return typeof globalThis<"u"&&typeof globalThis.indexedDB<"u"}function X(t){return typeof t=="string"?t:""}function dt(t){return Array.isArray(t)?t:[]}function pt(t){return t&&typeof t=="object"?t:{}}function ut(){return Pa()?ct||(ct=new Promise((t,e)=>{let r=globalThis.indexedDB.open(Fa,1);r.onupgradeneeded=()=>{let n=r.result;if(!n.objectStoreNames.contains(ee)){let o=n.createObjectStore(ee,{keyPath:"id",autoIncrement:!0});o.createIndex("createdAt","createdAt",{unique:!1}),o.createIndex("sourceType","sourceType",{unique:!1}),o.createIndex("fileName","fileName",{unique:!1})}},r.onsuccess=()=>t(r.result),r.onerror=()=>e(r.error||new Error("Failed to open import history database."))}),ct):Promise.resolve(null)}function gt(t){return new Promise((e,r)=>{t.onsuccess=()=>e(t.result),t.onerror=()=>r(t.error||new Error("IndexedDB operation failed."))})}function Na(t={}){let e=Date.now(),r=Number.isFinite(Number(t.createdAt))?Number(t.createdAt):e,n=new Date(r).toISOString(),o=dt(t.issues).map(p=>({severity:X(p?.severity||"info"),message:X(p?.message||"")})),a=dt(t.notes).filter(p=>typeof p=="string"),i=dt(t.unknownTailwindTokens).filter(p=>typeof p=="string"),s=dt(t.appliedRules).filter(p=>typeof p=="string");return{createdAt:r,createdAtIso:n,sourceType:X(t.sourceType||"unknown"),importMode:X(t.importMode||"convert-only"),source:X(t.source||"unknown"),type:X(t.type||"unknown"),fileName:X(t.fileName||""),fileSize:Number.isFinite(Number(t.fileSize))?Number(t.fileSize):0,mimeType:X(t.mimeType||""),fileContents:X(t.fileContents||""),convertedHtml:X(t.convertedHtml||""),confidence:Number.isFinite(Number(t.confidence))?Number(t.confidence):0,notes:a,issues:o,coverage:pt(t.coverage),unknownTailwindTokens:i,appliedRules:s,importStyleSheetInjected:!!t.importStyleSheetInjected,templateName:X(t.templateName||""),designPatch:pt(t.designPatch),meta:pt(t.meta),resultSnapshot:pt(t.resultSnapshot)}}async function Ia(t={}){let e=await ut();if(!e)return null;let r=Na(t),o=e.transaction(ee,"readwrite").objectStore(ee);return{id:await gt(o.add(r)),...r}}async function ja(t={}){let e=await ut();if(!e)return[];let r=Number.isFinite(Number(t.limit))?Math.max(1,Number(t.limit)):30,o=e.transaction(ee,"readonly").objectStore(ee);return(await gt(o.getAll())||[]).sort((i,s)=>Number(s?.createdAt||0)-Number(i?.createdAt||0)).slice(0,r)}async function Ba(t){let e=await ut();if(!e)return null;let r=Number(t);if(!Number.isFinite(r))return null;let o=e.transaction(ee,"readonly").objectStore(ee);return await gt(o.get(r))||null}async function _a(){let t=await ut();if(!t)return;let r=t.transaction(ee,"readwrite").objectStore(ee);await gt(r.clear())}export{_a as clearLiveImportHistory,Gt as convertBrandGuidelinesToPatch,lt as convertTailwindHtmlToPds,O as createImportResult,sa as describeTailwindConversionRules,Ba as getLiveImportHistoryEntry,La as getLiveImportSources,Zn as isImportResult,ja as listLiveImportHistory,Mr as listLiveTemplates,fr as loadGoogleFont,Xe as loadLiveTemplateCatalog,Ra as runLiveImport,Ia as saveLiveImportHistory,Yn as startLive};
